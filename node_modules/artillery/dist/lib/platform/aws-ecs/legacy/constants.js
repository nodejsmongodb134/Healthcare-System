...
export const LOGGROUP_RETENTION_DAYS = process.env.ARTILLERY_LOGGROUP_RETENTION_DAYS || 180;
export const IMAGE_VERSION = process.env.ECR_IMAGE_VERSION || DEFAULT_IMAGE_TAG;
export const WAIT_TIMEOUT = WAIT_TIMEOUT_SEC;
export const TEST_RUNS_MAX_TAGS = parseInt(process.env.TEST_RUNS_MAX_TAGS, 10) || 8;
