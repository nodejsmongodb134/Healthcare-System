...
function getAQS() {
    ...
    return new QueueClient(process.env.AZURE_STORAGE_QUEUE_URL, new DefaultAzureCredential());
}
...
function getBlobClient() {
    if (!blobContainerClient) {
        ...
        if (!storageAccount || !containerName) {
            throw new Error('AZURE_STORAGE_ACCOUNT and AZURE_STORAGE_BLOB_CONTAINER must be set');
        }
