...
import { createBOM, enrichPackageJson, prettyPrint } from "./bom.js";
...
function prepareManifest(context, callback) {
    ...
    createBOM(fileToAnalyse, extraFiles, {
...
async function syncS3(context) {
    ...
    return new Promise((resolve, reject) => {
        A.eachLimit(context.manifest.files, 3, async (item, eachDone) => {
            ...
            if (item.noPrefix === 'package.json') {
                body = Buffer.from(enrichPackageJson(body.toString(), context.manifest.moduleVersions));
            }
...
export { tryCreateTest, createTest, syncS3, prepareManifest };
