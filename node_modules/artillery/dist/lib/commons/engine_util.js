...
export { createThink, createLoopWithCount, createParallel, isProbableEnough, template, captureOrMatch, evil, ensurePropertyIsAList, renderVariables as _renderVariables };
    ...
    if (o && (o.constructor === Object || o.constructor === Array)) {
        ...
        if (match) {
            ...
            if (syntax.body &&
                ...
                const args = L.map(syntax.body[0].expression.arguments, (arg) => arg.value);
                ...
                if (funcName in funcs) {
                    return template(o.replace(funcCallRegex, funcs[funcName].apply(null, args)), context);
                }
            }
        }
        else {
...
function isCaptureFailed(v, defaultStrict) {
    const noValue = typeof v.value === 'undefined' ||
        v.value === '' ||
        typeof v.error !== 'undefined';
    if (!noValue) {
        return false;
    }
    return !((typeof defaultStrict === 'undefined' && v.strict === false) ||
...
function captureOrMatch(params, 
...
response, context, done) {
    ...
    async.eachSeries(specs, (spec, next) => {
...
function isJSON(res) {
    ...
    return Boolean(headers['content-type'] &&
