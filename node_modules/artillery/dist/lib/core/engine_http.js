...
function createAgents(proxies, opts) {
    ...
    if (proxies.https) {
        return {
            ...
            httpsAgent: new HttpsProxyAgent(Object.assign({ proxy: proxies.https }, agentOpts))
        };
    }
...
export default class HttpEngine {
    ...
    _isDistributedTracingEnabled(config) {
            ...
            async.eachSeries(functionNames, function iteratee(functionName, next) {
                ...
                function responseProcessor(isLast, res, body, done) {
                    if (process.env.DEBUG) {
                        ...
                        const jarInternal = context._jar._jar;
                        if (jarInternal &&
    ...
    _handleResponse(requestParams, res, ee, context, responseProcessor, callback) {
