...
function replaceMetricsWithHashes(replacementsArray, targetString) {
    ...
    if (skippedMetrics.length > 0) {
        debug("WARNING: The following metrics from the report were skipped because they weren't found in your expression. It's possible you misspelled them or they're not being reported by your test.");
