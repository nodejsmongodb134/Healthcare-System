...
export declare class AWSIntegrationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getAWSMetricNameFilterPreview(awsAccountConfigId: string, _options?: Configuration): Promise<RequestContext>;
    ...
    previewAWSMetricNameFilter(awsAccountConfigId: string, body: AWSMetricNameFilterPreviewRequest, _options?: Configuration): Promise<RequestContext>;
...
export declare class AWSIntegrationApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getAWSMetricNameFilterPreview(response: ResponseContext): Promise<AWSMetricNameFilterPreviewResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    previewAWSMetricNameFilter(response: ResponseContext): Promise<AWSMetricNameFilterPreviewResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export declare class AWSIntegrationApi {
     ...
     * @param param The request object
     */
    getAWSMetricNameFilterPreview(param: AWSIntegrationApiGetAWSMetricNameFilterPreviewRequest, options?: Configuration): Promise<AWSMetricNameFilterPreviewResponse>;
    /**
     ...
     * @param param The request object
     */
    previewAWSMetricNameFilter(param: AWSIntegrationApiPreviewAWSMetricNameFilterRequest, options?: Configuration): Promise<AWSMetricNameFilterPreviewResponse>;
    /**
