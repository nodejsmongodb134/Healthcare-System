...
export declare class DORAMetricsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    patchDORADeploymentByVersion(body: DORADeploymentPatchByVersionRequest, _options?: Configuration): Promise<RequestContext>;
}
export declare class DORAMetricsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    patchDORADeploymentByVersion(response: ResponseContext): Promise<void>;
}
...
export declare class DORAMetricsApi {
     ...
     * @param param The request object
     */
    patchDORADeploymentByVersion(param: DORAMetricsApiPatchDORADeploymentByVersionRequest, options?: Configuration): Promise<void>;
}
