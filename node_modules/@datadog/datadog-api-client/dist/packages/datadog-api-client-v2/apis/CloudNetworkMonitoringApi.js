...
class CloudNetworkMonitoringApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getAggregatedConnections(from, to, groupBy, tags, query, limit, _options) {
    ...
    getAggregatedDns(from, to, groupBy, tags, query, limit, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
...
class CloudNetworkMonitoringApi {
    ...
    getAggregatedConnections(param = {}, options) {
        const requestContextPromise = this.requestFactory.getAggregatedConnections(param.from, param.to, param.groupBy, param.tags, param.query, param.limit, options);
    ...
    getAggregatedDns(param = {}, options) {
        const requestContextPromise = this.requestFactory.getAggregatedDns(param.from, param.to, param.groupBy, param.tags, param.query, param.limit, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
