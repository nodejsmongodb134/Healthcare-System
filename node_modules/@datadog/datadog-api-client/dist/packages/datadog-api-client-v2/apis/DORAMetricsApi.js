...
class DORAMetricsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    patchDORADeploymentByVersion(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'patchDORADeploymentByVersion'");
            if (!_config.unstableOperations["v2.patchDORADeploymentByVersion"]) {
                throw new Error("Unstable operation 'patchDORADeploymentByVersion' is disabled");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "patchDORADeploymentByVersion");
            }
            // Path Params
            const localVarPath = "/api/v2/dora/deployments";
            // Make Request Context
            const requestContext = _config
                .getServer("v2.DORAMetricsApi.patchDORADeploymentByVersion")
                .makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
            requestContext.setHeaderParam("Accept", "*/*");
            requestContext.setHttpConfig(_config.httpConfig);
            // Set IaC header
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "DORADeploymentPatchByVersionRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class DORAMetricsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    patchDORADeploymentByVersion(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 202) {
                return;
...
class DORAMetricsApi {
     ...
     * @param param The request object
     */
    patchDORADeploymentByVersion(param, options) {
        const requestContextPromise = this.requestFactory.patchDORADeploymentByVersion(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.patchDORADeploymentByVersion(responseContext);
            });
        });
    }
}
