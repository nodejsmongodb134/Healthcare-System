...
class MicrosoftTeamsIntegrationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    deleteMSTeamsUserBinding(tenantId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tenantId' is not null or undefined
            if (tenantId === null || tenantId === undefined) {
                throw new baseapi_1.RequiredError("tenantId", "deleteMSTeamsUserBinding");
            }
            // Path Params
            const localVarPath = "/api/v2/integration/ms-teams/configuration/user-binding/{tenant_id}".replace("{tenant_id}", encodeURIComponent(String(tenantId)));
            // Make Request Context
            const requestContext = _config
...
class MicrosoftTeamsIntegrationApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteMSTeamsUserBinding(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
...
class MicrosoftTeamsIntegrationApi {
     ...
     * @param param The request object
     */
    deleteMSTeamsUserBinding(param, options) {
        const requestContextPromise = this.requestFactory.deleteMSTeamsUserBinding(param.tenantId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
