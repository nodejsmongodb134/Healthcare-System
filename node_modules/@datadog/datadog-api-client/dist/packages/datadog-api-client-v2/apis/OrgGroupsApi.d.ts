...
export declare class OrgGroupsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    listOrgGroupPolicySuggestions(filterOrgGroupId: string, _options?: Configuration): Promise<RequestContext>;
...
export declare class OrgGroupsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listOrgGroupPolicySuggestions(response: ResponseContext): Promise<OrgGroupPolicySuggestionListResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export declare class OrgGroupsApi {
     ...
     * @param param The request object
     */
    listOrgGroupPolicySuggestions(param: OrgGroupsApiListOrgGroupPolicySuggestionsRequest, options?: Configuration): Promise<OrgGroupPolicySuggestionListResponse>;
    /**
