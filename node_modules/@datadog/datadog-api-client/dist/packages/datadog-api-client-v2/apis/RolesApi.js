...
class RolesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    listRoleTemplates(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listRoleTemplates'");
...
class RolesApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listRoleTemplates(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "RoleTemplateArray");
                return body;
            }
