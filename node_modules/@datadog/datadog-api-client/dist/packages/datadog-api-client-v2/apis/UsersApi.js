...
class UsersApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    anonymizeUsers(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'anonymizeUsers'");
            if (!_config.unstableOperations["v2.anonymizeUsers"]) {
                throw new Error("Unstable operation 'anonymizeUsers' is disabled");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "anonymizeUsers");
            }
            // Path Params
            const localVarPath = "/api/v2/anonymize_users";
            // Make Request Context
            const requestContext = _config
                .getServer("v2.UsersApi.anonymizeUsers")
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "AnonymizeUsersRequest", ""), contentType);
    ...
    deleteUserInvitations(userId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new baseapi_1.RequiredError("userId", "deleteUserInvitations");
            }
            // Path Params
            const localVarPath = "/api/v2/users/{user_id}/invitations".replace("{user_id}", encodeURIComponent(String(userId)));
            // Make Request Context
            const requestContext = _config
    ...
    getUserIdentityProviders(userId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new baseapi_1.RequiredError("userId", "getUserIdentityProviders");
            }
            // Path Params
            const localVarPath = "/api/v2/users/{user_id}/identity_providers".replace("{user_id}", encodeURIComponent(String(userId)));
            // Make Request Context
            const requestContext = _config
                .getServer("v2.UsersApi.getUserIdentityProviders")
                .makeRequestContext(localVarPath, http_1.HttpMethod.GET);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Set IaC header
    ...
    updateCurrentUser(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateCurrentUser");
            }
            // Path Params
            const localVarPath = "/api/v2/current_user";
            // Make Request Context
    ...
    updateUserIdentityProviders(userId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new baseapi_1.RequiredError("userId", "updateUserIdentityProviders");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateUserIdentityProviders");
            }
            // Path Params
            const localVarPath = "/api/v2/users/{user_id}/relationships/identity_providers".replace("{user_id}", encodeURIComponent(String(userId)));
            // Make Request Context
            const requestContext = _config
                .getServer("v2.UsersApi.updateUserIdentityProviders")
                .makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
            requestContext.setHeaderParam("Accept", "*/*");
            requestContext.setHttpConfig(_config.httpConfig);
            // Set IaC header
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "UpdateUserIdentityProvidersRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class UsersApiResponseProcessor {
     ...
     */
    anonymizeUsers(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "AnonymizeUsersResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteUserInvitations(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                return;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getUserIdentityProviders
     * @throws ApiException if the response code was not in [200, 299]
     */
    getUserIdentityProviders(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "UserOverrideIdentityProvidersResponse");
                return body;
            }
            if (response.httpStatusCode === 403 ||
                response.httpStatusCode === 404 ||
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateUserIdentityProviders
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateUserIdentityProviders(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
...
class UsersApi {
     ...
     */
    anonymizeUsers(param, options) {
        const requestContextPromise = this.requestFactory.anonymizeUsers(param.body, options);
     ...
     * @param param The request object
     */
    deleteUserInvitations(param, options) {
        const requestContextPromise = this.requestFactory.deleteUserInvitations(param.userId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    getUserIdentityProviders(param, options) {
        const requestContextPromise = this.requestFactory.getUserIdentityProviders(param.userId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.getUserIdentityProviders(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    updateCurrentUser(param, options) {
        const requestContextPromise = this.requestFactory.updateCurrentUser(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    updateUserIdentityProviders(param, options) {
        const requestContextPromise = this.requestFactory.updateUserIdentityProviders(param.userId, param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.updateUserIdentityProviders(responseContext);
            });
        });
    }
}
