...
class CaseManagementTypeApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    updateCaseType(caseTypeId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'caseTypeId' is not null or undefined
            if (caseTypeId === null || caseTypeId === undefined) {
                throw new baseapi_1.RequiredError("caseTypeId", "updateCaseType");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateCaseType");
            }
            // Path Params
            const localVarPath = "/api/v2/cases/types/{case_type_id}".replace("{case_type_id}", encodeURIComponent(String(caseTypeId)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "CaseTypeUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class CaseManagementTypeApi {
     ...
     * @param param The request object
     */
    updateCaseType(param, options) {
        const requestContextPromise = this.requestFactory.updateCaseType(param.caseTypeId, param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
