...
class KeyManagementApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    createPersonalAccessToken(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createPersonalAccessToken");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "PersonalAccessTokenCreateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    getPersonalAccessToken(tokenId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tokenId' is not null or undefined
            if (tokenId === null || tokenId === undefined) {
                throw new baseapi_1.RequiredError("tokenId", "getPersonalAccessToken");
            }
            // Path Params
            const localVarPath = "/api/v2/personal_access_tokens/{token_id}".replace("{token_id}", encodeURIComponent(String(tokenId)));
            // Make Request Context
            const requestContext = _config
    ...
    listApplicationKeys(pageSize, pageNumber, sort, filter, filterCreatedAtStart, filterCreatedAtEnd, filterOwnedBy, include, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            ...
            if (filterOwnedBy !== undefined) {
                requestContext.setQueryParam("filter[owned_by]", ObjectSerializer_1.ObjectSerializer.serialize(filterOwnedBy, "string", ""), "");
            }
            if (include !== undefined) {
                requestContext.setQueryParam("include", ObjectSerializer_1.ObjectSerializer.serialize(include, "string", ""), "");
            }
    ...
    listPersonalAccessTokens(pageSize, pageNumber, sort, filter, filterOwnedBy, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            const localVarPath = "/api/v2/personal_access_tokens";
            ...
            if (filterOwnedBy !== undefined) {
                requestContext.setQueryParam("filter[owned_by]", ObjectSerializer_1.ObjectSerializer.serialize(filterOwnedBy, "Array<string>", ""), "multi");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    revokePersonalAccessToken(tokenId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tokenId' is not null or undefined
            if (tokenId === null || tokenId === undefined) {
                throw new baseapi_1.RequiredError("tokenId", "revokePersonalAccessToken");
            }
            // Path Params
            const localVarPath = "/api/v2/personal_access_tokens/{token_id}".replace("{token_id}", encodeURIComponent(String(tokenId)));
            // Make Request Context
    ...
    updatePersonalAccessToken(tokenId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tokenId' is not null or undefined
            if (tokenId === null || tokenId === undefined) {
                throw new baseapi_1.RequiredError("tokenId", "updatePersonalAccessToken");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updatePersonalAccessToken");
            }
            // Path Params
            const localVarPath = "/api/v2/personal_access_tokens/{token_id}".replace("{token_id}", encodeURIComponent(String(tokenId)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "PersonalAccessTokenUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    validate(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'validate'");
...
class KeyManagementApiResponseProcessor {
    ...
    createPersonalAccessToken(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PersonalAccessTokenCreateResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
    ...
    getPersonalAccessToken(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PersonalAccessTokenResponse");
                return body;
            }
            if (response.httpStatusCode === 403 ||
                response.httpStatusCode === 404 ||
    ...
    listPersonalAccessTokens(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListPersonalAccessTokensResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    revokePersonalAccessToken(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
    ...
    validate(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ValidateV2Response");
                return body;
            }
            if (response.httpStatusCode === 403) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
    ...
    validateAPIKey(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ValidateAPIKeyResponse");
                return body;
            }
...
class KeyManagementApi {
     ...
     * @param param The request object
     */
    createPersonalAccessToken(param, options) {
        const requestContextPromise = this.requestFactory.createPersonalAccessToken(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    getPersonalAccessToken(param, options) {
        const requestContextPromise = this.requestFactory.getPersonalAccessToken(param.tokenId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
    ...
    listApplicationKeys(param = {}, options) {
        const requestContextPromise = this.requestFactory.listApplicationKeys(param.pageSize, param.pageNumber, param.sort, param.filter, param.filterCreatedAtStart, param.filterCreatedAtEnd, param.filterOwnedBy, param.include, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    listPersonalAccessTokens(param = {}, options) {
        const requestContextPromise = this.requestFactory.listPersonalAccessTokens(param.pageSize, param.pageNumber, param.sort, param.filter, param.filterOwnedBy, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    revokePersonalAccessToken(param, options) {
        const requestContextPromise = this.requestFactory.revokePersonalAccessToken(param.tokenId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    updatePersonalAccessToken(param, options) {
        const requestContextPromise = this.requestFactory.updatePersonalAccessToken(param.tokenId, param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
