...
class SlackIntegrationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    listSlackUserBindings(userUuid, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'userUuid' is not null or undefined
            if (userUuid === null || userUuid === undefined) {
                throw new baseapi_1.RequiredError("userUuid", "listSlackUserBindings");
            }
            // Path Params
            ...
            if (userUuid !== undefined) {
                requestContext.setQueryParam("user_uuid", ObjectSerializer_1.ObjectSerializer.serialize(userUuid, "string", "uuid"), "");
            }
            // Apply auth methods
...
class SlackIntegrationApiResponseProcessor {
     ...
     */
    listSlackUserBindings(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SlackUserBindingsResponse");
                return body;
            }
...
class SlackIntegrationApi {
     ...
     */
    listSlackUserBindings(param, options) {
