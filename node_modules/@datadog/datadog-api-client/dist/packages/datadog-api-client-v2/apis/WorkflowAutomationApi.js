...
class WorkflowAutomationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    listWorkflows(limit, page, sort, filterQuery, filterTriggerIds, filterIncludeUnpublished, filterIncludeSpecs, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            const localVarPath = "/api/v2/workflows";
            ...
            if (filterTriggerIds !== undefined) {
                requestContext.setQueryParam("filter[triggerIds]", ObjectSerializer_1.ObjectSerializer.serialize(filterTriggerIds, "Array<string>", ""), "multi");
            }
            if (filterIncludeUnpublished !== undefined) {
                requestContext.setQueryParam("filter[includeUnpublished]", ObjectSerializer_1.ObjectSerializer.serialize(filterIncludeUnpublished, "boolean", ""), "");
            }
            if (filterIncludeSpecs !== undefined) {
                requestContext.setQueryParam("filter[includeSpecs]", ObjectSerializer_1.ObjectSerializer.serialize(filterIncludeSpecs, "boolean", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class WorkflowAutomationApiResponseProcessor {
    ...
    listWorkflows(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListWorkflowsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
...
class WorkflowAutomationApi {
     ...
     * @param param The request object
     */
    listWorkflows(param = {}, options) {
        const requestContextPromise = this.requestFactory.listWorkflows(param.limit, param.page, param.sort, param.filterQuery, param.filterTriggerIds, param.filterIncludeUnpublished, param.filterIncludeSpecs, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     */
    listWorkflowsWithPagination(param = {}, options) {
        return __asyncGenerator(this, arguments, function* listWorkflowsWithPagination_1() {
            let pageSize = 50;
            ...
            param.page = 0;
            while (true) {
                const requestContext = yield __await(this.requestFactory.listWorkflows(param.limit, param.page, param.sort, param.filterQuery, param.filterTriggerIds, param.filterIncludeUnpublished, param.filterIncludeSpecs, options));
                const responseContext = yield __await(this.configuration.httpApi.send(requestContext));
                const response = yield __await(this.responseProcessor.listWorkflows(responseContext));
