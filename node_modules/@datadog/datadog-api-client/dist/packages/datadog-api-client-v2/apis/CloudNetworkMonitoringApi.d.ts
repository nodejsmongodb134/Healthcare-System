...
export declare class CloudNetworkMonitoringApiRequestFactory extends BaseAPIRequestFactory {
    getAggregatedConnections(from?: number, to?: number, groupBy?: string, tags?: string, query?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
    getAggregatedDns(from?: number, to?: number, groupBy?: string, tags?: string, query?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
}
