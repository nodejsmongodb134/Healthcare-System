...
import { SecurityEntityRiskScoreResponse } from "../models/SecurityEntityRiskScoreResponse";
...
export declare class EntityRiskScoresApiRequestFactory extends BaseAPIRequestFactory {
    getEntityRiskScore(entityId: string, _options?: Configuration): Promise<RequestContext>;
...
export declare class EntityRiskScoresApiResponseProcessor {
     ...
     */
    getEntityRiskScore(response: ResponseContext): Promise<SecurityEntityRiskScoreResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export interface EntityRiskScoresApiGetEntityRiskScoreRequest {
    /**
...
export declare class EntityRiskScoresApi {
     ...
     */
    getEntityRiskScore(param: EntityRiskScoresApiGetEntityRiskScoreRequest, options?: Configuration): Promise<SecurityEntityRiskScoreResponse>;
    /**
