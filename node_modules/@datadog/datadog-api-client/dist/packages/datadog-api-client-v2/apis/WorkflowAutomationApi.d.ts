...
export declare class WorkflowAutomationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    listWorkflows(limit?: number, page?: number, sort?: string, filterQuery?: string, filterTriggerIds?: Array<string>, filterIncludeUnpublished?: boolean, filterIncludeSpecs?: boolean, _options?: Configuration): Promise<RequestContext>;
...
export declare class WorkflowAutomationApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listWorkflows(response: ResponseContext): Promise<ListWorkflowsResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export declare class WorkflowAutomationApi {
     ...
     * @param param The request object
     */
    listWorkflows(param?: WorkflowAutomationApiListWorkflowsRequest, options?: Configuration): Promise<ListWorkflowsResponse>;
    /**
     * Provide a paginated version of listWorkflows returning a generator with all the items.
     */
    listWorkflowsWithPagination(param?: WorkflowAutomationApiListWorkflowsRequest, options?: Configuration): AsyncGenerator<WorkflowListItem>;
    /**
