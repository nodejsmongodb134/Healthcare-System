...
class CaseManagementAttributeApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    updateCustomAttributeConfig(caseTypeId, customAttributeId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'caseTypeId' is not null or undefined
            if (caseTypeId === null || caseTypeId === undefined) {
                throw new baseapi_1.RequiredError("caseTypeId", "updateCustomAttributeConfig");
            }
            // verify required parameter 'customAttributeId' is not null or undefined
            if (customAttributeId === null || customAttributeId === undefined) {
                throw new baseapi_1.RequiredError("customAttributeId", "updateCustomAttributeConfig");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateCustomAttributeConfig");
            }
            // Path Params
            const localVarPath = "/api/v2/cases/types/{case_type_id}/custom_attributes/{custom_attribute_id}"
                .replace("{case_type_id}", encodeURIComponent(String(caseTypeId)))
            ...
            // Make Request Context
            const requestContext = _config
                .getServer("v2.CaseManagementAttributeApi.updateCustomAttributeConfig")
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "CustomAttributeConfigUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class CaseManagementAttributeApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateCustomAttributeConfig
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateCustomAttributeConfig(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CustomAttributeConfigResponse");
...
class CaseManagementAttributeApi {
     ...
     * @param param The request object
     */
    updateCustomAttributeConfig(param, options) {
        const requestContextPromise = this.requestFactory.updateCustomAttributeConfig(param.caseTypeId, param.customAttributeId, param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
