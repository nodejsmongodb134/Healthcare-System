...
class EntityRiskScoresApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getEntityRiskScore(entityId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getEntityRiskScore'");
            ...
            if (entityId === null || entityId === undefined) {
                throw new baseapi_1.RequiredError("entityId", "getEntityRiskScore");
            }
            // Path Params
            const localVarPath = "/api/v2/security-entities/risk-scores/{entity_id}".replace("{entity_id}", encodeURIComponent(String(entityId)));
...
class EntityRiskScoresApiResponseProcessor {
     ...
     */
    getEntityRiskScore(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SecurityEntityRiskScoreResponse");
                return body;
            }
...
class EntityRiskScoresApi {
     ...
     */
    getEntityRiskScore(param, options) {
