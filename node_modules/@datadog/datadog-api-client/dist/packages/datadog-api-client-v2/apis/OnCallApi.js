...
class OnCallApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    getScheduleOnCallResponders(scheduleId, include, filterPosition, filterAtTs, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'scheduleId' is not null or undefined
            if (scheduleId === null || scheduleId === undefined) {
                throw new baseapi_1.RequiredError("scheduleId", "getScheduleOnCallResponders");
            }
            // Path Params
            const localVarPath = "/api/v2/on-call/schedules/{schedule_id}/responders".replace("{schedule_id}", encodeURIComponent(String(scheduleId)));
            // Make Request Context
            const requestContext = _config
            ...
            if (filterPosition !== undefined) {
                requestContext.setQueryParam("filter[position]", ObjectSerializer_1.ObjectSerializer.serialize(filterPosition, "string", ""), "");
            }
...
class OnCallApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getScheduleOnCallResponders(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ScheduleOnCallResponders");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
...
class OnCallApi {
     ...
     * @param param The request object
     */
    getScheduleOnCallResponders(param, options) {
        const requestContextPromise = this.requestFactory.getScheduleOnCallResponders(param.scheduleId, param.include, param.filterPosition, param.filterAtTs, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
