...
export declare class OnCallApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getScheduleOnCallResponders(scheduleId: string, include?: string, filterPosition?: string, filterAtTs?: string, _options?: Configuration): Promise<RequestContext>;
...
export declare class OnCallApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getScheduleOnCallResponders(response: ResponseContext): Promise<ScheduleOnCallResponders>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export declare class OnCallApi {
     ...
     * @param param The request object
     */
    getScheduleOnCallResponders(param: OnCallApiGetScheduleOnCallRespondersRequest, options?: Configuration): Promise<ScheduleOnCallResponders>;
    /**
