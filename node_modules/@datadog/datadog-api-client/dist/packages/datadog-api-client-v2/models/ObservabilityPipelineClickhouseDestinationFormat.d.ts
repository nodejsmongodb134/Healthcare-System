 ...
 */
export declare type ObservabilityPipelineClickhouseDestinationFormat = typeof JSON_EACH_ROW | typeof JSON_AS_OBJECT | typeof JSON_AS_STRING | typeof ARROW_STREAM | UnparsedObject;
export declare const JSON_EACH_ROW = "json_each_row";
export declare const JSON_AS_OBJECT = "json_as_object";
export declare const JSON_AS_STRING = "json_as_string";
export declare const ARROW_STREAM = "arrow_stream";
