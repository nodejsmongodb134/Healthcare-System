...
const BarChartWidgetDefinition_1 = require("./BarChartWidgetDefinition");
const BarChartWidgetFlat_1 = require("./BarChartWidgetFlat");
const BarChartWidgetRequest_1 = require("./BarChartWidgetRequest");
const BarChartWidgetStacked_1 = require("./BarChartWidgetStacked");
const BarChartWidgetStyle_1 = require("./BarChartWidgetStyle");
const CalendarInterval_1 = require("./CalendarInterval");
...
const CohortWidgetDefinition_1 = require("./CohortWidgetDefinition");
const ComparisonCustomTimeframe_1 = require("./ComparisonCustomTimeframe");
const ComparisonDuration_1 = require("./ComparisonDuration");
...
const DashboardFixedTimeframe_1 = require("./DashboardFixedTimeframe");
...
const DashboardLiveTimeframe_1 = require("./DashboardLiveTimeframe");
...
const DashboardTab_1 = require("./DashboardTab");
...
const DataProjectionQuery_1 = require("./DataProjectionQuery");
const DatasetListQuery_1 = require("./DatasetListQuery");
const DatasetListQuerySort_1 = require("./DatasetListQuerySort");
const DatasetListQuerySortField_1 = require("./DatasetListQuerySortField");
...
const FormulaAndFunctionApmMetricsQueryDefinition_1 = require("./FormulaAndFunctionApmMetricsQueryDefinition");
...
const FormulaAndFunctionEventQueryGroupByFields_1 = require("./FormulaAndFunctionEventQueryGroupByFields");
...
const FormulaAndFunctionProductAnalyticsExtendedQueryDefinition_1 = require("./FormulaAndFunctionProductAnalyticsExtendedQueryDefinition");
const FormulaAndFunctionRetentionQueryDefinition_1 = require("./FormulaAndFunctionRetentionQueryDefinition");
const FormulaAndFunctionSLOQueryDefinition_1 = require("./FormulaAndFunctionSLOQueryDefinition");
const FormulaAndFunctionUserJourneyQueryDefinition_1 = require("./FormulaAndFunctionUserJourneyQueryDefinition");
const FreeTextWidgetDefinition_1 = require("./FreeTextWidgetDefinition");
const FunnelComparisonCustomTimeframe_1 = require("./FunnelComparisonCustomTimeframe");
const FunnelComparisonDuration_1 = require("./FunnelComparisonDuration");
...
const GCPMonitoredResourceConfig_1 = require("./GCPMonitoredResourceConfig");
...
const GeomapWidgetRequestStyle_1 = require("./GeomapWidgetRequestStyle");
...
const HeatMapWidgetXAxis_1 = require("./HeatMapWidgetXAxis");
...
const HostMapWidgetFormula_1 = require("./HostMapWidgetFormula");
const HostMapWidgetGroupBy_1 = require("./HostMapWidgetGroupBy");
const HostMapWidgetInfrastructureRequest_1 = require("./HostMapWidgetInfrastructureRequest");
const HostMapWidgetInfrastructureRequestLeaf_1 = require("./HostMapWidgetInfrastructureRequestLeaf");
const HostMapWidgetInfrastructureStyle_1 = require("./HostMapWidgetInfrastructureStyle");
const HostMapWidgetProjection_1 = require("./HostMapWidgetProjection");
const HostMapWidgetProjectionDimensionMapping_1 = require("./HostMapWidgetProjectionDimensionMapping");
const HostMapWidgetScalarRequest_1 = require("./HostMapWidgetScalarRequest");
...
const LogsAPILimitReachedResponse_1 = require("./LogsAPILimitReachedResponse");
const LogsArithmeticProcessor_1 = require("./LogsArithmeticProcessor");
const LogsArrayMapArithmeticSubProcessor_1 = require("./LogsArrayMapArithmeticSubProcessor");
const LogsArrayMapAttributeRemapper_1 = require("./LogsArrayMapAttributeRemapper");
const LogsArrayMapCategorySubProcessor_1 = require("./LogsArrayMapCategorySubProcessor");
const LogsArrayMapProcessor_1 = require("./LogsArrayMapProcessor");
const LogsArrayMapStringBuilderSubProcessor_1 = require("./LogsArrayMapStringBuilderSubProcessor");
...
const LogsArrayProcessorOperationExtractKeyValue_1 = require("./LogsArrayProcessorOperationExtractKeyValue");
...
const LogsDecoderProcessor_1 = require("./LogsDecoderProcessor");
const LogsExcludeAttributeProcessor_1 = require("./LogsExcludeAttributeProcessor");
...
const LogsSchemaCategoryMapper_1 = require("./LogsSchemaCategoryMapper");
const LogsSchemaCategoryMapperCategory_1 = require("./LogsSchemaCategoryMapperCategory");
const LogsSchemaCategoryMapperFallback_1 = require("./LogsSchemaCategoryMapperFallback");
const LogsSchemaCategoryMapperTargets_1 = require("./LogsSchemaCategoryMapperTargets");
const LogsSchemaData_1 = require("./LogsSchemaData");
const LogsSchemaProcessor_1 = require("./LogsSchemaProcessor");
const LogsSchemaRemapper_1 = require("./LogsSchemaRemapper");
...
const MonitorAsset_1 = require("./MonitorAsset");
const MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition_1 = require("./MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition");
const MonitorFormulaAndFunctionAggregateFilteredQueryDefinition_1 = require("./MonitorFormulaAndFunctionAggregateFilteredQueryDefinition");
const MonitorFormulaAndFunctionAggregateQueryFilter_1 = require("./MonitorFormulaAndFunctionAggregateQueryFilter");
const MonitorFormulaAndFunctionAggregateQueryJoinCondition_1 = require("./MonitorFormulaAndFunctionAggregateQueryJoinCondition");
const MonitorFormulaAndFunctionCostQueryDefinition_1 = require("./MonitorFormulaAndFunctionCostQueryDefinition");
const MonitorFormulaAndFunctionDataJobsQueryDefinition_1 = require("./MonitorFormulaAndFunctionDataJobsQueryDefinition");
const MonitorFormulaAndFunctionDataQualityMonitorOptions_1 = require("./MonitorFormulaAndFunctionDataQualityMonitorOptions");
const MonitorFormulaAndFunctionDataQualityQueryDefinition_1 = require("./MonitorFormulaAndFunctionDataQualityQueryDefinition");
...
const MonitorFormulaAndFunctionMetricsQueryDefinition_1 = require("./MonitorFormulaAndFunctionMetricsQueryDefinition");
const MonitorFormulaAndFunctionReferenceTableColumn_1 = require("./MonitorFormulaAndFunctionReferenceTableColumn");
const MonitorFormulaAndFunctionReferenceTableQueryDefinition_1 = require("./MonitorFormulaAndFunctionReferenceTableQueryDefinition");
...
const NotebookTemplateVariable_1 = require("./NotebookTemplateVariable");
const NotebookTemplateVariableAvailableValuesQueryGroupBy_1 = require("./NotebookTemplateVariableAvailableValuesQueryGroupBy");
const NotebookTemplateVariableAvailableValuesQueryLogRumSpans_1 = require("./NotebookTemplateVariableAvailableValuesQueryLogRumSpans");
const NotebookTemplateVariableAvailableValuesQueryMetrics_1 = require("./NotebookTemplateVariableAvailableValuesQueryMetrics");
const NotebookTemplateVariableAvailableValuesQuerySearch_1 = require("./NotebookTemplateVariableAvailableValuesQuerySearch");
...
const PointPlotProjection_1 = require("./PointPlotProjection");
const PointPlotProjectionDimension_1 = require("./PointPlotProjectionDimension");
const PointPlotWidgetDefinition_1 = require("./PointPlotWidgetDefinition");
const PointPlotWidgetLegend_1 = require("./PointPlotWidgetLegend");
const PointPlotWidgetRequest_1 = require("./PointPlotWidgetRequest");
...
const ProductAnalyticsAudienceAccountSubquery_1 = require("./ProductAnalyticsAudienceAccountSubquery");
const ProductAnalyticsAudienceFilters_1 = require("./ProductAnalyticsAudienceFilters");
const ProductAnalyticsAudienceOccurrenceFilter_1 = require("./ProductAnalyticsAudienceOccurrenceFilter");
const ProductAnalyticsAudienceSegmentSubquery_1 = require("./ProductAnalyticsAudienceSegmentSubquery");
const ProductAnalyticsAudienceUserSubquery_1 = require("./ProductAnalyticsAudienceUserSubquery");
const ProductAnalyticsExtendedCompute_1 = require("./ProductAnalyticsExtendedCompute");
const ProductAnalyticsExtendedGroupBy_1 = require("./ProductAnalyticsExtendedGroupBy");
const ProductAnalyticsFunnelCompute_1 = require("./ProductAnalyticsFunnelCompute");
const ProductAnalyticsFunnelGroupBy_1 = require("./ProductAnalyticsFunnelGroupBy");
const ProductAnalyticsFunnelGroupBySort_1 = require("./ProductAnalyticsFunnelGroupBySort");
const ProductAnalyticsFunnelQuery_1 = require("./ProductAnalyticsFunnelQuery");
const ProductAnalyticsFunnelRequest_1 = require("./ProductAnalyticsFunnelRequest");
const ProductAnalyticsFunnelWidgetDefinition_1 = require("./ProductAnalyticsFunnelWidgetDefinition");
const QueryValueWidgetComparison_1 = require("./QueryValueWidgetComparison");
...
const RetentionCohortCriteria_1 = require("./RetentionCohortCriteria");
const RetentionCohortCriteriaTimeInterval_1 = require("./RetentionCohortCriteriaTimeInterval");
const RetentionCompute_1 = require("./RetentionCompute");
const RetentionCurveStyle_1 = require("./RetentionCurveStyle");
const RetentionCurveWidgetDefinition_1 = require("./RetentionCurveWidgetDefinition");
const RetentionCurveWidgetRequest_1 = require("./RetentionCurveWidgetRequest");
const RetentionFilters_1 = require("./RetentionFilters");
const RetentionGridRequest_1 = require("./RetentionGridRequest");
const RetentionGroupBy_1 = require("./RetentionGroupBy");
const RetentionGroupBySort_1 = require("./RetentionGroupBySort");
const RetentionQuery_1 = require("./RetentionQuery");
const RetentionReturnCriteria_1 = require("./RetentionReturnCriteria");
const RetentionReturnCriteriaTimeInterval_1 = require("./RetentionReturnCriteriaTimeInterval");
const RetentionSearch_1 = require("./RetentionSearch");
...
const SLOCountDefinitionWithBadEventsFormula_1 = require("./SLOCountDefinitionWithBadEventsFormula");
const SLOCountDefinitionWithTotalEventsFormula_1 = require("./SLOCountDefinitionWithTotalEventsFormula");
const SLOCountSpec_1 = require("./SLOCountSpec");
...
const SankeyJoinKeys_1 = require("./SankeyJoinKeys");
const SankeyNetworkQuery_1 = require("./SankeyNetworkQuery");
const SankeyNetworkQueryCompute_1 = require("./SankeyNetworkQueryCompute");
const SankeyNetworkQuerySort_1 = require("./SankeyNetworkQuerySort");
const SankeyNetworkRequest_1 = require("./SankeyNetworkRequest");
const SankeyRumQuery_1 = require("./SankeyRumQuery");
const SankeyRumRequest_1 = require("./SankeyRumRequest");
const SankeyWidgetDefinition_1 = require("./SankeyWidgetDefinition");
...
const SyntheticsAPISubtestStep_1 = require("./SyntheticsAPISubtestStep");
...
const SyntheticsAssertionMCPRespectsSpecification_1 = require("./SyntheticsAssertionMCPRespectsSpecification");
const SyntheticsAssertionMCPServerCapabilitiesTarget_1 = require("./SyntheticsAssertionMCPServerCapabilitiesTarget");
...
const SyntheticsBasicAuthJWT_1 = require("./SyntheticsBasicAuthJWT");
const SyntheticsBasicAuthJWTAddClaims_1 = require("./SyntheticsBasicAuthJWTAddClaims");
...
const SyntheticsTestDetailsWithoutSteps_1 = require("./SyntheticsTestDetailsWithoutSteps");
...
const TimeseriesRequestStyle_1 = require("./TimeseriesRequestStyle");
...
const TopologyMapWidgetDefinitionDataStreams_1 = require("./TopologyMapWidgetDefinitionDataStreams");
const TopologyMapWidgetDefinitionServiceMap_1 = require("./TopologyMapWidgetDefinitionServiceMap");
const TopologyQueryDataStreams_1 = require("./TopologyQueryDataStreams");
const TopologyQueryServiceMap_1 = require("./TopologyQueryServiceMap");
const TopologyRequestDataStreams_1 = require("./TopologyRequestDataStreams");
const TopologyRequestServiceMap_1 = require("./TopologyRequestServiceMap");
...
const UserJourneyFormulaCompute_1 = require("./UserJourneyFormulaCompute");
const UserJourneyFormulaGroupBy_1 = require("./UserJourneyFormulaGroupBy");
const UserJourneyJoinKeys_1 = require("./UserJourneyJoinKeys");
const UserJourneySearch_1 = require("./UserJourneySearch");
const UserJourneySearchFilters_1 = require("./UserJourneySearchFilters");
const UserJourneySearchGraphFilter_1 = require("./UserJourneySearchGraphFilter");
const UserJourneySearchTarget_1 = require("./UserJourneySearchTarget");
...
const WildcardWidgetDefinition_1 = require("./WildcardWidgetDefinition");
const WildcardWidgetSpecification_1 = require("./WildcardWidgetSpecification");
...
const typeMap = {
    ...
    BarChartWidgetDefinition: BarChartWidgetDefinition_1.BarChartWidgetDefinition,
    BarChartWidgetFlat: BarChartWidgetFlat_1.BarChartWidgetFlat,
    BarChartWidgetRequest: BarChartWidgetRequest_1.BarChartWidgetRequest,
    BarChartWidgetStacked: BarChartWidgetStacked_1.BarChartWidgetStacked,
    BarChartWidgetStyle: BarChartWidgetStyle_1.BarChartWidgetStyle,
    CalendarInterval: CalendarInterval_1.CalendarInterval,
    ...
    CohortWidgetDefinition: CohortWidgetDefinition_1.CohortWidgetDefinition,
    ComparisonCustomTimeframe: ComparisonCustomTimeframe_1.ComparisonCustomTimeframe,
    ComparisonDuration: ComparisonDuration_1.ComparisonDuration,
    ...
    DashboardFixedTimeframe: DashboardFixedTimeframe_1.DashboardFixedTimeframe,
    ...
    DashboardLiveTimeframe: DashboardLiveTimeframe_1.DashboardLiveTimeframe,
    ...
    DashboardTab: DashboardTab_1.DashboardTab,
    ...
    DataProjectionQuery: DataProjectionQuery_1.DataProjectionQuery,
    DatasetListQuery: DatasetListQuery_1.DatasetListQuery,
    DatasetListQuerySort: DatasetListQuerySort_1.DatasetListQuerySort,
    DatasetListQuerySortField: DatasetListQuerySortField_1.DatasetListQuerySortField,
    ...
    FormulaAndFunctionApmMetricsQueryDefinition: FormulaAndFunctionApmMetricsQueryDefinition_1.FormulaAndFunctionApmMetricsQueryDefinition,
    ...
    FormulaAndFunctionEventQueryGroupByFields: FormulaAndFunctionEventQueryGroupByFields_1.FormulaAndFunctionEventQueryGroupByFields,
    ...
    FormulaAndFunctionProductAnalyticsExtendedQueryDefinition: FormulaAndFunctionProductAnalyticsExtendedQueryDefinition_1.FormulaAndFunctionProductAnalyticsExtendedQueryDefinition,
    FormulaAndFunctionRetentionQueryDefinition: FormulaAndFunctionRetentionQueryDefinition_1.FormulaAndFunctionRetentionQueryDefinition,
    FormulaAndFunctionSLOQueryDefinition: FormulaAndFunctionSLOQueryDefinition_1.FormulaAndFunctionSLOQueryDefinition,
    FormulaAndFunctionUserJourneyQueryDefinition: FormulaAndFunctionUserJourneyQueryDefinition_1.FormulaAndFunctionUserJourneyQueryDefinition,
    FreeTextWidgetDefinition: FreeTextWidgetDefinition_1.FreeTextWidgetDefinition,
    FunnelComparisonCustomTimeframe: FunnelComparisonCustomTimeframe_1.FunnelComparisonCustomTimeframe,
    FunnelComparisonDuration: FunnelComparisonDuration_1.FunnelComparisonDuration,
    ...
    GCPMonitoredResourceConfig: GCPMonitoredResourceConfig_1.GCPMonitoredResourceConfig,
    ...
    GeomapWidgetRequestStyle: GeomapWidgetRequestStyle_1.GeomapWidgetRequestStyle,
    ...
    HeatMapWidgetXAxis: HeatMapWidgetXAxis_1.HeatMapWidgetXAxis,
    Host: Host_1.Host,
    ...
    HostMapWidgetFormula: HostMapWidgetFormula_1.HostMapWidgetFormula,
    HostMapWidgetGroupBy: HostMapWidgetGroupBy_1.HostMapWidgetGroupBy,
    HostMapWidgetInfrastructureRequest: HostMapWidgetInfrastructureRequest_1.HostMapWidgetInfrastructureRequest,
    HostMapWidgetInfrastructureRequestLeaf: HostMapWidgetInfrastructureRequestLeaf_1.HostMapWidgetInfrastructureRequestLeaf,
    HostMapWidgetInfrastructureStyle: HostMapWidgetInfrastructureStyle_1.HostMapWidgetInfrastructureStyle,
    HostMapWidgetProjection: HostMapWidgetProjection_1.HostMapWidgetProjection,
    HostMapWidgetProjectionDimensionMapping: HostMapWidgetProjectionDimensionMapping_1.HostMapWidgetProjectionDimensionMapping,
    HostMapWidgetScalarRequest: HostMapWidgetScalarRequest_1.HostMapWidgetScalarRequest,
    ...
    LogsAPILimitReachedResponse: LogsAPILimitReachedResponse_1.LogsAPILimitReachedResponse,
    LogsArithmeticProcessor: LogsArithmeticProcessor_1.LogsArithmeticProcessor,
    LogsArrayMapArithmeticSubProcessor: LogsArrayMapArithmeticSubProcessor_1.LogsArrayMapArithmeticSubProcessor,
    LogsArrayMapAttributeRemapper: LogsArrayMapAttributeRemapper_1.LogsArrayMapAttributeRemapper,
    LogsArrayMapCategorySubProcessor: LogsArrayMapCategorySubProcessor_1.LogsArrayMapCategorySubProcessor,
    LogsArrayMapProcessor: LogsArrayMapProcessor_1.LogsArrayMapProcessor,
    LogsArrayMapStringBuilderSubProcessor: LogsArrayMapStringBuilderSubProcessor_1.LogsArrayMapStringBuilderSubProcessor,
    LogsArrayProcessor: LogsArrayProcessor_1.LogsArrayProcessor,
    LogsArrayProcessorOperationAppend: LogsArrayProcessorOperationAppend_1.LogsArrayProcessorOperationAppend,
    LogsArrayProcessorOperationExtractKeyValue: LogsArrayProcessorOperationExtractKeyValue_1.LogsArrayProcessorOperationExtractKeyValue,
    LogsArrayProcessorOperationLength: LogsArrayProcessorOperationLength_1.LogsArrayProcessorOperationLength,
    LogsArrayProcessorOperationSelect: LogsArrayProcessorOperationSelect_1.LogsArrayProcessorOperationSelect,
    ...
    LogsDecoderProcessor: LogsDecoderProcessor_1.LogsDecoderProcessor,
    LogsExcludeAttributeProcessor: LogsExcludeAttributeProcessor_1.LogsExcludeAttributeProcessor,
    ...
    LogsSchemaCategoryMapper: LogsSchemaCategoryMapper_1.LogsSchemaCategoryMapper,
    LogsSchemaCategoryMapperCategory: LogsSchemaCategoryMapperCategory_1.LogsSchemaCategoryMapperCategory,
    LogsSchemaCategoryMapperFallback: LogsSchemaCategoryMapperFallback_1.LogsSchemaCategoryMapperFallback,
    LogsSchemaCategoryMapperTargets: LogsSchemaCategoryMapperTargets_1.LogsSchemaCategoryMapperTargets,
    LogsSchemaData: LogsSchemaData_1.LogsSchemaData,
    LogsSchemaProcessor: LogsSchemaProcessor_1.LogsSchemaProcessor,
    LogsSchemaRemapper: LogsSchemaRemapper_1.LogsSchemaRemapper,
    ...
    MonitorAsset: MonitorAsset_1.MonitorAsset,
    MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition: MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition_1.MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition,
    MonitorFormulaAndFunctionAggregateFilteredQueryDefinition: MonitorFormulaAndFunctionAggregateFilteredQueryDefinition_1.MonitorFormulaAndFunctionAggregateFilteredQueryDefinition,
    MonitorFormulaAndFunctionAggregateQueryFilter: MonitorFormulaAndFunctionAggregateQueryFilter_1.MonitorFormulaAndFunctionAggregateQueryFilter,
    MonitorFormulaAndFunctionAggregateQueryJoinCondition: MonitorFormulaAndFunctionAggregateQueryJoinCondition_1.MonitorFormulaAndFunctionAggregateQueryJoinCondition,
    ...
    MonitorFormulaAndFunctionDataJobsQueryDefinition: MonitorFormulaAndFunctionDataJobsQueryDefinition_1.MonitorFormulaAndFunctionDataJobsQueryDefinition,
    MonitorFormulaAndFunctionDataQualityMonitorOptions: MonitorFormulaAndFunctionDataQualityMonitorOptions_1.MonitorFormulaAndFunctionDataQualityMonitorOptions,
    MonitorFormulaAndFunctionDataQualityQueryDefinition: MonitorFormulaAndFunctionDataQualityQueryDefinition_1.MonitorFormulaAndFunctionDataQualityQueryDefinition,
    ...
    MonitorFormulaAndFunctionMetricsQueryDefinition: MonitorFormulaAndFunctionMetricsQueryDefinition_1.MonitorFormulaAndFunctionMetricsQueryDefinition,
    MonitorFormulaAndFunctionReferenceTableColumn: MonitorFormulaAndFunctionReferenceTableColumn_1.MonitorFormulaAndFunctionReferenceTableColumn,
    MonitorFormulaAndFunctionReferenceTableQueryDefinition: MonitorFormulaAndFunctionReferenceTableQueryDefinition_1.MonitorFormulaAndFunctionReferenceTableQueryDefinition,
    ...
    NotebookTemplateVariable: NotebookTemplateVariable_1.NotebookTemplateVariable,
    NotebookTemplateVariableAvailableValuesQueryGroupBy: NotebookTemplateVariableAvailableValuesQueryGroupBy_1.NotebookTemplateVariableAvailableValuesQueryGroupBy,
    NotebookTemplateVariableAvailableValuesQueryLogRumSpans: NotebookTemplateVariableAvailableValuesQueryLogRumSpans_1.NotebookTemplateVariableAvailableValuesQueryLogRumSpans,
    NotebookTemplateVariableAvailableValuesQueryMetrics: NotebookTemplateVariableAvailableValuesQueryMetrics_1.NotebookTemplateVariableAvailableValuesQueryMetrics,
    NotebookTemplateVariableAvailableValuesQuerySearch: NotebookTemplateVariableAvailableValuesQuerySearch_1.NotebookTemplateVariableAvailableValuesQuerySearch,
    ...
    PointPlotProjection: PointPlotProjection_1.PointPlotProjection,
    PointPlotProjectionDimension: PointPlotProjectionDimension_1.PointPlotProjectionDimension,
    PointPlotWidgetDefinition: PointPlotWidgetDefinition_1.PointPlotWidgetDefinition,
    PointPlotWidgetLegend: PointPlotWidgetLegend_1.PointPlotWidgetLegend,
    PointPlotWidgetRequest: PointPlotWidgetRequest_1.PointPlotWidgetRequest,
    ...
    ProductAnalyticsAudienceAccountSubquery: ProductAnalyticsAudienceAccountSubquery_1.ProductAnalyticsAudienceAccountSubquery,
    ProductAnalyticsAudienceFilters: ProductAnalyticsAudienceFilters_1.ProductAnalyticsAudienceFilters,
    ProductAnalyticsAudienceOccurrenceFilter: ProductAnalyticsAudienceOccurrenceFilter_1.ProductAnalyticsAudienceOccurrenceFilter,
    ProductAnalyticsAudienceSegmentSubquery: ProductAnalyticsAudienceSegmentSubquery_1.ProductAnalyticsAudienceSegmentSubquery,
    ProductAnalyticsAudienceUserSubquery: ProductAnalyticsAudienceUserSubquery_1.ProductAnalyticsAudienceUserSubquery,
    ProductAnalyticsExtendedCompute: ProductAnalyticsExtendedCompute_1.ProductAnalyticsExtendedCompute,
    ProductAnalyticsExtendedGroupBy: ProductAnalyticsExtendedGroupBy_1.ProductAnalyticsExtendedGroupBy,
    ProductAnalyticsFunnelCompute: ProductAnalyticsFunnelCompute_1.ProductAnalyticsFunnelCompute,
    ProductAnalyticsFunnelGroupBy: ProductAnalyticsFunnelGroupBy_1.ProductAnalyticsFunnelGroupBy,
    ProductAnalyticsFunnelGroupBySort: ProductAnalyticsFunnelGroupBySort_1.ProductAnalyticsFunnelGroupBySort,
    ProductAnalyticsFunnelQuery: ProductAnalyticsFunnelQuery_1.ProductAnalyticsFunnelQuery,
    ProductAnalyticsFunnelRequest: ProductAnalyticsFunnelRequest_1.ProductAnalyticsFunnelRequest,
    ProductAnalyticsFunnelWidgetDefinition: ProductAnalyticsFunnelWidgetDefinition_1.ProductAnalyticsFunnelWidgetDefinition,
    QueryValueWidgetComparison: QueryValueWidgetComparison_1.QueryValueWidgetComparison,
    ...
    RetentionCohortCriteria: RetentionCohortCriteria_1.RetentionCohortCriteria,
    RetentionCohortCriteriaTimeInterval: RetentionCohortCriteriaTimeInterval_1.RetentionCohortCriteriaTimeInterval,
    RetentionCompute: RetentionCompute_1.RetentionCompute,
    RetentionCurveStyle: RetentionCurveStyle_1.RetentionCurveStyle,
    RetentionCurveWidgetDefinition: RetentionCurveWidgetDefinition_1.RetentionCurveWidgetDefinition,
    RetentionCurveWidgetRequest: RetentionCurveWidgetRequest_1.RetentionCurveWidgetRequest,
    RetentionFilters: RetentionFilters_1.RetentionFilters,
    RetentionGridRequest: RetentionGridRequest_1.RetentionGridRequest,
    RetentionGroupBy: RetentionGroupBy_1.RetentionGroupBy,
    RetentionGroupBySort: RetentionGroupBySort_1.RetentionGroupBySort,
    RetentionQuery: RetentionQuery_1.RetentionQuery,
    RetentionReturnCriteria: RetentionReturnCriteria_1.RetentionReturnCriteria,
    RetentionReturnCriteriaTimeInterval: RetentionReturnCriteriaTimeInterval_1.RetentionReturnCriteriaTimeInterval,
    RetentionSearch: RetentionSearch_1.RetentionSearch,
    ...
    SLOCountDefinitionWithBadEventsFormula: SLOCountDefinitionWithBadEventsFormula_1.SLOCountDefinitionWithBadEventsFormula,
    SLOCountDefinitionWithTotalEventsFormula: SLOCountDefinitionWithTotalEventsFormula_1.SLOCountDefinitionWithTotalEventsFormula,
    SLOCountSpec: SLOCountSpec_1.SLOCountSpec,
    ...
    SankeyJoinKeys: SankeyJoinKeys_1.SankeyJoinKeys,
    SankeyNetworkQuery: SankeyNetworkQuery_1.SankeyNetworkQuery,
    SankeyNetworkQueryCompute: SankeyNetworkQueryCompute_1.SankeyNetworkQueryCompute,
    SankeyNetworkQuerySort: SankeyNetworkQuerySort_1.SankeyNetworkQuerySort,
    SankeyNetworkRequest: SankeyNetworkRequest_1.SankeyNetworkRequest,
    SankeyRumQuery: SankeyRumQuery_1.SankeyRumQuery,
    SankeyRumRequest: SankeyRumRequest_1.SankeyRumRequest,
    SankeyWidgetDefinition: SankeyWidgetDefinition_1.SankeyWidgetDefinition,
    ...
    SyntheticsAPISubtestStep: SyntheticsAPISubtestStep_1.SyntheticsAPISubtestStep,
    ...
    SyntheticsAssertionMCPRespectsSpecification: SyntheticsAssertionMCPRespectsSpecification_1.SyntheticsAssertionMCPRespectsSpecification,
    SyntheticsAssertionMCPServerCapabilitiesTarget: SyntheticsAssertionMCPServerCapabilitiesTarget_1.SyntheticsAssertionMCPServerCapabilitiesTarget,
    ...
    SyntheticsBasicAuthJWT: SyntheticsBasicAuthJWT_1.SyntheticsBasicAuthJWT,
    SyntheticsBasicAuthJWTAddClaims: SyntheticsBasicAuthJWTAddClaims_1.SyntheticsBasicAuthJWTAddClaims,
    ...
    SyntheticsTestDetailsWithoutSteps: SyntheticsTestDetailsWithoutSteps_1.SyntheticsTestDetailsWithoutSteps,
    ...
    TimeseriesRequestStyle: TimeseriesRequestStyle_1.TimeseriesRequestStyle,
    ...
    TopologyMapWidgetDefinitionDataStreams: TopologyMapWidgetDefinitionDataStreams_1.TopologyMapWidgetDefinitionDataStreams,
    TopologyMapWidgetDefinitionServiceMap: TopologyMapWidgetDefinitionServiceMap_1.TopologyMapWidgetDefinitionServiceMap,
    TopologyQueryDataStreams: TopologyQueryDataStreams_1.TopologyQueryDataStreams,
    TopologyQueryServiceMap: TopologyQueryServiceMap_1.TopologyQueryServiceMap,
    TopologyRequestDataStreams: TopologyRequestDataStreams_1.TopologyRequestDataStreams,
    TopologyRequestServiceMap: TopologyRequestServiceMap_1.TopologyRequestServiceMap,
    ...
    UserJourneyFormulaCompute: UserJourneyFormulaCompute_1.UserJourneyFormulaCompute,
    UserJourneyFormulaGroupBy: UserJourneyFormulaGroupBy_1.UserJourneyFormulaGroupBy,
    UserJourneyJoinKeys: UserJourneyJoinKeys_1.UserJourneyJoinKeys,
    UserJourneySearch: UserJourneySearch_1.UserJourneySearch,
    UserJourneySearchFilters: UserJourneySearchFilters_1.UserJourneySearchFilters,
    UserJourneySearchGraphFilter: UserJourneySearchGraphFilter_1.UserJourneySearchGraphFilter,
    UserJourneySearchTarget: UserJourneySearchTarget_1.UserJourneySearchTarget,
    ...
    WildcardWidgetDefinition: WildcardWidgetDefinition_1.WildcardWidgetDefinition,
    WildcardWidgetSpecification: WildcardWidgetSpecification_1.WildcardWidgetSpecification,
};
const oneOfMap = {
...
class ObjectSerializer {
    static serialize(data, type, format) {
        if (data == undefined || type == "any") {
            ...
            for (const k of Object.keys(data)) {
                if (k === "_unparsed" || k === "additionalProperties")
                    continue;
                if (!(k in attributesMap) &&
            ...
            if (data.additionalProperties) {
                ...
                if (additionalPropertiesMap) {
                    const additionalProperties = ObjectSerializer.serialize(data.additionalProperties, additionalPropertiesMap.type, additionalPropertiesMap.format);
    ...
    static deserialize(data, type, format = "") {
        ...
        if (data == undefined || type == "any") {
            ...
            const attributesMap = typeMap[type].getAttributeTypeMap();
            const keepAllInAdditional = typeMap[type]._keepTypedInAdditionalProperties === true;
            ...
            const attributesBaseNames = {};
            const baseNameToAttr = {};
            ...
            const extraAttributes = Object.keys(data).filter((key) => keepAllInAdditional ||
            ...
            if (extraAttributes.length > 0) {
                if ("additionalProperties" in attributesMap) {
                    ...
                    if (keepAllInAdditional) {
                        ...
                        instance.additionalProperties = ObjectSerializer.deserialize(additionalProperties, attributeObj.type, attributeObj.format);
                    }
                }
                else {
