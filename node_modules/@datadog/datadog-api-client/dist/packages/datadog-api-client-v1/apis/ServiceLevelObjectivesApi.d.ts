...
export declare class ServiceLevelObjectivesApiRequestFactory extends BaseAPIRequestFactory {
    ...
    listSLOs(ids?: string, query?: string, tagsQuery?: string, metricsQuery?: string, limit?: number, offset?: number, isDeleted?: boolean, _options?: Configuration): Promise<RequestContext>;
