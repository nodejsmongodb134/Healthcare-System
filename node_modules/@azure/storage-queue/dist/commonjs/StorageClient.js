...
__export(StorageClient_exports, {
  ...
  getStorageClientContext: () => getStorageClientContext
});
...
function getStorageClientContext(url, pipeline) {
  ...
  if (pipelineOptions.retryOptions === void 0) {
    pipelineOptions.retryOptions = {
      tryTimeoutInMs: 30 * 1e3
    };
  } else if (pipelineOptions.retryOptions.tryTimeoutInMs === void 0) {
    pipelineOptions.retryOptions.tryTimeoutInMs = 30 * 1e3;
  }
  return new import_StorageContextClient.StorageContextClient(url, (0, import_Pipeline.getCoreClientOptions)(pipeline));
}
