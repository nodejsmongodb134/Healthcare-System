...
import type { FunctionConfiguration, GetFunctionConfigurationRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetFunctionConfigurationCommand_base: {
    new (input: GetFunctionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionConfigurationCommandInput, GetFunctionConfigurationCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFunctionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionConfigurationCommandInput, GetFunctionConfigurationCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
