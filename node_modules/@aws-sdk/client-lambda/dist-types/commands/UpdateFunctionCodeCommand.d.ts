...
declare const UpdateFunctionCodeCommand_base: {
    new (input: UpdateFunctionCodeCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionCodeCommandInput, UpdateFunctionCodeCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFunctionCodeCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionCodeCommandInput, UpdateFunctionCodeCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
