...
import type { FunctionConfiguration, UpdateFunctionConfigurationRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateFunctionConfigurationCommand_base: {
    new (input: UpdateFunctionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionConfigurationCommandInput, UpdateFunctionConfigurationCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFunctionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionConfigurationCommandInput, UpdateFunctionConfigurationCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
