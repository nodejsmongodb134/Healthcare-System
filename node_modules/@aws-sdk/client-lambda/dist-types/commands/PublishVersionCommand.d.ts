...
declare const PublishVersionCommand_base: {
    new (input: PublishVersionCommandInput): import("@smithy/core/client").CommandImpl<PublishVersionCommandInput, PublishVersionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PublishVersionCommandInput): import("@smithy/core/client").CommandImpl<PublishVersionCommandInput, PublishVersionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
