...
declare const ListVersionsByFunctionCommand_base: {
    new (input: ListVersionsByFunctionCommandInput): import("@smithy/core/client").CommandImpl<ListVersionsByFunctionCommandInput, ListVersionsByFunctionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListVersionsByFunctionCommandInput): import("@smithy/core/client").CommandImpl<ListVersionsByFunctionCommandInput, ListVersionsByFunctionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
