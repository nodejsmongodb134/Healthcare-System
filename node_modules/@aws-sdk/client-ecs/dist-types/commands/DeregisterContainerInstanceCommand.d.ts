...
declare const DeregisterContainerInstanceCommand_base: {
    new (input: DeregisterContainerInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeregisterContainerInstanceCommandInput, DeregisterContainerInstanceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterContainerInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeregisterContainerInstanceCommandInput, DeregisterContainerInstanceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
