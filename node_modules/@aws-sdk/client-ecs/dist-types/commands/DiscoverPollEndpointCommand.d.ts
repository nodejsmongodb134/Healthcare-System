...
declare const DiscoverPollEndpointCommand_base: {
    new (input: DiscoverPollEndpointCommandInput): import("@smithy/core/client").CommandImpl<DiscoverPollEndpointCommandInput, DiscoverPollEndpointCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DiscoverPollEndpointCommandInput]): import("@smithy/core/client").CommandImpl<DiscoverPollEndpointCommandInput, DiscoverPollEndpointCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
