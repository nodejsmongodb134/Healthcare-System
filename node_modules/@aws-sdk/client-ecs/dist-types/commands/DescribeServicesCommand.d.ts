...
declare const DescribeServicesCommand_base: {
    new (input: DescribeServicesCommandInput): import("@smithy/core/client").CommandImpl<DescribeServicesCommandInput, DescribeServicesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeServicesCommandInput): import("@smithy/core/client").CommandImpl<DescribeServicesCommandInput, DescribeServicesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
