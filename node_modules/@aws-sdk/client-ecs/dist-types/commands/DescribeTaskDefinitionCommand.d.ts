...
import type { DescribeTaskDefinitionRequest, DescribeTaskDefinitionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeTaskDefinitionCommand_base: {
    new (input: DescribeTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeTaskDefinitionCommandInput, DescribeTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeTaskDefinitionCommandInput, DescribeTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
