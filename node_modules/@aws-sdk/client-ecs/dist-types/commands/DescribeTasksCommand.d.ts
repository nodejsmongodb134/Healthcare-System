...
declare const DescribeTasksCommand_base: {
    new (input: DescribeTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeTasksCommandInput, DescribeTasksCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeTasksCommandInput, DescribeTasksCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
