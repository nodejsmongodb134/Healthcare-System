...
declare const DeleteCapacityProviderCommand_base: {
    new (input: DeleteCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteCapacityProviderCommandInput, DeleteCapacityProviderCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteCapacityProviderCommandInput, DeleteCapacityProviderCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
