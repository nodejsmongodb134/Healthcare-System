...
declare const ListAttributesCommand_base: {
    new (input: ListAttributesCommandInput): import("@smithy/core/client").CommandImpl<ListAttributesCommandInput, ListAttributesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAttributesCommandInput): import("@smithy/core/client").CommandImpl<ListAttributesCommandInput, ListAttributesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
