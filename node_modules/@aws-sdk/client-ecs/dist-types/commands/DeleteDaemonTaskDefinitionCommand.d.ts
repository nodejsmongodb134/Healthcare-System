...
declare const DeleteDaemonTaskDefinitionCommand_base: {
    new (input: DeleteDaemonTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDaemonTaskDefinitionCommandInput, DeleteDaemonTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDaemonTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDaemonTaskDefinitionCommandInput, DeleteDaemonTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
