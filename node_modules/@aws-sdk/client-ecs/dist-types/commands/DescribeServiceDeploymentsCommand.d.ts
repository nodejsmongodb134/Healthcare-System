...
declare const DescribeServiceDeploymentsCommand_base: {
    new (input: DescribeServiceDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeServiceDeploymentsCommandInput, DescribeServiceDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeServiceDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeServiceDeploymentsCommandInput, DescribeServiceDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
