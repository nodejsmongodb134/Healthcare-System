...
declare const DescribeTaskSetsCommand_base: {
    new (input: DescribeTaskSetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTaskSetsCommandInput, DescribeTaskSetsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTaskSetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTaskSetsCommandInput, DescribeTaskSetsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
