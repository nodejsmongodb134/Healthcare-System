...
declare const DescribeDaemonRevisionsCommand_base: {
    new (input: DescribeDaemonRevisionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonRevisionsCommandInput, DescribeDaemonRevisionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDaemonRevisionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonRevisionsCommandInput, DescribeDaemonRevisionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
