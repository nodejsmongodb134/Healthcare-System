...
declare const DescribeCapacityProvidersCommand_base: {
    new (input: DescribeCapacityProvidersCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityProvidersCommandInput, DescribeCapacityProvidersCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityProvidersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityProvidersCommandInput, DescribeCapacityProvidersCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
