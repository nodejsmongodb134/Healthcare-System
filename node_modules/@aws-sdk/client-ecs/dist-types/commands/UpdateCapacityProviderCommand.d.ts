...
declare const UpdateCapacityProviderCommand_base: {
    new (input: UpdateCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityProviderCommandInput, UpdateCapacityProviderCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityProviderCommandInput, UpdateCapacityProviderCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
