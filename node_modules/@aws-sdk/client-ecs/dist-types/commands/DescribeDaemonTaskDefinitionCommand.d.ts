...
declare const DescribeDaemonTaskDefinitionCommand_base: {
    new (input: DescribeDaemonTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonTaskDefinitionCommandInput, DescribeDaemonTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDaemonTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonTaskDefinitionCommandInput, DescribeDaemonTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
