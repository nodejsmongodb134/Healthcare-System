...
declare const ListServicesCommand_base: {
    new (input: ListServicesCommandInput): import("@smithy/core/client").CommandImpl<ListServicesCommandInput, ListServicesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListServicesCommandInput]): import("@smithy/core/client").CommandImpl<ListServicesCommandInput, ListServicesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
