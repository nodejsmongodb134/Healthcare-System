...
import type { ExecuteCommandRequest, ExecuteCommandResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ExecuteCommandCommand_base: {
    new (input: ExecuteCommandCommandInput): import("@smithy/core/client").CommandImpl<ExecuteCommandCommandInput, ExecuteCommandCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecuteCommandCommandInput): import("@smithy/core/client").CommandImpl<ExecuteCommandCommandInput, ExecuteCommandCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
