...
declare const DeleteDaemonCommand_base: {
    new (input: DeleteDaemonCommandInput): import("@smithy/core/client").CommandImpl<DeleteDaemonCommandInput, DeleteDaemonCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDaemonCommandInput): import("@smithy/core/client").CommandImpl<DeleteDaemonCommandInput, DeleteDaemonCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
