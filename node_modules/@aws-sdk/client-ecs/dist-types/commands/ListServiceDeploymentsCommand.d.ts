...
declare const ListServiceDeploymentsCommand_base: {
    new (input: ListServiceDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<ListServiceDeploymentsCommandInput, ListServiceDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListServiceDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<ListServiceDeploymentsCommandInput, ListServiceDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
