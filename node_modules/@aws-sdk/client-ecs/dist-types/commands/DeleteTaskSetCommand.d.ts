...
declare const DeleteTaskSetCommand_base: {
    new (input: DeleteTaskSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteTaskSetCommandInput, DeleteTaskSetCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTaskSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteTaskSetCommandInput, DeleteTaskSetCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
