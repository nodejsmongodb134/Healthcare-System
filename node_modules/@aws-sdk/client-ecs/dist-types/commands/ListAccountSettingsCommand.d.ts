...
declare const ListAccountSettingsCommand_base: {
    new (input: ListAccountSettingsCommandInput): import("@smithy/core/client").CommandImpl<ListAccountSettingsCommandInput, ListAccountSettingsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAccountSettingsCommandInput]): import("@smithy/core/client").CommandImpl<ListAccountSettingsCommandInput, ListAccountSettingsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
