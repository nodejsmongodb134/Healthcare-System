...
declare const DescribeContainerInstancesCommand_base: {
    new (input: DescribeContainerInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeContainerInstancesCommandInput, DescribeContainerInstancesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeContainerInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeContainerInstancesCommandInput, DescribeContainerInstancesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
