...
declare const DescribeExpressGatewayServiceCommand_base: {
    new (input: DescribeExpressGatewayServiceCommandInput): import("@smithy/core/client").CommandImpl<DescribeExpressGatewayServiceCommandInput, DescribeExpressGatewayServiceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeExpressGatewayServiceCommandInput): import("@smithy/core/client").CommandImpl<DescribeExpressGatewayServiceCommandInput, DescribeExpressGatewayServiceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
