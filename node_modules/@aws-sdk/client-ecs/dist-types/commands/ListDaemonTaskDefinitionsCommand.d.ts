...
declare const ListDaemonTaskDefinitionsCommand_base: {
    new (input: ListDaemonTaskDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<ListDaemonTaskDefinitionsCommandInput, ListDaemonTaskDefinitionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDaemonTaskDefinitionsCommandInput]): import("@smithy/core/client").CommandImpl<ListDaemonTaskDefinitionsCommandInput, ListDaemonTaskDefinitionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
