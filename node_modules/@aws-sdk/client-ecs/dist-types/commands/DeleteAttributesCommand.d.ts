...
declare const DeleteAttributesCommand_base: {
    new (input: DeleteAttributesCommandInput): import("@smithy/core/client").CommandImpl<DeleteAttributesCommandInput, DeleteAttributesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAttributesCommandInput): import("@smithy/core/client").CommandImpl<DeleteAttributesCommandInput, DeleteAttributesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
