...
declare const ListServicesByNamespaceCommand_base: {
    new (input: ListServicesByNamespaceCommandInput): import("@smithy/core/client").CommandImpl<ListServicesByNamespaceCommandInput, ListServicesByNamespaceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListServicesByNamespaceCommandInput): import("@smithy/core/client").CommandImpl<ListServicesByNamespaceCommandInput, ListServicesByNamespaceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
