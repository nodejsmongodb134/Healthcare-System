...
declare const DescribeDaemonDeploymentsCommand_base: {
    new (input: DescribeDaemonDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonDeploymentsCommandInput, DescribeDaemonDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDaemonDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonDeploymentsCommandInput, DescribeDaemonDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
