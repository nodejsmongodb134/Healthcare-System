...
declare const ListDaemonsCommand_base: {
    new (input: ListDaemonsCommandInput): import("@smithy/core/client").CommandImpl<ListDaemonsCommandInput, ListDaemonsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDaemonsCommandInput]): import("@smithy/core/client").CommandImpl<ListDaemonsCommandInput, ListDaemonsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
