...
declare const GetTaskProtectionCommand_base: {
    new (input: GetTaskProtectionCommandInput): import("@smithy/core/client").CommandImpl<GetTaskProtectionCommandInput, GetTaskProtectionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTaskProtectionCommandInput): import("@smithy/core/client").CommandImpl<GetTaskProtectionCommandInput, GetTaskProtectionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
