...
declare const DeleteExpressGatewayServiceCommand_base: {
    new (input: DeleteExpressGatewayServiceCommandInput): import("@smithy/core/client").CommandImpl<DeleteExpressGatewayServiceCommandInput, DeleteExpressGatewayServiceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteExpressGatewayServiceCommandInput): import("@smithy/core/client").CommandImpl<DeleteExpressGatewayServiceCommandInput, DeleteExpressGatewayServiceCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
