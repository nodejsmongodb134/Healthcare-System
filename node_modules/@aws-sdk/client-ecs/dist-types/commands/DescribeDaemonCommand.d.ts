...
declare const DescribeDaemonCommand_base: {
    new (input: DescribeDaemonCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonCommandInput, DescribeDaemonCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDaemonCommandInput): import("@smithy/core/client").CommandImpl<DescribeDaemonCommandInput, DescribeDaemonCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
