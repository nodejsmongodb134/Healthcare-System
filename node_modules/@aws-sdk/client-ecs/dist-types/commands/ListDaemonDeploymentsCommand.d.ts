...
declare const ListDaemonDeploymentsCommand_base: {
    new (input: ListDaemonDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<ListDaemonDeploymentsCommandInput, ListDaemonDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDaemonDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<ListDaemonDeploymentsCommandInput, ListDaemonDeploymentsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
