...
declare const DeleteTaskDefinitionsCommand_base: {
    new (input: DeleteTaskDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<DeleteTaskDefinitionsCommandInput, DeleteTaskDefinitionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTaskDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<DeleteTaskDefinitionsCommandInput, DeleteTaskDefinitionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
