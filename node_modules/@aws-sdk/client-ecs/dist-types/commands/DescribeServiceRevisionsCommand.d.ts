...
declare const DescribeServiceRevisionsCommand_base: {
    new (input: DescribeServiceRevisionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeServiceRevisionsCommandInput, DescribeServiceRevisionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeServiceRevisionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeServiceRevisionsCommandInput, DescribeServiceRevisionsCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
