...
import type { ListContainerInstancesRequest, ListContainerInstancesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListContainerInstancesCommand_base: {
    new (input: ListContainerInstancesCommandInput): import("@smithy/core/client").CommandImpl<ListContainerInstancesCommandInput, ListContainerInstancesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListContainerInstancesCommandInput]): import("@smithy/core/client").CommandImpl<ListContainerInstancesCommandInput, ListContainerInstancesCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
