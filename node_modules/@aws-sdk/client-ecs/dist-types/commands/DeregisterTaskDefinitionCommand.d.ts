...
declare const DeregisterTaskDefinitionCommand_base: {
    new (input: DeregisterTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTaskDefinitionCommandInput, DeregisterTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterTaskDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTaskDefinitionCommandInput, DeregisterTaskDefinitionCommandOutput, import("..").ECSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
