...
import type { DescribeIpamExternalResourceVerificationTokensRequest, DescribeIpamExternalResourceVerificationTokensResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeIpamExternalResourceVerificationTokensCommand_base: {
    new (input: DescribeIpamExternalResourceVerificationTokensCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamExternalResourceVerificationTokensCommandInput, DescribeIpamExternalResourceVerificationTokensCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamExternalResourceVerificationTokensCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamExternalResourceVerificationTokensCommandInput, DescribeIpamExternalResourceVerificationTokensCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
