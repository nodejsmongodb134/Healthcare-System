...
import type { DeleteVpcPeeringConnectionRequest, DeleteVpcPeeringConnectionResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVpcPeeringConnectionCommand_base: {
    new (input: DeleteVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcPeeringConnectionCommandInput, DeleteVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcPeeringConnectionCommandInput, DeleteVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
