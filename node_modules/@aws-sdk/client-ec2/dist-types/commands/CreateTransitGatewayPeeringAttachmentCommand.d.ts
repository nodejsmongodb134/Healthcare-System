...
import type { CreateTransitGatewayPeeringAttachmentRequest, CreateTransitGatewayPeeringAttachmentResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayPeeringAttachmentCommand_base: {
    new (input: CreateTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayPeeringAttachmentCommandInput, CreateTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayPeeringAttachmentCommandInput, CreateTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
