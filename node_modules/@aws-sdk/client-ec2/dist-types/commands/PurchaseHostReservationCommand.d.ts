...
import type { PurchaseHostReservationRequest, PurchaseHostReservationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const PurchaseHostReservationCommand_base: {
    new (input: PurchaseHostReservationCommandInput): import("@smithy/core/client").CommandImpl<PurchaseHostReservationCommandInput, PurchaseHostReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PurchaseHostReservationCommandInput): import("@smithy/core/client").CommandImpl<PurchaseHostReservationCommandInput, PurchaseHostReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
