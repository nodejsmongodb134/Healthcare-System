...
import type { DisableTransitGatewayRouteTablePropagationRequest, DisableTransitGatewayRouteTablePropagationResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisableTransitGatewayRouteTablePropagationCommand_base: {
    new (input: DisableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/core/client").CommandImpl<DisableTransitGatewayRouteTablePropagationCommandInput, DisableTransitGatewayRouteTablePropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/core/client").CommandImpl<DisableTransitGatewayRouteTablePropagationCommandInput, DisableTransitGatewayRouteTablePropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisableTransitGatewayRouteTablePropagationCommand extends DisableTransitGatewayRouteTablePropagationCommand_base {
