...
declare const DescribeIpamsCommand_base: {
    new (input: DescribeIpamsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamsCommandInput, DescribeIpamsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamsCommandInput, DescribeIpamsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
