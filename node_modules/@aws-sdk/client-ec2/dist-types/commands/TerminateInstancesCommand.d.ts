...
import type { TerminateInstancesRequest, TerminateInstancesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const TerminateInstancesCommand_base: {
    new (input: TerminateInstancesCommandInput): import("@smithy/core/client").CommandImpl<TerminateInstancesCommandInput, TerminateInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TerminateInstancesCommandInput): import("@smithy/core/client").CommandImpl<TerminateInstancesCommandInput, TerminateInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TerminateInstancesCommand extends TerminateInstancesCommand_base {
