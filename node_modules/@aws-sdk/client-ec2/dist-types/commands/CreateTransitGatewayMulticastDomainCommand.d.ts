...
import type { CreateTransitGatewayMulticastDomainRequest, CreateTransitGatewayMulticastDomainResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayMulticastDomainCommand_base: {
    new (input: CreateTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayMulticastDomainCommandInput, CreateTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayMulticastDomainCommandInput, CreateTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
