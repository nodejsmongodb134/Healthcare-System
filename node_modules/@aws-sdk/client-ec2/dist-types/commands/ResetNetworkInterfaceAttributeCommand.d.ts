...
import type { ResetNetworkInterfaceAttributeRequest } from "../models/models_8";
/**
 * @public
 */
...
declare const ResetNetworkInterfaceAttributeCommand_base: {
    new (input: ResetNetworkInterfaceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetNetworkInterfaceAttributeCommandInput, ResetNetworkInterfaceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetNetworkInterfaceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetNetworkInterfaceAttributeCommandInput, ResetNetworkInterfaceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
