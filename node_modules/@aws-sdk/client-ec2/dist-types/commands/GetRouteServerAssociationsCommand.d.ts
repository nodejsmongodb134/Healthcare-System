...
declare const GetRouteServerAssociationsCommand_base: {
    new (input: GetRouteServerAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetRouteServerAssociationsCommandInput, GetRouteServerAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRouteServerAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetRouteServerAssociationsCommandInput, GetRouteServerAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
