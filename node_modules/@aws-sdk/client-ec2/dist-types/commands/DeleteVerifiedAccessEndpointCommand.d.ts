...
declare const DeleteVerifiedAccessEndpointCommand_base: {
    new (input: DeleteVerifiedAccessEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessEndpointCommandInput, DeleteVerifiedAccessEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVerifiedAccessEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessEndpointCommandInput, DeleteVerifiedAccessEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
