...
import type { ModifyVerifiedAccessEndpointRequest, ModifyVerifiedAccessEndpointResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVerifiedAccessEndpointCommand_base: {
    new (input: ModifyVerifiedAccessEndpointCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessEndpointCommandInput, ModifyVerifiedAccessEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVerifiedAccessEndpointCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessEndpointCommandInput, ModifyVerifiedAccessEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
