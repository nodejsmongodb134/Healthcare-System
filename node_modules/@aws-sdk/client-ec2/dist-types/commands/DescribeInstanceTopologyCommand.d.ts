...
import type { DescribeInstanceTopologyRequest, DescribeInstanceTopologyResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeInstanceTopologyCommand_base: {
    new (input: DescribeInstanceTopologyCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceTopologyCommandInput, DescribeInstanceTopologyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceTopologyCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceTopologyCommandInput, DescribeInstanceTopologyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
