...
import type { DescribeTransitGatewayMeteringPoliciesRequest, DescribeTransitGatewayMeteringPoliciesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTransitGatewayMeteringPoliciesCommand_base: {
    new (input: DescribeTransitGatewayMeteringPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayMeteringPoliciesCommandInput, DescribeTransitGatewayMeteringPoliciesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayMeteringPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayMeteringPoliciesCommandInput, DescribeTransitGatewayMeteringPoliciesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
