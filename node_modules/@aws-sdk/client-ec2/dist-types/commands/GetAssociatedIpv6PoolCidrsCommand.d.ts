...
import type { GetAssociatedIpv6PoolCidrsRequest, GetAssociatedIpv6PoolCidrsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetAssociatedIpv6PoolCidrsCommand_base: {
    new (input: GetAssociatedIpv6PoolCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetAssociatedIpv6PoolCidrsCommandInput, GetAssociatedIpv6PoolCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAssociatedIpv6PoolCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetAssociatedIpv6PoolCidrsCommandInput, GetAssociatedIpv6PoolCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
