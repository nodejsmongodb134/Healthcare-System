...
import type { DescribeVpcEndpointConnectionNotificationsRequest, DescribeVpcEndpointConnectionNotificationsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcEndpointConnectionNotificationsCommand_base: {
    new (input: DescribeVpcEndpointConnectionNotificationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointConnectionNotificationsCommandInput, DescribeVpcEndpointConnectionNotificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEndpointConnectionNotificationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointConnectionNotificationsCommandInput, DescribeVpcEndpointConnectionNotificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
