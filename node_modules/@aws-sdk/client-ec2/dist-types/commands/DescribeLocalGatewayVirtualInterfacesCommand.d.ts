...
import type { DescribeLocalGatewayVirtualInterfacesRequest, DescribeLocalGatewayVirtualInterfacesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeLocalGatewayVirtualInterfacesCommand_base: {
    new (input: DescribeLocalGatewayVirtualInterfacesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayVirtualInterfacesCommandInput, DescribeLocalGatewayVirtualInterfacesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLocalGatewayVirtualInterfacesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayVirtualInterfacesCommandInput, DescribeLocalGatewayVirtualInterfacesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
