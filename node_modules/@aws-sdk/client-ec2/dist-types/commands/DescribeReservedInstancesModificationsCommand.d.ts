...
import type { DescribeReservedInstancesModificationsRequest, DescribeReservedInstancesModificationsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeReservedInstancesModificationsCommand_base: {
    new (input: DescribeReservedInstancesModificationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesModificationsCommandInput, DescribeReservedInstancesModificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeReservedInstancesModificationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesModificationsCommandInput, DescribeReservedInstancesModificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
