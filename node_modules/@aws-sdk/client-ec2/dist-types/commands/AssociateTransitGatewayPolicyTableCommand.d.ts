...
import type { AssociateTransitGatewayPolicyTableRequest, AssociateTransitGatewayPolicyTableResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateTransitGatewayPolicyTableCommand_base: {
    new (input: AssociateTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<AssociateTransitGatewayPolicyTableCommandInput, AssociateTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<AssociateTransitGatewayPolicyTableCommandInput, AssociateTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
