...
import type { DisableInstanceSqlHaStandbyDetectionsRequest, DisableInstanceSqlHaStandbyDetectionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisableInstanceSqlHaStandbyDetectionsCommand_base: {
    new (input: DisableInstanceSqlHaStandbyDetectionsCommandInput): import("@smithy/core/client").CommandImpl<DisableInstanceSqlHaStandbyDetectionsCommandInput, DisableInstanceSqlHaStandbyDetectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableInstanceSqlHaStandbyDetectionsCommandInput): import("@smithy/core/client").CommandImpl<DisableInstanceSqlHaStandbyDetectionsCommandInput, DisableInstanceSqlHaStandbyDetectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
