...
import type { EnableVpcClassicLinkRequest, EnableVpcClassicLinkResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableVpcClassicLinkCommand_base: {
    new (input: EnableVpcClassicLinkCommandInput): import("@smithy/core/client").CommandImpl<EnableVpcClassicLinkCommandInput, EnableVpcClassicLinkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableVpcClassicLinkCommandInput): import("@smithy/core/client").CommandImpl<EnableVpcClassicLinkCommandInput, EnableVpcClassicLinkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
