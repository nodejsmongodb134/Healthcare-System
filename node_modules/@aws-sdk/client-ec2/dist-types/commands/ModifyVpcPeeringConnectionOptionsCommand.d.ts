...
import type { ModifyVpcPeeringConnectionOptionsRequest, ModifyVpcPeeringConnectionOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcPeeringConnectionOptionsCommand_base: {
    new (input: ModifyVpcPeeringConnectionOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcPeeringConnectionOptionsCommandInput, ModifyVpcPeeringConnectionOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcPeeringConnectionOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcPeeringConnectionOptionsCommandInput, ModifyVpcPeeringConnectionOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
