...
import type { EnableVolumeIORequest } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableVolumeIOCommand_base: {
    new (input: EnableVolumeIOCommandInput): import("@smithy/core/client").CommandImpl<EnableVolumeIOCommandInput, EnableVolumeIOCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableVolumeIOCommandInput): import("@smithy/core/client").CommandImpl<EnableVolumeIOCommandInput, EnableVolumeIOCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
