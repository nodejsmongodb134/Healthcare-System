...
import type { ImportVolumeRequest, ImportVolumeResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ImportVolumeCommand_base: {
    new (input: ImportVolumeCommandInput): import("@smithy/core/client").CommandImpl<ImportVolumeCommandInput, ImportVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportVolumeCommandInput): import("@smithy/core/client").CommandImpl<ImportVolumeCommandInput, ImportVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
