...
import type { ModifyVpcEncryptionControlRequest, ModifyVpcEncryptionControlResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEncryptionControlCommand_base: {
    new (input: ModifyVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEncryptionControlCommandInput, ModifyVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEncryptionControlCommandInput, ModifyVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
