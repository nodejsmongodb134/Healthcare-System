...
import type { GetImageAncestryRequest, GetImageAncestryResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetImageAncestryCommand_base: {
    new (input: GetImageAncestryCommandInput): import("@smithy/core/client").CommandImpl<GetImageAncestryCommandInput, GetImageAncestryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetImageAncestryCommandInput): import("@smithy/core/client").CommandImpl<GetImageAncestryCommandInput, GetImageAncestryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
