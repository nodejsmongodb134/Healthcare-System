...
import type { DeprovisionByoipCidrRequest, DeprovisionByoipCidrResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeprovisionByoipCidrCommand_base: {
    new (input: DeprovisionByoipCidrCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionByoipCidrCommandInput, DeprovisionByoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeprovisionByoipCidrCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionByoipCidrCommandInput, DeprovisionByoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
