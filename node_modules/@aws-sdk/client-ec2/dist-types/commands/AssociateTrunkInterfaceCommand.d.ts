...
declare const AssociateTrunkInterfaceCommand_base: {
    new (input: AssociateTrunkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<AssociateTrunkInterfaceCommandInput, AssociateTrunkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTrunkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<AssociateTrunkInterfaceCommandInput, AssociateTrunkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
