...
import type { DescribeLocalGatewayRouteTablesRequest, DescribeLocalGatewayRouteTablesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeLocalGatewayRouteTablesCommand_base: {
    new (input: DescribeLocalGatewayRouteTablesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayRouteTablesCommandInput, DescribeLocalGatewayRouteTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLocalGatewayRouteTablesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayRouteTablesCommandInput, DescribeLocalGatewayRouteTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
