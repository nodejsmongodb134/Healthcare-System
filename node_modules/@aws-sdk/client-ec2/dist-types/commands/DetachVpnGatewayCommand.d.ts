...
declare const DetachVpnGatewayCommand_base: {
    new (input: DetachVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<DetachVpnGatewayCommandInput, DetachVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<DetachVpnGatewayCommandInput, DetachVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
