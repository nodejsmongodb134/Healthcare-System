...
import type { SearchLocalGatewayRoutesRequest, SearchLocalGatewayRoutesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const SearchLocalGatewayRoutesCommand_base: {
    new (input: SearchLocalGatewayRoutesCommandInput): import("@smithy/core/client").CommandImpl<SearchLocalGatewayRoutesCommandInput, SearchLocalGatewayRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchLocalGatewayRoutesCommandInput): import("@smithy/core/client").CommandImpl<SearchLocalGatewayRoutesCommandInput, SearchLocalGatewayRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
