...
import type { AllocateIpamPoolCidrRequest, AllocateIpamPoolCidrResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AllocateIpamPoolCidrCommand_base: {
    new (input: AllocateIpamPoolCidrCommandInput): import("@smithy/core/client").CommandImpl<AllocateIpamPoolCidrCommandInput, AllocateIpamPoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AllocateIpamPoolCidrCommandInput): import("@smithy/core/client").CommandImpl<AllocateIpamPoolCidrCommandInput, AllocateIpamPoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
