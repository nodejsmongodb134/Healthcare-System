...
import type { LockSnapshotRequest, LockSnapshotResult } from "../models/models_7";
/**
 * @public
 */
...
declare const LockSnapshotCommand_base: {
    new (input: LockSnapshotCommandInput): import("@smithy/core/client").CommandImpl<LockSnapshotCommandInput, LockSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: LockSnapshotCommandInput): import("@smithy/core/client").CommandImpl<LockSnapshotCommandInput, LockSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
