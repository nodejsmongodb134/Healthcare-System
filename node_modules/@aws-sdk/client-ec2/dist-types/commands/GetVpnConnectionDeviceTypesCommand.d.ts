...
import type { GetVpnConnectionDeviceTypesRequest, GetVpnConnectionDeviceTypesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetVpnConnectionDeviceTypesCommand_base: {
    new (input: GetVpnConnectionDeviceTypesCommandInput): import("@smithy/core/client").CommandImpl<GetVpnConnectionDeviceTypesCommandInput, GetVpnConnectionDeviceTypesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetVpnConnectionDeviceTypesCommandInput]): import("@smithy/core/client").CommandImpl<GetVpnConnectionDeviceTypesCommandInput, GetVpnConnectionDeviceTypesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
