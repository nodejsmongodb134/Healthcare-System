...
declare const DisableCapacityManagerCommand_base: {
    new (input: DisableCapacityManagerCommandInput): import("@smithy/core/client").CommandImpl<DisableCapacityManagerCommandInput, DisableCapacityManagerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableCapacityManagerCommandInput]): import("@smithy/core/client").CommandImpl<DisableCapacityManagerCommandInput, DisableCapacityManagerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
