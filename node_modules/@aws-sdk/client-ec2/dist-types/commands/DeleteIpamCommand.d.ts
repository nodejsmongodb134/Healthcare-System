...
declare const DeleteIpamCommand_base: {
    new (input: DeleteIpamCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamCommandInput, DeleteIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamCommandInput, DeleteIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
