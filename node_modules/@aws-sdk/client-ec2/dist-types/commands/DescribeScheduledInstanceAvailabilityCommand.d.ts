...
declare const DescribeScheduledInstanceAvailabilityCommand_base: {
    new (input: DescribeScheduledInstanceAvailabilityCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledInstanceAvailabilityCommandInput, DescribeScheduledInstanceAvailabilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeScheduledInstanceAvailabilityCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledInstanceAvailabilityCommandInput, DescribeScheduledInstanceAvailabilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
