...
declare const ConfirmProductInstanceCommand_base: {
    new (input: ConfirmProductInstanceCommandInput): import("@smithy/core/client").CommandImpl<ConfirmProductInstanceCommandInput, ConfirmProductInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConfirmProductInstanceCommandInput): import("@smithy/core/client").CommandImpl<ConfirmProductInstanceCommandInput, ConfirmProductInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
