...
declare const GetVpnTunnelReplacementStatusCommand_base: {
    new (input: GetVpnTunnelReplacementStatusCommandInput): import("@smithy/core/client").CommandImpl<GetVpnTunnelReplacementStatusCommandInput, GetVpnTunnelReplacementStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVpnTunnelReplacementStatusCommandInput): import("@smithy/core/client").CommandImpl<GetVpnTunnelReplacementStatusCommandInput, GetVpnTunnelReplacementStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
