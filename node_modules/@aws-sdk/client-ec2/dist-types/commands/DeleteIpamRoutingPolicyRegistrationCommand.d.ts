...
import type { DeleteIpamRoutingPolicyRegistrationRequest, DeleteIpamRoutingPolicyRegistrationResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteIpamRoutingPolicyRegistrationCommand_base: {
    new (input: DeleteIpamRoutingPolicyRegistrationCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamRoutingPolicyRegistrationCommandInput, DeleteIpamRoutingPolicyRegistrationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamRoutingPolicyRegistrationCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamRoutingPolicyRegistrationCommandInput, DeleteIpamRoutingPolicyRegistrationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
