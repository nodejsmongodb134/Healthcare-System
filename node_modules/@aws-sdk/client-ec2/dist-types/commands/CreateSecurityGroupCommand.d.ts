...
declare const CreateSecurityGroupCommand_base: {
    new (input: CreateSecurityGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateSecurityGroupCommandInput, CreateSecurityGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSecurityGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateSecurityGroupCommandInput, CreateSecurityGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
