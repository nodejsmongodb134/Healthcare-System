...
declare const DescribeCarrierGatewaysCommand_base: {
    new (input: DescribeCarrierGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeCarrierGatewaysCommandInput, DescribeCarrierGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCarrierGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCarrierGatewaysCommandInput, DescribeCarrierGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
