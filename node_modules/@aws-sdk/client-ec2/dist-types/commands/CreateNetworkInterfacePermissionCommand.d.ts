...
import type { CreateNetworkInterfacePermissionRequest, CreateNetworkInterfacePermissionResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateNetworkInterfacePermissionCommand_base: {
    new (input: CreateNetworkInterfacePermissionCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInterfacePermissionCommandInput, CreateNetworkInterfacePermissionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNetworkInterfacePermissionCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInterfacePermissionCommandInput, CreateNetworkInterfacePermissionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
