...
import type { RevokeSecurityGroupIngressRequest, RevokeSecurityGroupIngressResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RevokeSecurityGroupIngressCommand_base: {
    new (input: RevokeSecurityGroupIngressCommandInput): import("@smithy/core/client").CommandImpl<RevokeSecurityGroupIngressCommandInput, RevokeSecurityGroupIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RevokeSecurityGroupIngressCommandInput]): import("@smithy/core/client").CommandImpl<RevokeSecurityGroupIngressCommandInput, RevokeSecurityGroupIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
