...
import type { EnableIpamPolicyRequest, EnableIpamPolicyResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableIpamPolicyCommand_base: {
    new (input: EnableIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamPolicyCommandInput, EnableIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamPolicyCommandInput, EnableIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
