...
import type { DescribeDeclarativePoliciesReportsRequest, DescribeDeclarativePoliciesReportsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeDeclarativePoliciesReportsCommand_base: {
    new (input: DescribeDeclarativePoliciesReportsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeclarativePoliciesReportsCommandInput, DescribeDeclarativePoliciesReportsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDeclarativePoliciesReportsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDeclarativePoliciesReportsCommandInput, DescribeDeclarativePoliciesReportsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
