...
import type { CreateVpnConnectionRequest, CreateVpnConnectionResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpnConnectionCommand_base: {
    new (input: CreateVpnConnectionCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnConnectionCommandInput, CreateVpnConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpnConnectionCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnConnectionCommandInput, CreateVpnConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateVpnConnectionCommand extends CreateVpnConnectionCommand_base {
