...
import type { StartNetworkInsightsAccessScopeAnalysisRequest, StartNetworkInsightsAccessScopeAnalysisResult } from "../models/models_8";
/**
 * @public
 */
...
declare const StartNetworkInsightsAccessScopeAnalysisCommand_base: {
    new (input: StartNetworkInsightsAccessScopeAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartNetworkInsightsAccessScopeAnalysisCommandInput, StartNetworkInsightsAccessScopeAnalysisCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartNetworkInsightsAccessScopeAnalysisCommandInput): import("@smithy/core/client").CommandImpl<StartNetworkInsightsAccessScopeAnalysisCommandInput, StartNetworkInsightsAccessScopeAnalysisCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
