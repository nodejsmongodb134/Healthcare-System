...
declare const GetInstanceTpmEkPubCommand_base: {
    new (input: GetInstanceTpmEkPubCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceTpmEkPubCommandInput, GetInstanceTpmEkPubCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInstanceTpmEkPubCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceTpmEkPubCommandInput, GetInstanceTpmEkPubCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
