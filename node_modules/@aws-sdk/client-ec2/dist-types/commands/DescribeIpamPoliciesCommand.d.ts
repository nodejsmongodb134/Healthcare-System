...
declare const DescribeIpamPoliciesCommand_base: {
    new (input: DescribeIpamPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPoliciesCommandInput, DescribeIpamPoliciesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPoliciesCommandInput, DescribeIpamPoliciesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
