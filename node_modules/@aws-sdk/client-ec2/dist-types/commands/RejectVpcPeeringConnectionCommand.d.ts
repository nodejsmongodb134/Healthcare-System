...
declare const RejectVpcPeeringConnectionCommand_base: {
    new (input: RejectVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<RejectVpcPeeringConnectionCommandInput, RejectVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<RejectVpcPeeringConnectionCommandInput, RejectVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
