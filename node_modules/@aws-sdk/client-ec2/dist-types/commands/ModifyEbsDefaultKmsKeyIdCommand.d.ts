...
import type { ModifyEbsDefaultKmsKeyIdRequest, ModifyEbsDefaultKmsKeyIdResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyEbsDefaultKmsKeyIdCommand_base: {
    new (input: ModifyEbsDefaultKmsKeyIdCommandInput): import("@smithy/core/client").CommandImpl<ModifyEbsDefaultKmsKeyIdCommandInput, ModifyEbsDefaultKmsKeyIdCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyEbsDefaultKmsKeyIdCommandInput): import("@smithy/core/client").CommandImpl<ModifyEbsDefaultKmsKeyIdCommandInput, ModifyEbsDefaultKmsKeyIdCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyEbsDefaultKmsKeyIdCommand extends ModifyEbsDefaultKmsKeyIdCommand_base {
