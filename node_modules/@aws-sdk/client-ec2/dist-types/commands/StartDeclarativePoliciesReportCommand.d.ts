...
import type { StartDeclarativePoliciesReportRequest, StartDeclarativePoliciesReportResult } from "../models/models_8";
/**
 * @public
 */
...
declare const StartDeclarativePoliciesReportCommand_base: {
    new (input: StartDeclarativePoliciesReportCommandInput): import("@smithy/core/client").CommandImpl<StartDeclarativePoliciesReportCommandInput, StartDeclarativePoliciesReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDeclarativePoliciesReportCommandInput): import("@smithy/core/client").CommandImpl<StartDeclarativePoliciesReportCommandInput, StartDeclarativePoliciesReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
