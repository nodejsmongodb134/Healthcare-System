...
import type { EnableIpamOrganizationAdminAccountRequest, EnableIpamOrganizationAdminAccountResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableIpamOrganizationAdminAccountCommand_base: {
    new (input: EnableIpamOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamOrganizationAdminAccountCommandInput, EnableIpamOrganizationAdminAccountCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableIpamOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamOrganizationAdminAccountCommandInput, EnableIpamOrganizationAdminAccountCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
