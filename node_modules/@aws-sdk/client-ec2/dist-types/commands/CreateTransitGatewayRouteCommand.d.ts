...
declare const CreateTransitGatewayRouteCommand_base: {
    new (input: CreateTransitGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayRouteCommandInput, CreateTransitGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayRouteCommandInput, CreateTransitGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
