...
import type { ModifyPrivateDnsNameOptionsRequest, ModifyPrivateDnsNameOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyPrivateDnsNameOptionsCommand_base: {
    new (input: ModifyPrivateDnsNameOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyPrivateDnsNameOptionsCommandInput, ModifyPrivateDnsNameOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyPrivateDnsNameOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyPrivateDnsNameOptionsCommandInput, ModifyPrivateDnsNameOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
