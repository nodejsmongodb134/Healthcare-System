...
import type { CreateIpamExternalResourceVerificationTokenRequest, CreateIpamExternalResourceVerificationTokenResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamExternalResourceVerificationTokenCommand_base: {
    new (input: CreateIpamExternalResourceVerificationTokenCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamExternalResourceVerificationTokenCommandInput, CreateIpamExternalResourceVerificationTokenCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamExternalResourceVerificationTokenCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamExternalResourceVerificationTokenCommandInput, CreateIpamExternalResourceVerificationTokenCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
