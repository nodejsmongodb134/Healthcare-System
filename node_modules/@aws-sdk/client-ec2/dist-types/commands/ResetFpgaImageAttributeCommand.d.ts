...
import type { ResetFpgaImageAttributeRequest, ResetFpgaImageAttributeResult } from "../models/models_8";
/**
 * @public
 */
...
declare const ResetFpgaImageAttributeCommand_base: {
    new (input: ResetFpgaImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetFpgaImageAttributeCommandInput, ResetFpgaImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetFpgaImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetFpgaImageAttributeCommandInput, ResetFpgaImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
