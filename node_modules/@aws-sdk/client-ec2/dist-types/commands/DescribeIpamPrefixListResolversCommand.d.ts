...
declare const DescribeIpamPrefixListResolversCommand_base: {
    new (input: DescribeIpamPrefixListResolversCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPrefixListResolversCommandInput, DescribeIpamPrefixListResolversCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPrefixListResolversCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPrefixListResolversCommandInput, DescribeIpamPrefixListResolversCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
