...
import type { DescribeVerifiedAccessGroupsRequest, DescribeVerifiedAccessGroupsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVerifiedAccessGroupsCommand_base: {
    new (input: DescribeVerifiedAccessGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessGroupsCommandInput, DescribeVerifiedAccessGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVerifiedAccessGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessGroupsCommandInput, DescribeVerifiedAccessGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
