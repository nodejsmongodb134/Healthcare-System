...
import type { ModifyIpamRoutingPolicyRegistrationRequest, ModifyIpamRoutingPolicyRegistrationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamRoutingPolicyRegistrationCommand_base: {
    new (input: ModifyIpamRoutingPolicyRegistrationCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamRoutingPolicyRegistrationCommandInput, ModifyIpamRoutingPolicyRegistrationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamRoutingPolicyRegistrationCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamRoutingPolicyRegistrationCommandInput, ModifyIpamRoutingPolicyRegistrationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
