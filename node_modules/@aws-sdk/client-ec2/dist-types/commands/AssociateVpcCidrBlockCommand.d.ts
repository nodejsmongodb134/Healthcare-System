...
declare const AssociateVpcCidrBlockCommand_base: {
    new (input: AssociateVpcCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<AssociateVpcCidrBlockCommandInput, AssociateVpcCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateVpcCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<AssociateVpcCidrBlockCommandInput, AssociateVpcCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
