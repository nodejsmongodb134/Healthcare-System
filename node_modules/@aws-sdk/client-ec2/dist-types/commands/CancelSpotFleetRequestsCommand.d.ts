...
import type { CancelSpotFleetRequestsRequest, CancelSpotFleetRequestsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CancelSpotFleetRequestsCommand_base: {
    new (input: CancelSpotFleetRequestsCommandInput): import("@smithy/core/client").CommandImpl<CancelSpotFleetRequestsCommandInput, CancelSpotFleetRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelSpotFleetRequestsCommandInput): import("@smithy/core/client").CommandImpl<CancelSpotFleetRequestsCommandInput, CancelSpotFleetRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
