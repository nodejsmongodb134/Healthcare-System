...
declare const ModifyVpcAttributeCommand_base: {
    new (input: ModifyVpcAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcAttributeCommandInput, ModifyVpcAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcAttributeCommandInput, ModifyVpcAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
