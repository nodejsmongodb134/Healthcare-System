...
import type { DisassociateIpamResourceDiscoveryRequest, DisassociateIpamResourceDiscoveryResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateIpamResourceDiscoveryCommand_base: {
    new (input: DisassociateIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<DisassociateIpamResourceDiscoveryCommandInput, DisassociateIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<DisassociateIpamResourceDiscoveryCommandInput, DisassociateIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateIpamResourceDiscoveryCommand extends DisassociateIpamResourceDiscoveryCommand_base {
