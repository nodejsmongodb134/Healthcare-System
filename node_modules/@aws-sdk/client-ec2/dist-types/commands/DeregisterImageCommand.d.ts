...
declare const DeregisterImageCommand_base: {
    new (input: DeregisterImageCommandInput): import("@smithy/core/client").CommandImpl<DeregisterImageCommandInput, DeregisterImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterImageCommandInput): import("@smithy/core/client").CommandImpl<DeregisterImageCommandInput, DeregisterImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
