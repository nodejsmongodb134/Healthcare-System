...
import type { EnableFastSnapshotRestoresRequest, EnableFastSnapshotRestoresResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableFastSnapshotRestoresCommand_base: {
    new (input: EnableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<EnableFastSnapshotRestoresCommandInput, EnableFastSnapshotRestoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<EnableFastSnapshotRestoresCommandInput, EnableFastSnapshotRestoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EnableFastSnapshotRestoresCommand extends EnableFastSnapshotRestoresCommand_base {
