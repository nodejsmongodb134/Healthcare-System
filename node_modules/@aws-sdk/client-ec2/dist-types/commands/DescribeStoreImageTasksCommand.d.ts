...
import type { DescribeStoreImageTasksRequest, DescribeStoreImageTasksResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeStoreImageTasksCommand_base: {
    new (input: DescribeStoreImageTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeStoreImageTasksCommandInput, DescribeStoreImageTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeStoreImageTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeStoreImageTasksCommandInput, DescribeStoreImageTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
