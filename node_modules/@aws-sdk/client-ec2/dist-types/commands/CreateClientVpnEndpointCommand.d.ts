...
import type { CreateClientVpnEndpointRequest, CreateClientVpnEndpointResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateClientVpnEndpointCommand_base: {
    new (input: CreateClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnEndpointCommandInput, CreateClientVpnEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnEndpointCommandInput, CreateClientVpnEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
