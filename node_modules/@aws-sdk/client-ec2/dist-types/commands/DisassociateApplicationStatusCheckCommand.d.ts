...
import type { DisassociateApplicationStatusCheckRequest, DisassociateApplicationStatusCheckResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateApplicationStatusCheckCommand_base: {
    new (input: DisassociateApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<DisassociateApplicationStatusCheckCommandInput, DisassociateApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<DisassociateApplicationStatusCheckCommandInput, DisassociateApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
