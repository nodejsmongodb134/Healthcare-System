...
declare const ModifyTransitGatewayMeteringPolicyCommand_base: {
    new (input: ModifyTransitGatewayMeteringPolicyCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayMeteringPolicyCommandInput, ModifyTransitGatewayMeteringPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTransitGatewayMeteringPolicyCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayMeteringPolicyCommandInput, ModifyTransitGatewayMeteringPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
