...
declare const CreateLaunchTemplateCommand_base: {
    new (input: CreateLaunchTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateLaunchTemplateCommandInput, CreateLaunchTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLaunchTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateLaunchTemplateCommandInput, CreateLaunchTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
