...
import type { DescribeVolumesRequest, DescribeVolumesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVolumesCommand_base: {
    new (input: DescribeVolumesCommandInput): import("@smithy/core/client").CommandImpl<DescribeVolumesCommandInput, DescribeVolumesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVolumesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVolumesCommandInput, DescribeVolumesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
