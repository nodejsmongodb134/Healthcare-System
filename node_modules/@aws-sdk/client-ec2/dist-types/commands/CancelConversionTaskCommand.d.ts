...
import type { CancelConversionRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const CancelConversionTaskCommand_base: {
    new (input: CancelConversionTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelConversionTaskCommandInput, CancelConversionTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelConversionTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelConversionTaskCommandInput, CancelConversionTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
