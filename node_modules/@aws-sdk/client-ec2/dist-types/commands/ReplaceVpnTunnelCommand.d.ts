...
import type { ReplaceVpnTunnelRequest, ReplaceVpnTunnelResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ReplaceVpnTunnelCommand_base: {
    new (input: ReplaceVpnTunnelCommandInput): import("@smithy/core/client").CommandImpl<ReplaceVpnTunnelCommandInput, ReplaceVpnTunnelCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceVpnTunnelCommandInput): import("@smithy/core/client").CommandImpl<ReplaceVpnTunnelCommandInput, ReplaceVpnTunnelCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
