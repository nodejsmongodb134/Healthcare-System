...
import type { ModifyInstanceNetworkPerformanceRequest, ModifyInstanceNetworkPerformanceResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceNetworkPerformanceOptionsCommand_base: {
    new (input: ModifyInstanceNetworkPerformanceOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceNetworkPerformanceOptionsCommandInput, ModifyInstanceNetworkPerformanceOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceNetworkPerformanceOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceNetworkPerformanceOptionsCommandInput, ModifyInstanceNetworkPerformanceOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
