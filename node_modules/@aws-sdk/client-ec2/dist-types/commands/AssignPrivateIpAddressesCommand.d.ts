...
declare const AssignPrivateIpAddressesCommand_base: {
    new (input: AssignPrivateIpAddressesCommandInput): import("@smithy/core/client").CommandImpl<AssignPrivateIpAddressesCommandInput, AssignPrivateIpAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssignPrivateIpAddressesCommandInput): import("@smithy/core/client").CommandImpl<AssignPrivateIpAddressesCommandInput, AssignPrivateIpAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
