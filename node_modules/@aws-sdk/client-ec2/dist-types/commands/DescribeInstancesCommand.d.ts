...
declare const DescribeInstancesCommand_base: {
    new (input: DescribeInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstancesCommandInput, DescribeInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstancesCommandInput, DescribeInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
