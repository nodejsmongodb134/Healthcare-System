...
declare const CreateSecondarySubnetCommand_base: {
    new (input: CreateSecondarySubnetCommandInput): import("@smithy/core/client").CommandImpl<CreateSecondarySubnetCommandInput, CreateSecondarySubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSecondarySubnetCommandInput): import("@smithy/core/client").CommandImpl<CreateSecondarySubnetCommandInput, CreateSecondarySubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
