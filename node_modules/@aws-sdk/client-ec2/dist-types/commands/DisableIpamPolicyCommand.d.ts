...
declare const DisableIpamPolicyCommand_base: {
    new (input: DisableIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<DisableIpamPolicyCommandInput, DisableIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<DisableIpamPolicyCommandInput, DisableIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
