...
import type { DeleteTransitGatewayVpcAttachmentRequest, DeleteTransitGatewayVpcAttachmentResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteTransitGatewayVpcAttachmentCommand_base: {
    new (input: DeleteTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayVpcAttachmentCommandInput, DeleteTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayVpcAttachmentCommandInput, DeleteTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
