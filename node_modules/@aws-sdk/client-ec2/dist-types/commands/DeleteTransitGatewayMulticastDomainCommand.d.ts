...
declare const DeleteTransitGatewayMulticastDomainCommand_base: {
    new (input: DeleteTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayMulticastDomainCommandInput, DeleteTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayMulticastDomainCommandInput, DeleteTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
