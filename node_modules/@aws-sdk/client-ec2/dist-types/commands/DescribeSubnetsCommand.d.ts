...
import type { DescribeSubnetsRequest, DescribeSubnetsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSubnetsCommand_base: {
    new (input: DescribeSubnetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubnetsCommandInput, DescribeSubnetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSubnetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSubnetsCommandInput, DescribeSubnetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
