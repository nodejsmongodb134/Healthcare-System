...
import type { DisassociateTransitGatewayPolicyTableRequest, DisassociateTransitGatewayPolicyTableResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateTransitGatewayPolicyTableCommand_base: {
    new (input: DisassociateTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTransitGatewayPolicyTableCommandInput, DisassociateTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTransitGatewayPolicyTableCommandInput, DisassociateTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateTransitGatewayPolicyTableCommand extends DisassociateTransitGatewayPolicyTableCommand_base {
