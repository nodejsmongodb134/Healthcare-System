...
declare const GetEbsDefaultKmsKeyIdCommand_base: {
    new (input: GetEbsDefaultKmsKeyIdCommandInput): import("@smithy/core/client").CommandImpl<GetEbsDefaultKmsKeyIdCommandInput, GetEbsDefaultKmsKeyIdCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetEbsDefaultKmsKeyIdCommandInput]): import("@smithy/core/client").CommandImpl<GetEbsDefaultKmsKeyIdCommandInput, GetEbsDefaultKmsKeyIdCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
