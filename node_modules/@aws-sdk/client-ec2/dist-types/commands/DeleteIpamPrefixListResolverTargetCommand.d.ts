...
import type { DeleteIpamPrefixListResolverTargetRequest, DeleteIpamPrefixListResolverTargetResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteIpamPrefixListResolverTargetCommand_base: {
    new (input: DeleteIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPrefixListResolverTargetCommandInput, DeleteIpamPrefixListResolverTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPrefixListResolverTargetCommandInput, DeleteIpamPrefixListResolverTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
