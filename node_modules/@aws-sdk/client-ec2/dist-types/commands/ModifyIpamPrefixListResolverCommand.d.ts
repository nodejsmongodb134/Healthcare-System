...
import type { ModifyIpamPrefixListResolverRequest, ModifyIpamPrefixListResolverResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamPrefixListResolverCommand_base: {
    new (input: ModifyIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverCommandInput, ModifyIpamPrefixListResolverCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverCommandInput, ModifyIpamPrefixListResolverCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
