...
declare const DeleteRouteServerPeerCommand_base: {
    new (input: DeleteRouteServerPeerCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteServerPeerCommandInput, DeleteRouteServerPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteServerPeerCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteServerPeerCommandInput, DeleteRouteServerPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
