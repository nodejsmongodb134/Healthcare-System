...
import type { CreateTransitGatewayVpcAttachmentRequest, CreateTransitGatewayVpcAttachmentResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayVpcAttachmentCommand_base: {
    new (input: CreateTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayVpcAttachmentCommandInput, CreateTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayVpcAttachmentCommandInput, CreateTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
