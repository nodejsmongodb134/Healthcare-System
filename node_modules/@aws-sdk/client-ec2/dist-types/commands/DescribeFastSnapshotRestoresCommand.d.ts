...
declare const DescribeFastSnapshotRestoresCommand_base: {
    new (input: DescribeFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<DescribeFastSnapshotRestoresCommandInput, DescribeFastSnapshotRestoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeFastSnapshotRestoresCommandInput]): import("@smithy/core/client").CommandImpl<DescribeFastSnapshotRestoresCommandInput, DescribeFastSnapshotRestoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
