...
declare const DeleteTransitGatewayCommand_base: {
    new (input: DeleteTransitGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayCommandInput, DeleteTransitGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayCommandInput, DeleteTransitGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
