...
declare const DeleteVpnConnectionRouteCommand_base: {
    new (input: DeleteVpnConnectionRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnConnectionRouteCommandInput, DeleteVpnConnectionRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpnConnectionRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnConnectionRouteCommandInput, DeleteVpnConnectionRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
