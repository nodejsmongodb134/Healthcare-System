...
declare const GetIpamPrefixListResolverRulesCommand_base: {
    new (input: GetIpamPrefixListResolverRulesCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPrefixListResolverRulesCommandInput, GetIpamPrefixListResolverRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamPrefixListResolverRulesCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPrefixListResolverRulesCommandInput, GetIpamPrefixListResolverRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
