...
import type { CreateTrafficMirrorSessionRequest, CreateTrafficMirrorSessionResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTrafficMirrorSessionCommand_base: {
    new (input: CreateTrafficMirrorSessionCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorSessionCommandInput, CreateTrafficMirrorSessionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrafficMirrorSessionCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorSessionCommandInput, CreateTrafficMirrorSessionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
