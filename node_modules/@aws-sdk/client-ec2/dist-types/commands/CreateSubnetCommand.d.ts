...
import type { CreateSubnetRequest, CreateSubnetResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateSubnetCommand_base: {
    new (input: CreateSubnetCommandInput): import("@smithy/core/client").CommandImpl<CreateSubnetCommandInput, CreateSubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSubnetCommandInput): import("@smithy/core/client").CommandImpl<CreateSubnetCommandInput, CreateSubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
