...
declare const ModifyPublicIpDnsNameOptionsCommand_base: {
    new (input: ModifyPublicIpDnsNameOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyPublicIpDnsNameOptionsCommandInput, ModifyPublicIpDnsNameOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyPublicIpDnsNameOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyPublicIpDnsNameOptionsCommandInput, ModifyPublicIpDnsNameOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
