...
import type { DeleteNetworkInsightsAccessScopeRequest, DeleteNetworkInsightsAccessScopeResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteNetworkInsightsAccessScopeCommand_base: {
    new (input: DeleteNetworkInsightsAccessScopeCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAccessScopeCommandInput, DeleteNetworkInsightsAccessScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNetworkInsightsAccessScopeCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAccessScopeCommandInput, DeleteNetworkInsightsAccessScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
