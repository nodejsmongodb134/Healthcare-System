...
declare const CreateDhcpOptionsCommand_base: {
    new (input: CreateDhcpOptionsCommandInput): import("@smithy/core/client").CommandImpl<CreateDhcpOptionsCommandInput, CreateDhcpOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDhcpOptionsCommandInput): import("@smithy/core/client").CommandImpl<CreateDhcpOptionsCommandInput, CreateDhcpOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
