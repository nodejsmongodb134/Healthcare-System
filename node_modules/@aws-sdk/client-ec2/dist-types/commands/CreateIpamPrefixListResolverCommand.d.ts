 ...
 * @public
 *
 * The input for {@link CreateIpamPrefixListResolverCommand}.
 */
export interface CreateIpamPrefixListResolverCommandInput extends CreateIpamPrefixListResolverRequest {
}
/**
 * @public
 *
...
declare const CreateIpamPrefixListResolverCommand_base: {
    new (input: CreateIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPrefixListResolverCommandInput, CreateIpamPrefixListResolverCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPrefixListResolverCommandInput, CreateIpamPrefixListResolverCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * ```javascript
 * import { EC2Client, CreateIpamPrefixListResolverCommand } from "@aws-sdk/client-ec2"; // ES Modules import
 * // const { EC2Client, CreateIpamPrefixListResolverCommand } = require("@aws-sdk/client-ec2"); // CommonJS import
 * // import type { EC2ClientConfig } from "@aws-sdk/client-ec2";
 * const config = {}; // type is EC2ClientConfig
 * const client = new EC2Client(config);
 * const input = { // CreateIpamPrefixListResolverRequest
 *   DryRun: true || false,
 ...
 * };
 * const command = new CreateIpamPrefixListResolverCommand(input);
 ...
 * ```
 *
 * @param CreateIpamPrefixListResolverCommandInput - {@link CreateIpamPrefixListResolverCommandInput}
 * @returns {@link CreateIpamPrefixListResolverCommandOutput}
 * @see {@link CreateIpamPrefixListResolverCommandInput} for command's `input` shape.
 * @see {@link CreateIpamPrefixListResolverCommandOutput} for command's `response` shape.
