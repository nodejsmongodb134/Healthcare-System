...
declare const DeleteVpnConcentratorCommand_base: {
    new (input: DeleteVpnConcentratorCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnConcentratorCommandInput, DeleteVpnConcentratorCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpnConcentratorCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnConcentratorCommandInput, DeleteVpnConcentratorCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
