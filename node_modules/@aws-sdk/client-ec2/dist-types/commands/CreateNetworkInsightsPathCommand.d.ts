...
declare const CreateNetworkInsightsPathCommand_base: {
    new (input: CreateNetworkInsightsPathCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInsightsPathCommandInput, CreateNetworkInsightsPathCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNetworkInsightsPathCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInsightsPathCommandInput, CreateNetworkInsightsPathCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
