...
import type { CreateNetworkInsightsAccessScopeRequest, CreateNetworkInsightsAccessScopeResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateNetworkInsightsAccessScopeCommand_base: {
    new (input: CreateNetworkInsightsAccessScopeCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInsightsAccessScopeCommandInput, CreateNetworkInsightsAccessScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateNetworkInsightsAccessScopeCommandInput]): import("@smithy/core/client").CommandImpl<CreateNetworkInsightsAccessScopeCommandInput, CreateNetworkInsightsAccessScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
