...
import type { GetManagedPrefixListAssociationsRequest, GetManagedPrefixListAssociationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetManagedPrefixListAssociationsCommand_base: {
    new (input: GetManagedPrefixListAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetManagedPrefixListAssociationsCommandInput, GetManagedPrefixListAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetManagedPrefixListAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetManagedPrefixListAssociationsCommandInput, GetManagedPrefixListAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
