...
import type { GetIpamPrefixListResolverVersionsRequest, GetIpamPrefixListResolverVersionsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamPrefixListResolverVersionsCommand_base: {
    new (input: GetIpamPrefixListResolverVersionsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPrefixListResolverVersionsCommandInput, GetIpamPrefixListResolverVersionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamPrefixListResolverVersionsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPrefixListResolverVersionsCommandInput, GetIpamPrefixListResolverVersionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
