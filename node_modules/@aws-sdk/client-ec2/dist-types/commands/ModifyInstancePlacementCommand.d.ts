...
import type { ModifyInstancePlacementRequest, ModifyInstancePlacementResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstancePlacementCommand_base: {
    new (input: ModifyInstancePlacementCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstancePlacementCommandInput, ModifyInstancePlacementCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstancePlacementCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstancePlacementCommandInput, ModifyInstancePlacementCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstancePlacementCommand extends ModifyInstancePlacementCommand_base {
