...
declare const AssociateNatGatewayAddressCommand_base: {
    new (input: AssociateNatGatewayAddressCommandInput): import("@smithy/core/client").CommandImpl<AssociateNatGatewayAddressCommandInput, AssociateNatGatewayAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateNatGatewayAddressCommandInput): import("@smithy/core/client").CommandImpl<AssociateNatGatewayAddressCommandInput, AssociateNatGatewayAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
