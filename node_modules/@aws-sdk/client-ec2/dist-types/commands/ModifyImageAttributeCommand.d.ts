...
import type { ModifyImageAttributeRequest } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyImageAttributeCommand_base: {
    new (input: ModifyImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyImageAttributeCommandInput, ModifyImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyImageAttributeCommandInput, ModifyImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyImageAttributeCommand extends ModifyImageAttributeCommand_base {
