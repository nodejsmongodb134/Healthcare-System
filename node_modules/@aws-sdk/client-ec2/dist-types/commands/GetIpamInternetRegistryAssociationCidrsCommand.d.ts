...
import type { GetIpamInternetRegistryAssociationCidrsRequest, GetIpamInternetRegistryAssociationCidrsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamInternetRegistryAssociationCidrsCommand_base: {
    new (input: GetIpamInternetRegistryAssociationCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamInternetRegistryAssociationCidrsCommandInput, GetIpamInternetRegistryAssociationCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamInternetRegistryAssociationCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamInternetRegistryAssociationCidrsCommandInput, GetIpamInternetRegistryAssociationCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
