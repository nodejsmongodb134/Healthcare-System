...
declare const ModifyIpamPoolCommand_base: {
    new (input: ModifyIpamPoolCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPoolCommandInput, ModifyIpamPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamPoolCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPoolCommandInput, ModifyIpamPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyIpamPoolCommand extends ModifyIpamPoolCommand_base {
