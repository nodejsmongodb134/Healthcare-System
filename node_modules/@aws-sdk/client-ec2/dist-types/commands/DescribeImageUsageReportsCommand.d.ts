...
declare const DescribeImageUsageReportsCommand_base: {
    new (input: DescribeImageUsageReportsCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageUsageReportsCommandInput, DescribeImageUsageReportsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeImageUsageReportsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeImageUsageReportsCommandInput, DescribeImageUsageReportsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
