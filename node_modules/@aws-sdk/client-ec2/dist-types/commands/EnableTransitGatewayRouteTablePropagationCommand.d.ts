...
import type { EnableTransitGatewayRouteTablePropagationRequest, EnableTransitGatewayRouteTablePropagationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableTransitGatewayRouteTablePropagationCommand_base: {
    new (input: EnableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableTransitGatewayRouteTablePropagationCommandInput, EnableTransitGatewayRouteTablePropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableTransitGatewayRouteTablePropagationCommandInput, EnableTransitGatewayRouteTablePropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EnableTransitGatewayRouteTablePropagationCommand extends EnableTransitGatewayRouteTablePropagationCommand_base {
