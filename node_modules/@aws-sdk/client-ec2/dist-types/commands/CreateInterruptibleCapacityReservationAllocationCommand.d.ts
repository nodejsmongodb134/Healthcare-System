...
import type { CreateInterruptibleCapacityReservationAllocationRequest, CreateInterruptibleCapacityReservationAllocationResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateInterruptibleCapacityReservationAllocationCommand_base: {
    new (input: CreateInterruptibleCapacityReservationAllocationCommandInput): import("@smithy/core/client").CommandImpl<CreateInterruptibleCapacityReservationAllocationCommandInput, CreateInterruptibleCapacityReservationAllocationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateInterruptibleCapacityReservationAllocationCommandInput): import("@smithy/core/client").CommandImpl<CreateInterruptibleCapacityReservationAllocationCommandInput, CreateInterruptibleCapacityReservationAllocationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * ```javascript
 * import { EC2Client, CreateInterruptibleCapacityReservationAllocationCommand } from "@aws-sdk/client-ec2"; // ES Modules import
 * // const { EC2Client, CreateInterruptibleCapacityReservationAllocationCommand } = require("@aws-sdk/client-ec2"); // CommonJS import
 * // import type { EC2ClientConfig } from "@aws-sdk/client-ec2";
 * const config = {}; // type is EC2ClientConfig
 * const client = new EC2Client(config);
 * const input = { // CreateInterruptibleCapacityReservationAllocationRequest
 ...
 * ```
 *
 * @param CreateInterruptibleCapacityReservationAllocationCommandInput - {@link CreateInterruptibleCapacityReservationAllocationCommandInput}
 * @returns {@link CreateInterruptibleCapacityReservationAllocationCommandOutput}
 * @see {@link CreateInterruptibleCapacityReservationAllocationCommandInput} for command's `input` shape.
 * @see {@link CreateInterruptibleCapacityReservationAllocationCommandOutput} for command's `response` shape.
