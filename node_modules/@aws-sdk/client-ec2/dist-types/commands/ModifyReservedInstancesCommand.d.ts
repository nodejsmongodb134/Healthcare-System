...
import type { ModifyReservedInstancesRequest, ModifyReservedInstancesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyReservedInstancesCommand_base: {
    new (input: ModifyReservedInstancesCommandInput): import("@smithy/core/client").CommandImpl<ModifyReservedInstancesCommandInput, ModifyReservedInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyReservedInstancesCommandInput): import("@smithy/core/client").CommandImpl<ModifyReservedInstancesCommandInput, ModifyReservedInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyReservedInstancesCommand extends ModifyReservedInstancesCommand_base {
