...
declare const DetachClassicLinkVpcCommand_base: {
    new (input: DetachClassicLinkVpcCommandInput): import("@smithy/core/client").CommandImpl<DetachClassicLinkVpcCommandInput, DetachClassicLinkVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachClassicLinkVpcCommandInput): import("@smithy/core/client").CommandImpl<DetachClassicLinkVpcCommandInput, DetachClassicLinkVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
