...
import type { ModifyInstanceEventWindowRequest, ModifyInstanceEventWindowResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceEventWindowCommand_base: {
    new (input: ModifyInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceEventWindowCommandInput, ModifyInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceEventWindowCommandInput, ModifyInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstanceEventWindowCommand extends ModifyInstanceEventWindowCommand_base {
