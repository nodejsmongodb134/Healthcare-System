...
declare const GetAssociatedEnclaveCertificateIamRolesCommand_base: {
    new (input: GetAssociatedEnclaveCertificateIamRolesCommandInput): import("@smithy/core/client").CommandImpl<GetAssociatedEnclaveCertificateIamRolesCommandInput, GetAssociatedEnclaveCertificateIamRolesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAssociatedEnclaveCertificateIamRolesCommandInput): import("@smithy/core/client").CommandImpl<GetAssociatedEnclaveCertificateIamRolesCommandInput, GetAssociatedEnclaveCertificateIamRolesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
