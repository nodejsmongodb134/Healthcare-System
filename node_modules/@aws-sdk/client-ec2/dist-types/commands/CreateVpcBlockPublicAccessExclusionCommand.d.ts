...
import type { CreateVpcBlockPublicAccessExclusionRequest, CreateVpcBlockPublicAccessExclusionResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpcBlockPublicAccessExclusionCommand_base: {
    new (input: CreateVpcBlockPublicAccessExclusionCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcBlockPublicAccessExclusionCommandInput, CreateVpcBlockPublicAccessExclusionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcBlockPublicAccessExclusionCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcBlockPublicAccessExclusionCommandInput, CreateVpcBlockPublicAccessExclusionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
