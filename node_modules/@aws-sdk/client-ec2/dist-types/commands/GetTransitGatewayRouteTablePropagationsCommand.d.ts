...
import type { GetTransitGatewayRouteTablePropagationsRequest, GetTransitGatewayRouteTablePropagationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayRouteTablePropagationsCommand_base: {
    new (input: GetTransitGatewayRouteTablePropagationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayRouteTablePropagationsCommandInput, GetTransitGatewayRouteTablePropagationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayRouteTablePropagationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayRouteTablePropagationsCommandInput, GetTransitGatewayRouteTablePropagationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
