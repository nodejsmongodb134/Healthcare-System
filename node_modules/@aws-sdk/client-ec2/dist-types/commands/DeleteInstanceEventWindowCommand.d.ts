...
declare const DeleteInstanceEventWindowCommand_base: {
    new (input: DeleteInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<DeleteInstanceEventWindowCommandInput, DeleteInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<DeleteInstanceEventWindowCommandInput, DeleteInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
