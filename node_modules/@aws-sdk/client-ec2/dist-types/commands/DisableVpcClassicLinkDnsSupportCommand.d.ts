...
declare const DisableVpcClassicLinkDnsSupportCommand_base: {
    new (input: DisableVpcClassicLinkDnsSupportCommandInput): import("@smithy/core/client").CommandImpl<DisableVpcClassicLinkDnsSupportCommandInput, DisableVpcClassicLinkDnsSupportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableVpcClassicLinkDnsSupportCommandInput]): import("@smithy/core/client").CommandImpl<DisableVpcClassicLinkDnsSupportCommandInput, DisableVpcClassicLinkDnsSupportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
