...
import type { ModifyVpnConnectionRequest, ModifyVpnConnectionResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpnConnectionCommand_base: {
    new (input: ModifyVpnConnectionCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnConnectionCommandInput, ModifyVpnConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpnConnectionCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnConnectionCommandInput, ModifyVpnConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
