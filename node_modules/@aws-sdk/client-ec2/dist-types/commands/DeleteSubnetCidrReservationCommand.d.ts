...
import type { DeleteSubnetCidrReservationRequest, DeleteSubnetCidrReservationResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteSubnetCidrReservationCommand_base: {
    new (input: DeleteSubnetCidrReservationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubnetCidrReservationCommandInput, DeleteSubnetCidrReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSubnetCidrReservationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubnetCidrReservationCommandInput, DeleteSubnetCidrReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
