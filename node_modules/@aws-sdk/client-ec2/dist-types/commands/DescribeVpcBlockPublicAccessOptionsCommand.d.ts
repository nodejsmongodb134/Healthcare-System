...
import type { DescribeVpcBlockPublicAccessOptionsRequest, DescribeVpcBlockPublicAccessOptionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcBlockPublicAccessOptionsCommand_base: {
    new (input: DescribeVpcBlockPublicAccessOptionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcBlockPublicAccessOptionsCommandInput, DescribeVpcBlockPublicAccessOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcBlockPublicAccessOptionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcBlockPublicAccessOptionsCommandInput, DescribeVpcBlockPublicAccessOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
