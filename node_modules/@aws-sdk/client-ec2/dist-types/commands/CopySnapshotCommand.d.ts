...
declare const CopySnapshotCommand_base: {
    new (input: CopySnapshotCommandInput): import("@smithy/core/client").CommandImpl<CopySnapshotCommandInput, CopySnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CopySnapshotCommandInput): import("@smithy/core/client").CommandImpl<CopySnapshotCommandInput, CopySnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
