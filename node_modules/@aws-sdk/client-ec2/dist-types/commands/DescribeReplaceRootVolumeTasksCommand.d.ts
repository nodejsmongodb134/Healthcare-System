...
import type { DescribeReplaceRootVolumeTasksRequest, DescribeReplaceRootVolumeTasksResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeReplaceRootVolumeTasksCommand_base: {
    new (input: DescribeReplaceRootVolumeTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeReplaceRootVolumeTasksCommandInput, DescribeReplaceRootVolumeTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeReplaceRootVolumeTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeReplaceRootVolumeTasksCommandInput, DescribeReplaceRootVolumeTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
