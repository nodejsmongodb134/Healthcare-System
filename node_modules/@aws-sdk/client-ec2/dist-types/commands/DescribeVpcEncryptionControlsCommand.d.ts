...
declare const DescribeVpcEncryptionControlsCommand_base: {
    new (input: DescribeVpcEncryptionControlsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEncryptionControlsCommandInput, DescribeVpcEncryptionControlsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEncryptionControlsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEncryptionControlsCommandInput, DescribeVpcEncryptionControlsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
