...
import type { ModifyHostsRequest, ModifyHostsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyHostsCommand_base: {
    new (input: ModifyHostsCommandInput): import("@smithy/core/client").CommandImpl<ModifyHostsCommandInput, ModifyHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyHostsCommandInput): import("@smithy/core/client").CommandImpl<ModifyHostsCommandInput, ModifyHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyHostsCommand extends ModifyHostsCommand_base {
