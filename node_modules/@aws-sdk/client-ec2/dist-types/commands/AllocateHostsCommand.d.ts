...
declare const AllocateHostsCommand_base: {
    new (input: AllocateHostsCommandInput): import("@smithy/core/client").CommandImpl<AllocateHostsCommandInput, AllocateHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [AllocateHostsCommandInput]): import("@smithy/core/client").CommandImpl<AllocateHostsCommandInput, AllocateHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
