...
import type { CreateClientVpnRouteRequest, CreateClientVpnRouteResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateClientVpnRouteCommand_base: {
    new (input: CreateClientVpnRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnRouteCommandInput, CreateClientVpnRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateClientVpnRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnRouteCommandInput, CreateClientVpnRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
