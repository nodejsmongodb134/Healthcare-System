...
declare const DeleteVpcCommand_base: {
    new (input: DeleteVpcCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcCommandInput, DeleteVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcCommandInput, DeleteVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
