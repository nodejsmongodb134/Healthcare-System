...
import type { ReleaseAddressRequest } from "../models/models_7";
/**
 * @public
 */
...
declare const ReleaseAddressCommand_base: {
    new (input: ReleaseAddressCommandInput): import("@smithy/core/client").CommandImpl<ReleaseAddressCommandInput, ReleaseAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ReleaseAddressCommandInput]): import("@smithy/core/client").CommandImpl<ReleaseAddressCommandInput, ReleaseAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
