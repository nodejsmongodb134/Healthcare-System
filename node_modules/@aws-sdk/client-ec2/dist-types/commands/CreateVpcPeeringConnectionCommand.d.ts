...
import type { CreateVpcPeeringConnectionRequest, CreateVpcPeeringConnectionResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpcPeeringConnectionCommand_base: {
    new (input: CreateVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcPeeringConnectionCommandInput, CreateVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcPeeringConnectionCommandInput, CreateVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
