...
import type { RejectVpcEndpointConnectionsRequest, RejectVpcEndpointConnectionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RejectVpcEndpointConnectionsCommand_base: {
    new (input: RejectVpcEndpointConnectionsCommandInput): import("@smithy/core/client").CommandImpl<RejectVpcEndpointConnectionsCommandInput, RejectVpcEndpointConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectVpcEndpointConnectionsCommandInput): import("@smithy/core/client").CommandImpl<RejectVpcEndpointConnectionsCommandInput, RejectVpcEndpointConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
