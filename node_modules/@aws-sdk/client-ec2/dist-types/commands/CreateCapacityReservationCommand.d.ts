...
import type { CreateCapacityReservationRequest, CreateCapacityReservationResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCapacityReservationCommand_base: {
    new (input: CreateCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationCommandInput, CreateCapacityReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationCommandInput, CreateCapacityReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
