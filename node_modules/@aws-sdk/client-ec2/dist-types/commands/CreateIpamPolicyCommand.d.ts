...
import type { CreateIpamPolicyRequest, CreateIpamPolicyResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamPolicyCommand_base: {
    new (input: CreateIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPolicyCommandInput, CreateIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPolicyCommandInput, CreateIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
