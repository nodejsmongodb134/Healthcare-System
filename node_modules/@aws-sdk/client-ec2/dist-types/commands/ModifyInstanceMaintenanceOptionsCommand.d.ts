...
import type { ModifyInstanceMaintenanceOptionsRequest, ModifyInstanceMaintenanceOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceMaintenanceOptionsCommand_base: {
    new (input: ModifyInstanceMaintenanceOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMaintenanceOptionsCommandInput, ModifyInstanceMaintenanceOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceMaintenanceOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMaintenanceOptionsCommandInput, ModifyInstanceMaintenanceOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
