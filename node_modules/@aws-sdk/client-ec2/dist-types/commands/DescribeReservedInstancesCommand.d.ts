...
import type { DescribeReservedInstancesRequest, DescribeReservedInstancesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeReservedInstancesCommand_base: {
    new (input: DescribeReservedInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesCommandInput, DescribeReservedInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeReservedInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesCommandInput, DescribeReservedInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
