...
import type { GetEnabledIpamPolicyRequest, GetEnabledIpamPolicyResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetEnabledIpamPolicyCommand_base: {
    new (input: GetEnabledIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetEnabledIpamPolicyCommandInput, GetEnabledIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetEnabledIpamPolicyCommandInput]): import("@smithy/core/client").CommandImpl<GetEnabledIpamPolicyCommandInput, GetEnabledIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
