...
import type { ResetSnapshotAttributeRequest } from "../models/models_8";
/**
 * @public
 */
...
declare const ResetSnapshotAttributeCommand_base: {
    new (input: ResetSnapshotAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetSnapshotAttributeCommandInput, ResetSnapshotAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetSnapshotAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetSnapshotAttributeCommandInput, ResetSnapshotAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
