...
import type { CreateVpcEndpointRequest, CreateVpcEndpointResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpcEndpointCommand_base: {
    new (input: CreateVpcEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEndpointCommandInput, CreateVpcEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEndpointCommandInput, CreateVpcEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
