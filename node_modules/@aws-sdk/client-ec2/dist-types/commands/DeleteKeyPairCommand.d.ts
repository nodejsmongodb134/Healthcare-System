...
import type { DeleteKeyPairRequest, DeleteKeyPairResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteKeyPairCommand_base: {
    new (input: DeleteKeyPairCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyPairCommandInput, DeleteKeyPairCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteKeyPairCommandInput]): import("@smithy/core/client").CommandImpl<DeleteKeyPairCommandInput, DeleteKeyPairCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
