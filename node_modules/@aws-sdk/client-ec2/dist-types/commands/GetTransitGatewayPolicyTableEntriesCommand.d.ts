...
import type { GetTransitGatewayPolicyTableEntriesRequest, GetTransitGatewayPolicyTableEntriesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayPolicyTableEntriesCommand_base: {
    new (input: GetTransitGatewayPolicyTableEntriesCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayPolicyTableEntriesCommandInput, GetTransitGatewayPolicyTableEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayPolicyTableEntriesCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayPolicyTableEntriesCommandInput, GetTransitGatewayPolicyTableEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
