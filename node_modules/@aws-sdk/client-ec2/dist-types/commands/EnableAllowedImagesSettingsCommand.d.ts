...
import type { EnableAllowedImagesSettingsRequest, EnableAllowedImagesSettingsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableAllowedImagesSettingsCommand_base: {
    new (input: EnableAllowedImagesSettingsCommandInput): import("@smithy/core/client").CommandImpl<EnableAllowedImagesSettingsCommandInput, EnableAllowedImagesSettingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableAllowedImagesSettingsCommandInput): import("@smithy/core/client").CommandImpl<EnableAllowedImagesSettingsCommandInput, EnableAllowedImagesSettingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
