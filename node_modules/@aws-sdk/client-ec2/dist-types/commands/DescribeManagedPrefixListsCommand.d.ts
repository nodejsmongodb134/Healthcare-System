...
declare const DescribeManagedPrefixListsCommand_base: {
    new (input: DescribeManagedPrefixListsCommandInput): import("@smithy/core/client").CommandImpl<DescribeManagedPrefixListsCommandInput, DescribeManagedPrefixListsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeManagedPrefixListsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeManagedPrefixListsCommandInput, DescribeManagedPrefixListsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
