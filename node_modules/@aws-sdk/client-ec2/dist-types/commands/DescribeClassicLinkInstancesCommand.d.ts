...
import type { DescribeClassicLinkInstancesRequest, DescribeClassicLinkInstancesResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeClassicLinkInstancesCommand_base: {
    new (input: DescribeClassicLinkInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeClassicLinkInstancesCommandInput, DescribeClassicLinkInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeClassicLinkInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeClassicLinkInstancesCommandInput, DescribeClassicLinkInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
