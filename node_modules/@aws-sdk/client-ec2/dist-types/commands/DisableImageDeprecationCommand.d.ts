...
declare const DisableImageDeprecationCommand_base: {
    new (input: DisableImageDeprecationCommandInput): import("@smithy/core/client").CommandImpl<DisableImageDeprecationCommandInput, DisableImageDeprecationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableImageDeprecationCommandInput): import("@smithy/core/client").CommandImpl<DisableImageDeprecationCommandInput, DisableImageDeprecationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
