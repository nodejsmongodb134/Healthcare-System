...
declare const DeleteVpnConnectionCommand_base: {
    new (input: DeleteVpnConnectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnConnectionCommandInput, DeleteVpnConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpnConnectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnConnectionCommandInput, DeleteVpnConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
