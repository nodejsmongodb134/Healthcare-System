...
import type { ListVolumesInRecycleBinRequest, ListVolumesInRecycleBinResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ListVolumesInRecycleBinCommand_base: {
    new (input: ListVolumesInRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<ListVolumesInRecycleBinCommandInput, ListVolumesInRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVolumesInRecycleBinCommandInput]): import("@smithy/core/client").CommandImpl<ListVolumesInRecycleBinCommandInput, ListVolumesInRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
