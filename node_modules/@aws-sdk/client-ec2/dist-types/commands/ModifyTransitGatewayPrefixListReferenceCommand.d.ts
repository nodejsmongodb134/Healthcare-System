...
import type { ModifyTransitGatewayPrefixListReferenceRequest, ModifyTransitGatewayPrefixListReferenceResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyTransitGatewayPrefixListReferenceCommand_base: {
    new (input: ModifyTransitGatewayPrefixListReferenceCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayPrefixListReferenceCommandInput, ModifyTransitGatewayPrefixListReferenceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTransitGatewayPrefixListReferenceCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayPrefixListReferenceCommandInput, ModifyTransitGatewayPrefixListReferenceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
