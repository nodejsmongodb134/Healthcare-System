...
declare const DescribeIpv6PoolsCommand_base: {
    new (input: DescribeIpv6PoolsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpv6PoolsCommandInput, DescribeIpv6PoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpv6PoolsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpv6PoolsCommandInput, DescribeIpv6PoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
