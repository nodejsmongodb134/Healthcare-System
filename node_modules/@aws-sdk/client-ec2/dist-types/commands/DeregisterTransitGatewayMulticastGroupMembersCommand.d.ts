...
import type { DeregisterTransitGatewayMulticastGroupMembersRequest, DeregisterTransitGatewayMulticastGroupMembersResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeregisterTransitGatewayMulticastGroupMembersCommand_base: {
    new (input: DeregisterTransitGatewayMulticastGroupMembersCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTransitGatewayMulticastGroupMembersCommandInput, DeregisterTransitGatewayMulticastGroupMembersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeregisterTransitGatewayMulticastGroupMembersCommandInput]): import("@smithy/core/client").CommandImpl<DeregisterTransitGatewayMulticastGroupMembersCommandInput, DeregisterTransitGatewayMulticastGroupMembersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
