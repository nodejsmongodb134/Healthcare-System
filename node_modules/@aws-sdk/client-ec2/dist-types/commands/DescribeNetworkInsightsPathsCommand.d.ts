...
declare const DescribeNetworkInsightsPathsCommand_base: {
    new (input: DescribeNetworkInsightsPathsCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsPathsCommandInput, DescribeNetworkInsightsPathsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInsightsPathsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsPathsCommandInput, DescribeNetworkInsightsPathsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
