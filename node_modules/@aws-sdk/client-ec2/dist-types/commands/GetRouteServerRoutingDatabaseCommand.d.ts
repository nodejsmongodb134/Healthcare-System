...
declare const GetRouteServerRoutingDatabaseCommand_base: {
    new (input: GetRouteServerRoutingDatabaseCommandInput): import("@smithy/core/client").CommandImpl<GetRouteServerRoutingDatabaseCommandInput, GetRouteServerRoutingDatabaseCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRouteServerRoutingDatabaseCommandInput): import("@smithy/core/client").CommandImpl<GetRouteServerRoutingDatabaseCommandInput, GetRouteServerRoutingDatabaseCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRouteServerRoutingDatabaseCommand extends GetRouteServerRoutingDatabaseCommand_base {
