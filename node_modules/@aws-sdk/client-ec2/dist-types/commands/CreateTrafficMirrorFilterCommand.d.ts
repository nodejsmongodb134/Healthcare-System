...
import type { CreateTrafficMirrorFilterRequest, CreateTrafficMirrorFilterResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTrafficMirrorFilterCommand_base: {
    new (input: CreateTrafficMirrorFilterCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorFilterCommandInput, CreateTrafficMirrorFilterCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateTrafficMirrorFilterCommandInput]): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorFilterCommandInput, CreateTrafficMirrorFilterCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
