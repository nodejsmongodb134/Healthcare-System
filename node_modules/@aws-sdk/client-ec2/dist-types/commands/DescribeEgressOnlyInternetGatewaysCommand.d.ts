...
import type { DescribeEgressOnlyInternetGatewaysRequest, DescribeEgressOnlyInternetGatewaysResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeEgressOnlyInternetGatewaysCommand_base: {
    new (input: DescribeEgressOnlyInternetGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeEgressOnlyInternetGatewaysCommandInput, DescribeEgressOnlyInternetGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEgressOnlyInternetGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEgressOnlyInternetGatewaysCommandInput, DescribeEgressOnlyInternetGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
