...
import type { CreateTransitGatewayMeteringPolicyEntryRequest, CreateTransitGatewayMeteringPolicyEntryResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayMeteringPolicyEntryCommand_base: {
    new (input: CreateTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayMeteringPolicyEntryCommandInput, CreateTransitGatewayMeteringPolicyEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayMeteringPolicyEntryCommandInput, CreateTransitGatewayMeteringPolicyEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
