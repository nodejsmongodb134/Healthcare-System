...
declare const AssociateClientVpnTargetNetworkCommand_base: {
    new (input: AssociateClientVpnTargetNetworkCommandInput): import("@smithy/core/client").CommandImpl<AssociateClientVpnTargetNetworkCommandInput, AssociateClientVpnTargetNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateClientVpnTargetNetworkCommandInput): import("@smithy/core/client").CommandImpl<AssociateClientVpnTargetNetworkCommandInput, AssociateClientVpnTargetNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
