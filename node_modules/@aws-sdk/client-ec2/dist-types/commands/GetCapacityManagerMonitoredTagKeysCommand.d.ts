...
import type { GetCapacityManagerMonitoredTagKeysRequest, GetCapacityManagerMonitoredTagKeysResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetCapacityManagerMonitoredTagKeysCommand_base: {
    new (input: GetCapacityManagerMonitoredTagKeysCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetCapacityManagerMonitoredTagKeysCommandInput]): import("@smithy/core/client").CommandImpl<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
