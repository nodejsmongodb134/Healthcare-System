...
import type { DescribeSecondaryNetworksRequest, DescribeSecondaryNetworksResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSecondaryNetworksCommand_base: {
    new (input: DescribeSecondaryNetworksCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecondaryNetworksCommandInput, DescribeSecondaryNetworksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecondaryNetworksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecondaryNetworksCommandInput, DescribeSecondaryNetworksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
