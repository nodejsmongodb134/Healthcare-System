...
declare const DescribeIamInstanceProfileAssociationsCommand_base: {
    new (input: DescribeIamInstanceProfileAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIamInstanceProfileAssociationsCommandInput, DescribeIamInstanceProfileAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIamInstanceProfileAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIamInstanceProfileAssociationsCommandInput, DescribeIamInstanceProfileAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
