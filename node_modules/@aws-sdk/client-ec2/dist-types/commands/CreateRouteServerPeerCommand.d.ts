...
declare const CreateRouteServerPeerCommand_base: {
    new (input: CreateRouteServerPeerCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteServerPeerCommandInput, CreateRouteServerPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteServerPeerCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteServerPeerCommandInput, CreateRouteServerPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
