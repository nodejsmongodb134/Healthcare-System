...
import type { DeleteVerifiedAccessTrustProviderRequest, DeleteVerifiedAccessTrustProviderResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVerifiedAccessTrustProviderCommand_base: {
    new (input: DeleteVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessTrustProviderCommandInput, DeleteVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessTrustProviderCommandInput, DeleteVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
