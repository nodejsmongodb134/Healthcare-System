...
import type { ModifyVerifiedAccessGroupPolicyRequest, ModifyVerifiedAccessGroupPolicyResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVerifiedAccessGroupPolicyCommand_base: {
    new (input: ModifyVerifiedAccessGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessGroupPolicyCommandInput, ModifyVerifiedAccessGroupPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVerifiedAccessGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessGroupPolicyCommandInput, ModifyVerifiedAccessGroupPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
