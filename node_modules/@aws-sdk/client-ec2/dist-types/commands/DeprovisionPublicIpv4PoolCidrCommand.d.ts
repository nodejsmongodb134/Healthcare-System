...
declare const DeprovisionPublicIpv4PoolCidrCommand_base: {
    new (input: DeprovisionPublicIpv4PoolCidrCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionPublicIpv4PoolCidrCommandInput, DeprovisionPublicIpv4PoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeprovisionPublicIpv4PoolCidrCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionPublicIpv4PoolCidrCommandInput, DeprovisionPublicIpv4PoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
