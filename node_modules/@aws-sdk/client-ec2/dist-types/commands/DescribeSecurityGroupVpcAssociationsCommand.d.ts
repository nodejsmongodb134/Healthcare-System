...
declare const DescribeSecurityGroupVpcAssociationsCommand_base: {
    new (input: DescribeSecurityGroupVpcAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupVpcAssociationsCommandInput, DescribeSecurityGroupVpcAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecurityGroupVpcAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupVpcAssociationsCommandInput, DescribeSecurityGroupVpcAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
