...
import type { DescribeVpcEndpointServicesRequest, DescribeVpcEndpointServicesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcEndpointServicesCommand_base: {
    new (input: DescribeVpcEndpointServicesCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointServicesCommandInput, DescribeVpcEndpointServicesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEndpointServicesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointServicesCommandInput, DescribeVpcEndpointServicesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
