...
import type { CreateInternetGatewayRequest, CreateInternetGatewayResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateInternetGatewayCommand_base: {
    new (input: CreateInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateInternetGatewayCommandInput, CreateInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateInternetGatewayCommandInput]): import("@smithy/core/client").CommandImpl<CreateInternetGatewayCommandInput, CreateInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
