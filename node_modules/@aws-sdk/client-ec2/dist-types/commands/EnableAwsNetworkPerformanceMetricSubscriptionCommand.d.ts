...
import type { EnableAwsNetworkPerformanceMetricSubscriptionRequest, EnableAwsNetworkPerformanceMetricSubscriptionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableAwsNetworkPerformanceMetricSubscriptionCommand_base: {
    new (input: EnableAwsNetworkPerformanceMetricSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<EnableAwsNetworkPerformanceMetricSubscriptionCommandInput, EnableAwsNetworkPerformanceMetricSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableAwsNetworkPerformanceMetricSubscriptionCommandInput]): import("@smithy/core/client").CommandImpl<EnableAwsNetworkPerformanceMetricSubscriptionCommandInput, EnableAwsNetworkPerformanceMetricSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
