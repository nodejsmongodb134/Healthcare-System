...
import type { AcceptCapacityReservationBillingOwnershipRequest, AcceptCapacityReservationBillingOwnershipResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AcceptCapacityReservationBillingOwnershipCommand_base: {
    new (input: AcceptCapacityReservationBillingOwnershipCommandInput): import("@smithy/core/client").CommandImpl<AcceptCapacityReservationBillingOwnershipCommandInput, AcceptCapacityReservationBillingOwnershipCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptCapacityReservationBillingOwnershipCommandInput): import("@smithy/core/client").CommandImpl<AcceptCapacityReservationBillingOwnershipCommandInput, AcceptCapacityReservationBillingOwnershipCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
