...
declare const DescribeExportImageTasksCommand_base: {
    new (input: DescribeExportImageTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeExportImageTasksCommandInput, DescribeExportImageTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeExportImageTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeExportImageTasksCommandInput, DescribeExportImageTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
