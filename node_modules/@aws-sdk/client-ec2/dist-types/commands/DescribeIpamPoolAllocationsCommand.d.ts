...
declare const DescribeIpamPoolAllocationsCommand_base: {
    new (input: DescribeIpamPoolAllocationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPoolAllocationsCommandInput, DescribeIpamPoolAllocationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPoolAllocationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPoolAllocationsCommandInput, DescribeIpamPoolAllocationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
