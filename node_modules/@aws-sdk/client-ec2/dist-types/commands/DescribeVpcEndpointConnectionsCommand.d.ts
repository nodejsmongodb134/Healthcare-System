...
import type { DescribeVpcEndpointConnectionsRequest, DescribeVpcEndpointConnectionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcEndpointConnectionsCommand_base: {
    new (input: DescribeVpcEndpointConnectionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointConnectionsCommandInput, DescribeVpcEndpointConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEndpointConnectionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointConnectionsCommandInput, DescribeVpcEndpointConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
