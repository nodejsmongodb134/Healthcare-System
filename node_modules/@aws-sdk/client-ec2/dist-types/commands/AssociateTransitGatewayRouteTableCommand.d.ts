...
import type { AssociateTransitGatewayRouteTableRequest, AssociateTransitGatewayRouteTableResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateTransitGatewayRouteTableCommand_base: {
    new (input: AssociateTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<AssociateTransitGatewayRouteTableCommandInput, AssociateTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<AssociateTransitGatewayRouteTableCommandInput, AssociateTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
