...
declare const DescribeAggregateIdFormatCommand_base: {
    new (input: DescribeAggregateIdFormatCommandInput): import("@smithy/core/client").CommandImpl<DescribeAggregateIdFormatCommandInput, DescribeAggregateIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAggregateIdFormatCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAggregateIdFormatCommandInput, DescribeAggregateIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
