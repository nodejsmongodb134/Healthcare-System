...
import type { DescribeElasticGpusRequest, DescribeElasticGpusResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeElasticGpusCommand_base: {
    new (input: DescribeElasticGpusCommandInput): import("@smithy/core/client").CommandImpl<DescribeElasticGpusCommandInput, DescribeElasticGpusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeElasticGpusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeElasticGpusCommandInput, DescribeElasticGpusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
