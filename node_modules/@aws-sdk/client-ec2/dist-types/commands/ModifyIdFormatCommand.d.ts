...
declare const ModifyIdFormatCommand_base: {
    new (input: ModifyIdFormatCommandInput): import("@smithy/core/client").CommandImpl<ModifyIdFormatCommandInput, ModifyIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIdFormatCommandInput): import("@smithy/core/client").CommandImpl<ModifyIdFormatCommandInput, ModifyIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyIdFormatCommand extends ModifyIdFormatCommand_base {
