...
import type { ListImagesInRecycleBinRequest, ListImagesInRecycleBinResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ListImagesInRecycleBinCommand_base: {
    new (input: ListImagesInRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<ListImagesInRecycleBinCommandInput, ListImagesInRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListImagesInRecycleBinCommandInput]): import("@smithy/core/client").CommandImpl<ListImagesInRecycleBinCommandInput, ListImagesInRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
