...
import type { DisassociateTransitGatewayMulticastDomainRequest, DisassociateTransitGatewayMulticastDomainResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateTransitGatewayMulticastDomainCommand_base: {
    new (input: DisassociateTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTransitGatewayMulticastDomainCommandInput, DisassociateTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTransitGatewayMulticastDomainCommandInput, DisassociateTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateTransitGatewayMulticastDomainCommand extends DisassociateTransitGatewayMulticastDomainCommand_base {
