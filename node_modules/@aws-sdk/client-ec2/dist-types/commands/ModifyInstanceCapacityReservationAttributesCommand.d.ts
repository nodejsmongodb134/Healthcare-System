...
import type { ModifyInstanceCapacityReservationAttributesRequest, ModifyInstanceCapacityReservationAttributesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceCapacityReservationAttributesCommand_base: {
    new (input: ModifyInstanceCapacityReservationAttributesCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCapacityReservationAttributesCommandInput, ModifyInstanceCapacityReservationAttributesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceCapacityReservationAttributesCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCapacityReservationAttributesCommandInput, ModifyInstanceCapacityReservationAttributesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstanceCapacityReservationAttributesCommand extends ModifyInstanceCapacityReservationAttributesCommand_base {
