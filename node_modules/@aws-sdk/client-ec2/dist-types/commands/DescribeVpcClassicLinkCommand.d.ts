...
declare const DescribeVpcClassicLinkCommand_base: {
    new (input: DescribeVpcClassicLinkCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcClassicLinkCommandInput, DescribeVpcClassicLinkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcClassicLinkCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcClassicLinkCommandInput, DescribeVpcClassicLinkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
