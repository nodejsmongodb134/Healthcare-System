...
declare const GetSecurityGroupsForVpcCommand_base: {
    new (input: GetSecurityGroupsForVpcCommandInput): import("@smithy/core/client").CommandImpl<GetSecurityGroupsForVpcCommandInput, GetSecurityGroupsForVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSecurityGroupsForVpcCommandInput): import("@smithy/core/client").CommandImpl<GetSecurityGroupsForVpcCommandInput, GetSecurityGroupsForVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
