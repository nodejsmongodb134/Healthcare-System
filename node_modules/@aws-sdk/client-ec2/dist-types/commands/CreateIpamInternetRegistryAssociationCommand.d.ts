...
import type { CreateIpamInternetRegistryAssociationRequest, CreateIpamInternetRegistryAssociationResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamInternetRegistryAssociationCommand_base: {
    new (input: CreateIpamInternetRegistryAssociationCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamInternetRegistryAssociationCommandInput, CreateIpamInternetRegistryAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamInternetRegistryAssociationCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamInternetRegistryAssociationCommandInput, CreateIpamInternetRegistryAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
