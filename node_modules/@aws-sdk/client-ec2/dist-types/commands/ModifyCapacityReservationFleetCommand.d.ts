...
import type { ModifyCapacityReservationFleetRequest, ModifyCapacityReservationFleetResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyCapacityReservationFleetCommand_base: {
    new (input: ModifyCapacityReservationFleetCommandInput): import("@smithy/core/client").CommandImpl<ModifyCapacityReservationFleetCommandInput, ModifyCapacityReservationFleetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyCapacityReservationFleetCommandInput): import("@smithy/core/client").CommandImpl<ModifyCapacityReservationFleetCommandInput, ModifyCapacityReservationFleetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
