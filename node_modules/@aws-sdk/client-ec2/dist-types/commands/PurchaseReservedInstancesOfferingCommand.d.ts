...
import type { PurchaseReservedInstancesOfferingRequest, PurchaseReservedInstancesOfferingResult } from "../models/models_7";
/**
 * @public
 */
...
declare const PurchaseReservedInstancesOfferingCommand_base: {
    new (input: PurchaseReservedInstancesOfferingCommandInput): import("@smithy/core/client").CommandImpl<PurchaseReservedInstancesOfferingCommandInput, PurchaseReservedInstancesOfferingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PurchaseReservedInstancesOfferingCommandInput): import("@smithy/core/client").CommandImpl<PurchaseReservedInstancesOfferingCommandInput, PurchaseReservedInstancesOfferingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
