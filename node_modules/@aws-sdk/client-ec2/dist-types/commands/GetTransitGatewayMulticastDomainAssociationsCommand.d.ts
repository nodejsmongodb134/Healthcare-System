...
import type { GetTransitGatewayMulticastDomainAssociationsRequest, GetTransitGatewayMulticastDomainAssociationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayMulticastDomainAssociationsCommand_base: {
    new (input: GetTransitGatewayMulticastDomainAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayMulticastDomainAssociationsCommandInput, GetTransitGatewayMulticastDomainAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayMulticastDomainAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayMulticastDomainAssociationsCommandInput, GetTransitGatewayMulticastDomainAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
