...
declare const CreateVpcEncryptionControlCommand_base: {
    new (input: CreateVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEncryptionControlCommandInput, CreateVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEncryptionControlCommandInput, CreateVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
