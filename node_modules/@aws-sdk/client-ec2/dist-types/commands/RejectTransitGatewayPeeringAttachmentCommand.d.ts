...
import type { RejectTransitGatewayPeeringAttachmentRequest, RejectTransitGatewayPeeringAttachmentResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RejectTransitGatewayPeeringAttachmentCommand_base: {
    new (input: RejectTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<RejectTransitGatewayPeeringAttachmentCommandInput, RejectTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<RejectTransitGatewayPeeringAttachmentCommandInput, RejectTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
