...
declare const ReplaceRouteTableAssociationCommand_base: {
    new (input: ReplaceRouteTableAssociationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceRouteTableAssociationCommandInput, ReplaceRouteTableAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceRouteTableAssociationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceRouteTableAssociationCommandInput, ReplaceRouteTableAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
