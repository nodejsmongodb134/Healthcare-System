...
import type { CreateVerifiedAccessTrustProviderRequest, CreateVerifiedAccessTrustProviderResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVerifiedAccessTrustProviderCommand_base: {
    new (input: CreateVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessTrustProviderCommandInput, CreateVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessTrustProviderCommandInput, CreateVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
