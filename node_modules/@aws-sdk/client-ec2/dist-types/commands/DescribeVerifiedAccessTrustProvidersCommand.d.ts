...
import type { DescribeVerifiedAccessTrustProvidersRequest, DescribeVerifiedAccessTrustProvidersResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVerifiedAccessTrustProvidersCommand_base: {
    new (input: DescribeVerifiedAccessTrustProvidersCommandInput): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessTrustProvidersCommandInput, DescribeVerifiedAccessTrustProvidersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVerifiedAccessTrustProvidersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessTrustProvidersCommandInput, DescribeVerifiedAccessTrustProvidersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
