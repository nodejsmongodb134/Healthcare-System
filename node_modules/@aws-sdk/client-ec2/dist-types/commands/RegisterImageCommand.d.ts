...
declare const RegisterImageCommand_base: {
    new (input: RegisterImageCommandInput): import("@smithy/core/client").CommandImpl<RegisterImageCommandInput, RegisterImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterImageCommandInput): import("@smithy/core/client").CommandImpl<RegisterImageCommandInput, RegisterImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
