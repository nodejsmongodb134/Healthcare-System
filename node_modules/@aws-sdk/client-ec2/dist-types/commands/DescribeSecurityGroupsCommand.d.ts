...
declare const DescribeSecurityGroupsCommand_base: {
    new (input: DescribeSecurityGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupsCommandInput, DescribeSecurityGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecurityGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupsCommandInput, DescribeSecurityGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
