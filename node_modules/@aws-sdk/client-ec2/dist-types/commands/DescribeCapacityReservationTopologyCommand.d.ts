...
import type { DescribeCapacityReservationTopologyRequest, DescribeCapacityReservationTopologyResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityReservationTopologyCommand_base: {
    new (input: DescribeCapacityReservationTopologyCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationTopologyCommandInput, DescribeCapacityReservationTopologyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityReservationTopologyCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationTopologyCommandInput, DescribeCapacityReservationTopologyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
