...
import type { DescribeByoipCidrsRequest, DescribeByoipCidrsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeByoipCidrsCommand_base: {
    new (input: DescribeByoipCidrsCommandInput): import("@smithy/core/client").CommandImpl<DescribeByoipCidrsCommandInput, DescribeByoipCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeByoipCidrsCommandInput): import("@smithy/core/client").CommandImpl<DescribeByoipCidrsCommandInput, DescribeByoipCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
