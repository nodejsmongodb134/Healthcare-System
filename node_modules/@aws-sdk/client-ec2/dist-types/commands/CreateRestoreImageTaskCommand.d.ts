...
import type { CreateRestoreImageTaskRequest, CreateRestoreImageTaskResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateRestoreImageTaskCommand_base: {
    new (input: CreateRestoreImageTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateRestoreImageTaskCommandInput, CreateRestoreImageTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRestoreImageTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateRestoreImageTaskCommandInput, CreateRestoreImageTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
