...
declare const AssignPrivateNatGatewayAddressCommand_base: {
    new (input: AssignPrivateNatGatewayAddressCommandInput): import("@smithy/core/client").CommandImpl<AssignPrivateNatGatewayAddressCommandInput, AssignPrivateNatGatewayAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssignPrivateNatGatewayAddressCommandInput): import("@smithy/core/client").CommandImpl<AssignPrivateNatGatewayAddressCommandInput, AssignPrivateNatGatewayAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
