...
import type { DeleteNetworkInsightsAnalysisRequest, DeleteNetworkInsightsAnalysisResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteNetworkInsightsAnalysisCommand_base: {
    new (input: DeleteNetworkInsightsAnalysisCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNetworkInsightsAnalysisCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
