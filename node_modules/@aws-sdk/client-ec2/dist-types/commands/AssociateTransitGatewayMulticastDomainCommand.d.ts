...
import type { AssociateTransitGatewayMulticastDomainRequest, AssociateTransitGatewayMulticastDomainResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateTransitGatewayMulticastDomainCommand_base: {
    new (input: AssociateTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<AssociateTransitGatewayMulticastDomainCommandInput, AssociateTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTransitGatewayMulticastDomainCommandInput): import("@smithy/core/client").CommandImpl<AssociateTransitGatewayMulticastDomainCommandInput, AssociateTransitGatewayMulticastDomainCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
