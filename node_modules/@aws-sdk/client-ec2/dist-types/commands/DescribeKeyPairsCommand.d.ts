...
declare const DescribeKeyPairsCommand_base: {
    new (input: DescribeKeyPairsCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyPairsCommandInput, DescribeKeyPairsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeKeyPairsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeKeyPairsCommandInput, DescribeKeyPairsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
