...
declare const ModifyManagedPrefixListCommand_base: {
    new (input: ModifyManagedPrefixListCommandInput): import("@smithy/core/client").CommandImpl<ModifyManagedPrefixListCommandInput, ModifyManagedPrefixListCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyManagedPrefixListCommandInput): import("@smithy/core/client").CommandImpl<ModifyManagedPrefixListCommandInput, ModifyManagedPrefixListCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyManagedPrefixListCommand extends ModifyManagedPrefixListCommand_base {
