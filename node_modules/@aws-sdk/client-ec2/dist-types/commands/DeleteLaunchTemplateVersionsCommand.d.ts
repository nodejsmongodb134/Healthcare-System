...
declare const DeleteLaunchTemplateVersionsCommand_base: {
    new (input: DeleteLaunchTemplateVersionsCommandInput): import("@smithy/core/client").CommandImpl<DeleteLaunchTemplateVersionsCommandInput, DeleteLaunchTemplateVersionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLaunchTemplateVersionsCommandInput): import("@smithy/core/client").CommandImpl<DeleteLaunchTemplateVersionsCommandInput, DeleteLaunchTemplateVersionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
