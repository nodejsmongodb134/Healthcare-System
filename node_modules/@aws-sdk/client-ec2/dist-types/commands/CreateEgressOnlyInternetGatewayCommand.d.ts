...
declare const CreateEgressOnlyInternetGatewayCommand_base: {
    new (input: CreateEgressOnlyInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateEgressOnlyInternetGatewayCommandInput, CreateEgressOnlyInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEgressOnlyInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateEgressOnlyInternetGatewayCommandInput, CreateEgressOnlyInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
