...
import type { DisableVpcClassicLinkRequest, DisableVpcClassicLinkResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisableVpcClassicLinkCommand_base: {
    new (input: DisableVpcClassicLinkCommandInput): import("@smithy/core/client").CommandImpl<DisableVpcClassicLinkCommandInput, DisableVpcClassicLinkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableVpcClassicLinkCommandInput): import("@smithy/core/client").CommandImpl<DisableVpcClassicLinkCommandInput, DisableVpcClassicLinkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
