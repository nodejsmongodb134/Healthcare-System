...
import type { DeleteTransitGatewayRouteRequest, DeleteTransitGatewayRouteResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteTransitGatewayRouteCommand_base: {
    new (input: DeleteTransitGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayRouteCommandInput, DeleteTransitGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayRouteCommandInput, DeleteTransitGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
