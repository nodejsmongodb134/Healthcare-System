...
declare const ImportSnapshotCommand_base: {
    new (input: ImportSnapshotCommandInput): import("@smithy/core/client").CommandImpl<ImportSnapshotCommandInput, ImportSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ImportSnapshotCommandInput]): import("@smithy/core/client").CommandImpl<ImportSnapshotCommandInput, ImportSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
