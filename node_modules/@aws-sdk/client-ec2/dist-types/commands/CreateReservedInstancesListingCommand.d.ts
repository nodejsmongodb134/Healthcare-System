...
import type { CreateReservedInstancesListingRequest, CreateReservedInstancesListingResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateReservedInstancesListingCommand_base: {
    new (input: CreateReservedInstancesListingCommandInput): import("@smithy/core/client").CommandImpl<CreateReservedInstancesListingCommandInput, CreateReservedInstancesListingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateReservedInstancesListingCommandInput): import("@smithy/core/client").CommandImpl<CreateReservedInstancesListingCommandInput, CreateReservedInstancesListingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
