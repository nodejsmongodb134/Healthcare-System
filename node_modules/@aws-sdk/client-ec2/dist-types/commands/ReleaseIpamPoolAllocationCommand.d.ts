...
import type { ReleaseIpamPoolAllocationRequest, ReleaseIpamPoolAllocationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ReleaseIpamPoolAllocationCommand_base: {
    new (input: ReleaseIpamPoolAllocationCommandInput): import("@smithy/core/client").CommandImpl<ReleaseIpamPoolAllocationCommandInput, ReleaseIpamPoolAllocationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReleaseIpamPoolAllocationCommandInput): import("@smithy/core/client").CommandImpl<ReleaseIpamPoolAllocationCommandInput, ReleaseIpamPoolAllocationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
