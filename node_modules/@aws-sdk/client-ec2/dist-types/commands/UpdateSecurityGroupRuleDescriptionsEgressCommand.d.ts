...
import type { UpdateSecurityGroupRuleDescriptionsEgressRequest, UpdateSecurityGroupRuleDescriptionsEgressResult } from "../models/models_8";
/**
 * @public
 */
...
declare const UpdateSecurityGroupRuleDescriptionsEgressCommand_base: {
    new (input: UpdateSecurityGroupRuleDescriptionsEgressCommandInput): import("@smithy/core/client").CommandImpl<UpdateSecurityGroupRuleDescriptionsEgressCommandInput, UpdateSecurityGroupRuleDescriptionsEgressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateSecurityGroupRuleDescriptionsEgressCommandInput]): import("@smithy/core/client").CommandImpl<UpdateSecurityGroupRuleDescriptionsEgressCommandInput, UpdateSecurityGroupRuleDescriptionsEgressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
