...
declare const GetPasswordDataCommand_base: {
    new (input: GetPasswordDataCommandInput): import("@smithy/core/client").CommandImpl<GetPasswordDataCommandInput, GetPasswordDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPasswordDataCommandInput): import("@smithy/core/client").CommandImpl<GetPasswordDataCommandInput, GetPasswordDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
