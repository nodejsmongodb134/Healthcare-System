...
import type { CreatePlacementGroupRequest, CreatePlacementGroupResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreatePlacementGroupCommand_base: {
    new (input: CreatePlacementGroupCommandInput): import("@smithy/core/client").CommandImpl<CreatePlacementGroupCommandInput, CreatePlacementGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreatePlacementGroupCommandInput]): import("@smithy/core/client").CommandImpl<CreatePlacementGroupCommandInput, CreatePlacementGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
