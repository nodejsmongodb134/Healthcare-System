...
import type { DescribeSecondarySubnetsRequest, DescribeSecondarySubnetsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSecondarySubnetsCommand_base: {
    new (input: DescribeSecondarySubnetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecondarySubnetsCommandInput, DescribeSecondarySubnetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecondarySubnetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecondarySubnetsCommandInput, DescribeSecondarySubnetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
