...
declare const ModifyIpamPolicyAllocationRulesCommand_base: {
    new (input: ModifyIpamPolicyAllocationRulesCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPolicyAllocationRulesCommandInput, ModifyIpamPolicyAllocationRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamPolicyAllocationRulesCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPolicyAllocationRulesCommandInput, ModifyIpamPolicyAllocationRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
