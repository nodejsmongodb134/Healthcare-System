...
declare const DisassociateIamInstanceProfileCommand_base: {
    new (input: DisassociateIamInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<DisassociateIamInstanceProfileCommandInput, DisassociateIamInstanceProfileCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateIamInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<DisassociateIamInstanceProfileCommandInput, DisassociateIamInstanceProfileCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateIamInstanceProfileCommand extends DisassociateIamInstanceProfileCommand_base {
