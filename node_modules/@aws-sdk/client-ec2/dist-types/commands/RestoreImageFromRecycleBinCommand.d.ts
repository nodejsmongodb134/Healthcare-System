...
declare const RestoreImageFromRecycleBinCommand_base: {
    new (input: RestoreImageFromRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<RestoreImageFromRecycleBinCommandInput, RestoreImageFromRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreImageFromRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<RestoreImageFromRecycleBinCommandInput, RestoreImageFromRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
