...
declare const CreateLaunchTemplateVersionCommand_base: {
    new (input: CreateLaunchTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateLaunchTemplateVersionCommandInput, CreateLaunchTemplateVersionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLaunchTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateLaunchTemplateVersionCommandInput, CreateLaunchTemplateVersionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 *     },
 *     SecondaryInterfaces: [ // LaunchTemplateInstanceSecondaryInterfaceSpecificationRequestList
 *       { // LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest
 *         DeleteOnTermination: true || false,
 *         DeviceIndex: Number("int"),
 *         PrivateIpAddresses: [ // SecondaryInterfacePrivateIpAddressSpecificationListRequest
