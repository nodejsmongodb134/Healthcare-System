...
import type { DeleteVerifiedAccessGroupRequest, DeleteVerifiedAccessGroupResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVerifiedAccessGroupCommand_base: {
    new (input: DeleteVerifiedAccessGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessGroupCommandInput, DeleteVerifiedAccessGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVerifiedAccessGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessGroupCommandInput, DeleteVerifiedAccessGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
