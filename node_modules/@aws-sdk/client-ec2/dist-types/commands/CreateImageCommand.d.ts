...
import type { CreateImageRequest, CreateImageResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateImageCommand_base: {
    new (input: CreateImageCommandInput): import("@smithy/core/client").CommandImpl<CreateImageCommandInput, CreateImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateImageCommandInput): import("@smithy/core/client").CommandImpl<CreateImageCommandInput, CreateImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
