...
import type { GetVerifiedAccessEndpointTargetsRequest, GetVerifiedAccessEndpointTargetsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetVerifiedAccessEndpointTargetsCommand_base: {
    new (input: GetVerifiedAccessEndpointTargetsCommandInput): import("@smithy/core/client").CommandImpl<GetVerifiedAccessEndpointTargetsCommandInput, GetVerifiedAccessEndpointTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVerifiedAccessEndpointTargetsCommandInput): import("@smithy/core/client").CommandImpl<GetVerifiedAccessEndpointTargetsCommandInput, GetVerifiedAccessEndpointTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetVerifiedAccessEndpointTargetsCommand extends GetVerifiedAccessEndpointTargetsCommand_base {
