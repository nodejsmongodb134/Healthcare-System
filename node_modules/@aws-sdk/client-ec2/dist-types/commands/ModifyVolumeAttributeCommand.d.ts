...
import type { ModifyVolumeAttributeRequest } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVolumeAttributeCommand_base: {
    new (input: ModifyVolumeAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyVolumeAttributeCommandInput, ModifyVolumeAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVolumeAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyVolumeAttributeCommandInput, ModifyVolumeAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
