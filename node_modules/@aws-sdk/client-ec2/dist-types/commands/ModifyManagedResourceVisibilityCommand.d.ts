...
declare const ModifyManagedResourceVisibilityCommand_base: {
    new (input: ModifyManagedResourceVisibilityCommandInput): import("@smithy/core/client").CommandImpl<ModifyManagedResourceVisibilityCommandInput, ModifyManagedResourceVisibilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyManagedResourceVisibilityCommandInput): import("@smithy/core/client").CommandImpl<ModifyManagedResourceVisibilityCommandInput, ModifyManagedResourceVisibilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
