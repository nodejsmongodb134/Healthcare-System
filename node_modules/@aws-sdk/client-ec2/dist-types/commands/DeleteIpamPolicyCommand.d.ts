...
import type { DeleteIpamPolicyRequest, DeleteIpamPolicyResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteIpamPolicyCommand_base: {
    new (input: DeleteIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPolicyCommandInput, DeleteIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPolicyCommandInput, DeleteIpamPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
