...
import type { ModifyTrafficMirrorFilterNetworkServicesRequest, ModifyTrafficMirrorFilterNetworkServicesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyTrafficMirrorFilterNetworkServicesCommand_base: {
    new (input: ModifyTrafficMirrorFilterNetworkServicesCommandInput): import("@smithy/core/client").CommandImpl<ModifyTrafficMirrorFilterNetworkServicesCommandInput, ModifyTrafficMirrorFilterNetworkServicesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTrafficMirrorFilterNetworkServicesCommandInput): import("@smithy/core/client").CommandImpl<ModifyTrafficMirrorFilterNetworkServicesCommandInput, ModifyTrafficMirrorFilterNetworkServicesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
