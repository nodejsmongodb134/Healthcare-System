...
import type { GetTransitGatewayAttachmentPropagationsRequest, GetTransitGatewayAttachmentPropagationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayAttachmentPropagationsCommand_base: {
    new (input: GetTransitGatewayAttachmentPropagationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayAttachmentPropagationsCommandInput, GetTransitGatewayAttachmentPropagationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayAttachmentPropagationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayAttachmentPropagationsCommandInput, GetTransitGatewayAttachmentPropagationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
