...
declare const DeleteTransitGatewayPeeringAttachmentCommand_base: {
    new (input: DeleteTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayPeeringAttachmentCommandInput, DeleteTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayPeeringAttachmentCommandInput, DeleteTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
