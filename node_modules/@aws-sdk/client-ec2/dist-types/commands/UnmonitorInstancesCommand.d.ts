...
declare const UnmonitorInstancesCommand_base: {
    new (input: UnmonitorInstancesCommandInput): import("@smithy/core/client").CommandImpl<UnmonitorInstancesCommandInput, UnmonitorInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UnmonitorInstancesCommandInput): import("@smithy/core/client").CommandImpl<UnmonitorInstancesCommandInput, UnmonitorInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UnmonitorInstancesCommand extends UnmonitorInstancesCommand_base {
