...
declare const ModifySecurityGroupRulesCommand_base: {
    new (input: ModifySecurityGroupRulesCommandInput): import("@smithy/core/client").CommandImpl<ModifySecurityGroupRulesCommandInput, ModifySecurityGroupRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifySecurityGroupRulesCommandInput): import("@smithy/core/client").CommandImpl<ModifySecurityGroupRulesCommandInput, ModifySecurityGroupRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifySecurityGroupRulesCommand extends ModifySecurityGroupRulesCommand_base {
