...
import type { EnableVpcClassicLinkDnsSupportRequest, EnableVpcClassicLinkDnsSupportResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableVpcClassicLinkDnsSupportCommand_base: {
    new (input: EnableVpcClassicLinkDnsSupportCommandInput): import("@smithy/core/client").CommandImpl<EnableVpcClassicLinkDnsSupportCommandInput, EnableVpcClassicLinkDnsSupportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableVpcClassicLinkDnsSupportCommandInput]): import("@smithy/core/client").CommandImpl<EnableVpcClassicLinkDnsSupportCommandInput, EnableVpcClassicLinkDnsSupportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
