...
import type { GetCapacityReservationUsageRequest, GetCapacityReservationUsageResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetCapacityReservationUsageCommand_base: {
    new (input: GetCapacityReservationUsageCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityReservationUsageCommandInput, GetCapacityReservationUsageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCapacityReservationUsageCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityReservationUsageCommandInput, GetCapacityReservationUsageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
