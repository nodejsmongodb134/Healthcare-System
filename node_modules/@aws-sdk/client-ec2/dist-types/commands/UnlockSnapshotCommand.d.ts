...
declare const UnlockSnapshotCommand_base: {
    new (input: UnlockSnapshotCommandInput): import("@smithy/core/client").CommandImpl<UnlockSnapshotCommandInput, UnlockSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UnlockSnapshotCommandInput): import("@smithy/core/client").CommandImpl<UnlockSnapshotCommandInput, UnlockSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UnlockSnapshotCommand extends UnlockSnapshotCommand_base {
