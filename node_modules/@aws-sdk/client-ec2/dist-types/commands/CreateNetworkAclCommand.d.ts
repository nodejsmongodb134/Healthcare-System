...
import type { CreateNetworkAclRequest, CreateNetworkAclResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateNetworkAclCommand_base: {
    new (input: CreateNetworkAclCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkAclCommandInput, CreateNetworkAclCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNetworkAclCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkAclCommandInput, CreateNetworkAclCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
