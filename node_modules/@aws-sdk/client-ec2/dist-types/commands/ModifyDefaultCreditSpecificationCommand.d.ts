...
import type { ModifyDefaultCreditSpecificationRequest, ModifyDefaultCreditSpecificationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyDefaultCreditSpecificationCommand_base: {
    new (input: ModifyDefaultCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyDefaultCreditSpecificationCommandInput, ModifyDefaultCreditSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyDefaultCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyDefaultCreditSpecificationCommandInput, ModifyDefaultCreditSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
