...
import type { CreateLocalGatewayVirtualInterfaceRequest, CreateLocalGatewayVirtualInterfaceResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateLocalGatewayVirtualInterfaceCommand_base: {
    new (input: CreateLocalGatewayVirtualInterfaceCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayVirtualInterfaceCommandInput, CreateLocalGatewayVirtualInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLocalGatewayVirtualInterfaceCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayVirtualInterfaceCommandInput, CreateLocalGatewayVirtualInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
