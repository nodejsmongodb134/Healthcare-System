...
import type { CreateIpamPrefixListResolverTargetRequest, CreateIpamPrefixListResolverTargetResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamPrefixListResolverTargetCommand_base: {
    new (input: CreateIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPrefixListResolverTargetCommandInput, CreateIpamPrefixListResolverTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPrefixListResolverTargetCommandInput, CreateIpamPrefixListResolverTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
