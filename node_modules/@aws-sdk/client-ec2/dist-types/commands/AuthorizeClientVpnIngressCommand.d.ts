...
declare const AuthorizeClientVpnIngressCommand_base: {
    new (input: AuthorizeClientVpnIngressCommandInput): import("@smithy/core/client").CommandImpl<AuthorizeClientVpnIngressCommandInput, AuthorizeClientVpnIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AuthorizeClientVpnIngressCommandInput): import("@smithy/core/client").CommandImpl<AuthorizeClientVpnIngressCommandInput, AuthorizeClientVpnIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
