...
import type { CreateTransitGatewayRouteTableAnnouncementRequest, CreateTransitGatewayRouteTableAnnouncementResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayRouteTableAnnouncementCommand_base: {
    new (input: CreateTransitGatewayRouteTableAnnouncementCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayRouteTableAnnouncementCommandInput, CreateTransitGatewayRouteTableAnnouncementCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayRouteTableAnnouncementCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayRouteTableAnnouncementCommandInput, CreateTransitGatewayRouteTableAnnouncementCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
