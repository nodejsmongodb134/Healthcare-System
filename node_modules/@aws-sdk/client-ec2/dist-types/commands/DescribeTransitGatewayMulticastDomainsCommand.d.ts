...
import type { DescribeTransitGatewayMulticastDomainsRequest, DescribeTransitGatewayMulticastDomainsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTransitGatewayMulticastDomainsCommand_base: {
    new (input: DescribeTransitGatewayMulticastDomainsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayMulticastDomainsCommandInput, DescribeTransitGatewayMulticastDomainsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayMulticastDomainsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayMulticastDomainsCommandInput, DescribeTransitGatewayMulticastDomainsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
