...
import type { ModifyVpnConnectionOptionsRequest, ModifyVpnConnectionOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpnConnectionOptionsCommand_base: {
    new (input: ModifyVpnConnectionOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnConnectionOptionsCommandInput, ModifyVpnConnectionOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpnConnectionOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnConnectionOptionsCommandInput, ModifyVpnConnectionOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
