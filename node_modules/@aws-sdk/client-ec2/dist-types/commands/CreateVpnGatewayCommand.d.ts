...
import type { CreateVpnGatewayRequest, CreateVpnGatewayResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpnGatewayCommand_base: {
    new (input: CreateVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnGatewayCommandInput, CreateVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnGatewayCommandInput, CreateVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateVpnGatewayCommand extends CreateVpnGatewayCommand_base {
