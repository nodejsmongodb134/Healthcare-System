...
import type { GetDeclarativePoliciesReportSummaryRequest, GetDeclarativePoliciesReportSummaryResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetDeclarativePoliciesReportSummaryCommand_base: {
    new (input: GetDeclarativePoliciesReportSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetDeclarativePoliciesReportSummaryCommandInput, GetDeclarativePoliciesReportSummaryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeclarativePoliciesReportSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetDeclarativePoliciesReportSummaryCommandInput, GetDeclarativePoliciesReportSummaryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDeclarativePoliciesReportSummaryCommand extends GetDeclarativePoliciesReportSummaryCommand_base {
