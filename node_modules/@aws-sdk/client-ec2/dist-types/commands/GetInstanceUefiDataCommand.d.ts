...
declare const GetInstanceUefiDataCommand_base: {
    new (input: GetInstanceUefiDataCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceUefiDataCommandInput, GetInstanceUefiDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInstanceUefiDataCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceUefiDataCommandInput, GetInstanceUefiDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
