 ...
 * @public
 *
 * The input for {@link DescribeInstanceImageMetadataCommand}.
 */
export interface DescribeInstanceImageMetadataCommandInput extends DescribeInstanceImageMetadataRequest {
}
/**
 * @public
 *
...
declare const DescribeInstanceImageMetadataCommand_base: {
    new (input: DescribeInstanceImageMetadataCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceImageMetadataCommandInput, DescribeInstanceImageMetadataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceImageMetadataCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceImageMetadataCommandInput, DescribeInstanceImageMetadataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * ```javascript
 * import { EC2Client, DescribeInstanceImageMetadataCommand } from "@aws-sdk/client-ec2"; // ES Modules import
 * // const { EC2Client, DescribeInstanceImageMetadataCommand } = require("@aws-sdk/client-ec2"); // CommonJS import
 * // import type { EC2ClientConfig } from "@aws-sdk/client-ec2";
 * const config = {}; // type is EC2ClientConfig
 * const client = new EC2Client(config);
 * const input = { // DescribeInstanceImageMetadataRequest
 *   Filters: [ // FilterList
 *     { // Filter
 *       Name: "STRING_VALUE",
 ...
 *   DryRun: true || false,
 * };
 * const command = new DescribeInstanceImageMetadataCommand(input);
 ...
 * ```
 *
 * @param DescribeInstanceImageMetadataCommandInput - {@link DescribeInstanceImageMetadataCommandInput}
 * @returns {@link DescribeInstanceImageMetadataCommandOutput}
 * @see {@link DescribeInstanceImageMetadataCommandInput} for command's `input` shape.
 * @see {@link DescribeInstanceImageMetadataCommandOutput} for command's `response` shape.
