...
declare const DisableImageCommand_base: {
    new (input: DisableImageCommandInput): import("@smithy/core/client").CommandImpl<DisableImageCommandInput, DisableImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableImageCommandInput): import("@smithy/core/client").CommandImpl<DisableImageCommandInput, DisableImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
