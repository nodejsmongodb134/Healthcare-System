...
declare const DisassociateNatGatewayAddressCommand_base: {
    new (input: DisassociateNatGatewayAddressCommandInput): import("@smithy/core/client").CommandImpl<DisassociateNatGatewayAddressCommandInput, DisassociateNatGatewayAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateNatGatewayAddressCommandInput): import("@smithy/core/client").CommandImpl<DisassociateNatGatewayAddressCommandInput, DisassociateNatGatewayAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateNatGatewayAddressCommand extends DisassociateNatGatewayAddressCommand_base {
