...
import type { ModifyAccountVpcEncryptionControlRequest, ModifyAccountVpcEncryptionControlResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyAccountVpcEncryptionControlCommand_base: {
    new (input: ModifyAccountVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<ModifyAccountVpcEncryptionControlCommandInput, ModifyAccountVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ModifyAccountVpcEncryptionControlCommandInput]): import("@smithy/core/client").CommandImpl<ModifyAccountVpcEncryptionControlCommandInput, ModifyAccountVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyAccountVpcEncryptionControlCommand extends ModifyAccountVpcEncryptionControlCommand_base {
