...
declare const DescribeCapacityReservationsCommand_base: {
    new (input: DescribeCapacityReservationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationsCommandInput, DescribeCapacityReservationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityReservationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationsCommandInput, DescribeCapacityReservationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
