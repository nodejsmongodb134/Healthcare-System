...
import type { ModifyInstanceEventStartTimeRequest, ModifyInstanceEventStartTimeResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceEventStartTimeCommand_base: {
    new (input: ModifyInstanceEventStartTimeCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceEventStartTimeCommandInput, ModifyInstanceEventStartTimeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceEventStartTimeCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceEventStartTimeCommandInput, ModifyInstanceEventStartTimeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstanceEventStartTimeCommand extends ModifyInstanceEventStartTimeCommand_base {
