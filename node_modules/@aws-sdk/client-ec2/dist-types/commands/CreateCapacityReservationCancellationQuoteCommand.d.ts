...
import type { CreateCapacityReservationCancellationQuoteRequest, CreateCapacityReservationCancellationQuoteResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCapacityReservationCancellationQuoteCommand_base: {
    new (input: CreateCapacityReservationCancellationQuoteCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationCancellationQuoteCommandInput, CreateCapacityReservationCancellationQuoteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCapacityReservationCancellationQuoteCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationCancellationQuoteCommandInput, CreateCapacityReservationCancellationQuoteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
