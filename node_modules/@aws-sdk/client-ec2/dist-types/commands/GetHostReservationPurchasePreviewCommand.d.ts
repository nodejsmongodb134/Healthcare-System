...
import type { GetHostReservationPurchasePreviewRequest, GetHostReservationPurchasePreviewResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetHostReservationPurchasePreviewCommand_base: {
    new (input: GetHostReservationPurchasePreviewCommandInput): import("@smithy/core/client").CommandImpl<GetHostReservationPurchasePreviewCommandInput, GetHostReservationPurchasePreviewCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHostReservationPurchasePreviewCommandInput): import("@smithy/core/client").CommandImpl<GetHostReservationPurchasePreviewCommandInput, GetHostReservationPurchasePreviewCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
