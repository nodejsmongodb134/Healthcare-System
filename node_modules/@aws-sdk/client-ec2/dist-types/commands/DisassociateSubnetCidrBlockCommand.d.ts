...
import type { DisassociateSubnetCidrBlockRequest, DisassociateSubnetCidrBlockResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateSubnetCidrBlockCommand_base: {
    new (input: DisassociateSubnetCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSubnetCidrBlockCommandInput, DisassociateSubnetCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateSubnetCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSubnetCidrBlockCommandInput, DisassociateSubnetCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
