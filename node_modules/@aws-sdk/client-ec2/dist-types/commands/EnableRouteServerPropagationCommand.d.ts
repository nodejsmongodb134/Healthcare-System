...
import type { EnableRouteServerPropagationRequest, EnableRouteServerPropagationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableRouteServerPropagationCommand_base: {
    new (input: EnableRouteServerPropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableRouteServerPropagationCommandInput, EnableRouteServerPropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableRouteServerPropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableRouteServerPropagationCommandInput, EnableRouteServerPropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
