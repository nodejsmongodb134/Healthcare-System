...
import type { CreateFlowLogsRequest, CreateFlowLogsResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateFlowLogsCommand_base: {
    new (input: CreateFlowLogsCommandInput): import("@smithy/core/client").CommandImpl<CreateFlowLogsCommandInput, CreateFlowLogsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFlowLogsCommandInput): import("@smithy/core/client").CommandImpl<CreateFlowLogsCommandInput, CreateFlowLogsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 *     "STRING_VALUE",
 *   ],
 *   ResourceType: "VPC" || "Subnet" || "NetworkInterface" || "TransitGateway" || "TransitGatewayAttachment" || "RegionalNatGateway", // required
