...
import type { GetIpamRoutingPolicyRegistrationsRequest, GetIpamRoutingPolicyRegistrationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamRoutingPolicyRegistrationsCommand_base: {
    new (input: GetIpamRoutingPolicyRegistrationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRoutingPolicyRegistrationsCommandInput, GetIpamRoutingPolicyRegistrationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamRoutingPolicyRegistrationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRoutingPolicyRegistrationsCommandInput, GetIpamRoutingPolicyRegistrationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
