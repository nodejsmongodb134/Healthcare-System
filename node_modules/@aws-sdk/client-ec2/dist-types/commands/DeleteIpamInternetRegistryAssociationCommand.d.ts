...
import type { DeleteIpamInternetRegistryAssociationRequest, DeleteIpamInternetRegistryAssociationResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteIpamInternetRegistryAssociationCommand_base: {
    new (input: DeleteIpamInternetRegistryAssociationCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamInternetRegistryAssociationCommandInput, DeleteIpamInternetRegistryAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamInternetRegistryAssociationCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamInternetRegistryAssociationCommandInput, DeleteIpamInternetRegistryAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
