...
declare const DescribeTransitGatewayAttachmentsCommand_base: {
    new (input: DescribeTransitGatewayAttachmentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayAttachmentsCommandInput, DescribeTransitGatewayAttachmentsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayAttachmentsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayAttachmentsCommandInput, DescribeTransitGatewayAttachmentsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
