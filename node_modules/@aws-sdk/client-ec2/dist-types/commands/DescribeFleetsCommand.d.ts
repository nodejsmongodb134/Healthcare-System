...
declare const DescribeFleetsCommand_base: {
    new (input: DescribeFleetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeFleetsCommandInput, DescribeFleetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeFleetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeFleetsCommandInput, DescribeFleetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
