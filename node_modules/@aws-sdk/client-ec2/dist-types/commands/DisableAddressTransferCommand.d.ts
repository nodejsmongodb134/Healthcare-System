...
declare const DisableAddressTransferCommand_base: {
    new (input: DisableAddressTransferCommandInput): import("@smithy/core/client").CommandImpl<DisableAddressTransferCommandInput, DisableAddressTransferCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableAddressTransferCommandInput): import("@smithy/core/client").CommandImpl<DisableAddressTransferCommandInput, DisableAddressTransferCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
