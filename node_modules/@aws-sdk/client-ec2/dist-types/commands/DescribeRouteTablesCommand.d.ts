...
import type { DescribeRouteTablesRequest, DescribeRouteTablesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeRouteTablesCommand_base: {
    new (input: DescribeRouteTablesCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteTablesCommandInput, DescribeRouteTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRouteTablesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRouteTablesCommandInput, DescribeRouteTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
