...
declare const DescribeHostReservationOfferingsCommand_base: {
    new (input: DescribeHostReservationOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeHostReservationOfferingsCommandInput, DescribeHostReservationOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeHostReservationOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeHostReservationOfferingsCommandInput, DescribeHostReservationOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
