...
declare const AttachNetworkInterfaceCommand_base: {
    new (input: AttachNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<AttachNetworkInterfaceCommandInput, AttachNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<AttachNetworkInterfaceCommandInput, AttachNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
