...
declare const CopyVolumesCommand_base: {
    new (input: CopyVolumesCommandInput): import("@smithy/core/client").CommandImpl<CopyVolumesCommandInput, CopyVolumesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CopyVolumesCommandInput): import("@smithy/core/client").CommandImpl<CopyVolumesCommandInput, CopyVolumesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
