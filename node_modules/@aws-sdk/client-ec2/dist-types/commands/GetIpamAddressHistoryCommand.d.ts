...
declare const GetIpamAddressHistoryCommand_base: {
    new (input: GetIpamAddressHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetIpamAddressHistoryCommandInput, GetIpamAddressHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamAddressHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetIpamAddressHistoryCommandInput, GetIpamAddressHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
