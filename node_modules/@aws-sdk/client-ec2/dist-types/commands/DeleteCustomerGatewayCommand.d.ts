...
import type { DeleteCustomerGatewayRequest } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteCustomerGatewayCommand_base: {
    new (input: DeleteCustomerGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomerGatewayCommandInput, DeleteCustomerGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCustomerGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomerGatewayCommandInput, DeleteCustomerGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteCustomerGatewayCommand extends DeleteCustomerGatewayCommand_base {
