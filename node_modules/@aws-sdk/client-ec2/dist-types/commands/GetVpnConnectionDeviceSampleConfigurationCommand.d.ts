...
import type { GetVpnConnectionDeviceSampleConfigurationRequest, GetVpnConnectionDeviceSampleConfigurationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetVpnConnectionDeviceSampleConfigurationCommand_base: {
    new (input: GetVpnConnectionDeviceSampleConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetVpnConnectionDeviceSampleConfigurationCommandInput, GetVpnConnectionDeviceSampleConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVpnConnectionDeviceSampleConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetVpnConnectionDeviceSampleConfigurationCommandInput, GetVpnConnectionDeviceSampleConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
