...
declare const CancelReservedInstancesListingCommand_base: {
    new (input: CancelReservedInstancesListingCommandInput): import("@smithy/core/client").CommandImpl<CancelReservedInstancesListingCommandInput, CancelReservedInstancesListingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelReservedInstancesListingCommandInput): import("@smithy/core/client").CommandImpl<CancelReservedInstancesListingCommandInput, CancelReservedInstancesListingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
