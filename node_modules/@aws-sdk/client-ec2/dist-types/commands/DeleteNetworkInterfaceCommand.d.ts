...
declare const DeleteNetworkInterfaceCommand_base: {
    new (input: DeleteNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInterfaceCommandInput, DeleteNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInterfaceCommandInput, DeleteNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
