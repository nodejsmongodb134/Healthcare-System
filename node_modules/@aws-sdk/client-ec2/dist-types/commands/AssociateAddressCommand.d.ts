...
import type { AssociateAddressRequest, AssociateAddressResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateAddressCommand_base: {
    new (input: AssociateAddressCommandInput): import("@smithy/core/client").CommandImpl<AssociateAddressCommandInput, AssociateAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [AssociateAddressCommandInput]): import("@smithy/core/client").CommandImpl<AssociateAddressCommandInput, AssociateAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
