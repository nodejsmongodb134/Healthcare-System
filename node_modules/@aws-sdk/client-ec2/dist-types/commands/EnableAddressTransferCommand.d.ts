...
declare const EnableAddressTransferCommand_base: {
    new (input: EnableAddressTransferCommandInput): import("@smithy/core/client").CommandImpl<EnableAddressTransferCommandInput, EnableAddressTransferCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableAddressTransferCommandInput): import("@smithy/core/client").CommandImpl<EnableAddressTransferCommandInput, EnableAddressTransferCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
