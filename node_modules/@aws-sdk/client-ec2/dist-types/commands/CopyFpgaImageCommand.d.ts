...
declare const CopyFpgaImageCommand_base: {
    new (input: CopyFpgaImageCommandInput): import("@smithy/core/client").CommandImpl<CopyFpgaImageCommandInput, CopyFpgaImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CopyFpgaImageCommandInput): import("@smithy/core/client").CommandImpl<CopyFpgaImageCommandInput, CopyFpgaImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
