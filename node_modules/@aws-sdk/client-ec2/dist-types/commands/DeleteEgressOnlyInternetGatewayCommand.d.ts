...
declare const DeleteEgressOnlyInternetGatewayCommand_base: {
    new (input: DeleteEgressOnlyInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteEgressOnlyInternetGatewayCommandInput, DeleteEgressOnlyInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEgressOnlyInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteEgressOnlyInternetGatewayCommandInput, DeleteEgressOnlyInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
