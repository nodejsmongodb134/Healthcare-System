...
import type { RegisterTransitGatewayMulticastGroupSourcesRequest, RegisterTransitGatewayMulticastGroupSourcesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RegisterTransitGatewayMulticastGroupSourcesCommand_base: {
    new (input: RegisterTransitGatewayMulticastGroupSourcesCommandInput): import("@smithy/core/client").CommandImpl<RegisterTransitGatewayMulticastGroupSourcesCommandInput, RegisterTransitGatewayMulticastGroupSourcesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterTransitGatewayMulticastGroupSourcesCommandInput): import("@smithy/core/client").CommandImpl<RegisterTransitGatewayMulticastGroupSourcesCommandInput, RegisterTransitGatewayMulticastGroupSourcesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
