...
import type { CreateVpcEndpointConnectionNotificationRequest, CreateVpcEndpointConnectionNotificationResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpcEndpointConnectionNotificationCommand_base: {
    new (input: CreateVpcEndpointConnectionNotificationCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEndpointConnectionNotificationCommandInput, CreateVpcEndpointConnectionNotificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcEndpointConnectionNotificationCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEndpointConnectionNotificationCommandInput, CreateVpcEndpointConnectionNotificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
