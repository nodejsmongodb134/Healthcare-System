...
import type { DescribeSnapshotTierStatusRequest, DescribeSnapshotTierStatusResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSnapshotTierStatusCommand_base: {
    new (input: DescribeSnapshotTierStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeSnapshotTierStatusCommandInput, DescribeSnapshotTierStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSnapshotTierStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSnapshotTierStatusCommandInput, DescribeSnapshotTierStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
