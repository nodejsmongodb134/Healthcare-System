...
import type { DeleteTransitGatewayPrefixListReferenceRequest, DeleteTransitGatewayPrefixListReferenceResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteTransitGatewayPrefixListReferenceCommand_base: {
    new (input: DeleteTransitGatewayPrefixListReferenceCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayPrefixListReferenceCommandInput, DeleteTransitGatewayPrefixListReferenceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayPrefixListReferenceCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayPrefixListReferenceCommandInput, DeleteTransitGatewayPrefixListReferenceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
