...
import type { DisableAwsNetworkPerformanceMetricSubscriptionRequest, DisableAwsNetworkPerformanceMetricSubscriptionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisableAwsNetworkPerformanceMetricSubscriptionCommand_base: {
    new (input: DisableAwsNetworkPerformanceMetricSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DisableAwsNetworkPerformanceMetricSubscriptionCommandInput, DisableAwsNetworkPerformanceMetricSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableAwsNetworkPerformanceMetricSubscriptionCommandInput]): import("@smithy/core/client").CommandImpl<DisableAwsNetworkPerformanceMetricSubscriptionCommandInput, DisableAwsNetworkPerformanceMetricSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
