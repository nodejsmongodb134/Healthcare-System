...
declare const DescribeMacModificationTasksCommand_base: {
    new (input: DescribeMacModificationTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeMacModificationTasksCommandInput, DescribeMacModificationTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeMacModificationTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeMacModificationTasksCommandInput, DescribeMacModificationTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
