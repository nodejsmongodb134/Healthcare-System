...
import type { GetIpamRoutingPolicyRegistrationDeltasRequest, GetIpamRoutingPolicyRegistrationDeltasResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamRoutingPolicyRegistrationDeltasCommand_base: {
    new (input: GetIpamRoutingPolicyRegistrationDeltasCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRoutingPolicyRegistrationDeltasCommandInput, GetIpamRoutingPolicyRegistrationDeltasCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamRoutingPolicyRegistrationDeltasCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRoutingPolicyRegistrationDeltasCommandInput, GetIpamRoutingPolicyRegistrationDeltasCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
