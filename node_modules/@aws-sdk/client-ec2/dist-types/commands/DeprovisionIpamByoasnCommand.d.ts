...
declare const DeprovisionIpamByoasnCommand_base: {
    new (input: DeprovisionIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionIpamByoasnCommandInput, DeprovisionIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeprovisionIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionIpamByoasnCommandInput, DeprovisionIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
