...
import type { ModifyAddressAttributeRequest, ModifyAddressAttributeResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyAddressAttributeCommand_base: {
    new (input: ModifyAddressAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyAddressAttributeCommandInput, ModifyAddressAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyAddressAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyAddressAttributeCommandInput, ModifyAddressAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyAddressAttributeCommand extends ModifyAddressAttributeCommand_base {
