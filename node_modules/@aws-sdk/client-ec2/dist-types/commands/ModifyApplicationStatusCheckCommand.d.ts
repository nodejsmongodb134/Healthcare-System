...
declare const ModifyApplicationStatusCheckCommand_base: {
    new (input: ModifyApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<ModifyApplicationStatusCheckCommandInput, ModifyApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<ModifyApplicationStatusCheckCommandInput, ModifyApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
