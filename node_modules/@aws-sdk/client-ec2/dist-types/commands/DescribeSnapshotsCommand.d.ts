...
declare const DescribeSnapshotsCommand_base: {
    new (input: DescribeSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSnapshotsCommandInput, DescribeSnapshotsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSnapshotsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSnapshotsCommandInput, DescribeSnapshotsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
