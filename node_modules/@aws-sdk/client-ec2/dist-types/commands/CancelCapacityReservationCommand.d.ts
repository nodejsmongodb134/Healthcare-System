...
declare const CancelCapacityReservationCommand_base: {
    new (input: CancelCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<CancelCapacityReservationCommandInput, CancelCapacityReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<CancelCapacityReservationCommandInput, CancelCapacityReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
