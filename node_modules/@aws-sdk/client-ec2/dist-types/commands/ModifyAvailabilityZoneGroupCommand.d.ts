...
import type { ModifyAvailabilityZoneGroupRequest, ModifyAvailabilityZoneGroupResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyAvailabilityZoneGroupCommand_base: {
    new (input: ModifyAvailabilityZoneGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyAvailabilityZoneGroupCommandInput, ModifyAvailabilityZoneGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyAvailabilityZoneGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyAvailabilityZoneGroupCommandInput, ModifyAvailabilityZoneGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyAvailabilityZoneGroupCommand extends ModifyAvailabilityZoneGroupCommand_base {
