...
declare const CreateRouteTableCommand_base: {
    new (input: CreateRouteTableCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteTableCommandInput, CreateRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteTableCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteTableCommandInput, CreateRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
