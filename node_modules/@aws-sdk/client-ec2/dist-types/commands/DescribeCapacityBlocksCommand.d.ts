...
import type { DescribeCapacityBlocksRequest, DescribeCapacityBlocksResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityBlocksCommand_base: {
    new (input: DescribeCapacityBlocksCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlocksCommandInput, DescribeCapacityBlocksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityBlocksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityBlocksCommandInput, DescribeCapacityBlocksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
