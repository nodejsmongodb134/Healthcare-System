...
declare const DeleteLocalGatewayRouteTableCommand_base: {
    new (input: DeleteLocalGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayRouteTableCommandInput, DeleteLocalGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLocalGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayRouteTableCommandInput, DeleteLocalGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
