...
import type { ExportTransitGatewayRoutesRequest, ExportTransitGatewayRoutesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ExportTransitGatewayRoutesCommand_base: {
    new (input: ExportTransitGatewayRoutesCommandInput): import("@smithy/core/client").CommandImpl<ExportTransitGatewayRoutesCommandInput, ExportTransitGatewayRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportTransitGatewayRoutesCommandInput): import("@smithy/core/client").CommandImpl<ExportTransitGatewayRoutesCommandInput, ExportTransitGatewayRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
