...
import type { ProvisionPublicIpv4PoolCidrRequest, ProvisionPublicIpv4PoolCidrResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ProvisionPublicIpv4PoolCidrCommand_base: {
    new (input: ProvisionPublicIpv4PoolCidrCommandInput): import("@smithy/core/client").CommandImpl<ProvisionPublicIpv4PoolCidrCommandInput, ProvisionPublicIpv4PoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ProvisionPublicIpv4PoolCidrCommandInput): import("@smithy/core/client").CommandImpl<ProvisionPublicIpv4PoolCidrCommandInput, ProvisionPublicIpv4PoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
