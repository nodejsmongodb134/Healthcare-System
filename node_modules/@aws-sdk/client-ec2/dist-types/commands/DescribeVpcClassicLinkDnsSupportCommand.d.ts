...
import type { DescribeVpcClassicLinkDnsSupportRequest, DescribeVpcClassicLinkDnsSupportResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcClassicLinkDnsSupportCommand_base: {
    new (input: DescribeVpcClassicLinkDnsSupportCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcClassicLinkDnsSupportCommandInput, DescribeVpcClassicLinkDnsSupportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcClassicLinkDnsSupportCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcClassicLinkDnsSupportCommandInput, DescribeVpcClassicLinkDnsSupportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
