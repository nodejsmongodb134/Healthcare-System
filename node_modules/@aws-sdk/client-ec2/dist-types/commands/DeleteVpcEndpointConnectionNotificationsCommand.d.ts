...
import type { DeleteVpcEndpointConnectionNotificationsRequest, DeleteVpcEndpointConnectionNotificationsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVpcEndpointConnectionNotificationsCommand_base: {
    new (input: DeleteVpcEndpointConnectionNotificationsCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEndpointConnectionNotificationsCommandInput, DeleteVpcEndpointConnectionNotificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcEndpointConnectionNotificationsCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEndpointConnectionNotificationsCommandInput, DeleteVpcEndpointConnectionNotificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
