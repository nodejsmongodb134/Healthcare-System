...
declare const ModifyVerifiedAccessEndpointPolicyCommand_base: {
    new (input: ModifyVerifiedAccessEndpointPolicyCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessEndpointPolicyCommandInput, ModifyVerifiedAccessEndpointPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVerifiedAccessEndpointPolicyCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessEndpointPolicyCommandInput, ModifyVerifiedAccessEndpointPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
