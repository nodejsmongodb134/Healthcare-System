...
import type { DescribeSecondaryInterfacesRequest, DescribeSecondaryInterfacesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSecondaryInterfacesCommand_base: {
    new (input: DescribeSecondaryInterfacesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecondaryInterfacesCommandInput, DescribeSecondaryInterfacesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecondaryInterfacesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecondaryInterfacesCommandInput, DescribeSecondaryInterfacesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
