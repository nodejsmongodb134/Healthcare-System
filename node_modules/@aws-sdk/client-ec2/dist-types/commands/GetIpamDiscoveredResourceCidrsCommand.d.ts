...
declare const GetIpamDiscoveredResourceCidrsCommand_base: {
    new (input: GetIpamDiscoveredResourceCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamDiscoveredResourceCidrsCommandInput, GetIpamDiscoveredResourceCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamDiscoveredResourceCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamDiscoveredResourceCidrsCommandInput, GetIpamDiscoveredResourceCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
