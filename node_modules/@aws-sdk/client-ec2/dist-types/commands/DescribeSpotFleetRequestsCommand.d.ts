...
import type { DescribeSpotFleetRequestsRequest, DescribeSpotFleetRequestsResponse } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSpotFleetRequestsCommand_base: {
    new (input: DescribeSpotFleetRequestsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetRequestsCommandInput, DescribeSpotFleetRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSpotFleetRequestsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSpotFleetRequestsCommandInput, DescribeSpotFleetRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
