...
import type { DescribeVpcEndpointAssociationsRequest, DescribeVpcEndpointAssociationsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcEndpointAssociationsCommand_base: {
    new (input: DescribeVpcEndpointAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointAssociationsCommandInput, DescribeVpcEndpointAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEndpointAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointAssociationsCommandInput, DescribeVpcEndpointAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
