...
declare const DeleteRouteServerEndpointCommand_base: {
    new (input: DeleteRouteServerEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteServerEndpointCommandInput, DeleteRouteServerEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteServerEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteServerEndpointCommandInput, DeleteRouteServerEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
