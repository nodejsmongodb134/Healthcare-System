...
import type { CreateCoipPoolRequest, CreateCoipPoolResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateCoipPoolCommand_base: {
    new (input: CreateCoipPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateCoipPoolCommandInput, CreateCoipPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCoipPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateCoipPoolCommandInput, CreateCoipPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
