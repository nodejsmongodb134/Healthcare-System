...
declare const DisableFastLaunchCommand_base: {
    new (input: DisableFastLaunchCommandInput): import("@smithy/core/client").CommandImpl<DisableFastLaunchCommandInput, DisableFastLaunchCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableFastLaunchCommandInput): import("@smithy/core/client").CommandImpl<DisableFastLaunchCommandInput, DisableFastLaunchCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
