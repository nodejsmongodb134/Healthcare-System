...
declare const GetActiveVpnTunnelStatusCommand_base: {
    new (input: GetActiveVpnTunnelStatusCommandInput): import("@smithy/core/client").CommandImpl<GetActiveVpnTunnelStatusCommandInput, GetActiveVpnTunnelStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetActiveVpnTunnelStatusCommandInput): import("@smithy/core/client").CommandImpl<GetActiveVpnTunnelStatusCommandInput, GetActiveVpnTunnelStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
