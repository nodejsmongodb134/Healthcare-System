...
declare const RestoreAddressToClassicCommand_base: {
    new (input: RestoreAddressToClassicCommandInput): import("@smithy/core/client").CommandImpl<RestoreAddressToClassicCommandInput, RestoreAddressToClassicCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreAddressToClassicCommandInput): import("@smithy/core/client").CommandImpl<RestoreAddressToClassicCommandInput, RestoreAddressToClassicCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
