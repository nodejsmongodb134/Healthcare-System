...
declare const DeleteApplicationStatusCheckCommand_base: {
    new (input: DeleteApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<DeleteApplicationStatusCheckCommandInput, DeleteApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<DeleteApplicationStatusCheckCommandInput, DeleteApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
