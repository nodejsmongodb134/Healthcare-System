...
declare const PurchaseCapacityBlockExtensionCommand_base: {
    new (input: PurchaseCapacityBlockExtensionCommandInput): import("@smithy/core/client").CommandImpl<PurchaseCapacityBlockExtensionCommandInput, PurchaseCapacityBlockExtensionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PurchaseCapacityBlockExtensionCommandInput): import("@smithy/core/client").CommandImpl<PurchaseCapacityBlockExtensionCommandInput, PurchaseCapacityBlockExtensionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
