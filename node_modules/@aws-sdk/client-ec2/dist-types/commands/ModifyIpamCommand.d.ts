...
import type { ModifyIpamRequest, ModifyIpamResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamCommand_base: {
    new (input: ModifyIpamCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamCommandInput, ModifyIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamCommandInput, ModifyIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyIpamCommand extends ModifyIpamCommand_base {
