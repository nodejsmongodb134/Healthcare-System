...
import type { GetConsoleScreenshotRequest, GetConsoleScreenshotResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetConsoleScreenshotCommand_base: {
    new (input: GetConsoleScreenshotCommandInput): import("@smithy/core/client").CommandImpl<GetConsoleScreenshotCommandInput, GetConsoleScreenshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConsoleScreenshotCommandInput): import("@smithy/core/client").CommandImpl<GetConsoleScreenshotCommandInput, GetConsoleScreenshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
