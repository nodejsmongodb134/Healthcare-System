...
declare const DeleteInstanceConnectEndpointCommand_base: {
    new (input: DeleteInstanceConnectEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteInstanceConnectEndpointCommandInput, DeleteInstanceConnectEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteInstanceConnectEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteInstanceConnectEndpointCommandInput, DeleteInstanceConnectEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
