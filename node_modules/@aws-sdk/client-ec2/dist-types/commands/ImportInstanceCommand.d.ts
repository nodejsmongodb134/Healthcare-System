...
import type { ImportInstanceRequest, ImportInstanceResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ImportInstanceCommand_base: {
    new (input: ImportInstanceCommandInput): import("@smithy/core/client").CommandImpl<ImportInstanceCommandInput, ImportInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportInstanceCommandInput): import("@smithy/core/client").CommandImpl<ImportInstanceCommandInput, ImportInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ImportInstanceCommand extends ImportInstanceCommand_base {
