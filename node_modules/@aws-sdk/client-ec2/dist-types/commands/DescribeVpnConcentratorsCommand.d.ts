...
import type { DescribeVpnConcentratorsRequest, DescribeVpnConcentratorsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpnConcentratorsCommand_base: {
    new (input: DescribeVpnConcentratorsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpnConcentratorsCommandInput, DescribeVpnConcentratorsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpnConcentratorsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpnConcentratorsCommandInput, DescribeVpnConcentratorsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
