...
import type { GetNetworkInsightsAccessScopeContentRequest, GetNetworkInsightsAccessScopeContentResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetNetworkInsightsAccessScopeContentCommand_base: {
    new (input: GetNetworkInsightsAccessScopeContentCommandInput): import("@smithy/core/client").CommandImpl<GetNetworkInsightsAccessScopeContentCommandInput, GetNetworkInsightsAccessScopeContentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetNetworkInsightsAccessScopeContentCommandInput): import("@smithy/core/client").CommandImpl<GetNetworkInsightsAccessScopeContentCommandInput, GetNetworkInsightsAccessScopeContentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
