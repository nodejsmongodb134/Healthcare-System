...
declare const ModifyIpamPoolAllocationCommand_base: {
    new (input: ModifyIpamPoolAllocationCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPoolAllocationCommandInput, ModifyIpamPoolAllocationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamPoolAllocationCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPoolAllocationCommandInput, ModifyIpamPoolAllocationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
