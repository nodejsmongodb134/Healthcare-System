...
declare const DescribeHostReservationsCommand_base: {
    new (input: DescribeHostReservationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeHostReservationsCommandInput, DescribeHostReservationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeHostReservationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeHostReservationsCommandInput, DescribeHostReservationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
