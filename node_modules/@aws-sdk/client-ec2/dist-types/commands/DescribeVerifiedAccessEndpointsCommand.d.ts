...
import type { DescribeVerifiedAccessEndpointsRequest, DescribeVerifiedAccessEndpointsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVerifiedAccessEndpointsCommand_base: {
    new (input: DescribeVerifiedAccessEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessEndpointsCommandInput, DescribeVerifiedAccessEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVerifiedAccessEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessEndpointsCommandInput, DescribeVerifiedAccessEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
