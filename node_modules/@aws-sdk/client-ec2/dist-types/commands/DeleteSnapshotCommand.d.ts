...
import type { DeleteSnapshotRequest } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteSnapshotCommand_base: {
    new (input: DeleteSnapshotCommandInput): import("@smithy/core/client").CommandImpl<DeleteSnapshotCommandInput, DeleteSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSnapshotCommandInput): import("@smithy/core/client").CommandImpl<DeleteSnapshotCommandInput, DeleteSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
