...
import type { DescribeVpcEndpointServiceConfigurationsRequest, DescribeVpcEndpointServiceConfigurationsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcEndpointServiceConfigurationsCommand_base: {
    new (input: DescribeVpcEndpointServiceConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointServiceConfigurationsCommandInput, DescribeVpcEndpointServiceConfigurationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEndpointServiceConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointServiceConfigurationsCommandInput, DescribeVpcEndpointServiceConfigurationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
