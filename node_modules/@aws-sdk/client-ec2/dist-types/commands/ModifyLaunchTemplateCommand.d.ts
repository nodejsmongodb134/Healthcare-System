...
declare const ModifyLaunchTemplateCommand_base: {
    new (input: ModifyLaunchTemplateCommandInput): import("@smithy/core/client").CommandImpl<ModifyLaunchTemplateCommandInput, ModifyLaunchTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ModifyLaunchTemplateCommandInput]): import("@smithy/core/client").CommandImpl<ModifyLaunchTemplateCommandInput, ModifyLaunchTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
