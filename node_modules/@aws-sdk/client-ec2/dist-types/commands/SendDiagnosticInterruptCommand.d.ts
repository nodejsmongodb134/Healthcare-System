...
import type { SendDiagnosticInterruptRequest } from "../models/models_8";
/**
 * @public
 */
...
declare const SendDiagnosticInterruptCommand_base: {
    new (input: SendDiagnosticInterruptCommandInput): import("@smithy/core/client").CommandImpl<SendDiagnosticInterruptCommandInput, SendDiagnosticInterruptCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendDiagnosticInterruptCommandInput): import("@smithy/core/client").CommandImpl<SendDiagnosticInterruptCommandInput, SendDiagnosticInterruptCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SendDiagnosticInterruptCommand extends SendDiagnosticInterruptCommand_base {
