...
import type { DetachNetworkInterfaceRequest } from "../models/models_5";
/**
 * @public
 */
...
declare const DetachNetworkInterfaceCommand_base: {
    new (input: DetachNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DetachNetworkInterfaceCommandInput, DetachNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DetachNetworkInterfaceCommandInput, DetachNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
