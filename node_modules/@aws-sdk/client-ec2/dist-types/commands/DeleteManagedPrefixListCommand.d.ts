...
import type { DeleteManagedPrefixListRequest, DeleteManagedPrefixListResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteManagedPrefixListCommand_base: {
    new (input: DeleteManagedPrefixListCommandInput): import("@smithy/core/client").CommandImpl<DeleteManagedPrefixListCommandInput, DeleteManagedPrefixListCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteManagedPrefixListCommandInput): import("@smithy/core/client").CommandImpl<DeleteManagedPrefixListCommandInput, DeleteManagedPrefixListCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
