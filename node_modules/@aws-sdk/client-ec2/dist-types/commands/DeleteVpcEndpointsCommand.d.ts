...
declare const DeleteVpcEndpointsCommand_base: {
    new (input: DeleteVpcEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEndpointsCommandInput, DeleteVpcEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEndpointsCommandInput, DeleteVpcEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
