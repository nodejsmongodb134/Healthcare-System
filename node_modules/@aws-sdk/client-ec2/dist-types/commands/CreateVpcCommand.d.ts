...
declare const CreateVpcCommand_base: {
    new (input: CreateVpcCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcCommandInput, CreateVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateVpcCommandInput]): import("@smithy/core/client").CommandImpl<CreateVpcCommandInput, CreateVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
