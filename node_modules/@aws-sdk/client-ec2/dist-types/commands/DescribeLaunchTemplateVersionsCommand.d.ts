...
import type { DescribeLaunchTemplateVersionsRequest, DescribeLaunchTemplateVersionsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeLaunchTemplateVersionsCommand_base: {
    new (input: DescribeLaunchTemplateVersionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLaunchTemplateVersionsCommandInput, DescribeLaunchTemplateVersionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLaunchTemplateVersionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLaunchTemplateVersionsCommandInput, DescribeLaunchTemplateVersionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
