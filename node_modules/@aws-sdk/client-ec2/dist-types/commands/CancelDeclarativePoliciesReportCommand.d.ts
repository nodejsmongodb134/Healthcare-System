...
declare const CancelDeclarativePoliciesReportCommand_base: {
    new (input: CancelDeclarativePoliciesReportCommandInput): import("@smithy/core/client").CommandImpl<CancelDeclarativePoliciesReportCommandInput, CancelDeclarativePoliciesReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelDeclarativePoliciesReportCommandInput): import("@smithy/core/client").CommandImpl<CancelDeclarativePoliciesReportCommandInput, CancelDeclarativePoliciesReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
