...
import type { DeleteLocalGatewayVirtualInterfaceGroupRequest, DeleteLocalGatewayVirtualInterfaceGroupResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteLocalGatewayVirtualInterfaceGroupCommand_base: {
    new (input: DeleteLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceGroupCommandInput, DeleteLocalGatewayVirtualInterfaceGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceGroupCommandInput, DeleteLocalGatewayVirtualInterfaceGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
