...
declare const DescribeInstanceTypeOfferingsCommand_base: {
    new (input: DescribeInstanceTypeOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceTypeOfferingsCommandInput, DescribeInstanceTypeOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceTypeOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceTypeOfferingsCommandInput, DescribeInstanceTypeOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
