...
declare const EnableImageCommand_base: {
    new (input: EnableImageCommandInput): import("@smithy/core/client").CommandImpl<EnableImageCommandInput, EnableImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableImageCommandInput): import("@smithy/core/client").CommandImpl<EnableImageCommandInput, EnableImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
