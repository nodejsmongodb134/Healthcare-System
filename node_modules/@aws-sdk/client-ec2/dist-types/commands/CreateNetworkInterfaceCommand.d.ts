...
import type { CreateNetworkInterfaceRequest, CreateNetworkInterfaceResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateNetworkInterfaceCommand_base: {
    new (input: CreateNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInterfaceCommandInput, CreateNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNetworkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInterfaceCommandInput, CreateNetworkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
