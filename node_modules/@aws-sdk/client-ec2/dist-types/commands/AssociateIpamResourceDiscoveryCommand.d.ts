...
import type { AssociateIpamResourceDiscoveryRequest, AssociateIpamResourceDiscoveryResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateIpamResourceDiscoveryCommand_base: {
    new (input: AssociateIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<AssociateIpamResourceDiscoveryCommandInput, AssociateIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<AssociateIpamResourceDiscoveryCommandInput, AssociateIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
