...
import type { TerminateClientVpnConnectionsRequest, TerminateClientVpnConnectionsResult } from "../models/models_8";
/**
 * @public
 */
...
declare const TerminateClientVpnConnectionsCommand_base: {
    new (input: TerminateClientVpnConnectionsCommandInput): import("@smithy/core/client").CommandImpl<TerminateClientVpnConnectionsCommandInput, TerminateClientVpnConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TerminateClientVpnConnectionsCommandInput): import("@smithy/core/client").CommandImpl<TerminateClientVpnConnectionsCommandInput, TerminateClientVpnConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TerminateClientVpnConnectionsCommand extends TerminateClientVpnConnectionsCommand_base {
