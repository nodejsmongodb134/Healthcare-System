...
import type { DeleteIpamExternalResourceVerificationTokenRequest, DeleteIpamExternalResourceVerificationTokenResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteIpamExternalResourceVerificationTokenCommand_base: {
    new (input: DeleteIpamExternalResourceVerificationTokenCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamExternalResourceVerificationTokenCommandInput, DeleteIpamExternalResourceVerificationTokenCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamExternalResourceVerificationTokenCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamExternalResourceVerificationTokenCommandInput, DeleteIpamExternalResourceVerificationTokenCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
