...
import type { DescribeInstanceSqlHaHistoryStatesRequest, DescribeInstanceSqlHaHistoryStatesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeInstanceSqlHaHistoryStatesCommand_base: {
    new (input: DescribeInstanceSqlHaHistoryStatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceSqlHaHistoryStatesCommandInput, DescribeInstanceSqlHaHistoryStatesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceSqlHaHistoryStatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceSqlHaHistoryStatesCommandInput, DescribeInstanceSqlHaHistoryStatesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
