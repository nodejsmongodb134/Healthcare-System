...
import type { CreateImageUsageReportRequest, CreateImageUsageReportResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateImageUsageReportCommand_base: {
    new (input: CreateImageUsageReportCommandInput): import("@smithy/core/client").CommandImpl<CreateImageUsageReportCommandInput, CreateImageUsageReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateImageUsageReportCommandInput): import("@smithy/core/client").CommandImpl<CreateImageUsageReportCommandInput, CreateImageUsageReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
