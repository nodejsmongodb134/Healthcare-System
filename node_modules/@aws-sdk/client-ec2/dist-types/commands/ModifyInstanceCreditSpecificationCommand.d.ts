...
import type { ModifyInstanceCreditSpecificationRequest, ModifyInstanceCreditSpecificationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceCreditSpecificationCommand_base: {
    new (input: ModifyInstanceCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCreditSpecificationCommandInput, ModifyInstanceCreditSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCreditSpecificationCommandInput, ModifyInstanceCreditSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstanceCreditSpecificationCommand extends ModifyInstanceCreditSpecificationCommand_base {
