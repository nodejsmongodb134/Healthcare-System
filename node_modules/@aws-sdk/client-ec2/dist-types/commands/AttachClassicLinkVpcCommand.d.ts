...
declare const AttachClassicLinkVpcCommand_base: {
    new (input: AttachClassicLinkVpcCommandInput): import("@smithy/core/client").CommandImpl<AttachClassicLinkVpcCommandInput, AttachClassicLinkVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachClassicLinkVpcCommandInput): import("@smithy/core/client").CommandImpl<AttachClassicLinkVpcCommandInput, AttachClassicLinkVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
