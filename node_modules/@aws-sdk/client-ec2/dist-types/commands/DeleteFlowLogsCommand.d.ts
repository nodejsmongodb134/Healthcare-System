...
declare const DeleteFlowLogsCommand_base: {
    new (input: DeleteFlowLogsCommandInput): import("@smithy/core/client").CommandImpl<DeleteFlowLogsCommandInput, DeleteFlowLogsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFlowLogsCommandInput): import("@smithy/core/client").CommandImpl<DeleteFlowLogsCommandInput, DeleteFlowLogsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
