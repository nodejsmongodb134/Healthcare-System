...
declare const ModifySnapshotAttributeCommand_base: {
    new (input: ModifySnapshotAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifySnapshotAttributeCommandInput, ModifySnapshotAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifySnapshotAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifySnapshotAttributeCommandInput, ModifySnapshotAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifySnapshotAttributeCommand extends ModifySnapshotAttributeCommand_base {
