...
declare const DeleteIpamPrefixListResolverCommand_base: {
    new (input: DeleteIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPrefixListResolverCommandInput, DeleteIpamPrefixListResolverCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPrefixListResolverCommandInput, DeleteIpamPrefixListResolverCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
