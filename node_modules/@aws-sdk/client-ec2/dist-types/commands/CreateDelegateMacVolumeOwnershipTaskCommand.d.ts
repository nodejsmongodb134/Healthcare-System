...
import type { CreateDelegateMacVolumeOwnershipTaskRequest, CreateDelegateMacVolumeOwnershipTaskResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateDelegateMacVolumeOwnershipTaskCommand_base: {
    new (input: CreateDelegateMacVolumeOwnershipTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateDelegateMacVolumeOwnershipTaskCommandInput, CreateDelegateMacVolumeOwnershipTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDelegateMacVolumeOwnershipTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateDelegateMacVolumeOwnershipTaskCommandInput, CreateDelegateMacVolumeOwnershipTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
