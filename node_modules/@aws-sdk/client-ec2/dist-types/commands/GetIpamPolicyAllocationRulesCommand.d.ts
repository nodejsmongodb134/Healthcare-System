...
import type { GetIpamPolicyAllocationRulesRequest, GetIpamPolicyAllocationRulesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamPolicyAllocationRulesCommand_base: {
    new (input: GetIpamPolicyAllocationRulesCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPolicyAllocationRulesCommandInput, GetIpamPolicyAllocationRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamPolicyAllocationRulesCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPolicyAllocationRulesCommandInput, GetIpamPolicyAllocationRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
