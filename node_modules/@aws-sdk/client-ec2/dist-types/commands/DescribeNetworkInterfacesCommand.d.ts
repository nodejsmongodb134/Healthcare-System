...
declare const DescribeNetworkInterfacesCommand_base: {
    new (input: DescribeNetworkInterfacesCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfacesCommandInput, DescribeNetworkInterfacesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInterfacesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfacesCommandInput, DescribeNetworkInterfacesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
