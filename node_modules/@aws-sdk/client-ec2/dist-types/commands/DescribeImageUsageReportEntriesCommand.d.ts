...
declare const DescribeImageUsageReportEntriesCommand_base: {
    new (input: DescribeImageUsageReportEntriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageUsageReportEntriesCommandInput, DescribeImageUsageReportEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeImageUsageReportEntriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeImageUsageReportEntriesCommandInput, DescribeImageUsageReportEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
