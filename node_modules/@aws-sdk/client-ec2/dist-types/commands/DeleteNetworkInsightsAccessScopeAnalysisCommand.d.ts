...
import type { DeleteNetworkInsightsAccessScopeAnalysisRequest, DeleteNetworkInsightsAccessScopeAnalysisResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteNetworkInsightsAccessScopeAnalysisCommand_base: {
    new (input: DeleteNetworkInsightsAccessScopeAnalysisCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAccessScopeAnalysisCommandInput, DeleteNetworkInsightsAccessScopeAnalysisCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNetworkInsightsAccessScopeAnalysisCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAccessScopeAnalysisCommandInput, DeleteNetworkInsightsAccessScopeAnalysisCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
