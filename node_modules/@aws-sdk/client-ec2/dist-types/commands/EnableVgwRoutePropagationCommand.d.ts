...
import type { EnableVgwRoutePropagationRequest } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableVgwRoutePropagationCommand_base: {
    new (input: EnableVgwRoutePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableVgwRoutePropagationCommandInput, EnableVgwRoutePropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableVgwRoutePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableVgwRoutePropagationCommandInput, EnableVgwRoutePropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
