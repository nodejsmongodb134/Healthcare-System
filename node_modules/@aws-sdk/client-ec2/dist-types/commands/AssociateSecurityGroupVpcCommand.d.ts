...
declare const AssociateSecurityGroupVpcCommand_base: {
    new (input: AssociateSecurityGroupVpcCommandInput): import("@smithy/core/client").CommandImpl<AssociateSecurityGroupVpcCommandInput, AssociateSecurityGroupVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateSecurityGroupVpcCommandInput): import("@smithy/core/client").CommandImpl<AssociateSecurityGroupVpcCommandInput, AssociateSecurityGroupVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
