...
import type { EnableEbsEncryptionByDefaultRequest, EnableEbsEncryptionByDefaultResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableEbsEncryptionByDefaultCommand_base: {
    new (input: EnableEbsEncryptionByDefaultCommandInput): import("@smithy/core/client").CommandImpl<EnableEbsEncryptionByDefaultCommandInput, EnableEbsEncryptionByDefaultCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableEbsEncryptionByDefaultCommandInput]): import("@smithy/core/client").CommandImpl<EnableEbsEncryptionByDefaultCommandInput, EnableEbsEncryptionByDefaultCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
