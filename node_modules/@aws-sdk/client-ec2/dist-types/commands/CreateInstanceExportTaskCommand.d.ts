...
import type { CreateInstanceExportTaskRequest, CreateInstanceExportTaskResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateInstanceExportTaskCommand_base: {
    new (input: CreateInstanceExportTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceExportTaskCommandInput, CreateInstanceExportTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateInstanceExportTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceExportTaskCommandInput, CreateInstanceExportTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
