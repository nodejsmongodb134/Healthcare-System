...
import type { GetIpamDiscoveredAccountsRequest, GetIpamDiscoveredAccountsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamDiscoveredAccountsCommand_base: {
    new (input: GetIpamDiscoveredAccountsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamDiscoveredAccountsCommandInput, GetIpamDiscoveredAccountsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamDiscoveredAccountsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamDiscoveredAccountsCommandInput, GetIpamDiscoveredAccountsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
