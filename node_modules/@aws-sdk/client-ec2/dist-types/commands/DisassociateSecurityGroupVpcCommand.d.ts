...
declare const DisassociateSecurityGroupVpcCommand_base: {
    new (input: DisassociateSecurityGroupVpcCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSecurityGroupVpcCommandInput, DisassociateSecurityGroupVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateSecurityGroupVpcCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSecurityGroupVpcCommandInput, DisassociateSecurityGroupVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
