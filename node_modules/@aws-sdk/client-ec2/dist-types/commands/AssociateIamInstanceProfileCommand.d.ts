...
declare const AssociateIamInstanceProfileCommand_base: {
    new (input: AssociateIamInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<AssociateIamInstanceProfileCommandInput, AssociateIamInstanceProfileCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateIamInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<AssociateIamInstanceProfileCommandInput, AssociateIamInstanceProfileCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
