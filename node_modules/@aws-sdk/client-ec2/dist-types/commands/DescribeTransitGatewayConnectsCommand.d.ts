...
declare const DescribeTransitGatewayConnectsCommand_base: {
    new (input: DescribeTransitGatewayConnectsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayConnectsCommandInput, DescribeTransitGatewayConnectsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayConnectsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayConnectsCommandInput, DescribeTransitGatewayConnectsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
