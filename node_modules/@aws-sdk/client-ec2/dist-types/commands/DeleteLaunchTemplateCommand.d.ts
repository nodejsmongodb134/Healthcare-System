...
declare const DeleteLaunchTemplateCommand_base: {
    new (input: DeleteLaunchTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteLaunchTemplateCommandInput, DeleteLaunchTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteLaunchTemplateCommandInput]): import("@smithy/core/client").CommandImpl<DeleteLaunchTemplateCommandInput, DeleteLaunchTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
