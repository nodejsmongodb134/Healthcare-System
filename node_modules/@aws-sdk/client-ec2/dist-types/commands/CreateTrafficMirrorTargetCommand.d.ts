...
declare const CreateTrafficMirrorTargetCommand_base: {
    new (input: CreateTrafficMirrorTargetCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorTargetCommandInput, CreateTrafficMirrorTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateTrafficMirrorTargetCommandInput]): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorTargetCommandInput, CreateTrafficMirrorTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
