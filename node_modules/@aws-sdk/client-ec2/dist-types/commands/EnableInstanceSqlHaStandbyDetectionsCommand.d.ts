...
import type { EnableInstanceSqlHaStandbyDetectionsRequest, EnableInstanceSqlHaStandbyDetectionsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableInstanceSqlHaStandbyDetectionsCommand_base: {
    new (input: EnableInstanceSqlHaStandbyDetectionsCommandInput): import("@smithy/core/client").CommandImpl<EnableInstanceSqlHaStandbyDetectionsCommandInput, EnableInstanceSqlHaStandbyDetectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableInstanceSqlHaStandbyDetectionsCommandInput): import("@smithy/core/client").CommandImpl<EnableInstanceSqlHaStandbyDetectionsCommandInput, EnableInstanceSqlHaStandbyDetectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
