...
declare const ProvisionIpamByoasnCommand_base: {
    new (input: ProvisionIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<ProvisionIpamByoasnCommandInput, ProvisionIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ProvisionIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<ProvisionIpamByoasnCommandInput, ProvisionIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
