...
import type { CreateManagedPrefixListRequest, CreateManagedPrefixListResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateManagedPrefixListCommand_base: {
    new (input: CreateManagedPrefixListCommandInput): import("@smithy/core/client").CommandImpl<CreateManagedPrefixListCommandInput, CreateManagedPrefixListCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateManagedPrefixListCommandInput): import("@smithy/core/client").CommandImpl<CreateManagedPrefixListCommandInput, CreateManagedPrefixListCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateManagedPrefixListCommand extends CreateManagedPrefixListCommand_base {
