...
import type { DisableImageDeregistrationProtectionRequest, DisableImageDeregistrationProtectionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisableImageDeregistrationProtectionCommand_base: {
    new (input: DisableImageDeregistrationProtectionCommandInput): import("@smithy/core/client").CommandImpl<DisableImageDeregistrationProtectionCommandInput, DisableImageDeregistrationProtectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableImageDeregistrationProtectionCommandInput): import("@smithy/core/client").CommandImpl<DisableImageDeregistrationProtectionCommandInput, DisableImageDeregistrationProtectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
