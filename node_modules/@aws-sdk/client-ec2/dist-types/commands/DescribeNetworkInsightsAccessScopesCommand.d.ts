...
import type { DescribeNetworkInsightsAccessScopesRequest, DescribeNetworkInsightsAccessScopesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNetworkInsightsAccessScopesCommand_base: {
    new (input: DescribeNetworkInsightsAccessScopesCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsAccessScopesCommandInput, DescribeNetworkInsightsAccessScopesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInsightsAccessScopesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsAccessScopesCommandInput, DescribeNetworkInsightsAccessScopesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
