...
declare const DescribeCapacityBlockOfferingsCommand_base: {
    new (input: DescribeCapacityBlockOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockOfferingsCommandInput, DescribeCapacityBlockOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCapacityBlockOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockOfferingsCommandInput, DescribeCapacityBlockOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
