...
import type { ModifyVpcEndpointServicePayerResponsibilityRequest, ModifyVpcEndpointServicePayerResponsibilityResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEndpointServicePayerResponsibilityCommand_base: {
    new (input: ModifyVpcEndpointServicePayerResponsibilityCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointServicePayerResponsibilityCommandInput, ModifyVpcEndpointServicePayerResponsibilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEndpointServicePayerResponsibilityCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointServicePayerResponsibilityCommandInput, ModifyVpcEndpointServicePayerResponsibilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
