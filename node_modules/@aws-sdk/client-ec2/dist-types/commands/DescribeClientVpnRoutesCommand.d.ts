...
declare const DescribeClientVpnRoutesCommand_base: {
    new (input: DescribeClientVpnRoutesCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnRoutesCommandInput, DescribeClientVpnRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClientVpnRoutesCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnRoutesCommandInput, DescribeClientVpnRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
