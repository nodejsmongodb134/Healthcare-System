...
declare const DescribeMacHostsCommand_base: {
    new (input: DescribeMacHostsCommandInput): import("@smithy/core/client").CommandImpl<DescribeMacHostsCommandInput, DescribeMacHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeMacHostsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeMacHostsCommandInput, DescribeMacHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
