...
declare const ModifyIpamScopeCommand_base: {
    new (input: ModifyIpamScopeCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamScopeCommandInput, ModifyIpamScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamScopeCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamScopeCommandInput, ModifyIpamScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyIpamScopeCommand extends ModifyIpamScopeCommand_base {
