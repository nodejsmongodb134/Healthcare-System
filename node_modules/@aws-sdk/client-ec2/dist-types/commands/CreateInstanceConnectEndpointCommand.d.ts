...
declare const CreateInstanceConnectEndpointCommand_base: {
    new (input: CreateInstanceConnectEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceConnectEndpointCommandInput, CreateInstanceConnectEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateInstanceConnectEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceConnectEndpointCommandInput, CreateInstanceConnectEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
