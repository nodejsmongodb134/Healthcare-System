...
import type { DescribeScheduledInstancesRequest, DescribeScheduledInstancesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeScheduledInstancesCommand_base: {
    new (input: DescribeScheduledInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledInstancesCommandInput, DescribeScheduledInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeScheduledInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeScheduledInstancesCommandInput, DescribeScheduledInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
