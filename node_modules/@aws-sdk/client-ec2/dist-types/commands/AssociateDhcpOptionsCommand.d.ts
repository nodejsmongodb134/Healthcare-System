...
import type { AssociateDhcpOptionsRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateDhcpOptionsCommand_base: {
    new (input: AssociateDhcpOptionsCommandInput): import("@smithy/core/client").CommandImpl<AssociateDhcpOptionsCommandInput, AssociateDhcpOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateDhcpOptionsCommandInput): import("@smithy/core/client").CommandImpl<AssociateDhcpOptionsCommandInput, AssociateDhcpOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
