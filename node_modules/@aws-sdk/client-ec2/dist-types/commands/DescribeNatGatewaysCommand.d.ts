...
import type { DescribeNatGatewaysRequest, DescribeNatGatewaysResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNatGatewaysCommand_base: {
    new (input: DescribeNatGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeNatGatewaysCommandInput, DescribeNatGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNatGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNatGatewaysCommandInput, DescribeNatGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
