...
declare const DeleteIpamScopeCommand_base: {
    new (input: DeleteIpamScopeCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamScopeCommandInput, DeleteIpamScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamScopeCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamScopeCommandInput, DeleteIpamScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
