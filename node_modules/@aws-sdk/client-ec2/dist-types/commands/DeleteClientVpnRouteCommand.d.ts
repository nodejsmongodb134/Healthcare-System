...
import type { DeleteClientVpnRouteRequest, DeleteClientVpnRouteResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteClientVpnRouteCommand_base: {
    new (input: DeleteClientVpnRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteClientVpnRouteCommandInput, DeleteClientVpnRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteClientVpnRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteClientVpnRouteCommandInput, DeleteClientVpnRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteClientVpnRouteCommand extends DeleteClientVpnRouteCommand_base {
