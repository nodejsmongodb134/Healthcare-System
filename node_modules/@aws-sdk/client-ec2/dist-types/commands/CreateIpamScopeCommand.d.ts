...
import type { CreateIpamScopeRequest, CreateIpamScopeResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamScopeCommand_base: {
    new (input: CreateIpamScopeCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamScopeCommandInput, CreateIpamScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamScopeCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamScopeCommandInput, CreateIpamScopeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
