...
declare const DeleteCoipCidrCommand_base: {
    new (input: DeleteCoipCidrCommandInput): import("@smithy/core/client").CommandImpl<DeleteCoipCidrCommandInput, DeleteCoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCoipCidrCommandInput): import("@smithy/core/client").CommandImpl<DeleteCoipCidrCommandInput, DeleteCoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
