...
import type { DeleteVpcBlockPublicAccessExclusionRequest, DeleteVpcBlockPublicAccessExclusionResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVpcBlockPublicAccessExclusionCommand_base: {
    new (input: DeleteVpcBlockPublicAccessExclusionCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcBlockPublicAccessExclusionCommandInput, DeleteVpcBlockPublicAccessExclusionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcBlockPublicAccessExclusionCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcBlockPublicAccessExclusionCommandInput, DeleteVpcBlockPublicAccessExclusionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
