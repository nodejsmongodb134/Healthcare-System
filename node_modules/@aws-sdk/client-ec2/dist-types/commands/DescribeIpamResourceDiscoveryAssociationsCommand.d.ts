...
import type { DescribeIpamResourceDiscoveryAssociationsRequest, DescribeIpamResourceDiscoveryAssociationsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeIpamResourceDiscoveryAssociationsCommand_base: {
    new (input: DescribeIpamResourceDiscoveryAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamResourceDiscoveryAssociationsCommandInput, DescribeIpamResourceDiscoveryAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamResourceDiscoveryAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamResourceDiscoveryAssociationsCommandInput, DescribeIpamResourceDiscoveryAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
