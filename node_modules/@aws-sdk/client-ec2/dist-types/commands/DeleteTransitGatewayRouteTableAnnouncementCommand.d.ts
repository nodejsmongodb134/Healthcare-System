...
import type { DeleteTransitGatewayRouteTableAnnouncementRequest, DeleteTransitGatewayRouteTableAnnouncementResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteTransitGatewayRouteTableAnnouncementCommand_base: {
    new (input: DeleteTransitGatewayRouteTableAnnouncementCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayRouteTableAnnouncementCommandInput, DeleteTransitGatewayRouteTableAnnouncementCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayRouteTableAnnouncementCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayRouteTableAnnouncementCommandInput, DeleteTransitGatewayRouteTableAnnouncementCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
