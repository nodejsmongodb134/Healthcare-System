...
declare const DescribeVpnConnectionsCommand_base: {
    new (input: DescribeVpnConnectionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpnConnectionsCommandInput, DescribeVpnConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpnConnectionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpnConnectionsCommandInput, DescribeVpnConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
