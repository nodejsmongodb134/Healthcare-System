...
declare const AttachVpnGatewayCommand_base: {
    new (input: AttachVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<AttachVpnGatewayCommandInput, AttachVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<AttachVpnGatewayCommandInput, AttachVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
