...
import type { ModifyVerifiedAccessGroupRequest, ModifyVerifiedAccessGroupResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVerifiedAccessGroupCommand_base: {
    new (input: ModifyVerifiedAccessGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessGroupCommandInput, ModifyVerifiedAccessGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVerifiedAccessGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessGroupCommandInput, ModifyVerifiedAccessGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
