...
import type { ReplaceImageInstanceTypeSpecificationRequest, ReplaceImageInstanceTypeSpecificationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ReplaceImageInstanceTypeSpecificationCommand_base: {
    new (input: ReplaceImageInstanceTypeSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceImageInstanceTypeSpecificationCommandInput, ReplaceImageInstanceTypeSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceImageInstanceTypeSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceImageInstanceTypeSpecificationCommandInput, ReplaceImageInstanceTypeSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
