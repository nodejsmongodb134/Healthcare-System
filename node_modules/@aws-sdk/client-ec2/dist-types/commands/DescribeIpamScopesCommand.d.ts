...
import type { DescribeIpamScopesRequest, DescribeIpamScopesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeIpamScopesCommand_base: {
    new (input: DescribeIpamScopesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamScopesCommandInput, DescribeIpamScopesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamScopesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamScopesCommandInput, DescribeIpamScopesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
