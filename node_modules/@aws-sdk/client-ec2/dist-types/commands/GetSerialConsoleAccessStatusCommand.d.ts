...
declare const GetSerialConsoleAccessStatusCommand_base: {
    new (input: GetSerialConsoleAccessStatusCommandInput): import("@smithy/core/client").CommandImpl<GetSerialConsoleAccessStatusCommandInput, GetSerialConsoleAccessStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetSerialConsoleAccessStatusCommandInput]): import("@smithy/core/client").CommandImpl<GetSerialConsoleAccessStatusCommandInput, GetSerialConsoleAccessStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
