...
import type { DescribeCapacityReservationBillingRequestsRequest, DescribeCapacityReservationBillingRequestsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityReservationBillingRequestsCommand_base: {
    new (input: DescribeCapacityReservationBillingRequestsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationBillingRequestsCommandInput, DescribeCapacityReservationBillingRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCapacityReservationBillingRequestsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationBillingRequestsCommandInput, DescribeCapacityReservationBillingRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
