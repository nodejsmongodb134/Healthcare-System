...
import type { CreateTransitGatewayMeteringPolicyRequest, CreateTransitGatewayMeteringPolicyResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayMeteringPolicyCommand_base: {
    new (input: CreateTransitGatewayMeteringPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayMeteringPolicyCommandInput, CreateTransitGatewayMeteringPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayMeteringPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayMeteringPolicyCommandInput, CreateTransitGatewayMeteringPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
