...
import type { GetReservedInstancesExchangeQuoteRequest, GetReservedInstancesExchangeQuoteResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetReservedInstancesExchangeQuoteCommand_base: {
    new (input: GetReservedInstancesExchangeQuoteCommandInput): import("@smithy/core/client").CommandImpl<GetReservedInstancesExchangeQuoteCommandInput, GetReservedInstancesExchangeQuoteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetReservedInstancesExchangeQuoteCommandInput): import("@smithy/core/client").CommandImpl<GetReservedInstancesExchangeQuoteCommandInput, GetReservedInstancesExchangeQuoteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
