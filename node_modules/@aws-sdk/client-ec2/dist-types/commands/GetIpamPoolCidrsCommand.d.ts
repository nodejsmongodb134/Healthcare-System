...
declare const GetIpamPoolCidrsCommand_base: {
    new (input: GetIpamPoolCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPoolCidrsCommandInput, GetIpamPoolCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamPoolCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPoolCidrsCommandInput, GetIpamPoolCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
