...
import type { GetIpamDiscoveredPublicAddressesRequest, GetIpamDiscoveredPublicAddressesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamDiscoveredPublicAddressesCommand_base: {
    new (input: GetIpamDiscoveredPublicAddressesCommandInput): import("@smithy/core/client").CommandImpl<GetIpamDiscoveredPublicAddressesCommandInput, GetIpamDiscoveredPublicAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamDiscoveredPublicAddressesCommandInput): import("@smithy/core/client").CommandImpl<GetIpamDiscoveredPublicAddressesCommandInput, GetIpamDiscoveredPublicAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
