...
import type { GetInstanceTypesFromInstanceRequirementsRequest, GetInstanceTypesFromInstanceRequirementsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetInstanceTypesFromInstanceRequirementsCommand_base: {
    new (input: GetInstanceTypesFromInstanceRequirementsCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceTypesFromInstanceRequirementsCommandInput, GetInstanceTypesFromInstanceRequirementsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInstanceTypesFromInstanceRequirementsCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceTypesFromInstanceRequirementsCommandInput, GetInstanceTypesFromInstanceRequirementsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
