...
import type { ModifyInstanceMetadataOptionsRequest, ModifyInstanceMetadataOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceMetadataOptionsCommand_base: {
    new (input: ModifyInstanceMetadataOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMetadataOptionsCommandInput, ModifyInstanceMetadataOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceMetadataOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMetadataOptionsCommandInput, ModifyInstanceMetadataOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstanceMetadataOptionsCommand extends ModifyInstanceMetadataOptionsCommand_base {
