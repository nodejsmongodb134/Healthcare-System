...
declare const DisassociateVpcCidrBlockCommand_base: {
    new (input: DisassociateVpcCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<DisassociateVpcCidrBlockCommandInput, DisassociateVpcCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateVpcCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<DisassociateVpcCidrBlockCommandInput, DisassociateVpcCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateVpcCidrBlockCommand extends DisassociateVpcCidrBlockCommand_base {
