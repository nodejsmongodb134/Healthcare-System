...
declare const DeleteVpcEncryptionControlCommand_base: {
    new (input: DeleteVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEncryptionControlCommandInput, DeleteVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcEncryptionControlCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEncryptionControlCommandInput, DeleteVpcEncryptionControlCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
