...
declare const CreateDefaultSubnetCommand_base: {
    new (input: CreateDefaultSubnetCommandInput): import("@smithy/core/client").CommandImpl<CreateDefaultSubnetCommandInput, CreateDefaultSubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateDefaultSubnetCommandInput]): import("@smithy/core/client").CommandImpl<CreateDefaultSubnetCommandInput, CreateDefaultSubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
