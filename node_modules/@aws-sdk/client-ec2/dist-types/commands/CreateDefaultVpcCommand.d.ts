...
declare const CreateDefaultVpcCommand_base: {
    new (input: CreateDefaultVpcCommandInput): import("@smithy/core/client").CommandImpl<CreateDefaultVpcCommandInput, CreateDefaultVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateDefaultVpcCommandInput]): import("@smithy/core/client").CommandImpl<CreateDefaultVpcCommandInput, CreateDefaultVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
