...
declare const ReplaceNetworkAclEntryCommand_base: {
    new (input: ReplaceNetworkAclEntryCommandInput): import("@smithy/core/client").CommandImpl<ReplaceNetworkAclEntryCommandInput, ReplaceNetworkAclEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceNetworkAclEntryCommandInput): import("@smithy/core/client").CommandImpl<ReplaceNetworkAclEntryCommandInput, ReplaceNetworkAclEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
