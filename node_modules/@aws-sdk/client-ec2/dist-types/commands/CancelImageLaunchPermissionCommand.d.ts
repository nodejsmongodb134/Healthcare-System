...
declare const CancelImageLaunchPermissionCommand_base: {
    new (input: CancelImageLaunchPermissionCommandInput): import("@smithy/core/client").CommandImpl<CancelImageLaunchPermissionCommandInput, CancelImageLaunchPermissionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelImageLaunchPermissionCommandInput): import("@smithy/core/client").CommandImpl<CancelImageLaunchPermissionCommandInput, CancelImageLaunchPermissionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
