...
import type { DescribeReservedInstancesOfferingsRequest, DescribeReservedInstancesOfferingsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeReservedInstancesOfferingsCommand_base: {
    new (input: DescribeReservedInstancesOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesOfferingsCommandInput, DescribeReservedInstancesOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeReservedInstancesOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesOfferingsCommandInput, DescribeReservedInstancesOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
