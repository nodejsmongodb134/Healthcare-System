...
import type { CreateIpamRequest, CreateIpamResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamCommand_base: {
    new (input: CreateIpamCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamCommandInput, CreateIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateIpamCommandInput]): import("@smithy/core/client").CommandImpl<CreateIpamCommandInput, CreateIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
