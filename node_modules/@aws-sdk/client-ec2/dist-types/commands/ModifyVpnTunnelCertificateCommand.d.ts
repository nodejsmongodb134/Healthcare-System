...
import type { ModifyVpnTunnelCertificateRequest, ModifyVpnTunnelCertificateResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpnTunnelCertificateCommand_base: {
    new (input: ModifyVpnTunnelCertificateCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnTunnelCertificateCommandInput, ModifyVpnTunnelCertificateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpnTunnelCertificateCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnTunnelCertificateCommandInput, ModifyVpnTunnelCertificateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
