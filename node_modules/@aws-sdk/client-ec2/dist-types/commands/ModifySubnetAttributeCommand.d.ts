...
declare const ModifySubnetAttributeCommand_base: {
    new (input: ModifySubnetAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifySubnetAttributeCommandInput, ModifySubnetAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifySubnetAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifySubnetAttributeCommandInput, ModifySubnetAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifySubnetAttributeCommand extends ModifySubnetAttributeCommand_base {
