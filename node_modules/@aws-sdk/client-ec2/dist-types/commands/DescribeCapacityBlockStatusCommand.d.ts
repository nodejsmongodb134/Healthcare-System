...
import type { DescribeCapacityBlockStatusRequest, DescribeCapacityBlockStatusResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityBlockStatusCommand_base: {
    new (input: DescribeCapacityBlockStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockStatusCommandInput, DescribeCapacityBlockStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityBlockStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockStatusCommandInput, DescribeCapacityBlockStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
