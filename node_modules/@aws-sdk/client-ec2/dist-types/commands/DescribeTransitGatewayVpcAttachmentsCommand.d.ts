...
import type { DescribeTransitGatewayVpcAttachmentsRequest, DescribeTransitGatewayVpcAttachmentsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTransitGatewayVpcAttachmentsCommand_base: {
    new (input: DescribeTransitGatewayVpcAttachmentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayVpcAttachmentsCommandInput, DescribeTransitGatewayVpcAttachmentsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayVpcAttachmentsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayVpcAttachmentsCommandInput, DescribeTransitGatewayVpcAttachmentsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
