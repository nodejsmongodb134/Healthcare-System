...
declare const RebootInstancesCommand_base: {
    new (input: RebootInstancesCommandInput): import("@smithy/core/client").CommandImpl<RebootInstancesCommandInput, RebootInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RebootInstancesCommandInput): import("@smithy/core/client").CommandImpl<RebootInstancesCommandInput, RebootInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
