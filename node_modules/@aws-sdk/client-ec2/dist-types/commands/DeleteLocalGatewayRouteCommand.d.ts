...
declare const DeleteLocalGatewayRouteCommand_base: {
    new (input: DeleteLocalGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayRouteCommandInput, DeleteLocalGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLocalGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayRouteCommandInput, DeleteLocalGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
