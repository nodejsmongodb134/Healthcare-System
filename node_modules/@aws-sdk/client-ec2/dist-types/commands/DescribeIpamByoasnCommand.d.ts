...
declare const DescribeIpamByoasnCommand_base: {
    new (input: DescribeIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamByoasnCommandInput, DescribeIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamByoasnCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamByoasnCommandInput, DescribeIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
