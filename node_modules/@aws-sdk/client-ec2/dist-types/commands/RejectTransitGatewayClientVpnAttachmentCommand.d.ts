...
declare const RejectTransitGatewayClientVpnAttachmentCommand_base: {
    new (input: RejectTransitGatewayClientVpnAttachmentCommandInput): import("@smithy/core/client").CommandImpl<RejectTransitGatewayClientVpnAttachmentCommandInput, RejectTransitGatewayClientVpnAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectTransitGatewayClientVpnAttachmentCommandInput): import("@smithy/core/client").CommandImpl<RejectTransitGatewayClientVpnAttachmentCommandInput, RejectTransitGatewayClientVpnAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
