...
declare const DescribePlacementGroupsCommand_base: {
    new (input: DescribePlacementGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribePlacementGroupsCommandInput, DescribePlacementGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribePlacementGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribePlacementGroupsCommandInput, DescribePlacementGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
