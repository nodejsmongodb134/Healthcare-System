...
import type { DescribeIpamPoolsRequest, DescribeIpamPoolsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeIpamPoolsCommand_base: {
    new (input: DescribeIpamPoolsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPoolsCommandInput, DescribeIpamPoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPoolsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPoolsCommandInput, DescribeIpamPoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
