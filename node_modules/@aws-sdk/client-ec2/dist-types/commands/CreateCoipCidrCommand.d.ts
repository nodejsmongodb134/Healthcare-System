...
import type { CreateCoipCidrRequest, CreateCoipCidrResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateCoipCidrCommand_base: {
    new (input: CreateCoipCidrCommandInput): import("@smithy/core/client").CommandImpl<CreateCoipCidrCommandInput, CreateCoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCoipCidrCommandInput): import("@smithy/core/client").CommandImpl<CreateCoipCidrCommandInput, CreateCoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
