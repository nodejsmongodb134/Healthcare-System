...
declare const DeleteFpgaImageCommand_base: {
    new (input: DeleteFpgaImageCommandInput): import("@smithy/core/client").CommandImpl<DeleteFpgaImageCommandInput, DeleteFpgaImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFpgaImageCommandInput): import("@smithy/core/client").CommandImpl<DeleteFpgaImageCommandInput, DeleteFpgaImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
