...
import type { CreateTransitGatewayPolicyTableRequest, CreateTransitGatewayPolicyTableResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayPolicyTableCommand_base: {
    new (input: CreateTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayPolicyTableCommandInput, CreateTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayPolicyTableCommandInput, CreateTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
