...
declare const AuthorizeSecurityGroupEgressCommand_base: {
    new (input: AuthorizeSecurityGroupEgressCommandInput): import("@smithy/core/client").CommandImpl<AuthorizeSecurityGroupEgressCommandInput, AuthorizeSecurityGroupEgressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AuthorizeSecurityGroupEgressCommandInput): import("@smithy/core/client").CommandImpl<AuthorizeSecurityGroupEgressCommandInput, AuthorizeSecurityGroupEgressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
