...
import type { DescribeClientVpnAuthorizationRulesRequest, DescribeClientVpnAuthorizationRulesResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeClientVpnAuthorizationRulesCommand_base: {
    new (input: DescribeClientVpnAuthorizationRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnAuthorizationRulesCommandInput, DescribeClientVpnAuthorizationRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClientVpnAuthorizationRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnAuthorizationRulesCommandInput, DescribeClientVpnAuthorizationRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
