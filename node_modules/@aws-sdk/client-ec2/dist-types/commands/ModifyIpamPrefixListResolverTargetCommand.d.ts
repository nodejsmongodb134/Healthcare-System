...
import type { ModifyIpamPrefixListResolverTargetRequest, ModifyIpamPrefixListResolverTargetResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamPrefixListResolverTargetCommand_base: {
    new (input: ModifyIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverTargetCommandInput, ModifyIpamPrefixListResolverTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverTargetCommandInput, ModifyIpamPrefixListResolverTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
