...
declare const MoveAddressToVpcCommand_base: {
    new (input: MoveAddressToVpcCommandInput): import("@smithy/core/client").CommandImpl<MoveAddressToVpcCommandInput, MoveAddressToVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: MoveAddressToVpcCommandInput): import("@smithy/core/client").CommandImpl<MoveAddressToVpcCommandInput, MoveAddressToVpcCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
