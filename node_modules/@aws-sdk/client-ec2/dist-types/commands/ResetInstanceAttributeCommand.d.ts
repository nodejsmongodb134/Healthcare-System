...
import type { ResetInstanceAttributeRequest } from "../models/models_8";
/**
 * @public
 */
...
declare const ResetInstanceAttributeCommand_base: {
    new (input: ResetInstanceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetInstanceAttributeCommandInput, ResetInstanceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetInstanceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetInstanceAttributeCommandInput, ResetInstanceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
