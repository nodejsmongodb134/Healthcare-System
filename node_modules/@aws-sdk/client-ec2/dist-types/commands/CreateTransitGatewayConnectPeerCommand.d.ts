...
import type { CreateTransitGatewayConnectPeerRequest, CreateTransitGatewayConnectPeerResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayConnectPeerCommand_base: {
    new (input: CreateTransitGatewayConnectPeerCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayConnectPeerCommandInput, CreateTransitGatewayConnectPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayConnectPeerCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayConnectPeerCommandInput, CreateTransitGatewayConnectPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
