...
declare const DeleteTransitGatewayClientVpnAttachmentCommand_base: {
    new (input: DeleteTransitGatewayClientVpnAttachmentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayClientVpnAttachmentCommandInput, DeleteTransitGatewayClientVpnAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayClientVpnAttachmentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayClientVpnAttachmentCommandInput, DeleteTransitGatewayClientVpnAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
