...
import type { DeleteVpcEndpointServiceConfigurationsRequest, DeleteVpcEndpointServiceConfigurationsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVpcEndpointServiceConfigurationsCommand_base: {
    new (input: DeleteVpcEndpointServiceConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEndpointServiceConfigurationsCommandInput, DeleteVpcEndpointServiceConfigurationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcEndpointServiceConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcEndpointServiceConfigurationsCommandInput, DeleteVpcEndpointServiceConfigurationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
