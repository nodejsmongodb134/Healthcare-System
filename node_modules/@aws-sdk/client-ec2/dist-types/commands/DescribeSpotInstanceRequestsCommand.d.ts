...
declare const DescribeSpotInstanceRequestsCommand_base: {
    new (input: DescribeSpotInstanceRequestsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotInstanceRequestsCommandInput, DescribeSpotInstanceRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSpotInstanceRequestsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSpotInstanceRequestsCommandInput, DescribeSpotInstanceRequestsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
