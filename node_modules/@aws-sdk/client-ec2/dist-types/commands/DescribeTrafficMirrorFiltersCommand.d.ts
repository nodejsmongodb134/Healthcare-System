...
declare const DescribeTrafficMirrorFiltersCommand_base: {
    new (input: DescribeTrafficMirrorFiltersCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorFiltersCommandInput, DescribeTrafficMirrorFiltersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrafficMirrorFiltersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorFiltersCommandInput, DescribeTrafficMirrorFiltersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
