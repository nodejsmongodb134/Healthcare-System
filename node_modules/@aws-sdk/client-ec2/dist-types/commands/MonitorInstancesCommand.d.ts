...
declare const MonitorInstancesCommand_base: {
    new (input: MonitorInstancesCommandInput): import("@smithy/core/client").CommandImpl<MonitorInstancesCommandInput, MonitorInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: MonitorInstancesCommandInput): import("@smithy/core/client").CommandImpl<MonitorInstancesCommandInput, MonitorInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
