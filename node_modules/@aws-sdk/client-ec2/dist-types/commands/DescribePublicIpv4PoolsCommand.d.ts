...
import type { DescribePublicIpv4PoolsRequest, DescribePublicIpv4PoolsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribePublicIpv4PoolsCommand_base: {
    new (input: DescribePublicIpv4PoolsCommandInput): import("@smithy/core/client").CommandImpl<DescribePublicIpv4PoolsCommandInput, DescribePublicIpv4PoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribePublicIpv4PoolsCommandInput]): import("@smithy/core/client").CommandImpl<DescribePublicIpv4PoolsCommandInput, DescribePublicIpv4PoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
