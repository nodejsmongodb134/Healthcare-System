...
declare const DescribeInstanceSqlHaStatesCommand_base: {
    new (input: DescribeInstanceSqlHaStatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceSqlHaStatesCommandInput, DescribeInstanceSqlHaStatesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceSqlHaStatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceSqlHaStatesCommandInput, DescribeInstanceSqlHaStatesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
