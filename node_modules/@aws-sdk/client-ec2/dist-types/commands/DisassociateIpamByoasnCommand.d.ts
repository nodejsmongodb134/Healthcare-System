...
declare const DisassociateIpamByoasnCommand_base: {
    new (input: DisassociateIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DisassociateIpamByoasnCommandInput, DisassociateIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DisassociateIpamByoasnCommandInput, DisassociateIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateIpamByoasnCommand extends DisassociateIpamByoasnCommand_base {
