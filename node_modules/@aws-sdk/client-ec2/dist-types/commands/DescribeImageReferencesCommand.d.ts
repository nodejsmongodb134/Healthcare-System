...
declare const DescribeImageReferencesCommand_base: {
    new (input: DescribeImageReferencesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageReferencesCommandInput, DescribeImageReferencesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImageReferencesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageReferencesCommandInput, DescribeImageReferencesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
