...
declare const DeleteNatGatewayCommand_base: {
    new (input: DeleteNatGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteNatGatewayCommandInput, DeleteNatGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNatGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteNatGatewayCommandInput, DeleteNatGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
