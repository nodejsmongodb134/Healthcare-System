...
import type { CreateIpamPoolRequest, CreateIpamPoolResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamPoolCommand_base: {
    new (input: CreateIpamPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPoolCommandInput, CreateIpamPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIpamPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamPoolCommandInput, CreateIpamPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
