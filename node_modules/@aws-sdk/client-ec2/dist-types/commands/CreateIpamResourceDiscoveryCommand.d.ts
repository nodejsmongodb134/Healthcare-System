...
import type { CreateIpamResourceDiscoveryRequest, CreateIpamResourceDiscoveryResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamResourceDiscoveryCommand_base: {
    new (input: CreateIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<CreateIpamResourceDiscoveryCommandInput, CreateIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateIpamResourceDiscoveryCommandInput]): import("@smithy/core/client").CommandImpl<CreateIpamResourceDiscoveryCommandInput, CreateIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
