...
import type { DescribeTrunkInterfaceAssociationsRequest, DescribeTrunkInterfaceAssociationsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTrunkInterfaceAssociationsCommand_base: {
    new (input: DescribeTrunkInterfaceAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrunkInterfaceAssociationsCommandInput, DescribeTrunkInterfaceAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrunkInterfaceAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrunkInterfaceAssociationsCommandInput, DescribeTrunkInterfaceAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
