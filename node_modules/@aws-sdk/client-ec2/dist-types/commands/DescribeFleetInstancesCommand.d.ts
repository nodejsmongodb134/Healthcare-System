...
import type { DescribeFleetInstancesRequest, DescribeFleetInstancesResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeFleetInstancesCommand_base: {
    new (input: DescribeFleetInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeFleetInstancesCommandInput, DescribeFleetInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFleetInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeFleetInstancesCommandInput, DescribeFleetInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
