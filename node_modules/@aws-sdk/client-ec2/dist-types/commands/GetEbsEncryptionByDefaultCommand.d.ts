...
import type { GetEbsEncryptionByDefaultRequest, GetEbsEncryptionByDefaultResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetEbsEncryptionByDefaultCommand_base: {
    new (input: GetEbsEncryptionByDefaultCommandInput): import("@smithy/core/client").CommandImpl<GetEbsEncryptionByDefaultCommandInput, GetEbsEncryptionByDefaultCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetEbsEncryptionByDefaultCommandInput]): import("@smithy/core/client").CommandImpl<GetEbsEncryptionByDefaultCommandInput, GetEbsEncryptionByDefaultCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
