...
declare const CancelBundleTaskCommand_base: {
    new (input: CancelBundleTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelBundleTaskCommandInput, CancelBundleTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelBundleTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelBundleTaskCommandInput, CancelBundleTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
