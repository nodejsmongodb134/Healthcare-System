...
import type { ImportImageRequest, ImportImageResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ImportImageCommand_base: {
    new (input: ImportImageCommandInput): import("@smithy/core/client").CommandImpl<ImportImageCommandInput, ImportImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ImportImageCommandInput]): import("@smithy/core/client").CommandImpl<ImportImageCommandInput, ImportImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
