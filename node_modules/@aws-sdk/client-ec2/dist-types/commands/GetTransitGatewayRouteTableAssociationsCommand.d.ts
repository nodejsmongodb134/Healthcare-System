...
import type { GetTransitGatewayRouteTableAssociationsRequest, GetTransitGatewayRouteTableAssociationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayRouteTableAssociationsCommand_base: {
    new (input: GetTransitGatewayRouteTableAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayRouteTableAssociationsCommandInput, GetTransitGatewayRouteTableAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayRouteTableAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayRouteTableAssociationsCommandInput, GetTransitGatewayRouteTableAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
