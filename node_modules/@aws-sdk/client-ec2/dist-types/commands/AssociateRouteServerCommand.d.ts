...
import type { AssociateRouteServerRequest, AssociateRouteServerResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateRouteServerCommand_base: {
    new (input: AssociateRouteServerCommandInput): import("@smithy/core/client").CommandImpl<AssociateRouteServerCommandInput, AssociateRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateRouteServerCommandInput): import("@smithy/core/client").CommandImpl<AssociateRouteServerCommandInput, AssociateRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateRouteServerCommand extends AssociateRouteServerCommand_base {
