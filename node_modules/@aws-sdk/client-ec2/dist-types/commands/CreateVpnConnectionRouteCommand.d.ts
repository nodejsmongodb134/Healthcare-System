...
import type { CreateVpnConnectionRouteRequest } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpnConnectionRouteCommand_base: {
    new (input: CreateVpnConnectionRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnConnectionRouteCommandInput, CreateVpnConnectionRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpnConnectionRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnConnectionRouteCommandInput, CreateVpnConnectionRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateVpnConnectionRouteCommand extends CreateVpnConnectionRouteCommand_base {
