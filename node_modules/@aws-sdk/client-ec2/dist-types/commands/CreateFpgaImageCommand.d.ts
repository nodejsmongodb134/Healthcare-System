...
import type { CreateFpgaImageRequest, CreateFpgaImageResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateFpgaImageCommand_base: {
    new (input: CreateFpgaImageCommandInput): import("@smithy/core/client").CommandImpl<CreateFpgaImageCommandInput, CreateFpgaImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFpgaImageCommandInput): import("@smithy/core/client").CommandImpl<CreateFpgaImageCommandInput, CreateFpgaImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
