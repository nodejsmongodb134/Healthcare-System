...
import type { GetInstanceMetadataDefaultsRequest, GetInstanceMetadataDefaultsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetInstanceMetadataDefaultsCommand_base: {
    new (input: GetInstanceMetadataDefaultsCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceMetadataDefaultsCommandInput, GetInstanceMetadataDefaultsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetInstanceMetadataDefaultsCommandInput]): import("@smithy/core/client").CommandImpl<GetInstanceMetadataDefaultsCommandInput, GetInstanceMetadataDefaultsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
