...
import type { EnableIpamInternetRegistryAssociationRequest, EnableIpamInternetRegistryAssociationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableIpamInternetRegistryAssociationCommand_base: {
    new (input: EnableIpamInternetRegistryAssociationCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamInternetRegistryAssociationCommandInput, EnableIpamInternetRegistryAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableIpamInternetRegistryAssociationCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamInternetRegistryAssociationCommandInput, EnableIpamInternetRegistryAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
