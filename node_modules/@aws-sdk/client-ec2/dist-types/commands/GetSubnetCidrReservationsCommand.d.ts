...
declare const GetSubnetCidrReservationsCommand_base: {
    new (input: GetSubnetCidrReservationsCommandInput): import("@smithy/core/client").CommandImpl<GetSubnetCidrReservationsCommandInput, GetSubnetCidrReservationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSubnetCidrReservationsCommandInput): import("@smithy/core/client").CommandImpl<GetSubnetCidrReservationsCommandInput, GetSubnetCidrReservationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
