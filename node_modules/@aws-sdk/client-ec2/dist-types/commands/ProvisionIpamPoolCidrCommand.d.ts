...
import type { ProvisionIpamPoolCidrRequest, ProvisionIpamPoolCidrResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ProvisionIpamPoolCidrCommand_base: {
    new (input: ProvisionIpamPoolCidrCommandInput): import("@smithy/core/client").CommandImpl<ProvisionIpamPoolCidrCommandInput, ProvisionIpamPoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ProvisionIpamPoolCidrCommandInput): import("@smithy/core/client").CommandImpl<ProvisionIpamPoolCidrCommandInput, ProvisionIpamPoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
