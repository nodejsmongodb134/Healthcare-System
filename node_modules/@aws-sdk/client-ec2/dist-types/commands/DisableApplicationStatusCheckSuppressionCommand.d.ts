...
import type { DisableApplicationStatusCheckSuppressionRequest, DisableApplicationStatusCheckSuppressionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisableApplicationStatusCheckSuppressionCommand_base: {
    new (input: DisableApplicationStatusCheckSuppressionCommandInput): import("@smithy/core/client").CommandImpl<DisableApplicationStatusCheckSuppressionCommandInput, DisableApplicationStatusCheckSuppressionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableApplicationStatusCheckSuppressionCommandInput]): import("@smithy/core/client").CommandImpl<DisableApplicationStatusCheckSuppressionCommandInput, DisableApplicationStatusCheckSuppressionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
