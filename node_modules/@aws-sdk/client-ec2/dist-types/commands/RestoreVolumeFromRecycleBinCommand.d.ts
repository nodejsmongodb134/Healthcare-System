...
import type { RestoreVolumeFromRecycleBinRequest, RestoreVolumeFromRecycleBinResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RestoreVolumeFromRecycleBinCommand_base: {
    new (input: RestoreVolumeFromRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<RestoreVolumeFromRecycleBinCommandInput, RestoreVolumeFromRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreVolumeFromRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<RestoreVolumeFromRecycleBinCommandInput, RestoreVolumeFromRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
