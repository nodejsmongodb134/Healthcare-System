...
declare const ProvisionByoipCidrCommand_base: {
    new (input: ProvisionByoipCidrCommandInput): import("@smithy/core/client").CommandImpl<ProvisionByoipCidrCommandInput, ProvisionByoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ProvisionByoipCidrCommandInput): import("@smithy/core/client").CommandImpl<ProvisionByoipCidrCommandInput, ProvisionByoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 *          For the Amazon Web Services GovCloud (US) Regions, authorize only ASN 8987. For the Amazon Web Services
