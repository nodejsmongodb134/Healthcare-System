...
import type { DescribeInstanceTypesRequest, DescribeInstanceTypesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeInstanceTypesCommand_base: {
    new (input: DescribeInstanceTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceTypesCommandInput, DescribeInstanceTypesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceTypesCommandInput, DescribeInstanceTypesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
