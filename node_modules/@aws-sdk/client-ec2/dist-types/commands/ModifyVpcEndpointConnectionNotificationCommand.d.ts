...
import type { ModifyVpcEndpointConnectionNotificationRequest, ModifyVpcEndpointConnectionNotificationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEndpointConnectionNotificationCommand_base: {
    new (input: ModifyVpcEndpointConnectionNotificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointConnectionNotificationCommandInput, ModifyVpcEndpointConnectionNotificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEndpointConnectionNotificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointConnectionNotificationCommandInput, ModifyVpcEndpointConnectionNotificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
