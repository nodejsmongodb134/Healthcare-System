...
import type { DeleteLocalGatewayVirtualInterfaceRequest, DeleteLocalGatewayVirtualInterfaceResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteLocalGatewayVirtualInterfaceCommand_base: {
    new (input: DeleteLocalGatewayVirtualInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceCommandInput, DeleteLocalGatewayVirtualInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLocalGatewayVirtualInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceCommandInput, DeleteLocalGatewayVirtualInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
