...
import type { CreateCustomerGatewayRequest, CreateCustomerGatewayResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateCustomerGatewayCommand_base: {
    new (input: CreateCustomerGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateCustomerGatewayCommandInput, CreateCustomerGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCustomerGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateCustomerGatewayCommandInput, CreateCustomerGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
