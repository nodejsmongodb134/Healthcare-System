...
import type { EnableSerialConsoleAccessRequest, EnableSerialConsoleAccessResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableSerialConsoleAccessCommand_base: {
    new (input: EnableSerialConsoleAccessCommandInput): import("@smithy/core/client").CommandImpl<EnableSerialConsoleAccessCommandInput, EnableSerialConsoleAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableSerialConsoleAccessCommandInput]): import("@smithy/core/client").CommandImpl<EnableSerialConsoleAccessCommandInput, EnableSerialConsoleAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
