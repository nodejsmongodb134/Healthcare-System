...
declare const DescribeOutpostLagsCommand_base: {
    new (input: DescribeOutpostLagsCommandInput): import("@smithy/core/client").CommandImpl<DescribeOutpostLagsCommandInput, DescribeOutpostLagsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeOutpostLagsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeOutpostLagsCommandInput, DescribeOutpostLagsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
