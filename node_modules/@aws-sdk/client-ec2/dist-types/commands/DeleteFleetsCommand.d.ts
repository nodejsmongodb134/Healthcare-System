...
declare const DeleteFleetsCommand_base: {
    new (input: DeleteFleetsCommandInput): import("@smithy/core/client").CommandImpl<DeleteFleetsCommandInput, DeleteFleetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFleetsCommandInput): import("@smithy/core/client").CommandImpl<DeleteFleetsCommandInput, DeleteFleetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
