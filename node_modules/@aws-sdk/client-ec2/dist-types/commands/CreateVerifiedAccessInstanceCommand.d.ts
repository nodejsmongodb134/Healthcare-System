...
import type { CreateVerifiedAccessInstanceRequest, CreateVerifiedAccessInstanceResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVerifiedAccessInstanceCommand_base: {
    new (input: CreateVerifiedAccessInstanceCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessInstanceCommandInput, CreateVerifiedAccessInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateVerifiedAccessInstanceCommandInput]): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessInstanceCommandInput, CreateVerifiedAccessInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
