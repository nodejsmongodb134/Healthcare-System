...
import type { CreatePublicIpv4PoolRequest, CreatePublicIpv4PoolResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreatePublicIpv4PoolCommand_base: {
    new (input: CreatePublicIpv4PoolCommandInput): import("@smithy/core/client").CommandImpl<CreatePublicIpv4PoolCommandInput, CreatePublicIpv4PoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreatePublicIpv4PoolCommandInput]): import("@smithy/core/client").CommandImpl<CreatePublicIpv4PoolCommandInput, CreatePublicIpv4PoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
