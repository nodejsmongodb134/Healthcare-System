...
import type { DescribeTransitGatewayPolicyTablesRequest, DescribeTransitGatewayPolicyTablesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTransitGatewayPolicyTablesCommand_base: {
    new (input: DescribeTransitGatewayPolicyTablesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayPolicyTablesCommandInput, DescribeTransitGatewayPolicyTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayPolicyTablesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayPolicyTablesCommandInput, DescribeTransitGatewayPolicyTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
