...
import type { EnableApplicationStatusCheckSuppressionRequest, EnableApplicationStatusCheckSuppressionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableApplicationStatusCheckSuppressionCommand_base: {
    new (input: EnableApplicationStatusCheckSuppressionCommandInput): import("@smithy/core/client").CommandImpl<EnableApplicationStatusCheckSuppressionCommandInput, EnableApplicationStatusCheckSuppressionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableApplicationStatusCheckSuppressionCommandInput]): import("@smithy/core/client").CommandImpl<EnableApplicationStatusCheckSuppressionCommandInput, EnableApplicationStatusCheckSuppressionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
