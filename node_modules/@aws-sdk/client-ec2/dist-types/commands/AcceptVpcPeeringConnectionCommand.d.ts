...
declare const AcceptVpcPeeringConnectionCommand_base: {
    new (input: AcceptVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<AcceptVpcPeeringConnectionCommandInput, AcceptVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptVpcPeeringConnectionCommandInput): import("@smithy/core/client").CommandImpl<AcceptVpcPeeringConnectionCommandInput, AcceptVpcPeeringConnectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
