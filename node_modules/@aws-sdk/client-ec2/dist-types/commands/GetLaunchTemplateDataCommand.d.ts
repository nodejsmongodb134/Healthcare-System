...
import type { GetLaunchTemplateDataRequest, GetLaunchTemplateDataResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetLaunchTemplateDataCommand_base: {
    new (input: GetLaunchTemplateDataCommandInput): import("@smithy/core/client").CommandImpl<GetLaunchTemplateDataCommandInput, GetLaunchTemplateDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLaunchTemplateDataCommandInput): import("@smithy/core/client").CommandImpl<GetLaunchTemplateDataCommandInput, GetLaunchTemplateDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
