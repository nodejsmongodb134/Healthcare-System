...
import type { CreateCapacityReservationBySplittingRequest, CreateCapacityReservationBySplittingResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCapacityReservationBySplittingCommand_base: {
    new (input: CreateCapacityReservationBySplittingCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationBySplittingCommandInput, CreateCapacityReservationBySplittingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCapacityReservationBySplittingCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationBySplittingCommandInput, CreateCapacityReservationBySplittingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
