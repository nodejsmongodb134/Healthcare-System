...
declare const DeleteNetworkInterfacePermissionCommand_base: {
    new (input: DeleteNetworkInterfacePermissionCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInterfacePermissionCommandInput, DeleteNetworkInterfacePermissionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNetworkInterfacePermissionCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInterfacePermissionCommandInput, DeleteNetworkInterfacePermissionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
