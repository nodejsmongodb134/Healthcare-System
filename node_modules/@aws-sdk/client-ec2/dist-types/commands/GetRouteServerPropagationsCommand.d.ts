...
import type { GetRouteServerPropagationsRequest, GetRouteServerPropagationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetRouteServerPropagationsCommand_base: {
    new (input: GetRouteServerPropagationsCommandInput): import("@smithy/core/client").CommandImpl<GetRouteServerPropagationsCommandInput, GetRouteServerPropagationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRouteServerPropagationsCommandInput): import("@smithy/core/client").CommandImpl<GetRouteServerPropagationsCommandInput, GetRouteServerPropagationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRouteServerPropagationsCommand extends GetRouteServerPropagationsCommand_base {
