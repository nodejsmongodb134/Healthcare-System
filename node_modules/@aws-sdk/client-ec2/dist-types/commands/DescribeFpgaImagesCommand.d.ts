...
import type { DescribeFpgaImagesRequest, DescribeFpgaImagesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeFpgaImagesCommand_base: {
    new (input: DescribeFpgaImagesCommandInput): import("@smithy/core/client").CommandImpl<DescribeFpgaImagesCommandInput, DescribeFpgaImagesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeFpgaImagesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeFpgaImagesCommandInput, DescribeFpgaImagesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
