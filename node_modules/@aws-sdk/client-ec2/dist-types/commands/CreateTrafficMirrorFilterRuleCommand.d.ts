...
import type { CreateTrafficMirrorFilterRuleRequest, CreateTrafficMirrorFilterRuleResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTrafficMirrorFilterRuleCommand_base: {
    new (input: CreateTrafficMirrorFilterRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorFilterRuleCommandInput, CreateTrafficMirrorFilterRuleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrafficMirrorFilterRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficMirrorFilterRuleCommandInput, CreateTrafficMirrorFilterRuleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
