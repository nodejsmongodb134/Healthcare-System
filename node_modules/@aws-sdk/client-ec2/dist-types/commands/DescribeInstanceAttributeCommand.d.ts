...
declare const DescribeInstanceAttributeCommand_base: {
    new (input: DescribeInstanceAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceAttributeCommandInput, DescribeInstanceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInstanceAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceAttributeCommandInput, DescribeInstanceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
