...
import type { CreateVpcEndpointServiceConfigurationRequest, CreateVpcEndpointServiceConfigurationResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpcEndpointServiceConfigurationCommand_base: {
    new (input: CreateVpcEndpointServiceConfigurationCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcEndpointServiceConfigurationCommandInput, CreateVpcEndpointServiceConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateVpcEndpointServiceConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<CreateVpcEndpointServiceConfigurationCommandInput, CreateVpcEndpointServiceConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
