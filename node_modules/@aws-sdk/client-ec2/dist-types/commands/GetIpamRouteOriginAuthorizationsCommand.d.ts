...
import type { GetIpamRouteOriginAuthorizationsRequest, GetIpamRouteOriginAuthorizationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamRouteOriginAuthorizationsCommand_base: {
    new (input: GetIpamRouteOriginAuthorizationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRouteOriginAuthorizationsCommandInput, GetIpamRouteOriginAuthorizationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamRouteOriginAuthorizationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRouteOriginAuthorizationsCommandInput, GetIpamRouteOriginAuthorizationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
