...
import type { DescribeSpotFleetInstancesRequest, DescribeSpotFleetInstancesResponse } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSpotFleetInstancesCommand_base: {
    new (input: DescribeSpotFleetInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetInstancesCommandInput, DescribeSpotFleetInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSpotFleetInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetInstancesCommandInput, DescribeSpotFleetInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
