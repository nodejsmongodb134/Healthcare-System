...
import type { RegisterInstanceEventNotificationAttributesRequest, RegisterInstanceEventNotificationAttributesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RegisterInstanceEventNotificationAttributesCommand_base: {
    new (input: RegisterInstanceEventNotificationAttributesCommandInput): import("@smithy/core/client").CommandImpl<RegisterInstanceEventNotificationAttributesCommandInput, RegisterInstanceEventNotificationAttributesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterInstanceEventNotificationAttributesCommandInput): import("@smithy/core/client").CommandImpl<RegisterInstanceEventNotificationAttributesCommandInput, RegisterInstanceEventNotificationAttributesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
