...
import type { GetImageBlockPublicAccessStateRequest, GetImageBlockPublicAccessStateResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetImageBlockPublicAccessStateCommand_base: {
    new (input: GetImageBlockPublicAccessStateCommandInput): import("@smithy/core/client").CommandImpl<GetImageBlockPublicAccessStateCommandInput, GetImageBlockPublicAccessStateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetImageBlockPublicAccessStateCommandInput]): import("@smithy/core/client").CommandImpl<GetImageBlockPublicAccessStateCommandInput, GetImageBlockPublicAccessStateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
