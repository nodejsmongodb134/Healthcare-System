...
declare const DescribeRouteServersCommand_base: {
    new (input: DescribeRouteServersCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteServersCommandInput, DescribeRouteServersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRouteServersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRouteServersCommandInput, DescribeRouteServersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
