...
import type { DescribeNetworkInsightsAccessScopeAnalysesRequest, DescribeNetworkInsightsAccessScopeAnalysesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNetworkInsightsAccessScopeAnalysesCommand_base: {
    new (input: DescribeNetworkInsightsAccessScopeAnalysesCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsAccessScopeAnalysesCommandInput, DescribeNetworkInsightsAccessScopeAnalysesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInsightsAccessScopeAnalysesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsAccessScopeAnalysesCommandInput, DescribeNetworkInsightsAccessScopeAnalysesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
