...
declare const ModifyTrafficMirrorSessionCommand_base: {
    new (input: ModifyTrafficMirrorSessionCommandInput): import("@smithy/core/client").CommandImpl<ModifyTrafficMirrorSessionCommandInput, ModifyTrafficMirrorSessionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTrafficMirrorSessionCommandInput): import("@smithy/core/client").CommandImpl<ModifyTrafficMirrorSessionCommandInput, ModifyTrafficMirrorSessionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
