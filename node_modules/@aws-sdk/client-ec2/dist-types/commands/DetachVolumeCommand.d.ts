...
declare const DetachVolumeCommand_base: {
    new (input: DetachVolumeCommandInput): import("@smithy/core/client").CommandImpl<DetachVolumeCommandInput, DetachVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachVolumeCommandInput): import("@smithy/core/client").CommandImpl<DetachVolumeCommandInput, DetachVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
