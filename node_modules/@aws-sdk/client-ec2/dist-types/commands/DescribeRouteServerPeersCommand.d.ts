...
declare const DescribeRouteServerPeersCommand_base: {
    new (input: DescribeRouteServerPeersCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteServerPeersCommandInput, DescribeRouteServerPeersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRouteServerPeersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRouteServerPeersCommandInput, DescribeRouteServerPeersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
