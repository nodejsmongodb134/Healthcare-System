...
import type { ModifyTrafficMirrorFilterRuleRequest, ModifyTrafficMirrorFilterRuleResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyTrafficMirrorFilterRuleCommand_base: {
    new (input: ModifyTrafficMirrorFilterRuleCommandInput): import("@smithy/core/client").CommandImpl<ModifyTrafficMirrorFilterRuleCommandInput, ModifyTrafficMirrorFilterRuleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTrafficMirrorFilterRuleCommandInput): import("@smithy/core/client").CommandImpl<ModifyTrafficMirrorFilterRuleCommandInput, ModifyTrafficMirrorFilterRuleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
