...
import type { DescribeNetworkInsightsAnalysesRequest, DescribeNetworkInsightsAnalysesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNetworkInsightsAnalysesCommand_base: {
    new (input: DescribeNetworkInsightsAnalysesCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsAnalysesCommandInput, DescribeNetworkInsightsAnalysesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInsightsAnalysesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInsightsAnalysesCommandInput, DescribeNetworkInsightsAnalysesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
