...
import type { CreateTransitGatewayConnectRequest, CreateTransitGatewayConnectResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayConnectCommand_base: {
    new (input: CreateTransitGatewayConnectCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayConnectCommandInput, CreateTransitGatewayConnectCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayConnectCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayConnectCommandInput, CreateTransitGatewayConnectCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
