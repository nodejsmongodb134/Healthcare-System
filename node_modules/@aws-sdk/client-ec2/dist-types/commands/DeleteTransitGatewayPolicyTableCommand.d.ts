...
declare const DeleteTransitGatewayPolicyTableCommand_base: {
    new (input: DeleteTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayPolicyTableCommandInput, DeleteTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayPolicyTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayPolicyTableCommandInput, DeleteTransitGatewayPolicyTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
