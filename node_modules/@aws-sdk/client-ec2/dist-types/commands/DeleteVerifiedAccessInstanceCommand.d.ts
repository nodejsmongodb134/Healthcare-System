...
import type { DeleteVerifiedAccessInstanceRequest, DeleteVerifiedAccessInstanceResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVerifiedAccessInstanceCommand_base: {
    new (input: DeleteVerifiedAccessInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessInstanceCommandInput, DeleteVerifiedAccessInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVerifiedAccessInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeleteVerifiedAccessInstanceCommandInput, DeleteVerifiedAccessInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
