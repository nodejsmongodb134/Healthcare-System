...
declare const CreateTransitGatewayRouteTableCommand_base: {
    new (input: CreateTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayRouteTableCommandInput, CreateTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayRouteTableCommandInput, CreateTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
