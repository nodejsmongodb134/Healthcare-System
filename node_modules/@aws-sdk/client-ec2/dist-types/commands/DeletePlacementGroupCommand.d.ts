...
declare const DeletePlacementGroupCommand_base: {
    new (input: DeletePlacementGroupCommandInput): import("@smithy/core/client").CommandImpl<DeletePlacementGroupCommandInput, DeletePlacementGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePlacementGroupCommandInput): import("@smithy/core/client").CommandImpl<DeletePlacementGroupCommandInput, DeletePlacementGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
