...
declare const DisableFastSnapshotRestoresCommand_base: {
    new (input: DisableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<DisableFastSnapshotRestoresCommandInput, DisableFastSnapshotRestoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<DisableFastSnapshotRestoresCommandInput, DisableFastSnapshotRestoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
