...
declare const AttachInternetGatewayCommand_base: {
    new (input: AttachInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<AttachInternetGatewayCommandInput, AttachInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<AttachInternetGatewayCommandInput, AttachInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
