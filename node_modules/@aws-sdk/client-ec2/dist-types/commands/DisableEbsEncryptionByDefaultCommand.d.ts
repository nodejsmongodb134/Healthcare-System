...
declare const DisableEbsEncryptionByDefaultCommand_base: {
    new (input: DisableEbsEncryptionByDefaultCommandInput): import("@smithy/core/client").CommandImpl<DisableEbsEncryptionByDefaultCommandInput, DisableEbsEncryptionByDefaultCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableEbsEncryptionByDefaultCommandInput]): import("@smithy/core/client").CommandImpl<DisableEbsEncryptionByDefaultCommandInput, DisableEbsEncryptionByDefaultCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
