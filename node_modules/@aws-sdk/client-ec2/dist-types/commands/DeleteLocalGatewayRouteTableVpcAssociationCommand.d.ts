...
import type { DeleteLocalGatewayRouteTableVpcAssociationRequest, DeleteLocalGatewayRouteTableVpcAssociationResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteLocalGatewayRouteTableVpcAssociationCommand_base: {
    new (input: DeleteLocalGatewayRouteTableVpcAssociationCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayRouteTableVpcAssociationCommandInput, DeleteLocalGatewayRouteTableVpcAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLocalGatewayRouteTableVpcAssociationCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayRouteTableVpcAssociationCommandInput, DeleteLocalGatewayRouteTableVpcAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
