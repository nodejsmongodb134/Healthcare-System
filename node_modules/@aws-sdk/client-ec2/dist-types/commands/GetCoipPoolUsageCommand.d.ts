...
declare const GetCoipPoolUsageCommand_base: {
    new (input: GetCoipPoolUsageCommandInput): import("@smithy/core/client").CommandImpl<GetCoipPoolUsageCommandInput, GetCoipPoolUsageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCoipPoolUsageCommandInput): import("@smithy/core/client").CommandImpl<GetCoipPoolUsageCommandInput, GetCoipPoolUsageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
