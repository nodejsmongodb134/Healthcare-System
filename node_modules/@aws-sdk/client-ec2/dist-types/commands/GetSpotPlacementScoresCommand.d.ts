...
declare const GetSpotPlacementScoresCommand_base: {
    new (input: GetSpotPlacementScoresCommandInput): import("@smithy/core/client").CommandImpl<GetSpotPlacementScoresCommandInput, GetSpotPlacementScoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSpotPlacementScoresCommandInput): import("@smithy/core/client").CommandImpl<GetSpotPlacementScoresCommandInput, GetSpotPlacementScoresCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
