...
declare const DeleteTrafficMirrorFilterRuleCommand_base: {
    new (input: DeleteTrafficMirrorFilterRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficMirrorFilterRuleCommandInput, DeleteTrafficMirrorFilterRuleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrafficMirrorFilterRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficMirrorFilterRuleCommandInput, DeleteTrafficMirrorFilterRuleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
