...
declare const DisassociateInstanceEventWindowCommand_base: {
    new (input: DisassociateInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<DisassociateInstanceEventWindowCommandInput, DisassociateInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<DisassociateInstanceEventWindowCommandInput, DisassociateInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateInstanceEventWindowCommand extends DisassociateInstanceEventWindowCommand_base {
