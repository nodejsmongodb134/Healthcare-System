...
declare const DeleteSecurityGroupCommand_base: {
    new (input: DeleteSecurityGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteSecurityGroupCommandInput, DeleteSecurityGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteSecurityGroupCommandInput]): import("@smithy/core/client").CommandImpl<DeleteSecurityGroupCommandInput, DeleteSecurityGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
