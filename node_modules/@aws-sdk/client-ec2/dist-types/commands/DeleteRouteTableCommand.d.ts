...
import type { DeleteRouteTableRequest } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteRouteTableCommand_base: {
    new (input: DeleteRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteTableCommandInput, DeleteRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteTableCommandInput, DeleteRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
