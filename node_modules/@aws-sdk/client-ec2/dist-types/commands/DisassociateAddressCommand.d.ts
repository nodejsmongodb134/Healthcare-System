...
declare const DisassociateAddressCommand_base: {
    new (input: DisassociateAddressCommandInput): import("@smithy/core/client").CommandImpl<DisassociateAddressCommandInput, DisassociateAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisassociateAddressCommandInput]): import("@smithy/core/client").CommandImpl<DisassociateAddressCommandInput, DisassociateAddressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
