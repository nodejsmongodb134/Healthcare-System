...
import type { PurchaseCapacityBlockRequest, PurchaseCapacityBlockResult } from "../models/models_7";
/**
 * @public
 */
...
declare const PurchaseCapacityBlockCommand_base: {
    new (input: PurchaseCapacityBlockCommandInput): import("@smithy/core/client").CommandImpl<PurchaseCapacityBlockCommandInput, PurchaseCapacityBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PurchaseCapacityBlockCommandInput): import("@smithy/core/client").CommandImpl<PurchaseCapacityBlockCommandInput, PurchaseCapacityBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
