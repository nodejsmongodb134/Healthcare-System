...
import type { AuthorizeSecurityGroupIngressRequest, AuthorizeSecurityGroupIngressResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AuthorizeSecurityGroupIngressCommand_base: {
    new (input: AuthorizeSecurityGroupIngressCommandInput): import("@smithy/core/client").CommandImpl<AuthorizeSecurityGroupIngressCommandInput, AuthorizeSecurityGroupIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [AuthorizeSecurityGroupIngressCommandInput]): import("@smithy/core/client").CommandImpl<AuthorizeSecurityGroupIngressCommandInput, AuthorizeSecurityGroupIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
