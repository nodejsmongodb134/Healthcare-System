...
import type { DescribeImportImageTasksRequest, DescribeImportImageTasksResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeImportImageTasksCommand_base: {
    new (input: DescribeImportImageTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeImportImageTasksCommandInput, DescribeImportImageTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeImportImageTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeImportImageTasksCommandInput, DescribeImportImageTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
