...
declare const DescribeVolumeAttributeCommand_base: {
    new (input: DescribeVolumeAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeVolumeAttributeCommandInput, DescribeVolumeAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeVolumeAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeVolumeAttributeCommandInput, DescribeVolumeAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
