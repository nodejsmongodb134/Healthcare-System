...
import type { ModifyVpcBlockPublicAccessExclusionRequest, ModifyVpcBlockPublicAccessExclusionResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcBlockPublicAccessExclusionCommand_base: {
    new (input: ModifyVpcBlockPublicAccessExclusionCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcBlockPublicAccessExclusionCommandInput, ModifyVpcBlockPublicAccessExclusionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcBlockPublicAccessExclusionCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcBlockPublicAccessExclusionCommandInput, ModifyVpcBlockPublicAccessExclusionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
