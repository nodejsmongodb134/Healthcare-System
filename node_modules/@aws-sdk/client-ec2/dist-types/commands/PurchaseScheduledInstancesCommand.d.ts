...
import type { PurchaseScheduledInstancesRequest, PurchaseScheduledInstancesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const PurchaseScheduledInstancesCommand_base: {
    new (input: PurchaseScheduledInstancesCommandInput): import("@smithy/core/client").CommandImpl<PurchaseScheduledInstancesCommandInput, PurchaseScheduledInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PurchaseScheduledInstancesCommandInput): import("@smithy/core/client").CommandImpl<PurchaseScheduledInstancesCommandInput, PurchaseScheduledInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
