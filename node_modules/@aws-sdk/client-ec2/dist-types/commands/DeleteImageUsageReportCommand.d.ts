...
declare const DeleteImageUsageReportCommand_base: {
    new (input: DeleteImageUsageReportCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageUsageReportCommandInput, DeleteImageUsageReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteImageUsageReportCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageUsageReportCommandInput, DeleteImageUsageReportCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
