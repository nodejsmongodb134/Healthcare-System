...
import type { RunScheduledInstancesRequest, RunScheduledInstancesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RunScheduledInstancesCommand_base: {
    new (input: RunScheduledInstancesCommandInput): import("@smithy/core/client").CommandImpl<RunScheduledInstancesCommandInput, RunScheduledInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RunScheduledInstancesCommandInput): import("@smithy/core/client").CommandImpl<RunScheduledInstancesCommandInput, RunScheduledInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RunScheduledInstancesCommand extends RunScheduledInstancesCommand_base {
