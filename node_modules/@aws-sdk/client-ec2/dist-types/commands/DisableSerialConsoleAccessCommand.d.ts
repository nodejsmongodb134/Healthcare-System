...
declare const DisableSerialConsoleAccessCommand_base: {
    new (input: DisableSerialConsoleAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableSerialConsoleAccessCommandInput, DisableSerialConsoleAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableSerialConsoleAccessCommandInput]): import("@smithy/core/client").CommandImpl<DisableSerialConsoleAccessCommandInput, DisableSerialConsoleAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
