...
declare const DescribeLockedSnapshotsCommand_base: {
    new (input: DescribeLockedSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLockedSnapshotsCommandInput, DescribeLockedSnapshotsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLockedSnapshotsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLockedSnapshotsCommandInput, DescribeLockedSnapshotsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
