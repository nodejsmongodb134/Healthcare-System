...
declare const DescribeInstanceCreditSpecificationsCommand_base: {
    new (input: DescribeInstanceCreditSpecificationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceCreditSpecificationsCommandInput, DescribeInstanceCreditSpecificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceCreditSpecificationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceCreditSpecificationsCommandInput, DescribeInstanceCreditSpecificationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
