...
declare const DescribeFastLaunchImagesCommand_base: {
    new (input: DescribeFastLaunchImagesCommandInput): import("@smithy/core/client").CommandImpl<DescribeFastLaunchImagesCommandInput, DescribeFastLaunchImagesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeFastLaunchImagesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeFastLaunchImagesCommandInput, DescribeFastLaunchImagesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
