...
declare const UpdateCapacityManagerMonitoredTagKeysCommand_base: {
    new (input: UpdateCapacityManagerMonitoredTagKeysCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityManagerMonitoredTagKeysCommandInput, UpdateCapacityManagerMonitoredTagKeysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateCapacityManagerMonitoredTagKeysCommandInput]): import("@smithy/core/client").CommandImpl<UpdateCapacityManagerMonitoredTagKeysCommandInput, UpdateCapacityManagerMonitoredTagKeysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
