...
declare const DescribeStaleSecurityGroupsCommand_base: {
    new (input: DescribeStaleSecurityGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeStaleSecurityGroupsCommandInput, DescribeStaleSecurityGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeStaleSecurityGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeStaleSecurityGroupsCommandInput, DescribeStaleSecurityGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
