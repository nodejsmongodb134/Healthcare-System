...
declare const ModifySnapshotTierCommand_base: {
    new (input: ModifySnapshotTierCommandInput): import("@smithy/core/client").CommandImpl<ModifySnapshotTierCommandInput, ModifySnapshotTierCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifySnapshotTierCommandInput): import("@smithy/core/client").CommandImpl<ModifySnapshotTierCommandInput, ModifySnapshotTierCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifySnapshotTierCommand extends ModifySnapshotTierCommand_base {
