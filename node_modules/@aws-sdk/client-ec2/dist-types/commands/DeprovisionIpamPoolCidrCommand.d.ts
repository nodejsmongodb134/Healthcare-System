...
declare const DeprovisionIpamPoolCidrCommand_base: {
    new (input: DeprovisionIpamPoolCidrCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionIpamPoolCidrCommandInput, DeprovisionIpamPoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeprovisionIpamPoolCidrCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionIpamPoolCidrCommandInput, DeprovisionIpamPoolCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
