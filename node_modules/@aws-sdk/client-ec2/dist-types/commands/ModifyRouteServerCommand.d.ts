...
import type { ModifyRouteServerRequest, ModifyRouteServerResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyRouteServerCommand_base: {
    new (input: ModifyRouteServerCommandInput): import("@smithy/core/client").CommandImpl<ModifyRouteServerCommandInput, ModifyRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyRouteServerCommandInput): import("@smithy/core/client").CommandImpl<ModifyRouteServerCommandInput, ModifyRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyRouteServerCommand extends ModifyRouteServerCommand_base {
