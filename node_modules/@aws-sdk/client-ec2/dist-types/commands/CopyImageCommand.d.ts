...
declare const CopyImageCommand_base: {
    new (input: CopyImageCommandInput): import("@smithy/core/client").CommandImpl<CopyImageCommandInput, CopyImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CopyImageCommandInput): import("@smithy/core/client").CommandImpl<CopyImageCommandInput, CopyImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
