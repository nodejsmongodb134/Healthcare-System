...
declare const DescribeTrafficMirrorFilterRulesCommand_base: {
    new (input: DescribeTrafficMirrorFilterRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorFilterRulesCommandInput, DescribeTrafficMirrorFilterRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrafficMirrorFilterRulesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorFilterRulesCommandInput, DescribeTrafficMirrorFilterRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
