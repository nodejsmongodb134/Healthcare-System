...
declare const DeleteVpnGatewayCommand_base: {
    new (input: DeleteVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnGatewayCommandInput, DeleteVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpnGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpnGatewayCommandInput, DeleteVpnGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
