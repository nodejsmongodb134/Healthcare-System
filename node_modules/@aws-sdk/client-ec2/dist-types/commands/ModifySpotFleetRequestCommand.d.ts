...
declare const ModifySpotFleetRequestCommand_base: {
    new (input: ModifySpotFleetRequestCommandInput): import("@smithy/core/client").CommandImpl<ModifySpotFleetRequestCommandInput, ModifySpotFleetRequestCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifySpotFleetRequestCommandInput): import("@smithy/core/client").CommandImpl<ModifySpotFleetRequestCommandInput, ModifySpotFleetRequestCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifySpotFleetRequestCommand extends ModifySpotFleetRequestCommand_base {
