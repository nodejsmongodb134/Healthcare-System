...
declare const RestoreSnapshotFromRecycleBinCommand_base: {
    new (input: RestoreSnapshotFromRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<RestoreSnapshotFromRecycleBinCommandInput, RestoreSnapshotFromRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreSnapshotFromRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<RestoreSnapshotFromRecycleBinCommandInput, RestoreSnapshotFromRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RestoreSnapshotFromRecycleBinCommand extends RestoreSnapshotFromRecycleBinCommand_base {
