...
import type { ExportClientVpnClientConfigurationRequest, ExportClientVpnClientConfigurationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ExportClientVpnClientConfigurationCommand_base: {
    new (input: ExportClientVpnClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportClientVpnClientConfigurationCommandInput, ExportClientVpnClientConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportClientVpnClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportClientVpnClientConfigurationCommandInput, ExportClientVpnClientConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
