...
declare const DeleteCoipPoolCommand_base: {
    new (input: DeleteCoipPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteCoipPoolCommandInput, DeleteCoipPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCoipPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteCoipPoolCommandInput, DeleteCoipPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
