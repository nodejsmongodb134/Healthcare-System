...
declare const DetachImageWatermarkCommand_base: {
    new (input: DetachImageWatermarkCommandInput): import("@smithy/core/client").CommandImpl<DetachImageWatermarkCommandInput, DetachImageWatermarkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachImageWatermarkCommandInput): import("@smithy/core/client").CommandImpl<DetachImageWatermarkCommandInput, DetachImageWatermarkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
