...
import type { DescribeTransitGatewayRouteTablesRequest, DescribeTransitGatewayRouteTablesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTransitGatewayRouteTablesCommand_base: {
    new (input: DescribeTransitGatewayRouteTablesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayRouteTablesCommandInput, DescribeTransitGatewayRouteTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayRouteTablesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayRouteTablesCommandInput, DescribeTransitGatewayRouteTablesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
