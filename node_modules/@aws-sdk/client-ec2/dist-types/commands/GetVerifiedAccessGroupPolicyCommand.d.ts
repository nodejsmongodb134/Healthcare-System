...
declare const GetVerifiedAccessGroupPolicyCommand_base: {
    new (input: GetVerifiedAccessGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetVerifiedAccessGroupPolicyCommandInput, GetVerifiedAccessGroupPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVerifiedAccessGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetVerifiedAccessGroupPolicyCommandInput, GetVerifiedAccessGroupPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
