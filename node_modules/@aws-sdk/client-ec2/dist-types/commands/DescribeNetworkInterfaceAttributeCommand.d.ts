...
import type { DescribeNetworkInterfaceAttributeRequest, DescribeNetworkInterfaceAttributeResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNetworkInterfaceAttributeCommand_base: {
    new (input: DescribeNetworkInterfaceAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfaceAttributeCommandInput, DescribeNetworkInterfaceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeNetworkInterfaceAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfaceAttributeCommandInput, DescribeNetworkInterfaceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeNetworkInterfaceAttributeCommand extends DescribeNetworkInterfaceAttributeCommand_base {
