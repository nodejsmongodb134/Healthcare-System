...
import type { AcceptTransitGatewayClientVpnAttachmentRequest, AcceptTransitGatewayClientVpnAttachmentResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AcceptTransitGatewayClientVpnAttachmentCommand_base: {
    new (input: AcceptTransitGatewayClientVpnAttachmentCommandInput): import("@smithy/core/client").CommandImpl<AcceptTransitGatewayClientVpnAttachmentCommandInput, AcceptTransitGatewayClientVpnAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptTransitGatewayClientVpnAttachmentCommandInput): import("@smithy/core/client").CommandImpl<AcceptTransitGatewayClientVpnAttachmentCommandInput, AcceptTransitGatewayClientVpnAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
