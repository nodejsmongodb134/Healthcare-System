...
declare const DeleteSecondarySubnetCommand_base: {
    new (input: DeleteSecondarySubnetCommandInput): import("@smithy/core/client").CommandImpl<DeleteSecondarySubnetCommandInput, DeleteSecondarySubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSecondarySubnetCommandInput): import("@smithy/core/client").CommandImpl<DeleteSecondarySubnetCommandInput, DeleteSecondarySubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
