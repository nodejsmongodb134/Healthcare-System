...
import type { DescribeMovingAddressesRequest, DescribeMovingAddressesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeMovingAddressesCommand_base: {
    new (input: DescribeMovingAddressesCommandInput): import("@smithy/core/client").CommandImpl<DescribeMovingAddressesCommandInput, DescribeMovingAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeMovingAddressesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeMovingAddressesCommandInput, DescribeMovingAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeMovingAddressesCommand extends DescribeMovingAddressesCommand_base {
