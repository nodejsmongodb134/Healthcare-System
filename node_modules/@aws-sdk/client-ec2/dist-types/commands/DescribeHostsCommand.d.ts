...
declare const DescribeHostsCommand_base: {
    new (input: DescribeHostsCommandInput): import("@smithy/core/client").CommandImpl<DescribeHostsCommandInput, DescribeHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeHostsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeHostsCommandInput, DescribeHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
