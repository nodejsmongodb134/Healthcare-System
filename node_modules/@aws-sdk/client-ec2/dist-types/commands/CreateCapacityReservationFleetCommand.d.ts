...
declare const CreateCapacityReservationFleetCommand_base: {
    new (input: CreateCapacityReservationFleetCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationFleetCommandInput, CreateCapacityReservationFleetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCapacityReservationFleetCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationFleetCommandInput, CreateCapacityReservationFleetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
