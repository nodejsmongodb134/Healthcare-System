...
import type { ReplaceIamInstanceProfileAssociationRequest, ReplaceIamInstanceProfileAssociationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ReplaceIamInstanceProfileAssociationCommand_base: {
    new (input: ReplaceIamInstanceProfileAssociationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceIamInstanceProfileAssociationCommandInput, ReplaceIamInstanceProfileAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceIamInstanceProfileAssociationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceIamInstanceProfileAssociationCommandInput, ReplaceIamInstanceProfileAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
