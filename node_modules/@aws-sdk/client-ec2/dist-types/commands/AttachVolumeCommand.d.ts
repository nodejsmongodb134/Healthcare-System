...
declare const AttachVolumeCommand_base: {
    new (input: AttachVolumeCommandInput): import("@smithy/core/client").CommandImpl<AttachVolumeCommandInput, AttachVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachVolumeCommandInput): import("@smithy/core/client").CommandImpl<AttachVolumeCommandInput, AttachVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
