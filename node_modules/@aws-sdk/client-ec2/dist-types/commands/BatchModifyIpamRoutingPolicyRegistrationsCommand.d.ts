...
import type { BatchModifyIpamRoutingPolicyRegistrationsRequest, BatchModifyIpamRoutingPolicyRegistrationsResult } from "../models/models_0";
/**
 * @public
 */
...
declare const BatchModifyIpamRoutingPolicyRegistrationsCommand_base: {
    new (input: BatchModifyIpamRoutingPolicyRegistrationsCommandInput): import("@smithy/core/client").CommandImpl<BatchModifyIpamRoutingPolicyRegistrationsCommandInput, BatchModifyIpamRoutingPolicyRegistrationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchModifyIpamRoutingPolicyRegistrationsCommandInput): import("@smithy/core/client").CommandImpl<BatchModifyIpamRoutingPolicyRegistrationsCommandInput, BatchModifyIpamRoutingPolicyRegistrationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
