...
declare const DescribeVpnGatewaysCommand_base: {
    new (input: DescribeVpnGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpnGatewaysCommandInput, DescribeVpnGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpnGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpnGatewaysCommandInput, DescribeVpnGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
