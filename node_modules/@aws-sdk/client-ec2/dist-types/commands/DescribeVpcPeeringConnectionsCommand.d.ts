...
import type { DescribeVpcPeeringConnectionsRequest, DescribeVpcPeeringConnectionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcPeeringConnectionsCommand_base: {
    new (input: DescribeVpcPeeringConnectionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcPeeringConnectionsCommandInput, DescribeVpcPeeringConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcPeeringConnectionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcPeeringConnectionsCommandInput, DescribeVpcPeeringConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
