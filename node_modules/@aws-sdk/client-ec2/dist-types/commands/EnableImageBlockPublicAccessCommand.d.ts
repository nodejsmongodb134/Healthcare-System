...
declare const EnableImageBlockPublicAccessCommand_base: {
    new (input: EnableImageBlockPublicAccessCommandInput): import("@smithy/core/client").CommandImpl<EnableImageBlockPublicAccessCommandInput, EnableImageBlockPublicAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableImageBlockPublicAccessCommandInput): import("@smithy/core/client").CommandImpl<EnableImageBlockPublicAccessCommandInput, EnableImageBlockPublicAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EnableImageBlockPublicAccessCommand extends EnableImageBlockPublicAccessCommand_base {
