...
import type { AssociateRouteTableRequest, AssociateRouteTableResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateRouteTableCommand_base: {
    new (input: AssociateRouteTableCommandInput): import("@smithy/core/client").CommandImpl<AssociateRouteTableCommandInput, AssociateRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateRouteTableCommandInput): import("@smithy/core/client").CommandImpl<AssociateRouteTableCommandInput, AssociateRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
