...
declare const GetIpamResourceCidrsCommand_base: {
    new (input: GetIpamResourceCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamResourceCidrsCommandInput, GetIpamResourceCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamResourceCidrsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamResourceCidrsCommandInput, GetIpamResourceCidrsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
