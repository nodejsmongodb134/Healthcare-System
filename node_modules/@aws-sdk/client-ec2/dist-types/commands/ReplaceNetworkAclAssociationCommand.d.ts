...
declare const ReplaceNetworkAclAssociationCommand_base: {
    new (input: ReplaceNetworkAclAssociationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceNetworkAclAssociationCommandInput, ReplaceNetworkAclAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceNetworkAclAssociationCommandInput): import("@smithy/core/client").CommandImpl<ReplaceNetworkAclAssociationCommandInput, ReplaceNetworkAclAssociationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
