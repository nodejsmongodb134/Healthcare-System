...
declare const DisableRouteServerPropagationCommand_base: {
    new (input: DisableRouteServerPropagationCommandInput): import("@smithy/core/client").CommandImpl<DisableRouteServerPropagationCommandInput, DisableRouteServerPropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableRouteServerPropagationCommandInput): import("@smithy/core/client").CommandImpl<DisableRouteServerPropagationCommandInput, DisableRouteServerPropagationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
