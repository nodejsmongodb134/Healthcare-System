...
import type { CreateCarrierGatewayRequest, CreateCarrierGatewayResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCarrierGatewayCommand_base: {
    new (input: CreateCarrierGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateCarrierGatewayCommandInput, CreateCarrierGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCarrierGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateCarrierGatewayCommandInput, CreateCarrierGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
