...
import type { DescribeSpotDatafeedSubscriptionRequest, DescribeSpotDatafeedSubscriptionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSpotDatafeedSubscriptionCommand_base: {
    new (input: DescribeSpotDatafeedSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotDatafeedSubscriptionCommandInput, DescribeSpotDatafeedSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSpotDatafeedSubscriptionCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSpotDatafeedSubscriptionCommandInput, DescribeSpotDatafeedSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
