...
import type { ReportInstanceStatusRequest } from "../models/models_7";
/**
 * @public
 */
...
declare const ReportInstanceStatusCommand_base: {
    new (input: ReportInstanceStatusCommandInput): import("@smithy/core/client").CommandImpl<ReportInstanceStatusCommandInput, ReportInstanceStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReportInstanceStatusCommandInput): import("@smithy/core/client").CommandImpl<ReportInstanceStatusCommandInput, ReportInstanceStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
