...
import type { AcceptTransitGatewayPeeringAttachmentRequest, AcceptTransitGatewayPeeringAttachmentResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AcceptTransitGatewayPeeringAttachmentCommand_base: {
    new (input: AcceptTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<AcceptTransitGatewayPeeringAttachmentCommandInput, AcceptTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptTransitGatewayPeeringAttachmentCommandInput): import("@smithy/core/client").CommandImpl<AcceptTransitGatewayPeeringAttachmentCommandInput, AcceptTransitGatewayPeeringAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
