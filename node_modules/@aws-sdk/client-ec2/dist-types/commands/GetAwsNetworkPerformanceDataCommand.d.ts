...
import type { GetAwsNetworkPerformanceDataRequest, GetAwsNetworkPerformanceDataResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetAwsNetworkPerformanceDataCommand_base: {
    new (input: GetAwsNetworkPerformanceDataCommandInput): import("@smithy/core/client").CommandImpl<GetAwsNetworkPerformanceDataCommandInput, GetAwsNetworkPerformanceDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAwsNetworkPerformanceDataCommandInput]): import("@smithy/core/client").CommandImpl<GetAwsNetworkPerformanceDataCommandInput, GetAwsNetworkPerformanceDataCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
