...
import type { CreateTagsRequest } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTagsCommand_base: {
    new (input: CreateTagsCommandInput): import("@smithy/core/client").CommandImpl<CreateTagsCommandInput, CreateTagsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTagsCommandInput): import("@smithy/core/client").CommandImpl<CreateTagsCommandInput, CreateTagsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
