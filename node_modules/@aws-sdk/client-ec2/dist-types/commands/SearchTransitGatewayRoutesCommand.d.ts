...
import type { SearchTransitGatewayRoutesRequest, SearchTransitGatewayRoutesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const SearchTransitGatewayRoutesCommand_base: {
    new (input: SearchTransitGatewayRoutesCommandInput): import("@smithy/core/client").CommandImpl<SearchTransitGatewayRoutesCommandInput, SearchTransitGatewayRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchTransitGatewayRoutesCommandInput): import("@smithy/core/client").CommandImpl<SearchTransitGatewayRoutesCommandInput, SearchTransitGatewayRoutesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
