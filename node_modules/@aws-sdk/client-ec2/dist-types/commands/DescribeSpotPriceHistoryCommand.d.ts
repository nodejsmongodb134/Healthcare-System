...
declare const DescribeSpotPriceHistoryCommand_base: {
    new (input: DescribeSpotPriceHistoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotPriceHistoryCommandInput, DescribeSpotPriceHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSpotPriceHistoryCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSpotPriceHistoryCommandInput, DescribeSpotPriceHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
