...
declare const DisassociateTrunkInterfaceCommand_base: {
    new (input: DisassociateTrunkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTrunkInterfaceCommandInput, DisassociateTrunkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateTrunkInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTrunkInterfaceCommandInput, DisassociateTrunkInterfaceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateTrunkInterfaceCommand extends DisassociateTrunkInterfaceCommand_base {
