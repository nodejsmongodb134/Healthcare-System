...
declare const GetIpamRouteProtectionFindingsCommand_base: {
    new (input: GetIpamRouteProtectionFindingsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRouteProtectionFindingsCommandInput, GetIpamRouteProtectionFindingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamRouteProtectionFindingsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamRouteProtectionFindingsCommandInput, GetIpamRouteProtectionFindingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
