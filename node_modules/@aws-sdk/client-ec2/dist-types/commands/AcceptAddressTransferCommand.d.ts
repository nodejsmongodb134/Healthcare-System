...
declare const AcceptAddressTransferCommand_base: {
    new (input: AcceptAddressTransferCommandInput): import("@smithy/core/client").CommandImpl<AcceptAddressTransferCommandInput, AcceptAddressTransferCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptAddressTransferCommandInput): import("@smithy/core/client").CommandImpl<AcceptAddressTransferCommandInput, AcceptAddressTransferCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * const input = { // AcceptAddressTransferRequest
