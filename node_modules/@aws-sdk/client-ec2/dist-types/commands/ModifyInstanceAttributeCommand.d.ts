...
import type { ModifyInstanceAttributeRequest } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyInstanceAttributeCommand_base: {
    new (input: ModifyInstanceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceAttributeCommandInput, ModifyInstanceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyInstanceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceAttributeCommandInput, ModifyInstanceAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyInstanceAttributeCommand extends ModifyInstanceAttributeCommand_base {
