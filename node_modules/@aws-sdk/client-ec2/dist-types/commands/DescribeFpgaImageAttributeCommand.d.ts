...
import type { DescribeFpgaImageAttributeRequest, DescribeFpgaImageAttributeResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeFpgaImageAttributeCommand_base: {
    new (input: DescribeFpgaImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeFpgaImageAttributeCommandInput, DescribeFpgaImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFpgaImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeFpgaImageAttributeCommandInput, DescribeFpgaImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeFpgaImageAttributeCommand extends DescribeFpgaImageAttributeCommand_base {
