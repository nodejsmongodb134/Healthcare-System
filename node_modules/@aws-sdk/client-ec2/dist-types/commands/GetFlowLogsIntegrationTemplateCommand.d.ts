...
import type { GetFlowLogsIntegrationTemplateRequest, GetFlowLogsIntegrationTemplateResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetFlowLogsIntegrationTemplateCommand_base: {
    new (input: GetFlowLogsIntegrationTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetFlowLogsIntegrationTemplateCommandInput, GetFlowLogsIntegrationTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFlowLogsIntegrationTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetFlowLogsIntegrationTemplateCommandInput, GetFlowLogsIntegrationTemplateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
