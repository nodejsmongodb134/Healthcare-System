...
declare const AdvertiseByoipCidrCommand_base: {
    new (input: AdvertiseByoipCidrCommandInput): import("@smithy/core/client").CommandImpl<AdvertiseByoipCidrCommandInput, AdvertiseByoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdvertiseByoipCidrCommandInput): import("@smithy/core/client").CommandImpl<AdvertiseByoipCidrCommandInput, AdvertiseByoipCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
