...
declare const AssociateIpamByoasnCommand_base: {
    new (input: AssociateIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<AssociateIpamByoasnCommandInput, AssociateIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<AssociateIpamByoasnCommandInput, AssociateIpamByoasnCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
