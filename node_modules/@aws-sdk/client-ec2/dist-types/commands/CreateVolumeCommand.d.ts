...
declare const CreateVolumeCommand_base: {
    new (input: CreateVolumeCommandInput): import("@smithy/core/client").CommandImpl<CreateVolumeCommandInput, CreateVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateVolumeCommandInput]): import("@smithy/core/client").CommandImpl<CreateVolumeCommandInput, CreateVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
