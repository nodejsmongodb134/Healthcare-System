...
declare const DescribeIpamResourceDiscoveriesCommand_base: {
    new (input: DescribeIpamResourceDiscoveriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamResourceDiscoveriesCommandInput, DescribeIpamResourceDiscoveriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamResourceDiscoveriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamResourceDiscoveriesCommandInput, DescribeIpamResourceDiscoveriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
