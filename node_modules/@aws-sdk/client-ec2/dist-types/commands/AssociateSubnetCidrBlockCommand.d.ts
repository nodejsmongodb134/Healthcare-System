...
import type { AssociateSubnetCidrBlockRequest, AssociateSubnetCidrBlockResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateSubnetCidrBlockCommand_base: {
    new (input: AssociateSubnetCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<AssociateSubnetCidrBlockCommandInput, AssociateSubnetCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateSubnetCidrBlockCommandInput): import("@smithy/core/client").CommandImpl<AssociateSubnetCidrBlockCommandInput, AssociateSubnetCidrBlockCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
