...
declare const DescribeClientVpnTargetNetworksCommand_base: {
    new (input: DescribeClientVpnTargetNetworksCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnTargetNetworksCommandInput, DescribeClientVpnTargetNetworksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClientVpnTargetNetworksCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnTargetNetworksCommandInput, DescribeClientVpnTargetNetworksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
