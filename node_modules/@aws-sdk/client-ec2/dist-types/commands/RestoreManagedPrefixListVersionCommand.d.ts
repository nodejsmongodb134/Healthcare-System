...
import type { RestoreManagedPrefixListVersionRequest, RestoreManagedPrefixListVersionResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RestoreManagedPrefixListVersionCommand_base: {
    new (input: RestoreManagedPrefixListVersionCommandInput): import("@smithy/core/client").CommandImpl<RestoreManagedPrefixListVersionCommandInput, RestoreManagedPrefixListVersionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreManagedPrefixListVersionCommandInput): import("@smithy/core/client").CommandImpl<RestoreManagedPrefixListVersionCommandInput, RestoreManagedPrefixListVersionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
