...
declare const DeleteTransitGatewayConnectCommand_base: {
    new (input: DeleteTransitGatewayConnectCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayConnectCommandInput, DeleteTransitGatewayConnectCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayConnectCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayConnectCommandInput, DeleteTransitGatewayConnectCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
