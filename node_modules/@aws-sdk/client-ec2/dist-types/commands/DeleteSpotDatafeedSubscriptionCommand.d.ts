...
declare const DeleteSpotDatafeedSubscriptionCommand_base: {
    new (input: DeleteSpotDatafeedSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DeleteSpotDatafeedSubscriptionCommandInput, DeleteSpotDatafeedSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteSpotDatafeedSubscriptionCommandInput]): import("@smithy/core/client").CommandImpl<DeleteSpotDatafeedSubscriptionCommandInput, DeleteSpotDatafeedSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
