...
declare const DescribeRegionsCommand_base: {
    new (input: DescribeRegionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeRegionsCommandInput, DescribeRegionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRegionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRegionsCommandInput, DescribeRegionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
