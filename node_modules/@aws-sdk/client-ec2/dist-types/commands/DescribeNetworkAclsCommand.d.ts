...
import type { DescribeNetworkAclsRequest, DescribeNetworkAclsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNetworkAclsCommand_base: {
    new (input: DescribeNetworkAclsCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkAclsCommandInput, DescribeNetworkAclsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkAclsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkAclsCommandInput, DescribeNetworkAclsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
