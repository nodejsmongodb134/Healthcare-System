...
import type { ResetAddressAttributeRequest, ResetAddressAttributeResult } from "../models/models_8";
/**
 * @public
 */
...
declare const ResetAddressAttributeCommand_base: {
    new (input: ResetAddressAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetAddressAttributeCommandInput, ResetAddressAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetAddressAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetAddressAttributeCommandInput, ResetAddressAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
