...
import type { DescribeVpcsRequest, DescribeVpcsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcsCommand_base: {
    new (input: DescribeVpcsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcsCommandInput, DescribeVpcsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcsCommandInput, DescribeVpcsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
