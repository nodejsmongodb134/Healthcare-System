...
import type { MoveCapacityReservationInstancesRequest, MoveCapacityReservationInstancesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const MoveCapacityReservationInstancesCommand_base: {
    new (input: MoveCapacityReservationInstancesCommandInput): import("@smithy/core/client").CommandImpl<MoveCapacityReservationInstancesCommandInput, MoveCapacityReservationInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: MoveCapacityReservationInstancesCommandInput): import("@smithy/core/client").CommandImpl<MoveCapacityReservationInstancesCommandInput, MoveCapacityReservationInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
