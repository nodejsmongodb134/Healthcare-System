...
declare const CreateSpotDatafeedSubscriptionCommand_base: {
    new (input: CreateSpotDatafeedSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<CreateSpotDatafeedSubscriptionCommandInput, CreateSpotDatafeedSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSpotDatafeedSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<CreateSpotDatafeedSubscriptionCommandInput, CreateSpotDatafeedSubscriptionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
