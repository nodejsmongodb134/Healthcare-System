...
declare const DeletePublicIpv4PoolCommand_base: {
    new (input: DeletePublicIpv4PoolCommandInput): import("@smithy/core/client").CommandImpl<DeletePublicIpv4PoolCommandInput, DeletePublicIpv4PoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePublicIpv4PoolCommandInput): import("@smithy/core/client").CommandImpl<DeletePublicIpv4PoolCommandInput, DeletePublicIpv4PoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
