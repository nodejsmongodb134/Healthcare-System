...
import type { DeleteCarrierGatewayRequest, DeleteCarrierGatewayResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteCarrierGatewayCommand_base: {
    new (input: DeleteCarrierGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteCarrierGatewayCommandInput, DeleteCarrierGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCarrierGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteCarrierGatewayCommandInput, DeleteCarrierGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteCarrierGatewayCommand extends DeleteCarrierGatewayCommand_base {
