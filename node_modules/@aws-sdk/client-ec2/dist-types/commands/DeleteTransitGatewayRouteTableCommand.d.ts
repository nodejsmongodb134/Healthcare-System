...
declare const DeleteTransitGatewayRouteTableCommand_base: {
    new (input: DeleteTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayRouteTableCommandInput, DeleteTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayRouteTableCommandInput, DeleteTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
