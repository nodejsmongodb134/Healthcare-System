...
import type { ImportKeyPairRequest, ImportKeyPairResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ImportKeyPairCommand_base: {
    new (input: ImportKeyPairCommandInput): import("@smithy/core/client").CommandImpl<ImportKeyPairCommandInput, ImportKeyPairCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportKeyPairCommandInput): import("@smithy/core/client").CommandImpl<ImportKeyPairCommandInput, ImportKeyPairCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
