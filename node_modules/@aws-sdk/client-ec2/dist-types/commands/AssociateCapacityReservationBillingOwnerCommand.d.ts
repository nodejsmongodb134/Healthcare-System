...
declare const AssociateCapacityReservationBillingOwnerCommand_base: {
    new (input: AssociateCapacityReservationBillingOwnerCommandInput): import("@smithy/core/client").CommandImpl<AssociateCapacityReservationBillingOwnerCommandInput, AssociateCapacityReservationBillingOwnerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateCapacityReservationBillingOwnerCommandInput): import("@smithy/core/client").CommandImpl<AssociateCapacityReservationBillingOwnerCommandInput, AssociateCapacityReservationBillingOwnerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
