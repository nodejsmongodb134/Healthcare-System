...
import type { GetManagedPrefixListEntriesRequest, GetManagedPrefixListEntriesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetManagedPrefixListEntriesCommand_base: {
    new (input: GetManagedPrefixListEntriesCommandInput): import("@smithy/core/client").CommandImpl<GetManagedPrefixListEntriesCommandInput, GetManagedPrefixListEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetManagedPrefixListEntriesCommandInput): import("@smithy/core/client").CommandImpl<GetManagedPrefixListEntriesCommandInput, GetManagedPrefixListEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
