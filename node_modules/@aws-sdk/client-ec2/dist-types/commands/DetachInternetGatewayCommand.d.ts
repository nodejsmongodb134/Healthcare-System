...
declare const DetachInternetGatewayCommand_base: {
    new (input: DetachInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<DetachInternetGatewayCommandInput, DetachInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<DetachInternetGatewayCommandInput, DetachInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
