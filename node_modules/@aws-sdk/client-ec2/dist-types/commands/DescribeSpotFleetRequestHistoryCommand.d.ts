...
import type { DescribeSpotFleetRequestHistoryRequest, DescribeSpotFleetRequestHistoryResponse } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSpotFleetRequestHistoryCommand_base: {
    new (input: DescribeSpotFleetRequestHistoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetRequestHistoryCommandInput, DescribeSpotFleetRequestHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSpotFleetRequestHistoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetRequestHistoryCommandInput, DescribeSpotFleetRequestHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
