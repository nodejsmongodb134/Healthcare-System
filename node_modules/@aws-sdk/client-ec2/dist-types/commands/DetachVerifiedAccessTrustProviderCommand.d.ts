...
import type { DetachVerifiedAccessTrustProviderRequest, DetachVerifiedAccessTrustProviderResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DetachVerifiedAccessTrustProviderCommand_base: {
    new (input: DetachVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<DetachVerifiedAccessTrustProviderCommandInput, DetachVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<DetachVerifiedAccessTrustProviderCommandInput, DetachVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
