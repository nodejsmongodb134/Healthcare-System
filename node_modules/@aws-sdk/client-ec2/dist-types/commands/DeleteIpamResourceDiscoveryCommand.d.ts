...
declare const DeleteIpamResourceDiscoveryCommand_base: {
    new (input: DeleteIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamResourceDiscoveryCommandInput, DeleteIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamResourceDiscoveryCommandInput, DeleteIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
