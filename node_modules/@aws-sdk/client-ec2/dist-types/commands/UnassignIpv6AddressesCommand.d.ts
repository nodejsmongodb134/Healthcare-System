...
import type { UnassignIpv6AddressesRequest, UnassignIpv6AddressesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const UnassignIpv6AddressesCommand_base: {
    new (input: UnassignIpv6AddressesCommandInput): import("@smithy/core/client").CommandImpl<UnassignIpv6AddressesCommandInput, UnassignIpv6AddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UnassignIpv6AddressesCommandInput): import("@smithy/core/client").CommandImpl<UnassignIpv6AddressesCommandInput, UnassignIpv6AddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UnassignIpv6AddressesCommand extends UnassignIpv6AddressesCommand_base {
