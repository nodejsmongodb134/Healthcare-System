...
import type { AttachVerifiedAccessTrustProviderRequest, AttachVerifiedAccessTrustProviderResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AttachVerifiedAccessTrustProviderCommand_base: {
    new (input: AttachVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<AttachVerifiedAccessTrustProviderCommandInput, AttachVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<AttachVerifiedAccessTrustProviderCommandInput, AttachVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
