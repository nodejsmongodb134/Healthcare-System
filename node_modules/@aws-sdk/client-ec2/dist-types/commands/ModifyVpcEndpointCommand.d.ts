...
import type { ModifyVpcEndpointRequest, ModifyVpcEndpointResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEndpointCommand_base: {
    new (input: ModifyVpcEndpointCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointCommandInput, ModifyVpcEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEndpointCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointCommandInput, ModifyVpcEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
