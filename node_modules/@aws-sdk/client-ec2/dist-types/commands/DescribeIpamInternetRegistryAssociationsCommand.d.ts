...
import type { DescribeIpamInternetRegistryAssociationsRequest, DescribeIpamInternetRegistryAssociationsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeIpamInternetRegistryAssociationsCommand_base: {
    new (input: DescribeIpamInternetRegistryAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamInternetRegistryAssociationsCommandInput, DescribeIpamInternetRegistryAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamInternetRegistryAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamInternetRegistryAssociationsCommandInput, DescribeIpamInternetRegistryAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
