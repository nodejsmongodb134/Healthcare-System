...
import type { CreateReplaceRootVolumeTaskRequest, CreateReplaceRootVolumeTaskResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateReplaceRootVolumeTaskCommand_base: {
    new (input: CreateReplaceRootVolumeTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateReplaceRootVolumeTaskCommandInput, CreateReplaceRootVolumeTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateReplaceRootVolumeTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateReplaceRootVolumeTaskCommandInput, CreateReplaceRootVolumeTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
