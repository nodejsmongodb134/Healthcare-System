...
import type { DescribeCapacityBlockExtensionOfferingsRequest, DescribeCapacityBlockExtensionOfferingsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityBlockExtensionOfferingsCommand_base: {
    new (input: DescribeCapacityBlockExtensionOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockExtensionOfferingsCommandInput, DescribeCapacityBlockExtensionOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCapacityBlockExtensionOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockExtensionOfferingsCommandInput, DescribeCapacityBlockExtensionOfferingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
