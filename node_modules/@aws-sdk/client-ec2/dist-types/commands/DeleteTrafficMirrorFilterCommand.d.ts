...
import type { DeleteTrafficMirrorFilterRequest, DeleteTrafficMirrorFilterResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteTrafficMirrorFilterCommand_base: {
    new (input: DeleteTrafficMirrorFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficMirrorFilterCommandInput, DeleteTrafficMirrorFilterCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrafficMirrorFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficMirrorFilterCommandInput, DeleteTrafficMirrorFilterCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
