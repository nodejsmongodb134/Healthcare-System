...
declare const ModifyLocalGatewayRouteCommand_base: {
    new (input: ModifyLocalGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<ModifyLocalGatewayRouteCommandInput, ModifyLocalGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyLocalGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<ModifyLocalGatewayRouteCommandInput, ModifyLocalGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyLocalGatewayRouteCommand extends ModifyLocalGatewayRouteCommand_base {
