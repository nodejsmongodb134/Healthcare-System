...
declare const DescribeAddressesAttributeCommand_base: {
    new (input: DescribeAddressesAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeAddressesAttributeCommandInput, DescribeAddressesAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAddressesAttributeCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAddressesAttributeCommandInput, DescribeAddressesAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
