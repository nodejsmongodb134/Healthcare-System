...
import type { DescribeCapacityReservationFleetsRequest, DescribeCapacityReservationFleetsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityReservationFleetsCommand_base: {
    new (input: DescribeCapacityReservationFleetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationFleetsCommandInput, DescribeCapacityReservationFleetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityReservationFleetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityReservationFleetsCommandInput, DescribeCapacityReservationFleetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
