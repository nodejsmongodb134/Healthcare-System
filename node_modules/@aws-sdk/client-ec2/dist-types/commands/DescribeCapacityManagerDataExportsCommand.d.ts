...
import type { DescribeCapacityManagerDataExportsRequest, DescribeCapacityManagerDataExportsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityManagerDataExportsCommand_base: {
    new (input: DescribeCapacityManagerDataExportsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityManagerDataExportsCommandInput, DescribeCapacityManagerDataExportsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityManagerDataExportsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityManagerDataExportsCommandInput, DescribeCapacityManagerDataExportsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
