...
import type { GetTransitGatewayPolicyTableAssociationsRequest, GetTransitGatewayPolicyTableAssociationsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayPolicyTableAssociationsCommand_base: {
    new (input: GetTransitGatewayPolicyTableAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayPolicyTableAssociationsCommandInput, GetTransitGatewayPolicyTableAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayPolicyTableAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayPolicyTableAssociationsCommandInput, GetTransitGatewayPolicyTableAssociationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
