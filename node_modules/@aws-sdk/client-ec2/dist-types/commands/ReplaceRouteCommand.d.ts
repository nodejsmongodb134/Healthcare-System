...
import type { ReplaceRouteRequest } from "../models/models_7";
/**
 * @public
 */
...
declare const ReplaceRouteCommand_base: {
    new (input: ReplaceRouteCommandInput): import("@smithy/core/client").CommandImpl<ReplaceRouteCommandInput, ReplaceRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceRouteCommandInput): import("@smithy/core/client").CommandImpl<ReplaceRouteCommandInput, ReplaceRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
