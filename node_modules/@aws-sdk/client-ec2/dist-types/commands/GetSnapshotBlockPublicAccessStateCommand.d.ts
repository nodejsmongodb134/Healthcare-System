...
import type { GetSnapshotBlockPublicAccessStateRequest, GetSnapshotBlockPublicAccessStateResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetSnapshotBlockPublicAccessStateCommand_base: {
    new (input: GetSnapshotBlockPublicAccessStateCommandInput): import("@smithy/core/client").CommandImpl<GetSnapshotBlockPublicAccessStateCommandInput, GetSnapshotBlockPublicAccessStateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetSnapshotBlockPublicAccessStateCommandInput]): import("@smithy/core/client").CommandImpl<GetSnapshotBlockPublicAccessStateCommandInput, GetSnapshotBlockPublicAccessStateCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
