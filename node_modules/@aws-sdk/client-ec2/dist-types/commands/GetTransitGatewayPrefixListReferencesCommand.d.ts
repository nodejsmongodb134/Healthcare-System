...
import type { GetTransitGatewayPrefixListReferencesRequest, GetTransitGatewayPrefixListReferencesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayPrefixListReferencesCommand_base: {
    new (input: GetTransitGatewayPrefixListReferencesCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayPrefixListReferencesCommandInput, GetTransitGatewayPrefixListReferencesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayPrefixListReferencesCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayPrefixListReferencesCommandInput, GetTransitGatewayPrefixListReferencesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
