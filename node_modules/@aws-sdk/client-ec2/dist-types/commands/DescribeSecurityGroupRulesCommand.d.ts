...
import type { DescribeSecurityGroupRulesRequest, DescribeSecurityGroupRulesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSecurityGroupRulesCommand_base: {
    new (input: DescribeSecurityGroupRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupRulesCommandInput, DescribeSecurityGroupRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecurityGroupRulesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupRulesCommandInput, DescribeSecurityGroupRulesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
