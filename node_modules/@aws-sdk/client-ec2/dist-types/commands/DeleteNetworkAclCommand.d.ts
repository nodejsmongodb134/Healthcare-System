...
import type { DeleteNetworkAclRequest } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteNetworkAclCommand_base: {
    new (input: DeleteNetworkAclCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkAclCommandInput, DeleteNetworkAclCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNetworkAclCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkAclCommandInput, DeleteNetworkAclCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
