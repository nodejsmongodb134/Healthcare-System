...
declare const DescribeCoipPoolsCommand_base: {
    new (input: DescribeCoipPoolsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCoipPoolsCommandInput, DescribeCoipPoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCoipPoolsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCoipPoolsCommandInput, DescribeCoipPoolsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
