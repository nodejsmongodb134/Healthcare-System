...
import type { ModifyVpcBlockPublicAccessOptionsRequest, ModifyVpcBlockPublicAccessOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcBlockPublicAccessOptionsCommand_base: {
    new (input: ModifyVpcBlockPublicAccessOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcBlockPublicAccessOptionsCommandInput, ModifyVpcBlockPublicAccessOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcBlockPublicAccessOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcBlockPublicAccessOptionsCommandInput, ModifyVpcBlockPublicAccessOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
