...
import type { DisassociateRouteServerRequest, DisassociateRouteServerResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateRouteServerCommand_base: {
    new (input: DisassociateRouteServerCommandInput): import("@smithy/core/client").CommandImpl<DisassociateRouteServerCommandInput, DisassociateRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateRouteServerCommandInput): import("@smithy/core/client").CommandImpl<DisassociateRouteServerCommandInput, DisassociateRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
