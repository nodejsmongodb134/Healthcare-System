...
import type { ModifyVpcEndpointServiceConfigurationRequest, ModifyVpcEndpointServiceConfigurationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEndpointServiceConfigurationCommand_base: {
    new (input: ModifyVpcEndpointServiceConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointServiceConfigurationCommandInput, ModifyVpcEndpointServiceConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEndpointServiceConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointServiceConfigurationCommandInput, ModifyVpcEndpointServiceConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
