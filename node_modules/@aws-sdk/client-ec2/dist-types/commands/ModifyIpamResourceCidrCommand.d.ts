...
import type { ModifyIpamResourceCidrRequest, ModifyIpamResourceCidrResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamResourceCidrCommand_base: {
    new (input: ModifyIpamResourceCidrCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamResourceCidrCommandInput, ModifyIpamResourceCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamResourceCidrCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamResourceCidrCommandInput, ModifyIpamResourceCidrCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyIpamResourceCidrCommand extends ModifyIpamResourceCidrCommand_base {
