...
import type { EnableImageDeregistrationProtectionRequest, EnableImageDeregistrationProtectionResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableImageDeregistrationProtectionCommand_base: {
    new (input: EnableImageDeregistrationProtectionCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeregistrationProtectionCommandInput, EnableImageDeregistrationProtectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableImageDeregistrationProtectionCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeregistrationProtectionCommandInput, EnableImageDeregistrationProtectionCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
