...
import type { ModifyVerifiedAccessInstanceRequest, ModifyVerifiedAccessInstanceResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVerifiedAccessInstanceCommand_base: {
    new (input: ModifyVerifiedAccessInstanceCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessInstanceCommandInput, ModifyVerifiedAccessInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVerifiedAccessInstanceCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessInstanceCommandInput, ModifyVerifiedAccessInstanceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
