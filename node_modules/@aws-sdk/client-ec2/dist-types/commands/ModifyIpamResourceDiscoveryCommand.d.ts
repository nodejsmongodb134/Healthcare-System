...
import type { ModifyIpamResourceDiscoveryRequest, ModifyIpamResourceDiscoveryResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamResourceDiscoveryCommand_base: {
    new (input: ModifyIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamResourceDiscoveryCommandInput, ModifyIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyIpamResourceDiscoveryCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamResourceDiscoveryCommandInput, ModifyIpamResourceDiscoveryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyIpamResourceDiscoveryCommand extends ModifyIpamResourceDiscoveryCommand_base {
