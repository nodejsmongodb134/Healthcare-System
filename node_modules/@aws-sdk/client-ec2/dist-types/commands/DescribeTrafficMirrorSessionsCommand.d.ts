...
declare const DescribeTrafficMirrorSessionsCommand_base: {
    new (input: DescribeTrafficMirrorSessionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorSessionsCommandInput, DescribeTrafficMirrorSessionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrafficMirrorSessionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorSessionsCommandInput, DescribeTrafficMirrorSessionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
