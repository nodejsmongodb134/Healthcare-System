...
import type { GetTransitGatewayMeteringPolicyEntriesRequest, GetTransitGatewayMeteringPolicyEntriesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayMeteringPolicyEntriesCommand_base: {
    new (input: GetTransitGatewayMeteringPolicyEntriesCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayMeteringPolicyEntriesCommandInput, GetTransitGatewayMeteringPolicyEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransitGatewayMeteringPolicyEntriesCommandInput): import("@smithy/core/client").CommandImpl<GetTransitGatewayMeteringPolicyEntriesCommandInput, GetTransitGatewayMeteringPolicyEntriesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
