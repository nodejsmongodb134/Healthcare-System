...
import type { DescribeFlowLogsRequest, DescribeFlowLogsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeFlowLogsCommand_base: {
    new (input: DescribeFlowLogsCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlowLogsCommandInput, DescribeFlowLogsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeFlowLogsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeFlowLogsCommandInput, DescribeFlowLogsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
