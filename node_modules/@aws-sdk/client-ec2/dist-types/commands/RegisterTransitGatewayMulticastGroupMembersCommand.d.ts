...
import type { RegisterTransitGatewayMulticastGroupMembersRequest, RegisterTransitGatewayMulticastGroupMembersResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RegisterTransitGatewayMulticastGroupMembersCommand_base: {
    new (input: RegisterTransitGatewayMulticastGroupMembersCommandInput): import("@smithy/core/client").CommandImpl<RegisterTransitGatewayMulticastGroupMembersCommandInput, RegisterTransitGatewayMulticastGroupMembersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterTransitGatewayMulticastGroupMembersCommandInput): import("@smithy/core/client").CommandImpl<RegisterTransitGatewayMulticastGroupMembersCommandInput, RegisterTransitGatewayMulticastGroupMembersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
