...
import type { StopInstancesRequest, StopInstancesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const StopInstancesCommand_base: {
    new (input: StopInstancesCommandInput): import("@smithy/core/client").CommandImpl<StopInstancesCommandInput, StopInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopInstancesCommandInput): import("@smithy/core/client").CommandImpl<StopInstancesCommandInput, StopInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopInstancesCommand extends StopInstancesCommand_base {
