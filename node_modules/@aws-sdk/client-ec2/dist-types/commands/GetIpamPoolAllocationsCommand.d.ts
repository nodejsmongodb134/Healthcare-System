...
declare const GetIpamPoolAllocationsCommand_base: {
    new (input: GetIpamPoolAllocationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPoolAllocationsCommandInput, GetIpamPoolAllocationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamPoolAllocationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPoolAllocationsCommandInput, GetIpamPoolAllocationsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
