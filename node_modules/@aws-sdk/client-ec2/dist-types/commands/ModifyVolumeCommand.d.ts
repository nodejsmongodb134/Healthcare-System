...
declare const ModifyVolumeCommand_base: {
    new (input: ModifyVolumeCommandInput): import("@smithy/core/client").CommandImpl<ModifyVolumeCommandInput, ModifyVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVolumeCommandInput): import("@smithy/core/client").CommandImpl<ModifyVolumeCommandInput, ModifyVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
