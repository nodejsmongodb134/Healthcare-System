...
declare const DeleteTransitGatewayMeteringPolicyEntryCommand_base: {
    new (input: DeleteTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayMeteringPolicyEntryCommandInput, DeleteTransitGatewayMeteringPolicyEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayMeteringPolicyEntryCommandInput, DeleteTransitGatewayMeteringPolicyEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
