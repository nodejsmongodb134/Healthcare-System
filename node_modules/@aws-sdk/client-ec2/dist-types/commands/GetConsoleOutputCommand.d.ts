...
declare const GetConsoleOutputCommand_base: {
    new (input: GetConsoleOutputCommandInput): import("@smithy/core/client").CommandImpl<GetConsoleOutputCommandInput, GetConsoleOutputCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConsoleOutputCommandInput): import("@smithy/core/client").CommandImpl<GetConsoleOutputCommandInput, GetConsoleOutputCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
