...
declare const CreateNatGatewayCommand_base: {
    new (input: CreateNatGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateNatGatewayCommandInput, CreateNatGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateNatGatewayCommandInput]): import("@smithy/core/client").CommandImpl<CreateNatGatewayCommandInput, CreateNatGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateNatGatewayCommand extends CreateNatGatewayCommand_base {
