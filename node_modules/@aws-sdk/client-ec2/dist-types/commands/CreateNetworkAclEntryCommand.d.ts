...
declare const CreateNetworkAclEntryCommand_base: {
    new (input: CreateNetworkAclEntryCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkAclEntryCommandInput, CreateNetworkAclEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNetworkAclEntryCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkAclEntryCommandInput, CreateNetworkAclEntryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
