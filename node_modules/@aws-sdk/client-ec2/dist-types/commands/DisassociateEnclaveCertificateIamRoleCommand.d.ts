...
import type { DisassociateEnclaveCertificateIamRoleRequest, DisassociateEnclaveCertificateIamRoleResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateEnclaveCertificateIamRoleCommand_base: {
    new (input: DisassociateEnclaveCertificateIamRoleCommandInput): import("@smithy/core/client").CommandImpl<DisassociateEnclaveCertificateIamRoleCommandInput, DisassociateEnclaveCertificateIamRoleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateEnclaveCertificateIamRoleCommandInput): import("@smithy/core/client").CommandImpl<DisassociateEnclaveCertificateIamRoleCommandInput, DisassociateEnclaveCertificateIamRoleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
