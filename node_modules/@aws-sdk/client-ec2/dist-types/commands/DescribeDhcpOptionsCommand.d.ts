...
import type { DescribeDhcpOptionsRequest, DescribeDhcpOptionsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeDhcpOptionsCommand_base: {
    new (input: DescribeDhcpOptionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDhcpOptionsCommandInput, DescribeDhcpOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDhcpOptionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDhcpOptionsCommandInput, DescribeDhcpOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
