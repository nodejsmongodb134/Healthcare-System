...
import type { DisassociateClientVpnTargetNetworkRequest, DisassociateClientVpnTargetNetworkResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateClientVpnTargetNetworkCommand_base: {
    new (input: DisassociateClientVpnTargetNetworkCommandInput): import("@smithy/core/client").CommandImpl<DisassociateClientVpnTargetNetworkCommandInput, DisassociateClientVpnTargetNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateClientVpnTargetNetworkCommandInput): import("@smithy/core/client").CommandImpl<DisassociateClientVpnTargetNetworkCommandInput, DisassociateClientVpnTargetNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateClientVpnTargetNetworkCommand extends DisassociateClientVpnTargetNetworkCommand_base {
