...
declare const ModifyCapacityReservationCommand_base: {
    new (input: ModifyCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<ModifyCapacityReservationCommandInput, ModifyCapacityReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<ModifyCapacityReservationCommandInput, ModifyCapacityReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
