...
declare const DescribeTrafficMirrorTargetsCommand_base: {
    new (input: DescribeTrafficMirrorTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorTargetsCommandInput, DescribeTrafficMirrorTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrafficMirrorTargetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorTargetsCommandInput, DescribeTrafficMirrorTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
