...
declare const DescribeAddressTransfersCommand_base: {
    new (input: DescribeAddressTransfersCommandInput): import("@smithy/core/client").CommandImpl<DescribeAddressTransfersCommandInput, DescribeAddressTransfersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAddressTransfersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAddressTransfersCommandInput, DescribeAddressTransfersCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
