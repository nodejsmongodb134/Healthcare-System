...
declare const DisableImageBlockPublicAccessCommand_base: {
    new (input: DisableImageBlockPublicAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableImageBlockPublicAccessCommandInput, DisableImageBlockPublicAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableImageBlockPublicAccessCommandInput]): import("@smithy/core/client").CommandImpl<DisableImageBlockPublicAccessCommandInput, DisableImageBlockPublicAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
