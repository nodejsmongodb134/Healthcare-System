...
import type { CreateTransitGatewayRequest, CreateTransitGatewayResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayCommand_base: {
    new (input: CreateTransitGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayCommandInput, CreateTransitGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateTransitGatewayCommandInput]): import("@smithy/core/client").CommandImpl<CreateTransitGatewayCommandInput, CreateTransitGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
