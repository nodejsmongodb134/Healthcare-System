...
import type { DescribeSnapshotAttributeRequest, DescribeSnapshotAttributeResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSnapshotAttributeCommand_base: {
    new (input: DescribeSnapshotAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeSnapshotAttributeCommandInput, DescribeSnapshotAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSnapshotAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeSnapshotAttributeCommandInput, DescribeSnapshotAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
