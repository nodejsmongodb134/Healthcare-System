...
import type { CreateRouteRequest, CreateRouteResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateRouteCommand_base: {
    new (input: CreateRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteCommandInput, CreateRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteCommandInput, CreateRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
