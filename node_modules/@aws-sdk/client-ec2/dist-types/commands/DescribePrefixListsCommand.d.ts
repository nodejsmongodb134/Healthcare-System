...
import type { DescribePrefixListsRequest, DescribePrefixListsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribePrefixListsCommand_base: {
    new (input: DescribePrefixListsCommandInput): import("@smithy/core/client").CommandImpl<DescribePrefixListsCommandInput, DescribePrefixListsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribePrefixListsCommandInput]): import("@smithy/core/client").CommandImpl<DescribePrefixListsCommandInput, DescribePrefixListsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
