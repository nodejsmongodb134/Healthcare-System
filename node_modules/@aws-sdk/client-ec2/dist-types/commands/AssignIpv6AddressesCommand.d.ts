...
declare const AssignIpv6AddressesCommand_base: {
    new (input: AssignIpv6AddressesCommandInput): import("@smithy/core/client").CommandImpl<AssignIpv6AddressesCommandInput, AssignIpv6AddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssignIpv6AddressesCommandInput): import("@smithy/core/client").CommandImpl<AssignIpv6AddressesCommandInput, AssignIpv6AddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
