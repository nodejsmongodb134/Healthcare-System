...
import type { ModifyClientVpnEndpointRequest, ModifyClientVpnEndpointResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyClientVpnEndpointCommand_base: {
    new (input: ModifyClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<ModifyClientVpnEndpointCommandInput, ModifyClientVpnEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<ModifyClientVpnEndpointCommandInput, ModifyClientVpnEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyClientVpnEndpointCommand extends ModifyClientVpnEndpointCommand_base {
