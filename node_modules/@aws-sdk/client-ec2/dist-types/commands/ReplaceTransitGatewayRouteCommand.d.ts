...
declare const ReplaceTransitGatewayRouteCommand_base: {
    new (input: ReplaceTransitGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<ReplaceTransitGatewayRouteCommandInput, ReplaceTransitGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceTransitGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<ReplaceTransitGatewayRouteCommandInput, ReplaceTransitGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
