...
declare const DescribeIdFormatCommand_base: {
    new (input: DescribeIdFormatCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdFormatCommandInput, DescribeIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIdFormatCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIdFormatCommandInput, DescribeIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
