...
import type { DescribeNetworkInterfacePermissionsRequest, DescribeNetworkInterfacePermissionsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeNetworkInterfacePermissionsCommand_base: {
    new (input: DescribeNetworkInterfacePermissionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfacePermissionsCommandInput, DescribeNetworkInterfacePermissionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInterfacePermissionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfacePermissionsCommandInput, DescribeNetworkInterfacePermissionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
