...
import type { CreateRouteServerEndpointRequest, CreateRouteServerEndpointResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateRouteServerEndpointCommand_base: {
    new (input: CreateRouteServerEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteServerEndpointCommandInput, CreateRouteServerEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteServerEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteServerEndpointCommandInput, CreateRouteServerEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
