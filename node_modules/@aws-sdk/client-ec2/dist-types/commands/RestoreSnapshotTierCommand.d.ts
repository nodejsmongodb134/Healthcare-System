...
import type { RestoreSnapshotTierRequest, RestoreSnapshotTierResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RestoreSnapshotTierCommand_base: {
    new (input: RestoreSnapshotTierCommandInput): import("@smithy/core/client").CommandImpl<RestoreSnapshotTierCommandInput, RestoreSnapshotTierCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreSnapshotTierCommandInput): import("@smithy/core/client").CommandImpl<RestoreSnapshotTierCommandInput, RestoreSnapshotTierCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
