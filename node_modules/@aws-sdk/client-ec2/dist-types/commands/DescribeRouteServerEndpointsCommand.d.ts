...
declare const DescribeRouteServerEndpointsCommand_base: {
    new (input: DescribeRouteServerEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteServerEndpointsCommandInput, DescribeRouteServerEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRouteServerEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRouteServerEndpointsCommandInput, DescribeRouteServerEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
