...
declare const DescribeLaunchTemplatesCommand_base: {
    new (input: DescribeLaunchTemplatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLaunchTemplatesCommandInput, DescribeLaunchTemplatesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLaunchTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLaunchTemplatesCommandInput, DescribeLaunchTemplatesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
