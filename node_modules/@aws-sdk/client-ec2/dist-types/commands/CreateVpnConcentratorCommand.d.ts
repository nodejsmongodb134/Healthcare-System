...
import type { CreateVpnConcentratorRequest, CreateVpnConcentratorResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpnConcentratorCommand_base: {
    new (input: CreateVpnConcentratorCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnConcentratorCommandInput, CreateVpnConcentratorCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpnConcentratorCommandInput): import("@smithy/core/client").CommandImpl<CreateVpnConcentratorCommandInput, CreateVpnConcentratorCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
