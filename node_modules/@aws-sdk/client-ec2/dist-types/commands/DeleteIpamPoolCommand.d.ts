...
import type { DeleteIpamPoolRequest, DeleteIpamPoolResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteIpamPoolCommand_base: {
    new (input: DeleteIpamPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPoolCommandInput, DeleteIpamPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIpamPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteIpamPoolCommandInput, DeleteIpamPoolCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
