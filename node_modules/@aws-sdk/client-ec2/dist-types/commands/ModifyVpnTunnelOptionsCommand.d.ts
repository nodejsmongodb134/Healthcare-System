...
import type { ModifyVpnTunnelOptionsRequest, ModifyVpnTunnelOptionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpnTunnelOptionsCommand_base: {
    new (input: ModifyVpnTunnelOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnTunnelOptionsCommandInput, ModifyVpnTunnelOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpnTunnelOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpnTunnelOptionsCommandInput, ModifyVpnTunnelOptionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
