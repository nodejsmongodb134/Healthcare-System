...
import type { CreateTransitGatewayPrefixListReferenceRequest, CreateTransitGatewayPrefixListReferenceResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayPrefixListReferenceCommand_base: {
    new (input: CreateTransitGatewayPrefixListReferenceCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayPrefixListReferenceCommandInput, CreateTransitGatewayPrefixListReferenceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTransitGatewayPrefixListReferenceCommandInput): import("@smithy/core/client").CommandImpl<CreateTransitGatewayPrefixListReferenceCommandInput, CreateTransitGatewayPrefixListReferenceCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
