...
import type { ExportVerifiedAccessInstanceClientConfigurationRequest, ExportVerifiedAccessInstanceClientConfigurationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ExportVerifiedAccessInstanceClientConfigurationCommand_base: {
    new (input: ExportVerifiedAccessInstanceClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportVerifiedAccessInstanceClientConfigurationCommandInput, ExportVerifiedAccessInstanceClientConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportVerifiedAccessInstanceClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportVerifiedAccessInstanceClientConfigurationCommandInput, ExportVerifiedAccessInstanceClientConfigurationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
