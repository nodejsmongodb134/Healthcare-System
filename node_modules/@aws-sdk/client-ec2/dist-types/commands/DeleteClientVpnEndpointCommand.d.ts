...
import type { DeleteClientVpnEndpointRequest, DeleteClientVpnEndpointResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteClientVpnEndpointCommand_base: {
    new (input: DeleteClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteClientVpnEndpointCommandInput, DeleteClientVpnEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteClientVpnEndpointCommandInput, DeleteClientVpnEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteClientVpnEndpointCommand extends DeleteClientVpnEndpointCommand_base {
