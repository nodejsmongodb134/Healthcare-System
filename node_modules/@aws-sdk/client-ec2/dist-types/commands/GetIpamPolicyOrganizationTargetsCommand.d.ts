...
import type { GetIpamPolicyOrganizationTargetsRequest, GetIpamPolicyOrganizationTargetsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamPolicyOrganizationTargetsCommand_base: {
    new (input: GetIpamPolicyOrganizationTargetsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPolicyOrganizationTargetsCommandInput, GetIpamPolicyOrganizationTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIpamPolicyOrganizationTargetsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPolicyOrganizationTargetsCommandInput, GetIpamPolicyOrganizationTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
