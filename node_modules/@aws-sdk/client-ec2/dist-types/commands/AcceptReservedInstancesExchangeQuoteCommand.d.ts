...
import type { AcceptReservedInstancesExchangeQuoteRequest, AcceptReservedInstancesExchangeQuoteResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AcceptReservedInstancesExchangeQuoteCommand_base: {
    new (input: AcceptReservedInstancesExchangeQuoteCommandInput): import("@smithy/core/client").CommandImpl<AcceptReservedInstancesExchangeQuoteCommandInput, AcceptReservedInstancesExchangeQuoteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptReservedInstancesExchangeQuoteCommandInput): import("@smithy/core/client").CommandImpl<AcceptReservedInstancesExchangeQuoteCommandInput, AcceptReservedInstancesExchangeQuoteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
