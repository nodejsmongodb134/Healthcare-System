...
declare const ReleaseHostsCommand_base: {
    new (input: ReleaseHostsCommandInput): import("@smithy/core/client").CommandImpl<ReleaseHostsCommandInput, ReleaseHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReleaseHostsCommandInput): import("@smithy/core/client").CommandImpl<ReleaseHostsCommandInput, ReleaseHostsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
