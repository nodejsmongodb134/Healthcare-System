...
import type { DescribeSecurityGroupReferencesRequest, DescribeSecurityGroupReferencesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeSecurityGroupReferencesCommand_base: {
    new (input: DescribeSecurityGroupReferencesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupReferencesCommandInput, DescribeSecurityGroupReferencesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSecurityGroupReferencesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupReferencesCommandInput, DescribeSecurityGroupReferencesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
