...
declare const DescribeInstanceEventWindowsCommand_base: {
    new (input: DescribeInstanceEventWindowsCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceEventWindowsCommandInput, DescribeInstanceEventWindowsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceEventWindowsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceEventWindowsCommandInput, DescribeInstanceEventWindowsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
