...
import type { DescribeVolumeStatusRequest, DescribeVolumeStatusResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVolumeStatusCommand_base: {
    new (input: DescribeVolumeStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeVolumeStatusCommandInput, DescribeVolumeStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVolumeStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVolumeStatusCommandInput, DescribeVolumeStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
