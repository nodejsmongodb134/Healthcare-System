...
declare const DescribeInternetGatewaysCommand_base: {
    new (input: DescribeInternetGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeInternetGatewaysCommandInput, DescribeInternetGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInternetGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInternetGatewaysCommandInput, DescribeInternetGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
