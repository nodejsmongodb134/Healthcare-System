...
import type { DescribeInstanceConnectEndpointsRequest, DescribeInstanceConnectEndpointsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeInstanceConnectEndpointsCommand_base: {
    new (input: DescribeInstanceConnectEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceConnectEndpointsCommandInput, DescribeInstanceConnectEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceConnectEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceConnectEndpointsCommandInput, DescribeInstanceConnectEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
