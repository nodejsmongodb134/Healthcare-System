...
import type { CreateSnapshotsRequest, CreateSnapshotsResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateSnapshotsCommand_base: {
    new (input: CreateSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<CreateSnapshotsCommandInput, CreateSnapshotsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<CreateSnapshotsCommandInput, CreateSnapshotsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
