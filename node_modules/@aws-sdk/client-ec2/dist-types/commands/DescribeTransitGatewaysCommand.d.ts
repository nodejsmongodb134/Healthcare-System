...
import type { DescribeTransitGatewaysRequest, DescribeTransitGatewaysResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTransitGatewaysCommand_base: {
    new (input: DescribeTransitGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewaysCommandInput, DescribeTransitGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewaysCommandInput, DescribeTransitGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
