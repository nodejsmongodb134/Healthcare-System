...
import type { EnableFastLaunchRequest, EnableFastLaunchResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableFastLaunchCommand_base: {
    new (input: EnableFastLaunchCommandInput): import("@smithy/core/client").CommandImpl<EnableFastLaunchCommandInput, EnableFastLaunchCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableFastLaunchCommandInput): import("@smithy/core/client").CommandImpl<EnableFastLaunchCommandInput, EnableFastLaunchCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
