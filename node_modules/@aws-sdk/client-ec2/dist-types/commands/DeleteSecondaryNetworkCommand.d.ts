...
import type { DeleteSecondaryNetworkRequest, DeleteSecondaryNetworkResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteSecondaryNetworkCommand_base: {
    new (input: DeleteSecondaryNetworkCommandInput): import("@smithy/core/client").CommandImpl<DeleteSecondaryNetworkCommandInput, DeleteSecondaryNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSecondaryNetworkCommandInput): import("@smithy/core/client").CommandImpl<DeleteSecondaryNetworkCommandInput, DeleteSecondaryNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
