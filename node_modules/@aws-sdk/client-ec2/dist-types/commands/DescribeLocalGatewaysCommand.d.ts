...
declare const DescribeLocalGatewaysCommand_base: {
    new (input: DescribeLocalGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeLocalGatewaysCommandInput, DescribeLocalGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLocalGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLocalGatewaysCommandInput, DescribeLocalGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
