...
import type { DescribeIpamPrefixListResolverTargetsRequest, DescribeIpamPrefixListResolverTargetsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeIpamPrefixListResolverTargetsCommand_base: {
    new (input: DescribeIpamPrefixListResolverTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPrefixListResolverTargetsCommandInput, DescribeIpamPrefixListResolverTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPrefixListResolverTargetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPrefixListResolverTargetsCommandInput, DescribeIpamPrefixListResolverTargetsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
