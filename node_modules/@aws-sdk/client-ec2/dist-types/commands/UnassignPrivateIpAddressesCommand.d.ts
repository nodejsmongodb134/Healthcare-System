...
import type { UnassignPrivateIpAddressesRequest } from "../models/models_8";
/**
 * @public
 */
...
declare const UnassignPrivateIpAddressesCommand_base: {
    new (input: UnassignPrivateIpAddressesCommandInput): import("@smithy/core/client").CommandImpl<UnassignPrivateIpAddressesCommandInput, UnassignPrivateIpAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UnassignPrivateIpAddressesCommandInput): import("@smithy/core/client").CommandImpl<UnassignPrivateIpAddressesCommandInput, UnassignPrivateIpAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
