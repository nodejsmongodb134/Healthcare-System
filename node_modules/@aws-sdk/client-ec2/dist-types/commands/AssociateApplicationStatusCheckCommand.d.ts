...
declare const AssociateApplicationStatusCheckCommand_base: {
    new (input: AssociateApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<AssociateApplicationStatusCheckCommandInput, AssociateApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateApplicationStatusCheckCommandInput): import("@smithy/core/client").CommandImpl<AssociateApplicationStatusCheckCommandInput, AssociateApplicationStatusCheckCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
