...
import type { MoveByoipCidrToIpamRequest, MoveByoipCidrToIpamResult } from "../models/models_7";
/**
 * @public
 */
...
declare const MoveByoipCidrToIpamCommand_base: {
    new (input: MoveByoipCidrToIpamCommandInput): import("@smithy/core/client").CommandImpl<MoveByoipCidrToIpamCommandInput, MoveByoipCidrToIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: MoveByoipCidrToIpamCommandInput): import("@smithy/core/client").CommandImpl<MoveByoipCidrToIpamCommandInput, MoveByoipCidrToIpamCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
