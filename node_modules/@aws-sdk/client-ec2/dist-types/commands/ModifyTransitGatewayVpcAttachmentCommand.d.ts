...
import type { ModifyTransitGatewayVpcAttachmentRequest, ModifyTransitGatewayVpcAttachmentResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyTransitGatewayVpcAttachmentCommand_base: {
    new (input: ModifyTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayVpcAttachmentCommandInput, ModifyTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayVpcAttachmentCommandInput, ModifyTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
