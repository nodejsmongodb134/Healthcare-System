...
import type { DescribeAddressesRequest, DescribeAddressesResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeAddressesCommand_base: {
    new (input: DescribeAddressesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAddressesCommandInput, DescribeAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAddressesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAddressesCommandInput, DescribeAddressesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
