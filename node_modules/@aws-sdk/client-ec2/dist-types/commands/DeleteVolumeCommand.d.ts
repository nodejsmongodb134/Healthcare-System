...
import type { DeleteVolumeRequest } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteVolumeCommand_base: {
    new (input: DeleteVolumeCommandInput): import("@smithy/core/client").CommandImpl<DeleteVolumeCommandInput, DeleteVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVolumeCommandInput): import("@smithy/core/client").CommandImpl<DeleteVolumeCommandInput, DeleteVolumeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
