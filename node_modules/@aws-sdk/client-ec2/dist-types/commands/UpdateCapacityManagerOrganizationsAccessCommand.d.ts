...
import type { UpdateCapacityManagerOrganizationsAccessRequest, UpdateCapacityManagerOrganizationsAccessResult } from "../models/models_8";
/**
 * @public
 */
...
declare const UpdateCapacityManagerOrganizationsAccessCommand_base: {
    new (input: UpdateCapacityManagerOrganizationsAccessCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityManagerOrganizationsAccessCommandInput, UpdateCapacityManagerOrganizationsAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCapacityManagerOrganizationsAccessCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityManagerOrganizationsAccessCommandInput, UpdateCapacityManagerOrganizationsAccessCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
