...
import type { DescribePrincipalIdFormatRequest, DescribePrincipalIdFormatResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribePrincipalIdFormatCommand_base: {
    new (input: DescribePrincipalIdFormatCommandInput): import("@smithy/core/client").CommandImpl<DescribePrincipalIdFormatCommandInput, DescribePrincipalIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribePrincipalIdFormatCommandInput]): import("@smithy/core/client").CommandImpl<DescribePrincipalIdFormatCommandInput, DescribePrincipalIdFormatCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
