...
import type { ListSnapshotsInRecycleBinRequest, ListSnapshotsInRecycleBinResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ListSnapshotsInRecycleBinCommand_base: {
    new (input: ListSnapshotsInRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<ListSnapshotsInRecycleBinCommandInput, ListSnapshotsInRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSnapshotsInRecycleBinCommandInput]): import("@smithy/core/client").CommandImpl<ListSnapshotsInRecycleBinCommandInput, ListSnapshotsInRecycleBinCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
