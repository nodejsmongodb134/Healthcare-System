...
import type { StartVpcEndpointServicePrivateDnsVerificationRequest, StartVpcEndpointServicePrivateDnsVerificationResult } from "../models/models_8";
/**
 * @public
 */
...
declare const StartVpcEndpointServicePrivateDnsVerificationCommand_base: {
    new (input: StartVpcEndpointServicePrivateDnsVerificationCommandInput): import("@smithy/core/client").CommandImpl<StartVpcEndpointServicePrivateDnsVerificationCommandInput, StartVpcEndpointServicePrivateDnsVerificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartVpcEndpointServicePrivateDnsVerificationCommandInput): import("@smithy/core/client").CommandImpl<StartVpcEndpointServicePrivateDnsVerificationCommandInput, StartVpcEndpointServicePrivateDnsVerificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartVpcEndpointServicePrivateDnsVerificationCommand extends StartVpcEndpointServicePrivateDnsVerificationCommand_base {
