...
import type { ApplySecurityGroupsToClientVpnTargetNetworkRequest, ApplySecurityGroupsToClientVpnTargetNetworkResult } from "../models/models_0";
/**
 * @public
 */
...
declare const ApplySecurityGroupsToClientVpnTargetNetworkCommand_base: {
    new (input: ApplySecurityGroupsToClientVpnTargetNetworkCommandInput): import("@smithy/core/client").CommandImpl<ApplySecurityGroupsToClientVpnTargetNetworkCommandInput, ApplySecurityGroupsToClientVpnTargetNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ApplySecurityGroupsToClientVpnTargetNetworkCommandInput): import("@smithy/core/client").CommandImpl<ApplySecurityGroupsToClientVpnTargetNetworkCommandInput, ApplySecurityGroupsToClientVpnTargetNetworkCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
