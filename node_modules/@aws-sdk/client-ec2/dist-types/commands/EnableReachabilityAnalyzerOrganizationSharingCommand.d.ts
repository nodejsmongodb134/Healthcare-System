...
import type { EnableReachabilityAnalyzerOrganizationSharingRequest, EnableReachabilityAnalyzerOrganizationSharingResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableReachabilityAnalyzerOrganizationSharingCommand_base: {
    new (input: EnableReachabilityAnalyzerOrganizationSharingCommandInput): import("@smithy/core/client").CommandImpl<EnableReachabilityAnalyzerOrganizationSharingCommandInput, EnableReachabilityAnalyzerOrganizationSharingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableReachabilityAnalyzerOrganizationSharingCommandInput]): import("@smithy/core/client").CommandImpl<EnableReachabilityAnalyzerOrganizationSharingCommandInput, EnableReachabilityAnalyzerOrganizationSharingCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
