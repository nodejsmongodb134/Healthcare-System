...
import type { StartInstancesRequest, StartInstancesResult } from "../models/models_8";
/**
 * @public
 */
...
declare const StartInstancesCommand_base: {
    new (input: StartInstancesCommandInput): import("@smithy/core/client").CommandImpl<StartInstancesCommandInput, StartInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartInstancesCommandInput): import("@smithy/core/client").CommandImpl<StartInstancesCommandInput, StartInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartInstancesCommand extends StartInstancesCommand_base {
