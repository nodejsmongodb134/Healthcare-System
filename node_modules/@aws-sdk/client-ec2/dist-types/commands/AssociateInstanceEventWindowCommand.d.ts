...
declare const AssociateInstanceEventWindowCommand_base: {
    new (input: AssociateInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<AssociateInstanceEventWindowCommandInput, AssociateInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<AssociateInstanceEventWindowCommandInput, AssociateInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
