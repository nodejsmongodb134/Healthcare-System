...
import type { ExportImageRequest, ExportImageResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ExportImageCommand_base: {
    new (input: ExportImageCommandInput): import("@smithy/core/client").CommandImpl<ExportImageCommandInput, ExportImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportImageCommandInput): import("@smithy/core/client").CommandImpl<ExportImageCommandInput, ExportImageCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
