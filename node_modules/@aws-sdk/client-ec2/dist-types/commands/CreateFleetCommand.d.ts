...
declare const CreateFleetCommand_base: {
    new (input: CreateFleetCommandInput): import("@smithy/core/client").CommandImpl<CreateFleetCommandInput, CreateFleetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFleetCommandInput): import("@smithy/core/client").CommandImpl<CreateFleetCommandInput, CreateFleetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
