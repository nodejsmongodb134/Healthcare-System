...
declare const DescribeVpcEndpointsCommand_base: {
    new (input: DescribeVpcEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointsCommandInput, DescribeVpcEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointsCommandInput, DescribeVpcEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
