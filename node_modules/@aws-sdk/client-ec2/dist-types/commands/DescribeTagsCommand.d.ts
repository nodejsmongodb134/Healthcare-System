...
import type { DescribeTagsRequest, DescribeTagsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeTagsCommand_base: {
    new (input: DescribeTagsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTagsCommandInput, DescribeTagsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTagsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTagsCommandInput, DescribeTagsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
