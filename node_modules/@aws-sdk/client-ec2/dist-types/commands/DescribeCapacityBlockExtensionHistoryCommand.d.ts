...
import type { DescribeCapacityBlockExtensionHistoryRequest, DescribeCapacityBlockExtensionHistoryResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCapacityBlockExtensionHistoryCommand_base: {
    new (input: DescribeCapacityBlockExtensionHistoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockExtensionHistoryCommandInput, DescribeCapacityBlockExtensionHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityBlockExtensionHistoryCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockExtensionHistoryCommandInput, DescribeCapacityBlockExtensionHistoryCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
