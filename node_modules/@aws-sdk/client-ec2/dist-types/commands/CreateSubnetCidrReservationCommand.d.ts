...
import type { CreateSubnetCidrReservationRequest, CreateSubnetCidrReservationResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateSubnetCidrReservationCommand_base: {
    new (input: CreateSubnetCidrReservationCommandInput): import("@smithy/core/client").CommandImpl<CreateSubnetCidrReservationCommandInput, CreateSubnetCidrReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSubnetCidrReservationCommandInput): import("@smithy/core/client").CommandImpl<CreateSubnetCidrReservationCommandInput, CreateSubnetCidrReservationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
