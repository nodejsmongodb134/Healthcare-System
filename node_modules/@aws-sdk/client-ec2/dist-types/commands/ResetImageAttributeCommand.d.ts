...
import type { ResetImageAttributeRequest } from "../models/models_8";
/**
 * @public
 */
...
declare const ResetImageAttributeCommand_base: {
    new (input: ResetImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetImageAttributeCommandInput, ResetImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetImageAttributeCommandInput, ResetImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
