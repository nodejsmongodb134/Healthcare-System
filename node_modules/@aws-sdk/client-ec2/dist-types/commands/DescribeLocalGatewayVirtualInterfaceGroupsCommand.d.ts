...
import type { DescribeLocalGatewayVirtualInterfaceGroupsRequest, DescribeLocalGatewayVirtualInterfaceGroupsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeLocalGatewayVirtualInterfaceGroupsCommand_base: {
    new (input: DescribeLocalGatewayVirtualInterfaceGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayVirtualInterfaceGroupsCommandInput, DescribeLocalGatewayVirtualInterfaceGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLocalGatewayVirtualInterfaceGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayVirtualInterfaceGroupsCommandInput, DescribeLocalGatewayVirtualInterfaceGroupsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
