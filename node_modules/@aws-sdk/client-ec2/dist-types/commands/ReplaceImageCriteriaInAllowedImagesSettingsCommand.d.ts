...
import type { ReplaceImageCriteriaInAllowedImagesSettingsRequest, ReplaceImageCriteriaInAllowedImagesSettingsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ReplaceImageCriteriaInAllowedImagesSettingsCommand_base: {
    new (input: ReplaceImageCriteriaInAllowedImagesSettingsCommandInput): import("@smithy/core/client").CommandImpl<ReplaceImageCriteriaInAllowedImagesSettingsCommandInput, ReplaceImageCriteriaInAllowedImagesSettingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ReplaceImageCriteriaInAllowedImagesSettingsCommandInput]): import("@smithy/core/client").CommandImpl<ReplaceImageCriteriaInAllowedImagesSettingsCommandInput, ReplaceImageCriteriaInAllowedImagesSettingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
