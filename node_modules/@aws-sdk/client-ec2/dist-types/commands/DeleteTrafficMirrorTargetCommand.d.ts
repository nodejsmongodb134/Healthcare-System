...
declare const DeleteTrafficMirrorTargetCommand_base: {
    new (input: DeleteTrafficMirrorTargetCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficMirrorTargetCommandInput, DeleteTrafficMirrorTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrafficMirrorTargetCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficMirrorTargetCommandInput, DeleteTrafficMirrorTargetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
