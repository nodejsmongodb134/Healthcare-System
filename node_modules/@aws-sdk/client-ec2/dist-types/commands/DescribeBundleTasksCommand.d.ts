...
declare const DescribeBundleTasksCommand_base: {
    new (input: DescribeBundleTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeBundleTasksCommandInput, DescribeBundleTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeBundleTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeBundleTasksCommandInput, DescribeBundleTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
