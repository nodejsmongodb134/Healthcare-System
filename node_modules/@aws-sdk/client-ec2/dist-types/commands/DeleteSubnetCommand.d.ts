...
declare const DeleteSubnetCommand_base: {
    new (input: DeleteSubnetCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubnetCommandInput, DeleteSubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSubnetCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubnetCommandInput, DeleteSubnetCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
