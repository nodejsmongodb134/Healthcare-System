...
import type { DescribeVpcEndpointServicePermissionsRequest, DescribeVpcEndpointServicePermissionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcEndpointServicePermissionsCommand_base: {
    new (input: DescribeVpcEndpointServicePermissionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointServicePermissionsCommandInput, DescribeVpcEndpointServicePermissionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeVpcEndpointServicePermissionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEndpointServicePermissionsCommandInput, DescribeVpcEndpointServicePermissionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
