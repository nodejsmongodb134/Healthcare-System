...
import type { DescribeVpcBlockPublicAccessExclusionsRequest, DescribeVpcBlockPublicAccessExclusionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcBlockPublicAccessExclusionsCommand_base: {
    new (input: DescribeVpcBlockPublicAccessExclusionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcBlockPublicAccessExclusionsCommandInput, DescribeVpcBlockPublicAccessExclusionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcBlockPublicAccessExclusionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcBlockPublicAccessExclusionsCommandInput, DescribeVpcBlockPublicAccessExclusionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
