...
import type { EnableImageDeprecationRequest, EnableImageDeprecationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const EnableImageDeprecationCommand_base: {
    new (input: EnableImageDeprecationCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeprecationCommandInput, EnableImageDeprecationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableImageDeprecationCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeprecationCommandInput, EnableImageDeprecationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EnableImageDeprecationCommand extends EnableImageDeprecationCommand_base {
