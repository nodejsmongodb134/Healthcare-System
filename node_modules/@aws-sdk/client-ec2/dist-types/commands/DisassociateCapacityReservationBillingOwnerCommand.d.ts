...
import type { DisassociateCapacityReservationBillingOwnerRequest, DisassociateCapacityReservationBillingOwnerResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateCapacityReservationBillingOwnerCommand_base: {
    new (input: DisassociateCapacityReservationBillingOwnerCommandInput): import("@smithy/core/client").CommandImpl<DisassociateCapacityReservationBillingOwnerCommandInput, DisassociateCapacityReservationBillingOwnerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateCapacityReservationBillingOwnerCommandInput): import("@smithy/core/client").CommandImpl<DisassociateCapacityReservationBillingOwnerCommandInput, DisassociateCapacityReservationBillingOwnerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
