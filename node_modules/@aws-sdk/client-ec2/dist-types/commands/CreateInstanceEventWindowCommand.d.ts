...
declare const CreateInstanceEventWindowCommand_base: {
    new (input: CreateInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceEventWindowCommandInput, CreateInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateInstanceEventWindowCommandInput]): import("@smithy/core/client").CommandImpl<CreateInstanceEventWindowCommandInput, CreateInstanceEventWindowCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
