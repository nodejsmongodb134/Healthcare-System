...
import type { RejectTransitGatewayVpcAttachmentRequest, RejectTransitGatewayVpcAttachmentResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RejectTransitGatewayVpcAttachmentCommand_base: {
    new (input: RejectTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<RejectTransitGatewayVpcAttachmentCommandInput, RejectTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<RejectTransitGatewayVpcAttachmentCommandInput, RejectTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
