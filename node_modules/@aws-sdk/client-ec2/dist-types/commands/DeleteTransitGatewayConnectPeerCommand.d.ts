...
declare const DeleteTransitGatewayConnectPeerCommand_base: {
    new (input: DeleteTransitGatewayConnectPeerCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayConnectPeerCommandInput, DeleteTransitGatewayConnectPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransitGatewayConnectPeerCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayConnectPeerCommandInput, DeleteTransitGatewayConnectPeerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
