...
import type { CreateLocalGatewayVirtualInterfaceGroupRequest, CreateLocalGatewayVirtualInterfaceGroupResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateLocalGatewayVirtualInterfaceGroupCommand_base: {
    new (input: CreateLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayVirtualInterfaceGroupCommandInput, CreateLocalGatewayVirtualInterfaceGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayVirtualInterfaceGroupCommandInput, CreateLocalGatewayVirtualInterfaceGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
