...
import type { CreateLocalGatewayRouteRequest, CreateLocalGatewayRouteResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateLocalGatewayRouteCommand_base: {
    new (input: CreateLocalGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayRouteCommandInput, CreateLocalGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLocalGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayRouteCommandInput, CreateLocalGatewayRouteCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLocalGatewayRouteCommand extends CreateLocalGatewayRouteCommand_base {
