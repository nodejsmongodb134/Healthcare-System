...
declare const ModifyTransitGatewayCommand_base: {
    new (input: ModifyTransitGatewayCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayCommandInput, ModifyTransitGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyTransitGatewayCommandInput): import("@smithy/core/client").CommandImpl<ModifyTransitGatewayCommandInput, ModifyTransitGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
