...
declare const DescribeInstanceStatusCommand_base: {
    new (input: DescribeInstanceStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceStatusCommandInput, DescribeInstanceStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceStatusCommandInput, DescribeInstanceStatusCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
