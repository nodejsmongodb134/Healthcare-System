...
declare const CreateVerifiedAccessEndpointCommand_base: {
    new (input: CreateVerifiedAccessEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessEndpointCommandInput, CreateVerifiedAccessEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVerifiedAccessEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessEndpointCommandInput, CreateVerifiedAccessEndpointCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
