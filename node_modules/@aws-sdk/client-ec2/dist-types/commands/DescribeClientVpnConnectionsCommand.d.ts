...
declare const DescribeClientVpnConnectionsCommand_base: {
    new (input: DescribeClientVpnConnectionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnConnectionsCommandInput, DescribeClientVpnConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClientVpnConnectionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnConnectionsCommandInput, DescribeClientVpnConnectionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
