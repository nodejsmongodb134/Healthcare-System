...
declare const DescribeConversionTasksCommand_base: {
    new (input: DescribeConversionTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeConversionTasksCommandInput, DescribeConversionTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeConversionTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeConversionTasksCommandInput, DescribeConversionTasksCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeConversionTasksCommand extends DescribeConversionTasksCommand_base {
