...
import type { CreateSnapshotRequest, Snapshot } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateSnapshotCommand_base: {
    new (input: CreateSnapshotCommandInput): import("@smithy/core/client").CommandImpl<CreateSnapshotCommandInput, CreateSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSnapshotCommandInput): import("@smithy/core/client").CommandImpl<CreateSnapshotCommandInput, CreateSnapshotCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
