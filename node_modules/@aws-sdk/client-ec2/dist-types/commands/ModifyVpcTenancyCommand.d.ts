...
declare const ModifyVpcTenancyCommand_base: {
    new (input: ModifyVpcTenancyCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcTenancyCommandInput, ModifyVpcTenancyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcTenancyCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcTenancyCommandInput, ModifyVpcTenancyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
