...
declare const DescribeVerifiedAccessInstancesCommand_base: {
    new (input: DescribeVerifiedAccessInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessInstancesCommandInput, DescribeVerifiedAccessInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVerifiedAccessInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessInstancesCommandInput, DescribeVerifiedAccessInstancesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
