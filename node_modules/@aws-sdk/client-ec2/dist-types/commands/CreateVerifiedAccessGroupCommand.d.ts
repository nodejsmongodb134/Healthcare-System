...
import type { CreateVerifiedAccessGroupRequest, CreateVerifiedAccessGroupResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVerifiedAccessGroupCommand_base: {
    new (input: CreateVerifiedAccessGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessGroupCommandInput, CreateVerifiedAccessGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVerifiedAccessGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateVerifiedAccessGroupCommandInput, CreateVerifiedAccessGroupCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
