...
import type { GetNetworkInsightsAccessScopeAnalysisFindingsRequest, GetNetworkInsightsAccessScopeAnalysisFindingsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetNetworkInsightsAccessScopeAnalysisFindingsCommand_base: {
    new (input: GetNetworkInsightsAccessScopeAnalysisFindingsCommandInput): import("@smithy/core/client").CommandImpl<GetNetworkInsightsAccessScopeAnalysisFindingsCommandInput, GetNetworkInsightsAccessScopeAnalysisFindingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetNetworkInsightsAccessScopeAnalysisFindingsCommandInput): import("@smithy/core/client").CommandImpl<GetNetworkInsightsAccessScopeAnalysisFindingsCommandInput, GetNetworkInsightsAccessScopeAnalysisFindingsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
