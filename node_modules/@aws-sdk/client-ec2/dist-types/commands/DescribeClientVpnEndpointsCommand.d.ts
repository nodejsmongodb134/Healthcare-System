...
import type { DescribeClientVpnEndpointsRequest, DescribeClientVpnEndpointsResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeClientVpnEndpointsCommand_base: {
    new (input: DescribeClientVpnEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeClientVpnEndpointsCommandInput, DescribeClientVpnEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeClientVpnEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeClientVpnEndpointsCommandInput, DescribeClientVpnEndpointsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
