...
import type { DescribeVpcAttributeRequest, DescribeVpcAttributeResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeVpcAttributeCommand_base: {
    new (input: DescribeVpcAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcAttributeCommandInput, DescribeVpcAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeVpcAttributeCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcAttributeCommandInput, DescribeVpcAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
