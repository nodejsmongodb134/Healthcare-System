...
declare const ResetEbsDefaultKmsKeyIdCommand_base: {
    new (input: ResetEbsDefaultKmsKeyIdCommandInput): import("@smithy/core/client").CommandImpl<ResetEbsDefaultKmsKeyIdCommandInput, ResetEbsDefaultKmsKeyIdCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ResetEbsDefaultKmsKeyIdCommandInput]): import("@smithy/core/client").CommandImpl<ResetEbsDefaultKmsKeyIdCommandInput, ResetEbsDefaultKmsKeyIdCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
