...
import type { ModifyFpgaImageAttributeRequest, ModifyFpgaImageAttributeResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyFpgaImageAttributeCommand_base: {
    new (input: ModifyFpgaImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyFpgaImageAttributeCommandInput, ModifyFpgaImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyFpgaImageAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyFpgaImageAttributeCommandInput, ModifyFpgaImageAttributeCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ModifyFpgaImageAttributeCommand extends ModifyFpgaImageAttributeCommand_base {
