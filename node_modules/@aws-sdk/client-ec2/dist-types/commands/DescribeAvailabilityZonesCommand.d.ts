...
declare const DescribeAvailabilityZonesCommand_base: {
    new (input: DescribeAvailabilityZonesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAvailabilityZonesCommandInput, DescribeAvailabilityZonesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAvailabilityZonesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAvailabilityZonesCommandInput, DescribeAvailabilityZonesCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * //       Geography: [ // AvailabilityZoneGeographyList
 * //         { // AvailabilityZoneGeography
 * //           Name: "STRING_VALUE",
 * //         },
 * //       ],
 * //       SubGeography: [ // AvailabilityZoneSubGeographyList
