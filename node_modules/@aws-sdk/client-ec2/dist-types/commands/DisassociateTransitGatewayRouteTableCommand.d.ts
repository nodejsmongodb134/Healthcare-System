...
import type { DisassociateTransitGatewayRouteTableRequest, DisassociateTransitGatewayRouteTableResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DisassociateTransitGatewayRouteTableCommand_base: {
    new (input: DisassociateTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTransitGatewayRouteTableCommandInput, DisassociateTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateTransitGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTransitGatewayRouteTableCommandInput, DisassociateTransitGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateTransitGatewayRouteTableCommand extends DisassociateTransitGatewayRouteTableCommand_base {
