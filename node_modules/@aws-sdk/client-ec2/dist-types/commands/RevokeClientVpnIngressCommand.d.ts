...
import type { RevokeClientVpnIngressRequest, RevokeClientVpnIngressResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RevokeClientVpnIngressCommand_base: {
    new (input: RevokeClientVpnIngressCommandInput): import("@smithy/core/client").CommandImpl<RevokeClientVpnIngressCommandInput, RevokeClientVpnIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RevokeClientVpnIngressCommandInput): import("@smithy/core/client").CommandImpl<RevokeClientVpnIngressCommandInput, RevokeClientVpnIngressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RevokeClientVpnIngressCommand extends RevokeClientVpnIngressCommand_base {
