...
import type { AssociateEnclaveCertificateIamRoleRequest, AssociateEnclaveCertificateIamRoleResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateEnclaveCertificateIamRoleCommand_base: {
    new (input: AssociateEnclaveCertificateIamRoleCommandInput): import("@smithy/core/client").CommandImpl<AssociateEnclaveCertificateIamRoleCommandInput, AssociateEnclaveCertificateIamRoleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateEnclaveCertificateIamRoleCommandInput): import("@smithy/core/client").CommandImpl<AssociateEnclaveCertificateIamRoleCommandInput, AssociateEnclaveCertificateIamRoleCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
