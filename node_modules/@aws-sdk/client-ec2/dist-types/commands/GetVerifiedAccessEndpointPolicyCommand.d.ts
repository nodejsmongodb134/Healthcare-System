...
declare const GetVerifiedAccessEndpointPolicyCommand_base: {
    new (input: GetVerifiedAccessEndpointPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetVerifiedAccessEndpointPolicyCommandInput, GetVerifiedAccessEndpointPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVerifiedAccessEndpointPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetVerifiedAccessEndpointPolicyCommandInput, GetVerifiedAccessEndpointPolicyCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
