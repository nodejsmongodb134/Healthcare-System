...
import type { CreateRouteServerRequest, CreateRouteServerResult } from "../models/models_2";
/**
 * @public
 */
 ...
 * @public
 *
 * The input for {@link CreateRouteServerCommand}.
 */
 ...
 * @public
 *
 * The output of {@link CreateRouteServerCommand}.
 */
export interface CreateRouteServerCommandOutput extends CreateRouteServerResult, __MetadataBearer {
}
declare const CreateRouteServerCommand_base: {
    new (input: CreateRouteServerCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteServerCommandInput, CreateRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteServerCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteServerCommandInput, CreateRouteServerCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 *   ],
 * };
 * const command = new CreateRouteServerCommand(input);
 ...
 * ```
 *
 * @param CreateRouteServerCommandInput - {@link CreateRouteServerCommandInput}
 * @returns {@link CreateRouteServerCommandOutput}
 * @see {@link CreateRouteServerCommandInput} for command's `input` shape.
 * @see {@link CreateRouteServerCommandOutput} for command's `response` shape.
 ...
 * @public
 */
export declare class CreateRouteServerCommand extends CreateRouteServerCommand_base {
