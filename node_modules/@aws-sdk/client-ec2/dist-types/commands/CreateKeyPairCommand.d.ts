...
import type { CreateKeyPairRequest, KeyPair } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateKeyPairCommand_base: {
    new (input: CreateKeyPairCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyPairCommandInput, CreateKeyPairCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateKeyPairCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyPairCommandInput, CreateKeyPairCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
