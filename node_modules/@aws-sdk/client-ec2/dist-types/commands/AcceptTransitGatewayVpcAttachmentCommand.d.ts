...
import type { AcceptTransitGatewayVpcAttachmentRequest, AcceptTransitGatewayVpcAttachmentResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AcceptTransitGatewayVpcAttachmentCommand_base: {
    new (input: AcceptTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<AcceptTransitGatewayVpcAttachmentCommandInput, AcceptTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptTransitGatewayVpcAttachmentCommandInput): import("@smithy/core/client").CommandImpl<AcceptTransitGatewayVpcAttachmentCommandInput, AcceptTransitGatewayVpcAttachmentCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
