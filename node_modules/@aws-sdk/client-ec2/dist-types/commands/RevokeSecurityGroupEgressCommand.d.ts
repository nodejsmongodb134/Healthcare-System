...
import type { RevokeSecurityGroupEgressRequest, RevokeSecurityGroupEgressResult } from "../models/models_8";
/**
 * @public
 */
...
declare const RevokeSecurityGroupEgressCommand_base: {
    new (input: RevokeSecurityGroupEgressCommandInput): import("@smithy/core/client").CommandImpl<RevokeSecurityGroupEgressCommandInput, RevokeSecurityGroupEgressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RevokeSecurityGroupEgressCommandInput): import("@smithy/core/client").CommandImpl<RevokeSecurityGroupEgressCommandInput, RevokeSecurityGroupEgressCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RevokeSecurityGroupEgressCommand extends RevokeSecurityGroupEgressCommand_base {
