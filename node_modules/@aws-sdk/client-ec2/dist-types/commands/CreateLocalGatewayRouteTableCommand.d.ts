...
declare const CreateLocalGatewayRouteTableCommand_base: {
    new (input: CreateLocalGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayRouteTableCommandInput, CreateLocalGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLocalGatewayRouteTableCommandInput): import("@smithy/core/client").CommandImpl<CreateLocalGatewayRouteTableCommandInput, CreateLocalGatewayRouteTableCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLocalGatewayRouteTableCommand extends CreateLocalGatewayRouteTableCommand_base {
