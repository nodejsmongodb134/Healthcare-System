...
import type { ModifyVpcEndpointServicePermissionsRequest, ModifyVpcEndpointServicePermissionsResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEndpointServicePermissionsCommand_base: {
    new (input: ModifyVpcEndpointServicePermissionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointServicePermissionsCommandInput, ModifyVpcEndpointServicePermissionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEndpointServicePermissionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointServicePermissionsCommandInput, ModifyVpcEndpointServicePermissionsCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
