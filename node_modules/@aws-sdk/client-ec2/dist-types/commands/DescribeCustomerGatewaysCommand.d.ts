...
import type { DescribeCustomerGatewaysRequest, DescribeCustomerGatewaysResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeCustomerGatewaysCommand_base: {
    new (input: DescribeCustomerGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeCustomerGatewaysCommandInput, DescribeCustomerGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCustomerGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCustomerGatewaysCommandInput, DescribeCustomerGatewaysCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
