...
declare const DeleteInternetGatewayCommand_base: {
    new (input: DeleteInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteInternetGatewayCommandInput, DeleteInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteInternetGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteInternetGatewayCommandInput, DeleteInternetGatewayCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
