...
declare const CreateStoreImageTaskCommand_base: {
    new (input: CreateStoreImageTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateStoreImageTaskCommandInput, CreateStoreImageTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStoreImageTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateStoreImageTaskCommandInput, CreateStoreImageTaskCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
