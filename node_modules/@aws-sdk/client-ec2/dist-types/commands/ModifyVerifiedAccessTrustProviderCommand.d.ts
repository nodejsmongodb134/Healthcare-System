...
import type { ModifyVerifiedAccessTrustProviderRequest, ModifyVerifiedAccessTrustProviderResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVerifiedAccessTrustProviderCommand_base: {
    new (input: ModifyVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessTrustProviderCommandInput, ModifyVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVerifiedAccessTrustProviderCommandInput): import("@smithy/core/client").CommandImpl<ModifyVerifiedAccessTrustProviderCommandInput, ModifyVerifiedAccessTrustProviderCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
