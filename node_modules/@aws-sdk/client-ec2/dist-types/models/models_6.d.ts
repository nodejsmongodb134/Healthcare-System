import type { _InstanceType, AnalysisStatus, ArchitectureType, ArchitectureValues, BootModeValues, CapacityManagerMonitoredTagKeyStatus, CapacityManagerStatus, CapacityReservationState, CapacityTenancy, ChronologicalOrder, ClientCertificateRevocationListStatusCode, Comparison, CurrencyCodeValues, DeviceTrustProviderType, DiskImageFormat, EkPubKeyFormat, EkPubKeyType, FastLaunchResourceType, FastLaunchStateCode, FastSnapshotRestoreStateCode, FilterByDimension, GroupBy, HttpTokensEnforcedState, HttpTokensState, ImageBlockPublicAccessEnabledState, IngestionStatus, InstanceMetadataEndpointState, InstanceMetadataTagsState, IpamAddressHistoryResourceType, IpamByoipAdvertisementType, IpamByoipCidrState, IpamComplianceStatus, IpamDiscoveryFailureCode, IpamManagementState, IpamNetworkInterfaceAttachmentStatus, IpamOverlapStatus, IpamPolicyManagedBy, IpamPolicyResourceType, IpamPrefixListResolverRuleConditionOperation, IpamPrefixListResolverRuleType, IpamPublicAddressAssociationStatus, IpamPublicAddressAwsService, IpamPublicAddressType, IpamResourceCidrIpSource, IpamResourceType, IpamRoutingPolicyRegistrationState, IpamRpkiStatus, IpamRpkiStrength, ManagedBy, ManagedResourceDefaultVisibility, Metric, MetricType, PartitionLoadFrequency, PaymentOption, PeriodType, PlatformValues, ReservationEndDateType, ReservationState, ReservationType, RouteServerRouteInstallationStatus, RouteServerRouteStatus, ShutdownBehavior, SnapshotBlockPublicAccessState, SSEType, StatisticType, TargetCapacityUnitType, TransitGatewayAssociationState, TransitGatewayAttachmentResourceType, TransitGatewayPropagationState, UnlimitedSupportedInstanceFamily, UserTrustProviderType, VirtualizationType } from "./enums";
import type { AccessScopeAnalysisFinding, ActiveVpnTunnelStatus, InterruptibleCapacityAllocation, InterruptionInfo, IpamPoolAllocation, IpamRoutingPolicyRegistrationDelta, RouteServerAssociation, SubnetAssociation, Tag, TagSpecification, TargetConfigurationRequest, TransitGatewayPolicyTableAssociation } from "./models_0";
