...
import { type AcceptVpcEndpointConnectionsCommandInput, type AcceptVpcEndpointConnectionsCommandOutput } from "./commands/AcceptVpcEndpointConnectionsCommand";
import { type AcceptVpcPeeringConnectionCommandInput, type AcceptVpcPeeringConnectionCommandOutput } from "./commands/AcceptVpcPeeringConnectionCommand";
import { type AdvertiseByoipCidrCommandInput, type AdvertiseByoipCidrCommandOutput } from "./commands/AdvertiseByoipCidrCommand";
import { type AllocateAddressCommandInput, type AllocateAddressCommandOutput } from "./commands/AllocateAddressCommand";
import { type AllocateHostsCommandInput, type AllocateHostsCommandOutput } from "./commands/AllocateHostsCommand";
import { type AllocateIpamPoolCidrCommandInput, type AllocateIpamPoolCidrCommandOutput } from "./commands/AllocateIpamPoolCidrCommand";
import { type ApplySecurityGroupsToClientVpnTargetNetworkCommandInput, type ApplySecurityGroupsToClientVpnTargetNetworkCommandOutput } from "./commands/ApplySecurityGroupsToClientVpnTargetNetworkCommand";
import { type AssignIpv6AddressesCommandInput, type AssignIpv6AddressesCommandOutput } from "./commands/AssignIpv6AddressesCommand";
import { type AssignPrivateIpAddressesCommandInput, type AssignPrivateIpAddressesCommandOutput } from "./commands/AssignPrivateIpAddressesCommand";
import { type AssignPrivateNatGatewayAddressCommandInput, type AssignPrivateNatGatewayAddressCommandOutput } from "./commands/AssignPrivateNatGatewayAddressCommand";
import { type AssociateAddressCommandInput, type AssociateAddressCommandOutput } from "./commands/AssociateAddressCommand";
import { type AssociateApplicationStatusCheckCommandInput, type AssociateApplicationStatusCheckCommandOutput } from "./commands/AssociateApplicationStatusCheckCommand";
import { type AssociateCapacityReservationBillingOwnerCommandInput, type AssociateCapacityReservationBillingOwnerCommandOutput } from "./commands/AssociateCapacityReservationBillingOwnerCommand";
import { type AssociateClientVpnTargetNetworkCommandInput, type AssociateClientVpnTargetNetworkCommandOutput } from "./commands/AssociateClientVpnTargetNetworkCommand";
import { type AssociateDhcpOptionsCommandInput, type AssociateDhcpOptionsCommandOutput } from "./commands/AssociateDhcpOptionsCommand";
import { type AssociateEnclaveCertificateIamRoleCommandInput, type AssociateEnclaveCertificateIamRoleCommandOutput } from "./commands/AssociateEnclaveCertificateIamRoleCommand";
import { type AssociateIamInstanceProfileCommandInput, type AssociateIamInstanceProfileCommandOutput } from "./commands/AssociateIamInstanceProfileCommand";
import { type AssociateInstanceEventWindowCommandInput, type AssociateInstanceEventWindowCommandOutput } from "./commands/AssociateInstanceEventWindowCommand";
import { type AssociateIpamByoasnCommandInput, type AssociateIpamByoasnCommandOutput } from "./commands/AssociateIpamByoasnCommand";
import { type AssociateIpamResourceDiscoveryCommandInput, type AssociateIpamResourceDiscoveryCommandOutput } from "./commands/AssociateIpamResourceDiscoveryCommand";
import { type AssociateNatGatewayAddressCommandInput, type AssociateNatGatewayAddressCommandOutput } from "./commands/AssociateNatGatewayAddressCommand";
import { type AssociateRouteServerCommandInput, type AssociateRouteServerCommandOutput } from "./commands/AssociateRouteServerCommand";
import { type AssociateRouteTableCommandInput, type AssociateRouteTableCommandOutput } from "./commands/AssociateRouteTableCommand";
import { type AssociateSecurityGroupVpcCommandInput, type AssociateSecurityGroupVpcCommandOutput } from "./commands/AssociateSecurityGroupVpcCommand";
import { type AssociateSubnetCidrBlockCommandInput, type AssociateSubnetCidrBlockCommandOutput } from "./commands/AssociateSubnetCidrBlockCommand";
import { type AssociateTransitGatewayMulticastDomainCommandInput, type AssociateTransitGatewayMulticastDomainCommandOutput } from "./commands/AssociateTransitGatewayMulticastDomainCommand";
import { type AssociateTransitGatewayPolicyTableCommandInput, type AssociateTransitGatewayPolicyTableCommandOutput } from "./commands/AssociateTransitGatewayPolicyTableCommand";
import { type AssociateTransitGatewayRouteTableCommandInput, type AssociateTransitGatewayRouteTableCommandOutput } from "./commands/AssociateTransitGatewayRouteTableCommand";
...
import { type AttachVpnGatewayCommandInput, type AttachVpnGatewayCommandOutput } from "./commands/AttachVpnGatewayCommand";
...
import { type CancelCapacityReservationFleetsCommandInput, type CancelCapacityReservationFleetsCommandOutput } from "./commands/CancelCapacityReservationFleetsCommand";
import { type CancelConversionTaskCommandInput, type CancelConversionTaskCommandOutput } from "./commands/CancelConversionTaskCommand";
import { type CancelDeclarativePoliciesReportCommandInput, type CancelDeclarativePoliciesReportCommandOutput } from "./commands/CancelDeclarativePoliciesReportCommand";
import { type CancelExportTaskCommandInput, type CancelExportTaskCommandOutput } from "./commands/CancelExportTaskCommand";
import { type CancelImageLaunchPermissionCommandInput, type CancelImageLaunchPermissionCommandOutput } from "./commands/CancelImageLaunchPermissionCommand";
import { type CancelImportTaskCommandInput, type CancelImportTaskCommandOutput } from "./commands/CancelImportTaskCommand";
import { type CancelReservedInstancesListingCommandInput, type CancelReservedInstancesListingCommandOutput } from "./commands/CancelReservedInstancesListingCommand";
import { type CancelSpotFleetRequestsCommandInput, type CancelSpotFleetRequestsCommandOutput } from "./commands/CancelSpotFleetRequestsCommand";
import { type CancelSpotInstanceRequestsCommandInput, type CancelSpotInstanceRequestsCommandOutput } from "./commands/CancelSpotInstanceRequestsCommand";
import { type ConfirmProductInstanceCommandInput, type ConfirmProductInstanceCommandOutput } from "./commands/ConfirmProductInstanceCommand";
import { type CopyFpgaImageCommandInput, type CopyFpgaImageCommandOutput } from "./commands/CopyFpgaImageCommand";
...
import { type CreateApplicationStatusCheckCommandInput, type CreateApplicationStatusCheckCommandOutput } from "./commands/CreateApplicationStatusCheckCommand";
...
import { type CreateClientVpnEndpointCommandInput, type CreateClientVpnEndpointCommandOutput } from "./commands/CreateClientVpnEndpointCommand";
import { type CreateClientVpnRouteCommandInput, type CreateClientVpnRouteCommandOutput } from "./commands/CreateClientVpnRouteCommand";
import { type CreateCoipCidrCommandInput, type CreateCoipCidrCommandOutput } from "./commands/CreateCoipCidrCommand";
import { type CreateCoipPoolCommandInput, type CreateCoipPoolCommandOutput } from "./commands/CreateCoipPoolCommand";
import { type CreateCustomerGatewayCommandInput, type CreateCustomerGatewayCommandOutput } from "./commands/CreateCustomerGatewayCommand";
import { type CreateDefaultSubnetCommandInput, type CreateDefaultSubnetCommandOutput } from "./commands/CreateDefaultSubnetCommand";
import { type CreateDefaultVpcCommandInput, type CreateDefaultVpcCommandOutput } from "./commands/CreateDefaultVpcCommand";
import { type CreateDelegateMacVolumeOwnershipTaskCommandInput, type CreateDelegateMacVolumeOwnershipTaskCommandOutput } from "./commands/CreateDelegateMacVolumeOwnershipTaskCommand";
import { type CreateDhcpOptionsCommandInput, type CreateDhcpOptionsCommandOutput } from "./commands/CreateDhcpOptionsCommand";
import { type CreateEgressOnlyInternetGatewayCommandInput, type CreateEgressOnlyInternetGatewayCommandOutput } from "./commands/CreateEgressOnlyInternetGatewayCommand";
import { type CreateFleetCommandInput, type CreateFleetCommandOutput } from "./commands/CreateFleetCommand";
import { type CreateFlowLogsCommandInput, type CreateFlowLogsCommandOutput } from "./commands/CreateFlowLogsCommand";
import { type CreateFpgaImageCommandInput, type CreateFpgaImageCommandOutput } from "./commands/CreateFpgaImageCommand";
import { type CreateImageCommandInput, type CreateImageCommandOutput } from "./commands/CreateImageCommand";
import { type CreateImageUsageReportCommandInput, type CreateImageUsageReportCommandOutput } from "./commands/CreateImageUsageReportCommand";
import { type CreateInstanceConnectEndpointCommandInput, type CreateInstanceConnectEndpointCommandOutput } from "./commands/CreateInstanceConnectEndpointCommand";
import { type CreateInstanceEventWindowCommandInput, type CreateInstanceEventWindowCommandOutput } from "./commands/CreateInstanceEventWindowCommand";
import { type CreateInstanceExportTaskCommandInput, type CreateInstanceExportTaskCommandOutput } from "./commands/CreateInstanceExportTaskCommand";
import { type CreateInternetGatewayCommandInput, type CreateInternetGatewayCommandOutput } from "./commands/CreateInternetGatewayCommand";
...
import { type CreateLaunchTemplateVersionCommandInput, type CreateLaunchTemplateVersionCommandOutput } from "./commands/CreateLaunchTemplateVersionCommand";
import { type CreateLocalGatewayRouteCommandInput, type CreateLocalGatewayRouteCommandOutput } from "./commands/CreateLocalGatewayRouteCommand";
import { type CreateLocalGatewayRouteTableCommandInput, type CreateLocalGatewayRouteTableCommandOutput } from "./commands/CreateLocalGatewayRouteTableCommand";
import { type CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, type CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput } from "./commands/CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommand";
import { type CreateLocalGatewayRouteTableVpcAssociationCommandInput, type CreateLocalGatewayRouteTableVpcAssociationCommandOutput } from "./commands/CreateLocalGatewayRouteTableVpcAssociationCommand";
import { type CreateLocalGatewayVirtualInterfaceCommandInput, type CreateLocalGatewayVirtualInterfaceCommandOutput } from "./commands/CreateLocalGatewayVirtualInterfaceCommand";
import { type CreateLocalGatewayVirtualInterfaceGroupCommandInput, type CreateLocalGatewayVirtualInterfaceGroupCommandOutput } from "./commands/CreateLocalGatewayVirtualInterfaceGroupCommand";
import { type CreateMacSystemIntegrityProtectionModificationTaskCommandInput, type CreateMacSystemIntegrityProtectionModificationTaskCommandOutput } from "./commands/CreateMacSystemIntegrityProtectionModificationTaskCommand";
import { type CreateManagedPrefixListCommandInput, type CreateManagedPrefixListCommandOutput } from "./commands/CreateManagedPrefixListCommand";
import { type CreateNatGatewayCommandInput, type CreateNatGatewayCommandOutput } from "./commands/CreateNatGatewayCommand";
import { type CreateNetworkAclCommandInput, type CreateNetworkAclCommandOutput } from "./commands/CreateNetworkAclCommand";
import { type CreateNetworkAclEntryCommandInput, type CreateNetworkAclEntryCommandOutput } from "./commands/CreateNetworkAclEntryCommand";
import { type CreateNetworkInsightsAccessScopeCommandInput, type CreateNetworkInsightsAccessScopeCommandOutput } from "./commands/CreateNetworkInsightsAccessScopeCommand";
import { type CreateNetworkInsightsPathCommandInput, type CreateNetworkInsightsPathCommandOutput } from "./commands/CreateNetworkInsightsPathCommand";
import { type CreateNetworkInterfaceCommandInput, type CreateNetworkInterfaceCommandOutput } from "./commands/CreateNetworkInterfaceCommand";
import { type CreateNetworkInterfacePermissionCommandInput, type CreateNetworkInterfacePermissionCommandOutput } from "./commands/CreateNetworkInterfacePermissionCommand";
import { type CreatePlacementGroupCommandInput, type CreatePlacementGroupCommandOutput } from "./commands/CreatePlacementGroupCommand";
import { type CreatePublicIpv4PoolCommandInput, type CreatePublicIpv4PoolCommandOutput } from "./commands/CreatePublicIpv4PoolCommand";
import { type CreateReplaceRootVolumeTaskCommandInput, type CreateReplaceRootVolumeTaskCommandOutput } from "./commands/CreateReplaceRootVolumeTaskCommand";
import { type CreateReservedInstancesListingCommandInput, type CreateReservedInstancesListingCommandOutput } from "./commands/CreateReservedInstancesListingCommand";
import { type CreateRestoreImageTaskCommandInput, type CreateRestoreImageTaskCommandOutput } from "./commands/CreateRestoreImageTaskCommand";
import { type CreateRouteCommandInput, type CreateRouteCommandOutput } from "./commands/CreateRouteCommand";
import { type CreateRouteServerCommandInput, type CreateRouteServerCommandOutput } from "./commands/CreateRouteServerCommand";
import { type CreateRouteServerEndpointCommandInput, type CreateRouteServerEndpointCommandOutput } from "./commands/CreateRouteServerEndpointCommand";
import { type CreateRouteServerPeerCommandInput, type CreateRouteServerPeerCommandOutput } from "./commands/CreateRouteServerPeerCommand";
import { type CreateRouteTableCommandInput, type CreateRouteTableCommandOutput } from "./commands/CreateRouteTableCommand";
import { type CreateSecondaryNetworkCommandInput, type CreateSecondaryNetworkCommandOutput } from "./commands/CreateSecondaryNetworkCommand";
import { type CreateSecondarySubnetCommandInput, type CreateSecondarySubnetCommandOutput } from "./commands/CreateSecondarySubnetCommand";
import { type CreateSecurityGroupCommandInput, type CreateSecurityGroupCommandOutput } from "./commands/CreateSecurityGroupCommand";
import { type CreateSnapshotCommandInput, type CreateSnapshotCommandOutput } from "./commands/CreateSnapshotCommand";
import { type CreateSnapshotsCommandInput, type CreateSnapshotsCommandOutput } from "./commands/CreateSnapshotsCommand";
import { type CreateSpotDatafeedSubscriptionCommandInput, type CreateSpotDatafeedSubscriptionCommandOutput } from "./commands/CreateSpotDatafeedSubscriptionCommand";
import { type CreateStoreImageTaskCommandInput, type CreateStoreImageTaskCommandOutput } from "./commands/CreateStoreImageTaskCommand";
import { type CreateSubnetCidrReservationCommandInput, type CreateSubnetCidrReservationCommandOutput } from "./commands/CreateSubnetCidrReservationCommand";
import { type CreateSubnetCommandInput, type CreateSubnetCommandOutput } from "./commands/CreateSubnetCommand";
import { type CreateTagsCommandInput, type CreateTagsCommandOutput } from "./commands/CreateTagsCommand";
import { type CreateTrafficMirrorFilterCommandInput, type CreateTrafficMirrorFilterCommandOutput } from "./commands/CreateTrafficMirrorFilterCommand";
import { type CreateTrafficMirrorFilterRuleCommandInput, type CreateTrafficMirrorFilterRuleCommandOutput } from "./commands/CreateTrafficMirrorFilterRuleCommand";
import { type CreateTrafficMirrorSessionCommandInput, type CreateTrafficMirrorSessionCommandOutput } from "./commands/CreateTrafficMirrorSessionCommand";
import { type CreateTrafficMirrorTargetCommandInput, type CreateTrafficMirrorTargetCommandOutput } from "./commands/CreateTrafficMirrorTargetCommand";
import { type CreateTransitGatewayCommandInput, type CreateTransitGatewayCommandOutput } from "./commands/CreateTransitGatewayCommand";
import { type CreateTransitGatewayConnectCommandInput, type CreateTransitGatewayConnectCommandOutput } from "./commands/CreateTransitGatewayConnectCommand";
import { type CreateTransitGatewayConnectPeerCommandInput, type CreateTransitGatewayConnectPeerCommandOutput } from "./commands/CreateTransitGatewayConnectPeerCommand";
import { type CreateTransitGatewayMeteringPolicyCommandInput, type CreateTransitGatewayMeteringPolicyCommandOutput } from "./commands/CreateTransitGatewayMeteringPolicyCommand";
import { type CreateTransitGatewayMeteringPolicyEntryCommandInput, type CreateTransitGatewayMeteringPolicyEntryCommandOutput } from "./commands/CreateTransitGatewayMeteringPolicyEntryCommand";
import { type CreateTransitGatewayMulticastDomainCommandInput, type CreateTransitGatewayMulticastDomainCommandOutput } from "./commands/CreateTransitGatewayMulticastDomainCommand";
import { type CreateTransitGatewayPeeringAttachmentCommandInput, type CreateTransitGatewayPeeringAttachmentCommandOutput } from "./commands/CreateTransitGatewayPeeringAttachmentCommand";
import { type CreateTransitGatewayPolicyTableCommandInput, type CreateTransitGatewayPolicyTableCommandOutput } from "./commands/CreateTransitGatewayPolicyTableCommand";
import { type CreateTransitGatewayPolicyTableEntryCommandInput, type CreateTransitGatewayPolicyTableEntryCommandOutput } from "./commands/CreateTransitGatewayPolicyTableEntryCommand";
import { type CreateTransitGatewayPrefixListReferenceCommandInput, type CreateTransitGatewayPrefixListReferenceCommandOutput } from "./commands/CreateTransitGatewayPrefixListReferenceCommand";
import { type CreateTransitGatewayRouteCommandInput, type CreateTransitGatewayRouteCommandOutput } from "./commands/CreateTransitGatewayRouteCommand";
import { type CreateTransitGatewayRouteTableAnnouncementCommandInput, type CreateTransitGatewayRouteTableAnnouncementCommandOutput } from "./commands/CreateTransitGatewayRouteTableAnnouncementCommand";
import { type CreateTransitGatewayRouteTableCommandInput, type CreateTransitGatewayRouteTableCommandOutput } from "./commands/CreateTransitGatewayRouteTableCommand";
import { type CreateTransitGatewayVpcAttachmentCommandInput, type CreateTransitGatewayVpcAttachmentCommandOutput } from "./commands/CreateTransitGatewayVpcAttachmentCommand";
import { type CreateVerifiedAccessEndpointCommandInput, type CreateVerifiedAccessEndpointCommandOutput } from "./commands/CreateVerifiedAccessEndpointCommand";
import { type CreateVerifiedAccessGroupCommandInput, type CreateVerifiedAccessGroupCommandOutput } from "./commands/CreateVerifiedAccessGroupCommand";
import { type CreateVerifiedAccessInstanceCommandInput, type CreateVerifiedAccessInstanceCommandOutput } from "./commands/CreateVerifiedAccessInstanceCommand";
import { type CreateVerifiedAccessTrustProviderCommandInput, type CreateVerifiedAccessTrustProviderCommandOutput } from "./commands/CreateVerifiedAccessTrustProviderCommand";
import { type CreateVolumeCommandInput, type CreateVolumeCommandOutput } from "./commands/CreateVolumeCommand";
import { type CreateVpcBlockPublicAccessExclusionCommandInput, type CreateVpcBlockPublicAccessExclusionCommandOutput } from "./commands/CreateVpcBlockPublicAccessExclusionCommand";
import { type CreateVpcCommandInput, type CreateVpcCommandOutput } from "./commands/CreateVpcCommand";
import { type CreateVpcEncryptionControlCommandInput, type CreateVpcEncryptionControlCommandOutput } from "./commands/CreateVpcEncryptionControlCommand";
import { type CreateVpcEndpointCommandInput, type CreateVpcEndpointCommandOutput } from "./commands/CreateVpcEndpointCommand";
import { type CreateVpcEndpointConnectionNotificationCommandInput, type CreateVpcEndpointConnectionNotificationCommandOutput } from "./commands/CreateVpcEndpointConnectionNotificationCommand";
import { type CreateVpcEndpointServiceConfigurationCommandInput, type CreateVpcEndpointServiceConfigurationCommandOutput } from "./commands/CreateVpcEndpointServiceConfigurationCommand";
...
import { type CreateVpnConcentratorCommandInput, type CreateVpnConcentratorCommandOutput } from "./commands/CreateVpnConcentratorCommand";
import { type CreateVpnConnectionCommandInput, type CreateVpnConnectionCommandOutput } from "./commands/CreateVpnConnectionCommand";
import { type CreateVpnConnectionRouteCommandInput, type CreateVpnConnectionRouteCommandOutput } from "./commands/CreateVpnConnectionRouteCommand";
import { type CreateVpnGatewayCommandInput, type CreateVpnGatewayCommandOutput } from "./commands/CreateVpnGatewayCommand";
import { type DeleteApplicationStatusCheckCommandInput, type DeleteApplicationStatusCheckCommandOutput } from "./commands/DeleteApplicationStatusCheckCommand";
import { type DeleteCapacityManagerDataExportCommandInput, type DeleteCapacityManagerDataExportCommandOutput } from "./commands/DeleteCapacityManagerDataExportCommand";
import { type DeleteCarrierGatewayCommandInput, type DeleteCarrierGatewayCommandOutput } from "./commands/DeleteCarrierGatewayCommand";
import { type DeleteClientVpnEndpointCommandInput, type DeleteClientVpnEndpointCommandOutput } from "./commands/DeleteClientVpnEndpointCommand";
import { type DeleteClientVpnRouteCommandInput, type DeleteClientVpnRouteCommandOutput } from "./commands/DeleteClientVpnRouteCommand";
import { type DeleteCoipCidrCommandInput, type DeleteCoipCidrCommandOutput } from "./commands/DeleteCoipCidrCommand";
import { type DeleteCoipPoolCommandInput, type DeleteCoipPoolCommandOutput } from "./commands/DeleteCoipPoolCommand";
import { type DeleteCustomerGatewayCommandInput, type DeleteCustomerGatewayCommandOutput } from "./commands/DeleteCustomerGatewayCommand";
import { type DeleteDhcpOptionsCommandInput, type DeleteDhcpOptionsCommandOutput } from "./commands/DeleteDhcpOptionsCommand";
import { type DeleteEgressOnlyInternetGatewayCommandInput, type DeleteEgressOnlyInternetGatewayCommandOutput } from "./commands/DeleteEgressOnlyInternetGatewayCommand";
import { type DeleteFleetsCommandInput, type DeleteFleetsCommandOutput } from "./commands/DeleteFleetsCommand";
import { type DeleteFlowLogsCommandInput, type DeleteFlowLogsCommandOutput } from "./commands/DeleteFlowLogsCommand";
import { type DeleteFpgaImageCommandInput, type DeleteFpgaImageCommandOutput } from "./commands/DeleteFpgaImageCommand";
import { type DeleteImageUsageReportCommandInput, type DeleteImageUsageReportCommandOutput } from "./commands/DeleteImageUsageReportCommand";
import { type DeleteInstanceConnectEndpointCommandInput, type DeleteInstanceConnectEndpointCommandOutput } from "./commands/DeleteInstanceConnectEndpointCommand";
import { type DeleteInstanceEventWindowCommandInput, type DeleteInstanceEventWindowCommandOutput } from "./commands/DeleteInstanceEventWindowCommand";
...
import { type DeleteLaunchTemplateVersionsCommandInput, type DeleteLaunchTemplateVersionsCommandOutput } from "./commands/DeleteLaunchTemplateVersionsCommand";
import { type DeleteLocalGatewayRouteCommandInput, type DeleteLocalGatewayRouteCommandOutput } from "./commands/DeleteLocalGatewayRouteCommand";
import { type DeleteLocalGatewayRouteTableCommandInput, type DeleteLocalGatewayRouteTableCommandOutput } from "./commands/DeleteLocalGatewayRouteTableCommand";
import { type DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, type DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput } from "./commands/DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommand";
import { type DeleteLocalGatewayRouteTableVpcAssociationCommandInput, type DeleteLocalGatewayRouteTableVpcAssociationCommandOutput } from "./commands/DeleteLocalGatewayRouteTableVpcAssociationCommand";
import { type DeleteLocalGatewayVirtualInterfaceCommandInput, type DeleteLocalGatewayVirtualInterfaceCommandOutput } from "./commands/DeleteLocalGatewayVirtualInterfaceCommand";
import { type DeleteLocalGatewayVirtualInterfaceGroupCommandInput, type DeleteLocalGatewayVirtualInterfaceGroupCommandOutput } from "./commands/DeleteLocalGatewayVirtualInterfaceGroupCommand";
import { type DeleteManagedPrefixListCommandInput, type DeleteManagedPrefixListCommandOutput } from "./commands/DeleteManagedPrefixListCommand";
import { type DeleteNatGatewayCommandInput, type DeleteNatGatewayCommandOutput } from "./commands/DeleteNatGatewayCommand";
import { type DeleteNetworkAclCommandInput, type DeleteNetworkAclCommandOutput } from "./commands/DeleteNetworkAclCommand";
import { type DeleteNetworkAclEntryCommandInput, type DeleteNetworkAclEntryCommandOutput } from "./commands/DeleteNetworkAclEntryCommand";
import { type DeleteNetworkInsightsAccessScopeAnalysisCommandInput, type DeleteNetworkInsightsAccessScopeAnalysisCommandOutput } from "./commands/DeleteNetworkInsightsAccessScopeAnalysisCommand";
import { type DeleteNetworkInsightsAccessScopeCommandInput, type DeleteNetworkInsightsAccessScopeCommandOutput } from "./commands/DeleteNetworkInsightsAccessScopeCommand";
import { type DeleteNetworkInsightsAnalysisCommandInput, type DeleteNetworkInsightsAnalysisCommandOutput } from "./commands/DeleteNetworkInsightsAnalysisCommand";
import { type DeleteNetworkInsightsPathCommandInput, type DeleteNetworkInsightsPathCommandOutput } from "./commands/DeleteNetworkInsightsPathCommand";
import { type DeleteNetworkInterfaceCommandInput, type DeleteNetworkInterfaceCommandOutput } from "./commands/DeleteNetworkInterfaceCommand";
import { type DeleteNetworkInterfacePermissionCommandInput, type DeleteNetworkInterfacePermissionCommandOutput } from "./commands/DeleteNetworkInterfacePermissionCommand";
import { type DeletePlacementGroupCommandInput, type DeletePlacementGroupCommandOutput } from "./commands/DeletePlacementGroupCommand";
import { type DeletePublicIpv4PoolCommandInput, type DeletePublicIpv4PoolCommandOutput } from "./commands/DeletePublicIpv4PoolCommand";
import { type DeleteQueuedReservedInstancesCommandInput, type DeleteQueuedReservedInstancesCommandOutput } from "./commands/DeleteQueuedReservedInstancesCommand";
import { type DeleteRouteCommandInput, type DeleteRouteCommandOutput } from "./commands/DeleteRouteCommand";
import { type DeleteRouteServerCommandInput, type DeleteRouteServerCommandOutput } from "./commands/DeleteRouteServerCommand";
import { type DeleteRouteServerEndpointCommandInput, type DeleteRouteServerEndpointCommandOutput } from "./commands/DeleteRouteServerEndpointCommand";
import { type DeleteRouteServerPeerCommandInput, type DeleteRouteServerPeerCommandOutput } from "./commands/DeleteRouteServerPeerCommand";
import { type DeleteRouteTableCommandInput, type DeleteRouteTableCommandOutput } from "./commands/DeleteRouteTableCommand";
import { type DeleteSecondaryNetworkCommandInput, type DeleteSecondaryNetworkCommandOutput } from "./commands/DeleteSecondaryNetworkCommand";
import { type DeleteSecondarySubnetCommandInput, type DeleteSecondarySubnetCommandOutput } from "./commands/DeleteSecondarySubnetCommand";
import { type DeleteSecurityGroupCommandInput, type DeleteSecurityGroupCommandOutput } from "./commands/DeleteSecurityGroupCommand";
import { type DeleteSnapshotCommandInput, type DeleteSnapshotCommandOutput } from "./commands/DeleteSnapshotCommand";
import { type DeleteSpotDatafeedSubscriptionCommandInput, type DeleteSpotDatafeedSubscriptionCommandOutput } from "./commands/DeleteSpotDatafeedSubscriptionCommand";
import { type DeleteSubnetCidrReservationCommandInput, type DeleteSubnetCidrReservationCommandOutput } from "./commands/DeleteSubnetCidrReservationCommand";
import { type DeleteSubnetCommandInput, type DeleteSubnetCommandOutput } from "./commands/DeleteSubnetCommand";
import { type DeleteTagsCommandInput, type DeleteTagsCommandOutput } from "./commands/DeleteTagsCommand";
import { type DeleteTrafficMirrorFilterCommandInput, type DeleteTrafficMirrorFilterCommandOutput } from "./commands/DeleteTrafficMirrorFilterCommand";
...
import { type DeleteTransitGatewayMeteringPolicyCommandInput, type DeleteTransitGatewayMeteringPolicyCommandOutput } from "./commands/DeleteTransitGatewayMeteringPolicyCommand";
import { type DeleteTransitGatewayMeteringPolicyEntryCommandInput, type DeleteTransitGatewayMeteringPolicyEntryCommandOutput } from "./commands/DeleteTransitGatewayMeteringPolicyEntryCommand";
import { type DeleteTransitGatewayMulticastDomainCommandInput, type DeleteTransitGatewayMulticastDomainCommandOutput } from "./commands/DeleteTransitGatewayMulticastDomainCommand";
import { type DeleteTransitGatewayPeeringAttachmentCommandInput, type DeleteTransitGatewayPeeringAttachmentCommandOutput } from "./commands/DeleteTransitGatewayPeeringAttachmentCommand";
import { type DeleteTransitGatewayPolicyTableCommandInput, type DeleteTransitGatewayPolicyTableCommandOutput } from "./commands/DeleteTransitGatewayPolicyTableCommand";
import { type DeleteTransitGatewayPolicyTableEntryCommandInput, type DeleteTransitGatewayPolicyTableEntryCommandOutput } from "./commands/DeleteTransitGatewayPolicyTableEntryCommand";
import { type DeleteTransitGatewayPrefixListReferenceCommandInput, type DeleteTransitGatewayPrefixListReferenceCommandOutput } from "./commands/DeleteTransitGatewayPrefixListReferenceCommand";
import { type DeleteTransitGatewayRouteCommandInput, type DeleteTransitGatewayRouteCommandOutput } from "./commands/DeleteTransitGatewayRouteCommand";
import { type DeleteTransitGatewayRouteTableAnnouncementCommandInput, type DeleteTransitGatewayRouteTableAnnouncementCommandOutput } from "./commands/DeleteTransitGatewayRouteTableAnnouncementCommand";
import { type DeleteTransitGatewayRouteTableCommandInput, type DeleteTransitGatewayRouteTableCommandOutput } from "./commands/DeleteTransitGatewayRouteTableCommand";
import { type DeleteTransitGatewayVpcAttachmentCommandInput, type DeleteTransitGatewayVpcAttachmentCommandOutput } from "./commands/DeleteTransitGatewayVpcAttachmentCommand";
import { type DeleteVerifiedAccessEndpointCommandInput, type DeleteVerifiedAccessEndpointCommandOutput } from "./commands/DeleteVerifiedAccessEndpointCommand";
import { type DeleteVerifiedAccessGroupCommandInput, type DeleteVerifiedAccessGroupCommandOutput } from "./commands/DeleteVerifiedAccessGroupCommand";
import { type DeleteVerifiedAccessInstanceCommandInput, type DeleteVerifiedAccessInstanceCommandOutput } from "./commands/DeleteVerifiedAccessInstanceCommand";
import { type DeleteVerifiedAccessTrustProviderCommandInput, type DeleteVerifiedAccessTrustProviderCommandOutput } from "./commands/DeleteVerifiedAccessTrustProviderCommand";
import { type DeleteVolumeCommandInput, type DeleteVolumeCommandOutput } from "./commands/DeleteVolumeCommand";
import { type DeleteVpcBlockPublicAccessExclusionCommandInput, type DeleteVpcBlockPublicAccessExclusionCommandOutput } from "./commands/DeleteVpcBlockPublicAccessExclusionCommand";
import { type DeleteVpcCommandInput, type DeleteVpcCommandOutput } from "./commands/DeleteVpcCommand";
import { type DeleteVpcEncryptionControlCommandInput, type DeleteVpcEncryptionControlCommandOutput } from "./commands/DeleteVpcEncryptionControlCommand";
import { type DeleteVpcEndpointConnectionNotificationsCommandInput, type DeleteVpcEndpointConnectionNotificationsCommandOutput } from "./commands/DeleteVpcEndpointConnectionNotificationsCommand";
import { type DeleteVpcEndpointsCommandInput, type DeleteVpcEndpointsCommandOutput } from "./commands/DeleteVpcEndpointsCommand";
import { type DeleteVpcEndpointServiceConfigurationsCommandInput, type DeleteVpcEndpointServiceConfigurationsCommandOutput } from "./commands/DeleteVpcEndpointServiceConfigurationsCommand";
...
import { type DeleteVpnConcentratorCommandInput, type DeleteVpnConcentratorCommandOutput } from "./commands/DeleteVpnConcentratorCommand";
import { type DeleteVpnConnectionCommandInput, type DeleteVpnConnectionCommandOutput } from "./commands/DeleteVpnConnectionCommand";
import { type DeleteVpnConnectionRouteCommandInput, type DeleteVpnConnectionRouteCommandOutput } from "./commands/DeleteVpnConnectionRouteCommand";
import { type DeleteVpnGatewayCommandInput, type DeleteVpnGatewayCommandOutput } from "./commands/DeleteVpnGatewayCommand";
import { type DeprovisionByoipCidrCommandInput, type DeprovisionByoipCidrCommandOutput } from "./commands/DeprovisionByoipCidrCommand";
import { type DeprovisionIpamByoasnCommandInput, type DeprovisionIpamByoasnCommandOutput } from "./commands/DeprovisionIpamByoasnCommand";
import { type DeprovisionIpamPoolCidrCommandInput, type DeprovisionIpamPoolCidrCommandOutput } from "./commands/DeprovisionIpamPoolCidrCommand";
import { type DeprovisionPublicIpv4PoolCidrCommandInput, type DeprovisionPublicIpv4PoolCidrCommandOutput } from "./commands/DeprovisionPublicIpv4PoolCidrCommand";
import { type DeregisterImageCommandInput, type DeregisterImageCommandOutput } from "./commands/DeregisterImageCommand";
import { type DeregisterInstanceEventNotificationAttributesCommandInput, type DeregisterInstanceEventNotificationAttributesCommandOutput } from "./commands/DeregisterInstanceEventNotificationAttributesCommand";
import { type DeregisterTransitGatewayMulticastGroupMembersCommandInput, type DeregisterTransitGatewayMulticastGroupMembersCommandOutput } from "./commands/DeregisterTransitGatewayMulticastGroupMembersCommand";
import { type DeregisterTransitGatewayMulticastGroupSourcesCommandInput, type DeregisterTransitGatewayMulticastGroupSourcesCommandOutput } from "./commands/DeregisterTransitGatewayMulticastGroupSourcesCommand";
...
import { type DescribeAccountVpcEncryptionControlCommandInput, type DescribeAccountVpcEncryptionControlCommandOutput } from "./commands/DescribeAccountVpcEncryptionControlCommand";
import { type DescribeAddressesAttributeCommandInput, type DescribeAddressesAttributeCommandOutput } from "./commands/DescribeAddressesAttributeCommand";
import { type DescribeAddressesCommandInput, type DescribeAddressesCommandOutput } from "./commands/DescribeAddressesCommand";
import { type DescribeAddressTransfersCommandInput, type DescribeAddressTransfersCommandOutput } from "./commands/DescribeAddressTransfersCommand";
import { type DescribeAggregateIdFormatCommandInput, type DescribeAggregateIdFormatCommandOutput } from "./commands/DescribeAggregateIdFormatCommand";
import { type DescribeApplicationStatusCheckAssociationsCommandInput, type DescribeApplicationStatusCheckAssociationsCommandOutput } from "./commands/DescribeApplicationStatusCheckAssociationsCommand";
import { type DescribeApplicationStatusChecksCommandInput, type DescribeApplicationStatusChecksCommandOutput } from "./commands/DescribeApplicationStatusChecksCommand";
import { type DescribeApplicationStatusCommandInput, type DescribeApplicationStatusCommandOutput } from "./commands/DescribeApplicationStatusCommand";
import { type DescribeAvailabilityZonesCommandInput, type DescribeAvailabilityZonesCommandOutput } from "./commands/DescribeAvailabilityZonesCommand";
import { type DescribeAwsNetworkPerformanceMetricSubscriptionsCommandInput, type DescribeAwsNetworkPerformanceMetricSubscriptionsCommandOutput } from "./commands/DescribeAwsNetworkPerformanceMetricSubscriptionsCommand";
...
import { type DescribeByoipCidrsCommandInput, type DescribeByoipCidrsCommandOutput } from "./commands/DescribeByoipCidrsCommand";
import { type DescribeCapacityBlockExtensionHistoryCommandInput, type DescribeCapacityBlockExtensionHistoryCommandOutput } from "./commands/DescribeCapacityBlockExtensionHistoryCommand";
import { type DescribeCapacityBlockExtensionOfferingsCommandInput, type DescribeCapacityBlockExtensionOfferingsCommandOutput } from "./commands/DescribeCapacityBlockExtensionOfferingsCommand";
import { type DescribeCapacityBlockOfferingsCommandInput, type DescribeCapacityBlockOfferingsCommandOutput } from "./commands/DescribeCapacityBlockOfferingsCommand";
import { type DescribeCapacityBlocksCommandInput, type DescribeCapacityBlocksCommandOutput } from "./commands/DescribeCapacityBlocksCommand";
...
import { type DescribeCarrierGatewaysCommandInput, type DescribeCarrierGatewaysCommandOutput } from "./commands/DescribeCarrierGatewaysCommand";
import { type DescribeClassicLinkInstancesCommandInput, type DescribeClassicLinkInstancesCommandOutput } from "./commands/DescribeClassicLinkInstancesCommand";
import { type DescribeClientVpnAuthorizationRulesCommandInput, type DescribeClientVpnAuthorizationRulesCommandOutput } from "./commands/DescribeClientVpnAuthorizationRulesCommand";
import { type DescribeClientVpnConnectionsCommandInput, type DescribeClientVpnConnectionsCommandOutput } from "./commands/DescribeClientVpnConnectionsCommand";
import { type DescribeClientVpnEndpointsCommandInput, type DescribeClientVpnEndpointsCommandOutput } from "./commands/DescribeClientVpnEndpointsCommand";
import { type DescribeClientVpnRoutesCommandInput, type DescribeClientVpnRoutesCommandOutput } from "./commands/DescribeClientVpnRoutesCommand";
import { type DescribeClientVpnTargetNetworksCommandInput, type DescribeClientVpnTargetNetworksCommandOutput } from "./commands/DescribeClientVpnTargetNetworksCommand";
import { type DescribeCoipPoolsCommandInput, type DescribeCoipPoolsCommandOutput } from "./commands/DescribeCoipPoolsCommand";
...
import { type DescribeDeclarativePoliciesReportsCommandInput, type DescribeDeclarativePoliciesReportsCommandOutput } from "./commands/DescribeDeclarativePoliciesReportsCommand";
import { type DescribeDhcpOptionsCommandInput, type DescribeDhcpOptionsCommandOutput } from "./commands/DescribeDhcpOptionsCommand";
import { type DescribeEgressOnlyInternetGatewaysCommandInput, type DescribeEgressOnlyInternetGatewaysCommandOutput } from "./commands/DescribeEgressOnlyInternetGatewaysCommand";
import { type DescribeElasticGpusCommandInput, type DescribeElasticGpusCommandOutput } from "./commands/DescribeElasticGpusCommand";
import { type DescribeExportImageTasksCommandInput, type DescribeExportImageTasksCommandOutput } from "./commands/DescribeExportImageTasksCommand";
...
import { type DescribeFastLaunchImagesCommandInput, type DescribeFastLaunchImagesCommandOutput } from "./commands/DescribeFastLaunchImagesCommand";
import { type DescribeFastSnapshotRestoresCommandInput, type DescribeFastSnapshotRestoresCommandOutput } from "./commands/DescribeFastSnapshotRestoresCommand";
import { type DescribeFleetHistoryCommandInput, type DescribeFleetHistoryCommandOutput } from "./commands/DescribeFleetHistoryCommand";
import { type DescribeFleetInstancesCommandInput, type DescribeFleetInstancesCommandOutput } from "./commands/DescribeFleetInstancesCommand";
import { type DescribeFleetsCommandInput, type DescribeFleetsCommandOutput } from "./commands/DescribeFleetsCommand";
import { type DescribeFlowLogsCommandInput, type DescribeFlowLogsCommandOutput } from "./commands/DescribeFlowLogsCommand";
import { type DescribeFpgaImageAttributeCommandInput, type DescribeFpgaImageAttributeCommandOutput } from "./commands/DescribeFpgaImageAttributeCommand";
import { type DescribeFpgaImagesCommandInput, type DescribeFpgaImagesCommandOutput } from "./commands/DescribeFpgaImagesCommand";
import { type DescribeHostReservationOfferingsCommandInput, type DescribeHostReservationOfferingsCommandOutput } from "./commands/DescribeHostReservationOfferingsCommand";
import { type DescribeHostReservationsCommandInput, type DescribeHostReservationsCommandOutput } from "./commands/DescribeHostReservationsCommand";
import { type DescribeHostsCommandInput, type DescribeHostsCommandOutput } from "./commands/DescribeHostsCommand";
import { type DescribeIamInstanceProfileAssociationsCommandInput, type DescribeIamInstanceProfileAssociationsCommandOutput } from "./commands/DescribeIamInstanceProfileAssociationsCommand";
import { type DescribeIdentityIdFormatCommandInput, type DescribeIdentityIdFormatCommandOutput } from "./commands/DescribeIdentityIdFormatCommand";
import { type DescribeIdFormatCommandInput, type DescribeIdFormatCommandOutput } from "./commands/DescribeIdFormatCommand";
import { type DescribeImageAttributeCommandInput, type DescribeImageAttributeCommandOutput } from "./commands/DescribeImageAttributeCommand";
import { type DescribeImageReferencesCommandInput, type DescribeImageReferencesCommandOutput } from "./commands/DescribeImageReferencesCommand";
import { type DescribeImagesCommandInput, type DescribeImagesCommandOutput } from "./commands/DescribeImagesCommand";
import { type DescribeImageUsageReportEntriesCommandInput, type DescribeImageUsageReportEntriesCommandOutput } from "./commands/DescribeImageUsageReportEntriesCommand";
...
import { type DescribeImportImageTasksCommandInput, type DescribeImportImageTasksCommandOutput } from "./commands/DescribeImportImageTasksCommand";
...
import { type DescribeInstanceAttributeCommandInput, type DescribeInstanceAttributeCommandOutput } from "./commands/DescribeInstanceAttributeCommand";
import { type DescribeInstanceConnectEndpointsCommandInput, type DescribeInstanceConnectEndpointsCommandOutput } from "./commands/DescribeInstanceConnectEndpointsCommand";
import { type DescribeInstanceCreditSpecificationsCommandInput, type DescribeInstanceCreditSpecificationsCommandOutput } from "./commands/DescribeInstanceCreditSpecificationsCommand";
import { type DescribeInstanceEventNotificationAttributesCommandInput, type DescribeInstanceEventNotificationAttributesCommandOutput } from "./commands/DescribeInstanceEventNotificationAttributesCommand";
import { type DescribeInstanceEventWindowsCommandInput, type DescribeInstanceEventWindowsCommandOutput } from "./commands/DescribeInstanceEventWindowsCommand";
import { type DescribeInstanceImageMetadataCommandInput, type DescribeInstanceImageMetadataCommandOutput } from "./commands/DescribeInstanceImageMetadataCommand";
import { type DescribeInstancesCommandInput, type DescribeInstancesCommandOutput } from "./commands/DescribeInstancesCommand";
import { type DescribeInstanceSqlHaHistoryStatesCommandInput, type DescribeInstanceSqlHaHistoryStatesCommandOutput } from "./commands/DescribeInstanceSqlHaHistoryStatesCommand";
import { type DescribeInstanceSqlHaStatesCommandInput, type DescribeInstanceSqlHaStatesCommandOutput } from "./commands/DescribeInstanceSqlHaStatesCommand";
...
import { type DescribeInstanceTopologyCommandInput, type DescribeInstanceTopologyCommandOutput } from "./commands/DescribeInstanceTopologyCommand";
import { type DescribeInstanceTypeOfferingsCommandInput, type DescribeInstanceTypeOfferingsCommandOutput } from "./commands/DescribeInstanceTypeOfferingsCommand";
import { type DescribeInstanceTypesCommandInput, type DescribeInstanceTypesCommandOutput } from "./commands/DescribeInstanceTypesCommand";
...
import { type DescribeIpamResourceDiscoveriesCommandInput, type DescribeIpamResourceDiscoveriesCommandOutput } from "./commands/DescribeIpamResourceDiscoveriesCommand";
import { type DescribeIpamResourceDiscoveryAssociationsCommandInput, type DescribeIpamResourceDiscoveryAssociationsCommandOutput } from "./commands/DescribeIpamResourceDiscoveryAssociationsCommand";
import { type DescribeIpamsCommandInput, type DescribeIpamsCommandOutput } from "./commands/DescribeIpamsCommand";
import { type DescribeIpamScopesCommandInput, type DescribeIpamScopesCommandOutput } from "./commands/DescribeIpamScopesCommand";
import { type DescribeIpv6PoolsCommandInput, type DescribeIpv6PoolsCommandOutput } from "./commands/DescribeIpv6PoolsCommand";
import { type DescribeKeyPairsCommandInput, type DescribeKeyPairsCommandOutput } from "./commands/DescribeKeyPairsCommand";
import { type DescribeLaunchTemplatesCommandInput, type DescribeLaunchTemplatesCommandOutput } from "./commands/DescribeLaunchTemplatesCommand";
import { type DescribeLaunchTemplateVersionsCommandInput, type DescribeLaunchTemplateVersionsCommandOutput } from "./commands/DescribeLaunchTemplateVersionsCommand";
import { type DescribeLocalGatewayRouteTablesCommandInput, type DescribeLocalGatewayRouteTablesCommandOutput } from "./commands/DescribeLocalGatewayRouteTablesCommand";
import { type DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsCommandInput, type DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsCommandOutput } from "./commands/DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsCommand";
import { type DescribeLocalGatewayRouteTableVpcAssociationsCommandInput, type DescribeLocalGatewayRouteTableVpcAssociationsCommandOutput } from "./commands/DescribeLocalGatewayRouteTableVpcAssociationsCommand";
import { type DescribeLocalGatewaysCommandInput, type DescribeLocalGatewaysCommandOutput } from "./commands/DescribeLocalGatewaysCommand";
import { type DescribeLocalGatewayVirtualInterfaceGroupsCommandInput, type DescribeLocalGatewayVirtualInterfaceGroupsCommandOutput } from "./commands/DescribeLocalGatewayVirtualInterfaceGroupsCommand";
import { type DescribeLocalGatewayVirtualInterfacesCommandInput, type DescribeLocalGatewayVirtualInterfacesCommandOutput } from "./commands/DescribeLocalGatewayVirtualInterfacesCommand";
import { type DescribeLockedSnapshotsCommandInput, type DescribeLockedSnapshotsCommandOutput } from "./commands/DescribeLockedSnapshotsCommand";
import { type DescribeMacHostsCommandInput, type DescribeMacHostsCommandOutput } from "./commands/DescribeMacHostsCommand";
import { type DescribeMacModificationTasksCommandInput, type DescribeMacModificationTasksCommandOutput } from "./commands/DescribeMacModificationTasksCommand";
import { type DescribeManagedPrefixListsCommandInput, type DescribeManagedPrefixListsCommandOutput } from "./commands/DescribeManagedPrefixListsCommand";
import { type DescribeMovingAddressesCommandInput, type DescribeMovingAddressesCommandOutput } from "./commands/DescribeMovingAddressesCommand";
...
import { type DescribeNetworkAclsCommandInput, type DescribeNetworkAclsCommandOutput } from "./commands/DescribeNetworkAclsCommand";
import { type DescribeNetworkInsightsAccessScopeAnalysesCommandInput, type DescribeNetworkInsightsAccessScopeAnalysesCommandOutput } from "./commands/DescribeNetworkInsightsAccessScopeAnalysesCommand";
import { type DescribeNetworkInsightsAccessScopesCommandInput, type DescribeNetworkInsightsAccessScopesCommandOutput } from "./commands/DescribeNetworkInsightsAccessScopesCommand";
import { type DescribeNetworkInsightsAnalysesCommandInput, type DescribeNetworkInsightsAnalysesCommandOutput } from "./commands/DescribeNetworkInsightsAnalysesCommand";
import { type DescribeNetworkInsightsPathsCommandInput, type DescribeNetworkInsightsPathsCommandOutput } from "./commands/DescribeNetworkInsightsPathsCommand";
import { type DescribeNetworkInterfaceAttributeCommandInput, type DescribeNetworkInterfaceAttributeCommandOutput } from "./commands/DescribeNetworkInterfaceAttributeCommand";
import { type DescribeNetworkInterfacePermissionsCommandInput, type DescribeNetworkInterfacePermissionsCommandOutput } from "./commands/DescribeNetworkInterfacePermissionsCommand";
...
import { type DescribeOutpostLagsCommandInput, type DescribeOutpostLagsCommandOutput } from "./commands/DescribeOutpostLagsCommand";
import { type DescribePlacementGroupsCommandInput, type DescribePlacementGroupsCommandOutput } from "./commands/DescribePlacementGroupsCommand";
import { type DescribePrefixListsCommandInput, type DescribePrefixListsCommandOutput } from "./commands/DescribePrefixListsCommand";
import { type DescribePrincipalIdFormatCommandInput, type DescribePrincipalIdFormatCommandOutput } from "./commands/DescribePrincipalIdFormatCommand";
import { type DescribePublicIpv4PoolsCommandInput, type DescribePublicIpv4PoolsCommandOutput } from "./commands/DescribePublicIpv4PoolsCommand";
import { type DescribeRegionsCommandInput, type DescribeRegionsCommandOutput } from "./commands/DescribeRegionsCommand";
import { type DescribeReplaceRootVolumeTasksCommandInput, type DescribeReplaceRootVolumeTasksCommandOutput } from "./commands/DescribeReplaceRootVolumeTasksCommand";
...
import { type DescribeReservedInstancesListingsCommandInput, type DescribeReservedInstancesListingsCommandOutput } from "./commands/DescribeReservedInstancesListingsCommand";
import { type DescribeReservedInstancesModificationsCommandInput, type DescribeReservedInstancesModificationsCommandOutput } from "./commands/DescribeReservedInstancesModificationsCommand";
import { type DescribeReservedInstancesOfferingsCommandInput, type DescribeReservedInstancesOfferingsCommandOutput } from "./commands/DescribeReservedInstancesOfferingsCommand";
import { type DescribeRouteServerEndpointsCommandInput, type DescribeRouteServerEndpointsCommandOutput } from "./commands/DescribeRouteServerEndpointsCommand";
import { type DescribeRouteServerPeersCommandInput, type DescribeRouteServerPeersCommandOutput } from "./commands/DescribeRouteServerPeersCommand";
import { type DescribeRouteServersCommandInput, type DescribeRouteServersCommandOutput } from "./commands/DescribeRouteServersCommand";
import { type DescribeRouteTablesCommandInput, type DescribeRouteTablesCommandOutput } from "./commands/DescribeRouteTablesCommand";
import { type DescribeScheduledInstanceAvailabilityCommandInput, type DescribeScheduledInstanceAvailabilityCommandOutput } from "./commands/DescribeScheduledInstanceAvailabilityCommand";
import { type DescribeScheduledInstancesCommandInput, type DescribeScheduledInstancesCommandOutput } from "./commands/DescribeScheduledInstancesCommand";
import { type DescribeSecondaryInterfacesCommandInput, type DescribeSecondaryInterfacesCommandOutput } from "./commands/DescribeSecondaryInterfacesCommand";
...
import { type DescribeSecurityGroupReferencesCommandInput, type DescribeSecurityGroupReferencesCommandOutput } from "./commands/DescribeSecurityGroupReferencesCommand";
import { type DescribeSecurityGroupRulesCommandInput, type DescribeSecurityGroupRulesCommandOutput } from "./commands/DescribeSecurityGroupRulesCommand";
...
import { type DescribeServiceLinkVirtualInterfacesCommandInput, type DescribeServiceLinkVirtualInterfacesCommandOutput } from "./commands/DescribeServiceLinkVirtualInterfacesCommand";
import { type DescribeSnapshotAttributeCommandInput, type DescribeSnapshotAttributeCommandOutput } from "./commands/DescribeSnapshotAttributeCommand";
import { type DescribeSnapshotsCommandInput, type DescribeSnapshotsCommandOutput } from "./commands/DescribeSnapshotsCommand";
import { type DescribeSnapshotTierStatusCommandInput, type DescribeSnapshotTierStatusCommandOutput } from "./commands/DescribeSnapshotTierStatusCommand";
import { type DescribeSpotDatafeedSubscriptionCommandInput, type DescribeSpotDatafeedSubscriptionCommandOutput } from "./commands/DescribeSpotDatafeedSubscriptionCommand";
import { type DescribeSpotFleetInstancesCommandInput, type DescribeSpotFleetInstancesCommandOutput } from "./commands/DescribeSpotFleetInstancesCommand";
import { type DescribeSpotFleetRequestHistoryCommandInput, type DescribeSpotFleetRequestHistoryCommandOutput } from "./commands/DescribeSpotFleetRequestHistoryCommand";
import { type DescribeSpotFleetRequestsCommandInput, type DescribeSpotFleetRequestsCommandOutput } from "./commands/DescribeSpotFleetRequestsCommand";
...
import { type DescribeSpotPriceHistoryCommandInput, type DescribeSpotPriceHistoryCommandOutput } from "./commands/DescribeSpotPriceHistoryCommand";
import { type DescribeStaleSecurityGroupsCommandInput, type DescribeStaleSecurityGroupsCommandOutput } from "./commands/DescribeStaleSecurityGroupsCommand";
...
import { type DescribeTrafficMirrorFilterRulesCommandInput, type DescribeTrafficMirrorFilterRulesCommandOutput } from "./commands/DescribeTrafficMirrorFilterRulesCommand";
import { type DescribeTrafficMirrorFiltersCommandInput, type DescribeTrafficMirrorFiltersCommandOutput } from "./commands/DescribeTrafficMirrorFiltersCommand";
import { type DescribeTrafficMirrorSessionsCommandInput, type DescribeTrafficMirrorSessionsCommandOutput } from "./commands/DescribeTrafficMirrorSessionsCommand";
import { type DescribeTrafficMirrorTargetsCommandInput, type DescribeTrafficMirrorTargetsCommandOutput } from "./commands/DescribeTrafficMirrorTargetsCommand";
import { type DescribeTransitGatewayAttachmentsCommandInput, type DescribeTransitGatewayAttachmentsCommandOutput } from "./commands/DescribeTransitGatewayAttachmentsCommand";
import { type DescribeTransitGatewayConnectPeersCommandInput, type DescribeTransitGatewayConnectPeersCommandOutput } from "./commands/DescribeTransitGatewayConnectPeersCommand";
import { type DescribeTransitGatewayConnectsCommandInput, type DescribeTransitGatewayConnectsCommandOutput } from "./commands/DescribeTransitGatewayConnectsCommand";
import { type DescribeTransitGatewayMeteringPoliciesCommandInput, type DescribeTransitGatewayMeteringPoliciesCommandOutput } from "./commands/DescribeTransitGatewayMeteringPoliciesCommand";
import { type DescribeTransitGatewayMulticastDomainsCommandInput, type DescribeTransitGatewayMulticastDomainsCommandOutput } from "./commands/DescribeTransitGatewayMulticastDomainsCommand";
import { type DescribeTransitGatewayPeeringAttachmentsCommandInput, type DescribeTransitGatewayPeeringAttachmentsCommandOutput } from "./commands/DescribeTransitGatewayPeeringAttachmentsCommand";
import { type DescribeTransitGatewayPolicyTablesCommandInput, type DescribeTransitGatewayPolicyTablesCommandOutput } from "./commands/DescribeTransitGatewayPolicyTablesCommand";
import { type DescribeTransitGatewayRouteTableAnnouncementsCommandInput, type DescribeTransitGatewayRouteTableAnnouncementsCommandOutput } from "./commands/DescribeTransitGatewayRouteTableAnnouncementsCommand";
import { type DescribeTransitGatewayRouteTablesCommandInput, type DescribeTransitGatewayRouteTablesCommandOutput } from "./commands/DescribeTransitGatewayRouteTablesCommand";
import { type DescribeTransitGatewaysCommandInput, type DescribeTransitGatewaysCommandOutput } from "./commands/DescribeTransitGatewaysCommand";
import { type DescribeTransitGatewayVpcAttachmentsCommandInput, type DescribeTransitGatewayVpcAttachmentsCommandOutput } from "./commands/DescribeTransitGatewayVpcAttachmentsCommand";
import { type DescribeTrunkInterfaceAssociationsCommandInput, type DescribeTrunkInterfaceAssociationsCommandOutput } from "./commands/DescribeTrunkInterfaceAssociationsCommand";
import { type DescribeVerifiedAccessEndpointsCommandInput, type DescribeVerifiedAccessEndpointsCommandOutput } from "./commands/DescribeVerifiedAccessEndpointsCommand";
import { type DescribeVerifiedAccessGroupsCommandInput, type DescribeVerifiedAccessGroupsCommandOutput } from "./commands/DescribeVerifiedAccessGroupsCommand";
import { type DescribeVerifiedAccessInstanceLoggingConfigurationsCommandInput, type DescribeVerifiedAccessInstanceLoggingConfigurationsCommandOutput } from "./commands/DescribeVerifiedAccessInstanceLoggingConfigurationsCommand";
import { type DescribeVerifiedAccessInstancesCommandInput, type DescribeVerifiedAccessInstancesCommandOutput } from "./commands/DescribeVerifiedAccessInstancesCommand";
import { type DescribeVerifiedAccessTrustProvidersCommandInput, type DescribeVerifiedAccessTrustProvidersCommandOutput } from "./commands/DescribeVerifiedAccessTrustProvidersCommand";
import { type DescribeVolumeAttributeCommandInput, type DescribeVolumeAttributeCommandOutput } from "./commands/DescribeVolumeAttributeCommand";
import { type DescribeVolumesCommandInput, type DescribeVolumesCommandOutput } from "./commands/DescribeVolumesCommand";
import { type DescribeVolumesModificationsCommandInput, type DescribeVolumesModificationsCommandOutput } from "./commands/DescribeVolumesModificationsCommand";
import { type DescribeVolumeStatusCommandInput, type DescribeVolumeStatusCommandOutput } from "./commands/DescribeVolumeStatusCommand";
import { type DescribeVpcAttributeCommandInput, type DescribeVpcAttributeCommandOutput } from "./commands/DescribeVpcAttributeCommand";
import { type DescribeVpcBlockPublicAccessExclusionsCommandInput, type DescribeVpcBlockPublicAccessExclusionsCommandOutput } from "./commands/DescribeVpcBlockPublicAccessExclusionsCommand";
import { type DescribeVpcBlockPublicAccessOptionsCommandInput, type DescribeVpcBlockPublicAccessOptionsCommandOutput } from "./commands/DescribeVpcBlockPublicAccessOptionsCommand";
import { type DescribeVpcClassicLinkCommandInput, type DescribeVpcClassicLinkCommandOutput } from "./commands/DescribeVpcClassicLinkCommand";
import { type DescribeVpcClassicLinkDnsSupportCommandInput, type DescribeVpcClassicLinkDnsSupportCommandOutput } from "./commands/DescribeVpcClassicLinkDnsSupportCommand";
import { type DescribeVpcEncryptionControlsCommandInput, type DescribeVpcEncryptionControlsCommandOutput } from "./commands/DescribeVpcEncryptionControlsCommand";
import { type DescribeVpcEndpointAssociationsCommandInput, type DescribeVpcEndpointAssociationsCommandOutput } from "./commands/DescribeVpcEndpointAssociationsCommand";
import { type DescribeVpcEndpointConnectionNotificationsCommandInput, type DescribeVpcEndpointConnectionNotificationsCommandOutput } from "./commands/DescribeVpcEndpointConnectionNotificationsCommand";
import { type DescribeVpcEndpointConnectionsCommandInput, type DescribeVpcEndpointConnectionsCommandOutput } from "./commands/DescribeVpcEndpointConnectionsCommand";
...
import { type DescribeVpcEndpointServiceConfigurationsCommandInput, type DescribeVpcEndpointServiceConfigurationsCommandOutput } from "./commands/DescribeVpcEndpointServiceConfigurationsCommand";
import { type DescribeVpcEndpointServicePermissionsCommandInput, type DescribeVpcEndpointServicePermissionsCommandOutput } from "./commands/DescribeVpcEndpointServicePermissionsCommand";
import { type DescribeVpcEndpointServicesCommandInput, type DescribeVpcEndpointServicesCommandOutput } from "./commands/DescribeVpcEndpointServicesCommand";
...
import { type DescribeVpnConcentratorsCommandInput, type DescribeVpnConcentratorsCommandOutput } from "./commands/DescribeVpnConcentratorsCommand";
...
import { type DetachVpnGatewayCommandInput, type DetachVpnGatewayCommandOutput } from "./commands/DetachVpnGatewayCommand";
import { type DisableAddressTransferCommandInput, type DisableAddressTransferCommandOutput } from "./commands/DisableAddressTransferCommand";
import { type DisableAllowedImagesSettingsCommandInput, type DisableAllowedImagesSettingsCommandOutput } from "./commands/DisableAllowedImagesSettingsCommand";
import { type DisableApplicationStatusCheckSuppressionCommandInput, type DisableApplicationStatusCheckSuppressionCommandOutput } from "./commands/DisableApplicationStatusCheckSuppressionCommand";
import { type DisableAwsNetworkPerformanceMetricSubscriptionCommandInput, type DisableAwsNetworkPerformanceMetricSubscriptionCommandOutput } from "./commands/DisableAwsNetworkPerformanceMetricSubscriptionCommand";
import { type DisableCapacityManagerCommandInput, type DisableCapacityManagerCommandOutput } from "./commands/DisableCapacityManagerCommand";
import { type DisableEbsEncryptionByDefaultCommandInput, type DisableEbsEncryptionByDefaultCommandOutput } from "./commands/DisableEbsEncryptionByDefaultCommand";
import { type DisableFastLaunchCommandInput, type DisableFastLaunchCommandOutput } from "./commands/DisableFastLaunchCommand";
import { type DisableFastSnapshotRestoresCommandInput, type DisableFastSnapshotRestoresCommandOutput } from "./commands/DisableFastSnapshotRestoresCommand";
import { type DisableImageBlockPublicAccessCommandInput, type DisableImageBlockPublicAccessCommandOutput } from "./commands/DisableImageBlockPublicAccessCommand";
import { type DisableImageCommandInput, type DisableImageCommandOutput } from "./commands/DisableImageCommand";
import { type DisableImageDeprecationCommandInput, type DisableImageDeprecationCommandOutput } from "./commands/DisableImageDeprecationCommand";
import { type DisableImageDeregistrationProtectionCommandInput, type DisableImageDeregistrationProtectionCommandOutput } from "./commands/DisableImageDeregistrationProtectionCommand";
import { type DisableInstanceSqlHaStandbyDetectionsCommandInput, type DisableInstanceSqlHaStandbyDetectionsCommandOutput } from "./commands/DisableInstanceSqlHaStandbyDetectionsCommand";
import { type DisableIpamOrganizationAdminAccountCommandInput, type DisableIpamOrganizationAdminAccountCommandOutput } from "./commands/DisableIpamOrganizationAdminAccountCommand";
import { type DisableIpamPolicyCommandInput, type DisableIpamPolicyCommandOutput } from "./commands/DisableIpamPolicyCommand";
import { type DisableRouteServerPropagationCommandInput, type DisableRouteServerPropagationCommandOutput } from "./commands/DisableRouteServerPropagationCommand";
import { type DisableSerialConsoleAccessCommandInput, type DisableSerialConsoleAccessCommandOutput } from "./commands/DisableSerialConsoleAccessCommand";
import { type DisableSnapshotBlockPublicAccessCommandInput, type DisableSnapshotBlockPublicAccessCommandOutput } from "./commands/DisableSnapshotBlockPublicAccessCommand";
import { type DisableTransitGatewayRouteTablePropagationCommandInput, type DisableTransitGatewayRouteTablePropagationCommandOutput } from "./commands/DisableTransitGatewayRouteTablePropagationCommand";
import { type DisableVgwRoutePropagationCommandInput, type DisableVgwRoutePropagationCommandOutput } from "./commands/DisableVgwRoutePropagationCommand";
import { type DisableVpcClassicLinkCommandInput, type DisableVpcClassicLinkCommandOutput } from "./commands/DisableVpcClassicLinkCommand";
import { type DisableVpcClassicLinkDnsSupportCommandInput, type DisableVpcClassicLinkDnsSupportCommandOutput } from "./commands/DisableVpcClassicLinkDnsSupportCommand";
import { type DisassociateAddressCommandInput, type DisassociateAddressCommandOutput } from "./commands/DisassociateAddressCommand";
import { type DisassociateApplicationStatusCheckCommandInput, type DisassociateApplicationStatusCheckCommandOutput } from "./commands/DisassociateApplicationStatusCheckCommand";
import { type DisassociateCapacityReservationBillingOwnerCommandInput, type DisassociateCapacityReservationBillingOwnerCommandOutput } from "./commands/DisassociateCapacityReservationBillingOwnerCommand";
import { type DisassociateClientVpnTargetNetworkCommandInput, type DisassociateClientVpnTargetNetworkCommandOutput } from "./commands/DisassociateClientVpnTargetNetworkCommand";
import { type DisassociateEnclaveCertificateIamRoleCommandInput, type DisassociateEnclaveCertificateIamRoleCommandOutput } from "./commands/DisassociateEnclaveCertificateIamRoleCommand";
import { type DisassociateIamInstanceProfileCommandInput, type DisassociateIamInstanceProfileCommandOutput } from "./commands/DisassociateIamInstanceProfileCommand";
import { type DisassociateInstanceEventWindowCommandInput, type DisassociateInstanceEventWindowCommandOutput } from "./commands/DisassociateInstanceEventWindowCommand";
import { type DisassociateIpamByoasnCommandInput, type DisassociateIpamByoasnCommandOutput } from "./commands/DisassociateIpamByoasnCommand";
import { type DisassociateIpamResourceDiscoveryCommandInput, type DisassociateIpamResourceDiscoveryCommandOutput } from "./commands/DisassociateIpamResourceDiscoveryCommand";
import { type DisassociateNatGatewayAddressCommandInput, type DisassociateNatGatewayAddressCommandOutput } from "./commands/DisassociateNatGatewayAddressCommand";
import { type DisassociateRouteServerCommandInput, type DisassociateRouteServerCommandOutput } from "./commands/DisassociateRouteServerCommand";
import { type DisassociateRouteTableCommandInput, type DisassociateRouteTableCommandOutput } from "./commands/DisassociateRouteTableCommand";
import { type DisassociateSecurityGroupVpcCommandInput, type DisassociateSecurityGroupVpcCommandOutput } from "./commands/DisassociateSecurityGroupVpcCommand";
import { type DisassociateSubnetCidrBlockCommandInput, type DisassociateSubnetCidrBlockCommandOutput } from "./commands/DisassociateSubnetCidrBlockCommand";
import { type DisassociateTransitGatewayMulticastDomainCommandInput, type DisassociateTransitGatewayMulticastDomainCommandOutput } from "./commands/DisassociateTransitGatewayMulticastDomainCommand";
import { type DisassociateTransitGatewayPolicyTableCommandInput, type DisassociateTransitGatewayPolicyTableCommandOutput } from "./commands/DisassociateTransitGatewayPolicyTableCommand";
import { type DisassociateTransitGatewayRouteTableCommandInput, type DisassociateTransitGatewayRouteTableCommandOutput } from "./commands/DisassociateTransitGatewayRouteTableCommand";
import { type DisassociateTrunkInterfaceCommandInput, type DisassociateTrunkInterfaceCommandOutput } from "./commands/DisassociateTrunkInterfaceCommand";
import { type DisassociateVpcCidrBlockCommandInput, type DisassociateVpcCidrBlockCommandOutput } from "./commands/DisassociateVpcCidrBlockCommand";
import { type EnableAddressTransferCommandInput, type EnableAddressTransferCommandOutput } from "./commands/EnableAddressTransferCommand";
import { type EnableAllowedImagesSettingsCommandInput, type EnableAllowedImagesSettingsCommandOutput } from "./commands/EnableAllowedImagesSettingsCommand";
import { type EnableApplicationStatusCheckSuppressionCommandInput, type EnableApplicationStatusCheckSuppressionCommandOutput } from "./commands/EnableApplicationStatusCheckSuppressionCommand";
import { type EnableAwsNetworkPerformanceMetricSubscriptionCommandInput, type EnableAwsNetworkPerformanceMetricSubscriptionCommandOutput } from "./commands/EnableAwsNetworkPerformanceMetricSubscriptionCommand";
import { type EnableCapacityManagerCommandInput, type EnableCapacityManagerCommandOutput } from "./commands/EnableCapacityManagerCommand";
import { type EnableEbsEncryptionByDefaultCommandInput, type EnableEbsEncryptionByDefaultCommandOutput } from "./commands/EnableEbsEncryptionByDefaultCommand";
import { type EnableFastLaunchCommandInput, type EnableFastLaunchCommandOutput } from "./commands/EnableFastLaunchCommand";
import { type EnableFastSnapshotRestoresCommandInput, type EnableFastSnapshotRestoresCommandOutput } from "./commands/EnableFastSnapshotRestoresCommand";
import { type EnableImageBlockPublicAccessCommandInput, type EnableImageBlockPublicAccessCommandOutput } from "./commands/EnableImageBlockPublicAccessCommand";
import { type EnableImageCommandInput, type EnableImageCommandOutput } from "./commands/EnableImageCommand";
...
import { type EnableRouteServerPropagationCommandInput, type EnableRouteServerPropagationCommandOutput } from "./commands/EnableRouteServerPropagationCommand";
import { type EnableSerialConsoleAccessCommandInput, type EnableSerialConsoleAccessCommandOutput } from "./commands/EnableSerialConsoleAccessCommand";
import { type EnableSnapshotBlockPublicAccessCommandInput, type EnableSnapshotBlockPublicAccessCommandOutput } from "./commands/EnableSnapshotBlockPublicAccessCommand";
import { type EnableTransitGatewayRouteTablePropagationCommandInput, type EnableTransitGatewayRouteTablePropagationCommandOutput } from "./commands/EnableTransitGatewayRouteTablePropagationCommand";
import { type EnableVgwRoutePropagationCommandInput, type EnableVgwRoutePropagationCommandOutput } from "./commands/EnableVgwRoutePropagationCommand";
import { type EnableVolumeIOCommandInput, type EnableVolumeIOCommandOutput } from "./commands/EnableVolumeIOCommand";
import { type EnableVpcClassicLinkCommandInput, type EnableVpcClassicLinkCommandOutput } from "./commands/EnableVpcClassicLinkCommand";
import { type EnableVpcClassicLinkDnsSupportCommandInput, type EnableVpcClassicLinkDnsSupportCommandOutput } from "./commands/EnableVpcClassicLinkDnsSupportCommand";
import { type ExportClientVpnClientCertificateRevocationListCommandInput, type ExportClientVpnClientCertificateRevocationListCommandOutput } from "./commands/ExportClientVpnClientCertificateRevocationListCommand";
import { type ExportClientVpnClientConfigurationCommandInput, type ExportClientVpnClientConfigurationCommandOutput } from "./commands/ExportClientVpnClientConfigurationCommand";
import { type ExportImageCommandInput, type ExportImageCommandOutput } from "./commands/ExportImageCommand";
import { type ExportTransitGatewayRoutesCommandInput, type ExportTransitGatewayRoutesCommandOutput } from "./commands/ExportTransitGatewayRoutesCommand";
import { type ExportVerifiedAccessInstanceClientConfigurationCommandInput, type ExportVerifiedAccessInstanceClientConfigurationCommandOutput } from "./commands/ExportVerifiedAccessInstanceClientConfigurationCommand";
import { type GetActiveVpnTunnelStatusCommandInput, type GetActiveVpnTunnelStatusCommandOutput } from "./commands/GetActiveVpnTunnelStatusCommand";
import { type GetAllowedImagesSettingsCommandInput, type GetAllowedImagesSettingsCommandOutput } from "./commands/GetAllowedImagesSettingsCommand";
import { type GetAssociatedEnclaveCertificateIamRolesCommandInput, type GetAssociatedEnclaveCertificateIamRolesCommandOutput } from "./commands/GetAssociatedEnclaveCertificateIamRolesCommand";
import { type GetAssociatedIpv6PoolCidrsCommandInput, type GetAssociatedIpv6PoolCidrsCommandOutput } from "./commands/GetAssociatedIpv6PoolCidrsCommand";
import { type GetAwsNetworkPerformanceDataCommandInput, type GetAwsNetworkPerformanceDataCommandOutput } from "./commands/GetAwsNetworkPerformanceDataCommand";
...
import { type GetConsoleScreenshotCommandInput, type GetConsoleScreenshotCommandOutput } from "./commands/GetConsoleScreenshotCommand";
import { type GetDeclarativePoliciesReportSummaryCommandInput, type GetDeclarativePoliciesReportSummaryCommandOutput } from "./commands/GetDeclarativePoliciesReportSummaryCommand";
import { type GetDefaultCreditSpecificationCommandInput, type GetDefaultCreditSpecificationCommandOutput } from "./commands/GetDefaultCreditSpecificationCommand";
import { type GetEbsDefaultKmsKeyIdCommandInput, type GetEbsDefaultKmsKeyIdCommandOutput } from "./commands/GetEbsDefaultKmsKeyIdCommand";
import { type GetEbsEncryptionByDefaultCommandInput, type GetEbsEncryptionByDefaultCommandOutput } from "./commands/GetEbsEncryptionByDefaultCommand";
import { type GetEnabledIpamPolicyCommandInput, type GetEnabledIpamPolicyCommandOutput } from "./commands/GetEnabledIpamPolicyCommand";
import { type GetFlowLogsIntegrationTemplateCommandInput, type GetFlowLogsIntegrationTemplateCommandOutput } from "./commands/GetFlowLogsIntegrationTemplateCommand";
import { type GetGroupsForCapacityReservationCommandInput, type GetGroupsForCapacityReservationCommandOutput } from "./commands/GetGroupsForCapacityReservationCommand";
import { type GetHostReservationPurchasePreviewCommandInput, type GetHostReservationPurchasePreviewCommandOutput } from "./commands/GetHostReservationPurchasePreviewCommand";
import { type GetImageAncestryCommandInput, type GetImageAncestryCommandOutput } from "./commands/GetImageAncestryCommand";
import { type GetImageBlockPublicAccessStateCommandInput, type GetImageBlockPublicAccessStateCommandOutput } from "./commands/GetImageBlockPublicAccessStateCommand";
import { type GetInstanceMetadataDefaultsCommandInput, type GetInstanceMetadataDefaultsCommandOutput } from "./commands/GetInstanceMetadataDefaultsCommand";
import { type GetInstanceTpmEkPubCommandInput, type GetInstanceTpmEkPubCommandOutput } from "./commands/GetInstanceTpmEkPubCommand";
import { type GetInstanceTypesFromInstanceRequirementsCommandInput, type GetInstanceTypesFromInstanceRequirementsCommandOutput } from "./commands/GetInstanceTypesFromInstanceRequirementsCommand";
import { type GetInstanceUefiDataCommandInput, type GetInstanceUefiDataCommandOutput } from "./commands/GetInstanceUefiDataCommand";
import { type GetIpamAddressHistoryCommandInput, type GetIpamAddressHistoryCommandOutput } from "./commands/GetIpamAddressHistoryCommand";
...
import { type GetIpamPoolCidrsCommandInput, type GetIpamPoolCidrsCommandOutput } from "./commands/GetIpamPoolCidrsCommand";
import { type GetIpamPrefixListResolverRulesCommandInput, type GetIpamPrefixListResolverRulesCommandOutput } from "./commands/GetIpamPrefixListResolverRulesCommand";
...
import { type GetReservedInstancesExchangeQuoteCommandInput, type GetReservedInstancesExchangeQuoteCommandOutput } from "./commands/GetReservedInstancesExchangeQuoteCommand";
import { type GetRouteServerAssociationsCommandInput, type GetRouteServerAssociationsCommandOutput } from "./commands/GetRouteServerAssociationsCommand";
import { type GetRouteServerPropagationsCommandInput, type GetRouteServerPropagationsCommandOutput } from "./commands/GetRouteServerPropagationsCommand";
import { type GetRouteServerRoutingDatabaseCommandInput, type GetRouteServerRoutingDatabaseCommandOutput } from "./commands/GetRouteServerRoutingDatabaseCommand";
import { type GetSecurityGroupsForVpcCommandInput, type GetSecurityGroupsForVpcCommandOutput } from "./commands/GetSecurityGroupsForVpcCommand";
import { type GetSerialConsoleAccessStatusCommandInput, type GetSerialConsoleAccessStatusCommandOutput } from "./commands/GetSerialConsoleAccessStatusCommand";
import { type GetSnapshotBlockPublicAccessStateCommandInput, type GetSnapshotBlockPublicAccessStateCommandOutput } from "./commands/GetSnapshotBlockPublicAccessStateCommand";
import { type GetSpotPlacementScoresCommandInput, type GetSpotPlacementScoresCommandOutput } from "./commands/GetSpotPlacementScoresCommand";
import { type GetSubnetCidrReservationsCommandInput, type GetSubnetCidrReservationsCommandOutput } from "./commands/GetSubnetCidrReservationsCommand";
import { type GetTransitGatewayAttachmentPropagationsCommandInput, type GetTransitGatewayAttachmentPropagationsCommandOutput } from "./commands/GetTransitGatewayAttachmentPropagationsCommand";
import { type GetTransitGatewayMeteringPolicyEntriesCommandInput, type GetTransitGatewayMeteringPolicyEntriesCommandOutput } from "./commands/GetTransitGatewayMeteringPolicyEntriesCommand";
import { type GetTransitGatewayMulticastDomainAssociationsCommandInput, type GetTransitGatewayMulticastDomainAssociationsCommandOutput } from "./commands/GetTransitGatewayMulticastDomainAssociationsCommand";
import { type GetTransitGatewayPolicyTableAssociationsCommandInput, type GetTransitGatewayPolicyTableAssociationsCommandOutput } from "./commands/GetTransitGatewayPolicyTableAssociationsCommand";
import { type GetTransitGatewayPolicyTableEntriesCommandInput, type GetTransitGatewayPolicyTableEntriesCommandOutput } from "./commands/GetTransitGatewayPolicyTableEntriesCommand";
import { type GetTransitGatewayPrefixListReferencesCommandInput, type GetTransitGatewayPrefixListReferencesCommandOutput } from "./commands/GetTransitGatewayPrefixListReferencesCommand";
import { type GetTransitGatewayRouteTableAssociationsCommandInput, type GetTransitGatewayRouteTableAssociationsCommandOutput } from "./commands/GetTransitGatewayRouteTableAssociationsCommand";
import { type GetTransitGatewayRouteTablePropagationsCommandInput, type GetTransitGatewayRouteTablePropagationsCommandOutput } from "./commands/GetTransitGatewayRouteTablePropagationsCommand";
import { type GetVerifiedAccessEndpointPolicyCommandInput, type GetVerifiedAccessEndpointPolicyCommandOutput } from "./commands/GetVerifiedAccessEndpointPolicyCommand";
import { type GetVerifiedAccessEndpointTargetsCommandInput, type GetVerifiedAccessEndpointTargetsCommandOutput } from "./commands/GetVerifiedAccessEndpointTargetsCommand";
import { type GetVerifiedAccessGroupPolicyCommandInput, type GetVerifiedAccessGroupPolicyCommandOutput } from "./commands/GetVerifiedAccessGroupPolicyCommand";
import { type GetVpcResourcesBlockingEncryptionEnforcementCommandInput, type GetVpcResourcesBlockingEncryptionEnforcementCommandOutput } from "./commands/GetVpcResourcesBlockingEncryptionEnforcementCommand";
import { type GetVpnConnectionDeviceSampleConfigurationCommandInput, type GetVpnConnectionDeviceSampleConfigurationCommandOutput } from "./commands/GetVpnConnectionDeviceSampleConfigurationCommand";
import { type GetVpnConnectionDeviceTypesCommandInput, type GetVpnConnectionDeviceTypesCommandOutput } from "./commands/GetVpnConnectionDeviceTypesCommand";
import { type GetVpnTunnelReplacementStatusCommandInput, type GetVpnTunnelReplacementStatusCommandOutput } from "./commands/GetVpnTunnelReplacementStatusCommand";
import { type ImportClientVpnClientCertificateRevocationListCommandInput, type ImportClientVpnClientCertificateRevocationListCommandOutput } from "./commands/ImportClientVpnClientCertificateRevocationListCommand";
import { type ImportImageCommandInput, type ImportImageCommandOutput } from "./commands/ImportImageCommand";
import { type ImportInstanceCommandInput, type ImportInstanceCommandOutput } from "./commands/ImportInstanceCommand";
import { type ImportKeyPairCommandInput, type ImportKeyPairCommandOutput } from "./commands/ImportKeyPairCommand";
import { type ImportSnapshotCommandInput, type ImportSnapshotCommandOutput } from "./commands/ImportSnapshotCommand";
import { type ImportVolumeCommandInput, type ImportVolumeCommandOutput } from "./commands/ImportVolumeCommand";
import { type ListImagesInRecycleBinCommandInput, type ListImagesInRecycleBinCommandOutput } from "./commands/ListImagesInRecycleBinCommand";
import { type ListSnapshotsInRecycleBinCommandInput, type ListSnapshotsInRecycleBinCommandOutput } from "./commands/ListSnapshotsInRecycleBinCommand";
import { type ListVolumesInRecycleBinCommandInput, type ListVolumesInRecycleBinCommandOutput } from "./commands/ListVolumesInRecycleBinCommand";
import { type LockSnapshotCommandInput, type LockSnapshotCommandOutput } from "./commands/LockSnapshotCommand";
import { type ModifyAccountVpcEncryptionControlCommandInput, type ModifyAccountVpcEncryptionControlCommandOutput } from "./commands/ModifyAccountVpcEncryptionControlCommand";
import { type ModifyAddressAttributeCommandInput, type ModifyAddressAttributeCommandOutput } from "./commands/ModifyAddressAttributeCommand";
import { type ModifyApplicationStatusCheckCommandInput, type ModifyApplicationStatusCheckCommandOutput } from "./commands/ModifyApplicationStatusCheckCommand";
import { type ModifyAvailabilityZoneGroupCommandInput, type ModifyAvailabilityZoneGroupCommandOutput } from "./commands/ModifyAvailabilityZoneGroupCommand";
import { type ModifyCapacityReservationCommandInput, type ModifyCapacityReservationCommandOutput } from "./commands/ModifyCapacityReservationCommand";
import { type ModifyCapacityReservationFleetCommandInput, type ModifyCapacityReservationFleetCommandOutput } from "./commands/ModifyCapacityReservationFleetCommand";
import { type ModifyClientVpnEndpointCommandInput, type ModifyClientVpnEndpointCommandOutput } from "./commands/ModifyClientVpnEndpointCommand";
import { type ModifyDefaultCreditSpecificationCommandInput, type ModifyDefaultCreditSpecificationCommandOutput } from "./commands/ModifyDefaultCreditSpecificationCommand";
import { type ModifyEbsDefaultKmsKeyIdCommandInput, type ModifyEbsDefaultKmsKeyIdCommandOutput } from "./commands/ModifyEbsDefaultKmsKeyIdCommand";
import { type ModifyFleetCommandInput, type ModifyFleetCommandOutput } from "./commands/ModifyFleetCommand";
import { type ModifyFpgaImageAttributeCommandInput, type ModifyFpgaImageAttributeCommandOutput } from "./commands/ModifyFpgaImageAttributeCommand";
import { type ModifyHostsCommandInput, type ModifyHostsCommandOutput } from "./commands/ModifyHostsCommand";
import { type ModifyIdentityIdFormatCommandInput, type ModifyIdentityIdFormatCommandOutput } from "./commands/ModifyIdentityIdFormatCommand";
import { type ModifyIdFormatCommandInput, type ModifyIdFormatCommandOutput } from "./commands/ModifyIdFormatCommand";
import { type ModifyImageAttributeCommandInput, type ModifyImageAttributeCommandOutput } from "./commands/ModifyImageAttributeCommand";
import { type ModifyInstanceAttributeCommandInput, type ModifyInstanceAttributeCommandOutput } from "./commands/ModifyInstanceAttributeCommand";
import { type ModifyInstanceCapacityReservationAttributesCommandInput, type ModifyInstanceCapacityReservationAttributesCommandOutput } from "./commands/ModifyInstanceCapacityReservationAttributesCommand";
import { type ModifyInstanceConnectEndpointCommandInput, type ModifyInstanceConnectEndpointCommandOutput } from "./commands/ModifyInstanceConnectEndpointCommand";
import { type ModifyInstanceCpuOptionsCommandInput, type ModifyInstanceCpuOptionsCommandOutput } from "./commands/ModifyInstanceCpuOptionsCommand";
import { type ModifyInstanceCreditSpecificationCommandInput, type ModifyInstanceCreditSpecificationCommandOutput } from "./commands/ModifyInstanceCreditSpecificationCommand";
import { type ModifyInstanceEventStartTimeCommandInput, type ModifyInstanceEventStartTimeCommandOutput } from "./commands/ModifyInstanceEventStartTimeCommand";
import { type ModifyInstanceEventWindowCommandInput, type ModifyInstanceEventWindowCommandOutput } from "./commands/ModifyInstanceEventWindowCommand";
import { type ModifyInstanceMaintenanceOptionsCommandInput, type ModifyInstanceMaintenanceOptionsCommandOutput } from "./commands/ModifyInstanceMaintenanceOptionsCommand";
import { type ModifyInstanceMetadataDefaultsCommandInput, type ModifyInstanceMetadataDefaultsCommandOutput } from "./commands/ModifyInstanceMetadataDefaultsCommand";
import { type ModifyInstanceMetadataOptionsCommandInput, type ModifyInstanceMetadataOptionsCommandOutput } from "./commands/ModifyInstanceMetadataOptionsCommand";
import { type ModifyInstanceNetworkPerformanceOptionsCommandInput, type ModifyInstanceNetworkPerformanceOptionsCommandOutput } from "./commands/ModifyInstanceNetworkPerformanceOptionsCommand";
...
import { type ModifyReservedInstancesCommandInput, type ModifyReservedInstancesCommandOutput } from "./commands/ModifyReservedInstancesCommand";
import { type ModifyRouteServerCommandInput, type ModifyRouteServerCommandOutput } from "./commands/ModifyRouteServerCommand";
import { type ModifySecurityGroupRulesCommandInput, type ModifySecurityGroupRulesCommandOutput } from "./commands/ModifySecurityGroupRulesCommand";
import { type ModifySnapshotAttributeCommandInput, type ModifySnapshotAttributeCommandOutput } from "./commands/ModifySnapshotAttributeCommand";
import { type ModifySnapshotTierCommandInput, type ModifySnapshotTierCommandOutput } from "./commands/ModifySnapshotTierCommand";
import { type ModifySpotFleetRequestCommandInput, type ModifySpotFleetRequestCommandOutput } from "./commands/ModifySpotFleetRequestCommand";
import { type ModifySubnetAttributeCommandInput, type ModifySubnetAttributeCommandOutput } from "./commands/ModifySubnetAttributeCommand";
import { type ModifyTrafficMirrorFilterNetworkServicesCommandInput, type ModifyTrafficMirrorFilterNetworkServicesCommandOutput } from "./commands/ModifyTrafficMirrorFilterNetworkServicesCommand";
import { type ModifyTrafficMirrorFilterRuleCommandInput, type ModifyTrafficMirrorFilterRuleCommandOutput } from "./commands/ModifyTrafficMirrorFilterRuleCommand";
import { type ModifyTrafficMirrorSessionCommandInput, type ModifyTrafficMirrorSessionCommandOutput } from "./commands/ModifyTrafficMirrorSessionCommand";
import { type ModifyTransitGatewayCommandInput, type ModifyTransitGatewayCommandOutput } from "./commands/ModifyTransitGatewayCommand";
import { type ModifyTransitGatewayMeteringPolicyCommandInput, type ModifyTransitGatewayMeteringPolicyCommandOutput } from "./commands/ModifyTransitGatewayMeteringPolicyCommand";
import { type ModifyTransitGatewayPolicyTableEntryCommandInput, type ModifyTransitGatewayPolicyTableEntryCommandOutput } from "./commands/ModifyTransitGatewayPolicyTableEntryCommand";
import { type ModifyTransitGatewayPrefixListReferenceCommandInput, type ModifyTransitGatewayPrefixListReferenceCommandOutput } from "./commands/ModifyTransitGatewayPrefixListReferenceCommand";
import { type ModifyTransitGatewayVpcAttachmentCommandInput, type ModifyTransitGatewayVpcAttachmentCommandOutput } from "./commands/ModifyTransitGatewayVpcAttachmentCommand";
import { type ModifyVerifiedAccessEndpointCommandInput, type ModifyVerifiedAccessEndpointCommandOutput } from "./commands/ModifyVerifiedAccessEndpointCommand";
import { type ModifyVerifiedAccessEndpointPolicyCommandInput, type ModifyVerifiedAccessEndpointPolicyCommandOutput } from "./commands/ModifyVerifiedAccessEndpointPolicyCommand";
import { type ModifyVerifiedAccessGroupCommandInput, type ModifyVerifiedAccessGroupCommandOutput } from "./commands/ModifyVerifiedAccessGroupCommand";
import { type ModifyVerifiedAccessGroupPolicyCommandInput, type ModifyVerifiedAccessGroupPolicyCommandOutput } from "./commands/ModifyVerifiedAccessGroupPolicyCommand";
import { type ModifyVerifiedAccessInstanceCommandInput, type ModifyVerifiedAccessInstanceCommandOutput } from "./commands/ModifyVerifiedAccessInstanceCommand";
import { type ModifyVerifiedAccessInstanceLoggingConfigurationCommandInput, type ModifyVerifiedAccessInstanceLoggingConfigurationCommandOutput } from "./commands/ModifyVerifiedAccessInstanceLoggingConfigurationCommand";
import { type ModifyVerifiedAccessTrustProviderCommandInput, type ModifyVerifiedAccessTrustProviderCommandOutput } from "./commands/ModifyVerifiedAccessTrustProviderCommand";
import { type ModifyVolumeAttributeCommandInput, type ModifyVolumeAttributeCommandOutput } from "./commands/ModifyVolumeAttributeCommand";
import { type ModifyVolumeCommandInput, type ModifyVolumeCommandOutput } from "./commands/ModifyVolumeCommand";
import { type ModifyVpcAttributeCommandInput, type ModifyVpcAttributeCommandOutput } from "./commands/ModifyVpcAttributeCommand";
import { type ModifyVpcBlockPublicAccessExclusionCommandInput, type ModifyVpcBlockPublicAccessExclusionCommandOutput } from "./commands/ModifyVpcBlockPublicAccessExclusionCommand";
import { type ModifyVpcBlockPublicAccessOptionsCommandInput, type ModifyVpcBlockPublicAccessOptionsCommandOutput } from "./commands/ModifyVpcBlockPublicAccessOptionsCommand";
...
import { type ModifyVpcPeeringConnectionOptionsCommandInput, type ModifyVpcPeeringConnectionOptionsCommandOutput } from "./commands/ModifyVpcPeeringConnectionOptionsCommand";
import { type ModifyVpcTenancyCommandInput, type ModifyVpcTenancyCommandOutput } from "./commands/ModifyVpcTenancyCommand";
import { type ModifyVpnConnectionCommandInput, type ModifyVpnConnectionCommandOutput } from "./commands/ModifyVpnConnectionCommand";
import { type ModifyVpnConnectionOptionsCommandInput, type ModifyVpnConnectionOptionsCommandOutput } from "./commands/ModifyVpnConnectionOptionsCommand";
import { type ModifyVpnTunnelCertificateCommandInput, type ModifyVpnTunnelCertificateCommandOutput } from "./commands/ModifyVpnTunnelCertificateCommand";
import { type ModifyVpnTunnelOptionsCommandInput, type ModifyVpnTunnelOptionsCommandOutput } from "./commands/ModifyVpnTunnelOptionsCommand";
import { type MonitorInstancesCommandInput, type MonitorInstancesCommandOutput } from "./commands/MonitorInstancesCommand";
import { type MoveAddressToVpcCommandInput, type MoveAddressToVpcCommandOutput } from "./commands/MoveAddressToVpcCommand";
import { type MoveByoipCidrToIpamCommandInput, type MoveByoipCidrToIpamCommandOutput } from "./commands/MoveByoipCidrToIpamCommand";
import { type MoveCapacityReservationInstancesCommandInput, type MoveCapacityReservationInstancesCommandOutput } from "./commands/MoveCapacityReservationInstancesCommand";
import { type ProvisionByoipCidrCommandInput, type ProvisionByoipCidrCommandOutput } from "./commands/ProvisionByoipCidrCommand";
import { type ProvisionIpamByoasnCommandInput, type ProvisionIpamByoasnCommandOutput } from "./commands/ProvisionIpamByoasnCommand";
import { type ProvisionIpamPoolCidrCommandInput, type ProvisionIpamPoolCidrCommandOutput } from "./commands/ProvisionIpamPoolCidrCommand";
import { type ProvisionPublicIpv4PoolCidrCommandInput, type ProvisionPublicIpv4PoolCidrCommandOutput } from "./commands/ProvisionPublicIpv4PoolCidrCommand";
import { type PurchaseCapacityBlockCommandInput, type PurchaseCapacityBlockCommandOutput } from "./commands/PurchaseCapacityBlockCommand";
import { type PurchaseCapacityBlockExtensionCommandInput, type PurchaseCapacityBlockExtensionCommandOutput } from "./commands/PurchaseCapacityBlockExtensionCommand";
import { type PurchaseHostReservationCommandInput, type PurchaseHostReservationCommandOutput } from "./commands/PurchaseHostReservationCommand";
import { type PurchaseReservedInstancesOfferingCommandInput, type PurchaseReservedInstancesOfferingCommandOutput } from "./commands/PurchaseReservedInstancesOfferingCommand";
import { type PurchaseScheduledInstancesCommandInput, type PurchaseScheduledInstancesCommandOutput } from "./commands/PurchaseScheduledInstancesCommand";
import { type RebootInstancesCommandInput, type RebootInstancesCommandOutput } from "./commands/RebootInstancesCommand";
import { type RegisterImageCommandInput, type RegisterImageCommandOutput } from "./commands/RegisterImageCommand";
import { type RegisterInstanceEventNotificationAttributesCommandInput, type RegisterInstanceEventNotificationAttributesCommandOutput } from "./commands/RegisterInstanceEventNotificationAttributesCommand";
...
import { type RejectVpcEndpointConnectionsCommandInput, type RejectVpcEndpointConnectionsCommandOutput } from "./commands/RejectVpcEndpointConnectionsCommand";
import { type RejectVpcPeeringConnectionCommandInput, type RejectVpcPeeringConnectionCommandOutput } from "./commands/RejectVpcPeeringConnectionCommand";
import { type ReleaseAddressCommandInput, type ReleaseAddressCommandOutput } from "./commands/ReleaseAddressCommand";
import { type ReleaseHostsCommandInput, type ReleaseHostsCommandOutput } from "./commands/ReleaseHostsCommand";
...
import { type ReplaceRouteTableAssociationCommandInput, type ReplaceRouteTableAssociationCommandOutput } from "./commands/ReplaceRouteTableAssociationCommand";
import { type ReplaceTransitGatewayRouteCommandInput, type ReplaceTransitGatewayRouteCommandOutput } from "./commands/ReplaceTransitGatewayRouteCommand";
import { type ReplaceVpnTunnelCommandInput, type ReplaceVpnTunnelCommandOutput } from "./commands/ReplaceVpnTunnelCommand";
import { type ReportInstanceStatusCommandInput, type ReportInstanceStatusCommandOutput } from "./commands/ReportInstanceStatusCommand";
import { type RequestSpotFleetCommandInput, type RequestSpotFleetCommandOutput } from "./commands/RequestSpotFleetCommand";
import { type RequestSpotInstancesCommandInput, type RequestSpotInstancesCommandOutput } from "./commands/RequestSpotInstancesCommand";
import { type ResetAddressAttributeCommandInput, type ResetAddressAttributeCommandOutput } from "./commands/ResetAddressAttributeCommand";
import { type ResetEbsDefaultKmsKeyIdCommandInput, type ResetEbsDefaultKmsKeyIdCommandOutput } from "./commands/ResetEbsDefaultKmsKeyIdCommand";
import { type ResetFpgaImageAttributeCommandInput, type ResetFpgaImageAttributeCommandOutput } from "./commands/ResetFpgaImageAttributeCommand";
import { type ResetImageAttributeCommandInput, type ResetImageAttributeCommandOutput } from "./commands/ResetImageAttributeCommand";
import { type ResetInstanceAttributeCommandInput, type ResetInstanceAttributeCommandOutput } from "./commands/ResetInstanceAttributeCommand";
import { type ResetNetworkInterfaceAttributeCommandInput, type ResetNetworkInterfaceAttributeCommandOutput } from "./commands/ResetNetworkInterfaceAttributeCommand";
import { type ResetSnapshotAttributeCommandInput, type ResetSnapshotAttributeCommandOutput } from "./commands/ResetSnapshotAttributeCommand";
import { type RestoreAddressToClassicCommandInput, type RestoreAddressToClassicCommandOutput } from "./commands/RestoreAddressToClassicCommand";
import { type RestoreImageFromRecycleBinCommandInput, type RestoreImageFromRecycleBinCommandOutput } from "./commands/RestoreImageFromRecycleBinCommand";
import { type RestoreManagedPrefixListVersionCommandInput, type RestoreManagedPrefixListVersionCommandOutput } from "./commands/RestoreManagedPrefixListVersionCommand";
import { type RestoreSnapshotFromRecycleBinCommandInput, type RestoreSnapshotFromRecycleBinCommandOutput } from "./commands/RestoreSnapshotFromRecycleBinCommand";
import { type RestoreSnapshotTierCommandInput, type RestoreSnapshotTierCommandOutput } from "./commands/RestoreSnapshotTierCommand";
import { type RestoreVolumeFromRecycleBinCommandInput, type RestoreVolumeFromRecycleBinCommandOutput } from "./commands/RestoreVolumeFromRecycleBinCommand";
import { type RevokeClientVpnIngressCommandInput, type RevokeClientVpnIngressCommandOutput } from "./commands/RevokeClientVpnIngressCommand";
import { type RevokeSecurityGroupEgressCommandInput, type RevokeSecurityGroupEgressCommandOutput } from "./commands/RevokeSecurityGroupEgressCommand";
import { type RevokeSecurityGroupIngressCommandInput, type RevokeSecurityGroupIngressCommandOutput } from "./commands/RevokeSecurityGroupIngressCommand";
import { type RunInstancesCommandInput, type RunInstancesCommandOutput } from "./commands/RunInstancesCommand";
import { type RunScheduledInstancesCommandInput, type RunScheduledInstancesCommandOutput } from "./commands/RunScheduledInstancesCommand";
import { type SearchLocalGatewayRoutesCommandInput, type SearchLocalGatewayRoutesCommandOutput } from "./commands/SearchLocalGatewayRoutesCommand";
import { type SearchTransitGatewayMulticastGroupsCommandInput, type SearchTransitGatewayMulticastGroupsCommandOutput } from "./commands/SearchTransitGatewayMulticastGroupsCommand";
import { type SearchTransitGatewayRoutesCommandInput, type SearchTransitGatewayRoutesCommandOutput } from "./commands/SearchTransitGatewayRoutesCommand";
import { type SendDiagnosticInterruptCommandInput, type SendDiagnosticInterruptCommandOutput } from "./commands/SendDiagnosticInterruptCommand";
import { type StartDeclarativePoliciesReportCommandInput, type StartDeclarativePoliciesReportCommandOutput } from "./commands/StartDeclarativePoliciesReportCommand";
import { type StartInstancesCommandInput, type StartInstancesCommandOutput } from "./commands/StartInstancesCommand";
import { type StartNetworkInsightsAccessScopeAnalysisCommandInput, type StartNetworkInsightsAccessScopeAnalysisCommandOutput } from "./commands/StartNetworkInsightsAccessScopeAnalysisCommand";
import { type StartNetworkInsightsAnalysisCommandInput, type StartNetworkInsightsAnalysisCommandOutput } from "./commands/StartNetworkInsightsAnalysisCommand";
import { type StartVpcEndpointServicePrivateDnsVerificationCommandInput, type StartVpcEndpointServicePrivateDnsVerificationCommandOutput } from "./commands/StartVpcEndpointServicePrivateDnsVerificationCommand";
import { type StopInstancesCommandInput, type StopInstancesCommandOutput } from "./commands/StopInstancesCommand";
import { type TerminateClientVpnConnectionsCommandInput, type TerminateClientVpnConnectionsCommandOutput } from "./commands/TerminateClientVpnConnectionsCommand";
import { type TerminateInstancesCommandInput, type TerminateInstancesCommandOutput } from "./commands/TerminateInstancesCommand";
import { type UnassignIpv6AddressesCommandInput, type UnassignIpv6AddressesCommandOutput } from "./commands/UnassignIpv6AddressesCommand";
import { type UnassignPrivateIpAddressesCommandInput, type UnassignPrivateIpAddressesCommandOutput } from "./commands/UnassignPrivateIpAddressesCommand";
...
export interface EC2 {
     ...
     */
    acceptCapacityReservationBillingOwnership(args: AcceptCapacityReservationBillingOwnershipCommandInput, options?: __HttpHandlerOptions): Promise<AcceptCapacityReservationBillingOwnershipCommandOutput>;
    acceptCapacityReservationBillingOwnership(args: AcceptCapacityReservationBillingOwnershipCommandInput, cb: (err: any, data?: AcceptCapacityReservationBillingOwnershipCommandOutput) => void): void;
    acceptCapacityReservationBillingOwnership(args: AcceptCapacityReservationBillingOwnershipCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AcceptCapacityReservationBillingOwnershipCommandOutput) => void): void;
    /**
     ...
     */
    associateApplicationStatusCheck(args: AssociateApplicationStatusCheckCommandInput, options?: __HttpHandlerOptions): Promise<AssociateApplicationStatusCheckCommandOutput>;
    associateApplicationStatusCheck(args: AssociateApplicationStatusCheckCommandInput, cb: (err: any, data?: AssociateApplicationStatusCheckCommandOutput) => void): void;
    associateApplicationStatusCheck(args: AssociateApplicationStatusCheckCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateApplicationStatusCheckCommandOutput) => void): void;
    /**
     * @see {@link AssociateCapacityReservationBillingOwnerCommand}
     */
    associateCapacityReservationBillingOwner(args: AssociateCapacityReservationBillingOwnerCommandInput, options?: __HttpHandlerOptions): Promise<AssociateCapacityReservationBillingOwnerCommandOutput>;
    associateCapacityReservationBillingOwner(args: AssociateCapacityReservationBillingOwnerCommandInput, cb: (err: any, data?: AssociateCapacityReservationBillingOwnerCommandOutput) => void): void;
    associateCapacityReservationBillingOwner(args: AssociateCapacityReservationBillingOwnerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateCapacityReservationBillingOwnerCommandOutput) => void): void;
    /**
     ...
     */
    associateIpamByoasn(args: AssociateIpamByoasnCommandInput, options?: __HttpHandlerOptions): Promise<AssociateIpamByoasnCommandOutput>;
    associateIpamByoasn(args: AssociateIpamByoasnCommandInput, cb: (err: any, data?: AssociateIpamByoasnCommandOutput) => void): void;
    associateIpamByoasn(args: AssociateIpamByoasnCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateIpamByoasnCommandOutput) => void): void;
    /**
     ...
     */
    associateRouteServer(args: AssociateRouteServerCommandInput, options?: __HttpHandlerOptions): Promise<AssociateRouteServerCommandOutput>;
    associateRouteServer(args: AssociateRouteServerCommandInput, cb: (err: any, data?: AssociateRouteServerCommandOutput) => void): void;
    associateRouteServer(args: AssociateRouteServerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateRouteServerCommandOutput) => void): void;
    /**
     ...
     */
    createApplicationStatusCheck(args: CreateApplicationStatusCheckCommandInput, options?: __HttpHandlerOptions): Promise<CreateApplicationStatusCheckCommandOutput>;
    createApplicationStatusCheck(args: CreateApplicationStatusCheckCommandInput, cb: (err: any, data?: CreateApplicationStatusCheckCommandOutput) => void): void;
    createApplicationStatusCheck(args: CreateApplicationStatusCheckCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateApplicationStatusCheckCommandOutput) => void): void;
    /**
     * @see {@link CreateCapacityManagerDataExportCommand}
     */
    createCapacityManagerDataExport(args: CreateCapacityManagerDataExportCommandInput, options?: __HttpHandlerOptions): Promise<CreateCapacityManagerDataExportCommandOutput>;
    createCapacityManagerDataExport(args: CreateCapacityManagerDataExportCommandInput, cb: (err: any, data?: CreateCapacityManagerDataExportCommandOutput) => void): void;
    createCapacityManagerDataExport(args: CreateCapacityManagerDataExportCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateCapacityManagerDataExportCommandOutput) => void): void;
    /**
     ...
     */
    createDelegateMacVolumeOwnershipTask(args: CreateDelegateMacVolumeOwnershipTaskCommandInput, options?: __HttpHandlerOptions): Promise<CreateDelegateMacVolumeOwnershipTaskCommandOutput>;
    createDelegateMacVolumeOwnershipTask(args: CreateDelegateMacVolumeOwnershipTaskCommandInput, cb: (err: any, data?: CreateDelegateMacVolumeOwnershipTaskCommandOutput) => void): void;
    createDelegateMacVolumeOwnershipTask(args: CreateDelegateMacVolumeOwnershipTaskCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateDelegateMacVolumeOwnershipTaskCommandOutput) => void): void;
    /**
     ...
     */
    createImageUsageReport(args: CreateImageUsageReportCommandInput, options?: __HttpHandlerOptions): Promise<CreateImageUsageReportCommandOutput>;
    createImageUsageReport(args: CreateImageUsageReportCommandInput, cb: (err: any, data?: CreateImageUsageReportCommandOutput) => void): void;
    createImageUsageReport(args: CreateImageUsageReportCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateImageUsageReportCommandOutput) => void): void;
    /**
     ...
     */
    createIpamPolicy(args: CreateIpamPolicyCommandInput, options?: __HttpHandlerOptions): Promise<CreateIpamPolicyCommandOutput>;
    createIpamPolicy(args: CreateIpamPolicyCommandInput, cb: (err: any, data?: CreateIpamPolicyCommandOutput) => void): void;
    createIpamPolicy(args: CreateIpamPolicyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateIpamPolicyCommandOutput) => void): void;
    /**
     ...
     */
    createIpamPrefixListResolver(args: CreateIpamPrefixListResolverCommandInput, options?: __HttpHandlerOptions): Promise<CreateIpamPrefixListResolverCommandOutput>;
    createIpamPrefixListResolver(args: CreateIpamPrefixListResolverCommandInput, cb: (err: any, data?: CreateIpamPrefixListResolverCommandOutput) => void): void;
    createIpamPrefixListResolver(args: CreateIpamPrefixListResolverCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateIpamPrefixListResolverCommandOutput) => void): void;
    /**
     * @see {@link CreateIpamPrefixListResolverTargetCommand}
     */
    createIpamPrefixListResolverTarget(args: CreateIpamPrefixListResolverTargetCommandInput, options?: __HttpHandlerOptions): Promise<CreateIpamPrefixListResolverTargetCommandOutput>;
    createIpamPrefixListResolverTarget(args: CreateIpamPrefixListResolverTargetCommandInput, cb: (err: any, data?: CreateIpamPrefixListResolverTargetCommandOutput) => void): void;
    createIpamPrefixListResolverTarget(args: CreateIpamPrefixListResolverTargetCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateIpamPrefixListResolverTargetCommandOutput) => void): void;
    /**
     ...
     */
    createLocalGatewayVirtualInterface(args: CreateLocalGatewayVirtualInterfaceCommandInput, options?: __HttpHandlerOptions): Promise<CreateLocalGatewayVirtualInterfaceCommandOutput>;
    createLocalGatewayVirtualInterface(args: CreateLocalGatewayVirtualInterfaceCommandInput, cb: (err: any, data?: CreateLocalGatewayVirtualInterfaceCommandOutput) => void): void;
    createLocalGatewayVirtualInterface(args: CreateLocalGatewayVirtualInterfaceCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateLocalGatewayVirtualInterfaceCommandOutput) => void): void;
    /**
     * @see {@link CreateLocalGatewayVirtualInterfaceGroupCommand}
     */
    createLocalGatewayVirtualInterfaceGroup(args: CreateLocalGatewayVirtualInterfaceGroupCommandInput, options?: __HttpHandlerOptions): Promise<CreateLocalGatewayVirtualInterfaceGroupCommandOutput>;
    createLocalGatewayVirtualInterfaceGroup(args: CreateLocalGatewayVirtualInterfaceGroupCommandInput, cb: (err: any, data?: CreateLocalGatewayVirtualInterfaceGroupCommandOutput) => void): void;
    createLocalGatewayVirtualInterfaceGroup(args: CreateLocalGatewayVirtualInterfaceGroupCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateLocalGatewayVirtualInterfaceGroupCommandOutput) => void): void;
    /**
     * @see {@link CreateMacSystemIntegrityProtectionModificationTaskCommand}
     */
    createMacSystemIntegrityProtectionModificationTask(args: CreateMacSystemIntegrityProtectionModificationTaskCommandInput, options?: __HttpHandlerOptions): Promise<CreateMacSystemIntegrityProtectionModificationTaskCommandOutput>;
    createMacSystemIntegrityProtectionModificationTask(args: CreateMacSystemIntegrityProtectionModificationTaskCommandInput, cb: (err: any, data?: CreateMacSystemIntegrityProtectionModificationTaskCommandOutput) => void): void;
    createMacSystemIntegrityProtectionModificationTask(args: CreateMacSystemIntegrityProtectionModificationTaskCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateMacSystemIntegrityProtectionModificationTaskCommandOutput) => void): void;
    /**
     ...
     */
    createRouteServer(args: CreateRouteServerCommandInput, options?: __HttpHandlerOptions): Promise<CreateRouteServerCommandOutput>;
    createRouteServer(args: CreateRouteServerCommandInput, cb: (err: any, data?: CreateRouteServerCommandOutput) => void): void;
    createRouteServer(args: CreateRouteServerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateRouteServerCommandOutput) => void): void;
    /**
     * @see {@link CreateRouteServerEndpointCommand}
     */
    createRouteServerEndpoint(args: CreateRouteServerEndpointCommandInput, options?: __HttpHandlerOptions): Promise<CreateRouteServerEndpointCommandOutput>;
    createRouteServerEndpoint(args: CreateRouteServerEndpointCommandInput, cb: (err: any, data?: CreateRouteServerEndpointCommandOutput) => void): void;
    createRouteServerEndpoint(args: CreateRouteServerEndpointCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateRouteServerEndpointCommandOutput) => void): void;
    /**
     * @see {@link CreateRouteServerPeerCommand}
     */
    createRouteServerPeer(args: CreateRouteServerPeerCommandInput, options?: __HttpHandlerOptions): Promise<CreateRouteServerPeerCommandOutput>;
    createRouteServerPeer(args: CreateRouteServerPeerCommandInput, cb: (err: any, data?: CreateRouteServerPeerCommandOutput) => void): void;
    createRouteServerPeer(args: CreateRouteServerPeerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateRouteServerPeerCommandOutput) => void): void;
    /**
     ...
     */
    createTransitGatewayPolicyTableEntry(args: CreateTransitGatewayPolicyTableEntryCommandInput, options?: __HttpHandlerOptions): Promise<CreateTransitGatewayPolicyTableEntryCommandOutput>;
    createTransitGatewayPolicyTableEntry(args: CreateTransitGatewayPolicyTableEntryCommandInput, cb: (err: any, data?: CreateTransitGatewayPolicyTableEntryCommandOutput) => void): void;
    createTransitGatewayPolicyTableEntry(args: CreateTransitGatewayPolicyTableEntryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateTransitGatewayPolicyTableEntryCommandOutput) => void): void;
    /**
     ...
     */
    createVpnConcentrator(args: CreateVpnConcentratorCommandInput, options?: __HttpHandlerOptions): Promise<CreateVpnConcentratorCommandOutput>;
    createVpnConcentrator(args: CreateVpnConcentratorCommandInput, cb: (err: any, data?: CreateVpnConcentratorCommandOutput) => void): void;
    createVpnConcentrator(args: CreateVpnConcentratorCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateVpnConcentratorCommandOutput) => void): void;
    /**
     ...
     */
    deleteApplicationStatusCheck(args: DeleteApplicationStatusCheckCommandInput, options?: __HttpHandlerOptions): Promise<DeleteApplicationStatusCheckCommandOutput>;
    deleteApplicationStatusCheck(args: DeleteApplicationStatusCheckCommandInput, cb: (err: any, data?: DeleteApplicationStatusCheckCommandOutput) => void): void;
    deleteApplicationStatusCheck(args: DeleteApplicationStatusCheckCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteApplicationStatusCheckCommandOutput) => void): void;
    /**
     * @see {@link DeleteCapacityManagerDataExportCommand}
     */
    deleteCapacityManagerDataExport(args: DeleteCapacityManagerDataExportCommandInput, options?: __HttpHandlerOptions): Promise<DeleteCapacityManagerDataExportCommandOutput>;
    deleteCapacityManagerDataExport(args: DeleteCapacityManagerDataExportCommandInput, cb: (err: any, data?: DeleteCapacityManagerDataExportCommandOutput) => void): void;
    deleteCapacityManagerDataExport(args: DeleteCapacityManagerDataExportCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteCapacityManagerDataExportCommandOutput) => void): void;
    /**
     ...
     */
    deleteImageUsageReport(args: DeleteImageUsageReportCommandInput, options?: __HttpHandlerOptions): Promise<DeleteImageUsageReportCommandOutput>;
    deleteImageUsageReport(args: DeleteImageUsageReportCommandInput, cb: (err: any, data?: DeleteImageUsageReportCommandOutput) => void): void;
    deleteImageUsageReport(args: DeleteImageUsageReportCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteImageUsageReportCommandOutput) => void): void;
    /**
     ...
     */
    deleteIpamPolicy(args: DeleteIpamPolicyCommandInput, options?: __HttpHandlerOptions): Promise<DeleteIpamPolicyCommandOutput>;
    deleteIpamPolicy(args: DeleteIpamPolicyCommandInput, cb: (err: any, data?: DeleteIpamPolicyCommandOutput) => void): void;
    deleteIpamPolicy(args: DeleteIpamPolicyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteIpamPolicyCommandOutput) => void): void;
    /**
     ...
     */
    deleteIpamPrefixListResolver(args: DeleteIpamPrefixListResolverCommandInput, options?: __HttpHandlerOptions): Promise<DeleteIpamPrefixListResolverCommandOutput>;
    deleteIpamPrefixListResolver(args: DeleteIpamPrefixListResolverCommandInput, cb: (err: any, data?: DeleteIpamPrefixListResolverCommandOutput) => void): void;
    deleteIpamPrefixListResolver(args: DeleteIpamPrefixListResolverCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteIpamPrefixListResolverCommandOutput) => void): void;
    /**
     * @see {@link DeleteIpamPrefixListResolverTargetCommand}
     */
    deleteIpamPrefixListResolverTarget(args: DeleteIpamPrefixListResolverTargetCommandInput, options?: __HttpHandlerOptions): Promise<DeleteIpamPrefixListResolverTargetCommandOutput>;
    deleteIpamPrefixListResolverTarget(args: DeleteIpamPrefixListResolverTargetCommandInput, cb: (err: any, data?: DeleteIpamPrefixListResolverTargetCommandOutput) => void): void;
    deleteIpamPrefixListResolverTarget(args: DeleteIpamPrefixListResolverTargetCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteIpamPrefixListResolverTargetCommandOutput) => void): void;
    /**
     ...
     */
    deleteLocalGatewayVirtualInterface(args: DeleteLocalGatewayVirtualInterfaceCommandInput, options?: __HttpHandlerOptions): Promise<DeleteLocalGatewayVirtualInterfaceCommandOutput>;
    deleteLocalGatewayVirtualInterface(args: DeleteLocalGatewayVirtualInterfaceCommandInput, cb: (err: any, data?: DeleteLocalGatewayVirtualInterfaceCommandOutput) => void): void;
    deleteLocalGatewayVirtualInterface(args: DeleteLocalGatewayVirtualInterfaceCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteLocalGatewayVirtualInterfaceCommandOutput) => void): void;
    /**
     * @see {@link DeleteLocalGatewayVirtualInterfaceGroupCommand}
     */
    deleteLocalGatewayVirtualInterfaceGroup(args: DeleteLocalGatewayVirtualInterfaceGroupCommandInput, options?: __HttpHandlerOptions): Promise<DeleteLocalGatewayVirtualInterfaceGroupCommandOutput>;
    deleteLocalGatewayVirtualInterfaceGroup(args: DeleteLocalGatewayVirtualInterfaceGroupCommandInput, cb: (err: any, data?: DeleteLocalGatewayVirtualInterfaceGroupCommandOutput) => void): void;
    deleteLocalGatewayVirtualInterfaceGroup(args: DeleteLocalGatewayVirtualInterfaceGroupCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteLocalGatewayVirtualInterfaceGroupCommandOutput) => void): void;
    /**
     ...
     */
    deleteRouteServer(args: DeleteRouteServerCommandInput, options?: __HttpHandlerOptions): Promise<DeleteRouteServerCommandOutput>;
    deleteRouteServer(args: DeleteRouteServerCommandInput, cb: (err: any, data?: DeleteRouteServerCommandOutput) => void): void;
    deleteRouteServer(args: DeleteRouteServerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteRouteServerCommandOutput) => void): void;
    /**
     * @see {@link DeleteRouteServerEndpointCommand}
     */
    deleteRouteServerEndpoint(args: DeleteRouteServerEndpointCommandInput, options?: __HttpHandlerOptions): Promise<DeleteRouteServerEndpointCommandOutput>;
    deleteRouteServerEndpoint(args: DeleteRouteServerEndpointCommandInput, cb: (err: any, data?: DeleteRouteServerEndpointCommandOutput) => void): void;
    deleteRouteServerEndpoint(args: DeleteRouteServerEndpointCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteRouteServerEndpointCommandOutput) => void): void;
    /**
     * @see {@link DeleteRouteServerPeerCommand}
     */
    deleteRouteServerPeer(args: DeleteRouteServerPeerCommandInput, options?: __HttpHandlerOptions): Promise<DeleteRouteServerPeerCommandOutput>;
    deleteRouteServerPeer(args: DeleteRouteServerPeerCommandInput, cb: (err: any, data?: DeleteRouteServerPeerCommandOutput) => void): void;
    deleteRouteServerPeer(args: DeleteRouteServerPeerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteRouteServerPeerCommandOutput) => void): void;
    /**
     ...
     */
    deleteTransitGatewayPolicyTableEntry(args: DeleteTransitGatewayPolicyTableEntryCommandInput, options?: __HttpHandlerOptions): Promise<DeleteTransitGatewayPolicyTableEntryCommandOutput>;
    deleteTransitGatewayPolicyTableEntry(args: DeleteTransitGatewayPolicyTableEntryCommandInput, cb: (err: any, data?: DeleteTransitGatewayPolicyTableEntryCommandOutput) => void): void;
    deleteTransitGatewayPolicyTableEntry(args: DeleteTransitGatewayPolicyTableEntryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteTransitGatewayPolicyTableEntryCommandOutput) => void): void;
    /**
     ...
     */
    deleteVpnConcentrator(args: DeleteVpnConcentratorCommandInput, options?: __HttpHandlerOptions): Promise<DeleteVpnConcentratorCommandOutput>;
    deleteVpnConcentrator(args: DeleteVpnConcentratorCommandInput, cb: (err: any, data?: DeleteVpnConcentratorCommandOutput) => void): void;
    deleteVpnConcentrator(args: DeleteVpnConcentratorCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteVpnConcentratorCommandOutput) => void): void;
    /**
     ...
     */
    deprovisionIpamByoasn(args: DeprovisionIpamByoasnCommandInput, options?: __HttpHandlerOptions): Promise<DeprovisionIpamByoasnCommandOutput>;
    deprovisionIpamByoasn(args: DeprovisionIpamByoasnCommandInput, cb: (err: any, data?: DeprovisionIpamByoasnCommandOutput) => void): void;
    deprovisionIpamByoasn(args: DeprovisionIpamByoasnCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeprovisionIpamByoasnCommandOutput) => void): void;
    /**
    ...
    describeAccountVpcEncryptionControl(args: DescribeAccountVpcEncryptionControlCommandInput, options?: __HttpHandlerOptions): Promise<DescribeAccountVpcEncryptionControlCommandOutput>;
    describeAccountVpcEncryptionControl(args: DescribeAccountVpcEncryptionControlCommandInput, cb: (err: any, data?: DescribeAccountVpcEncryptionControlCommandOutput) => void): void;
    describeAccountVpcEncryptionControl(args: DescribeAccountVpcEncryptionControlCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeAccountVpcEncryptionControlCommandOutput) => void): void;
    /**
    ...
    describeApplicationStatus(args: DescribeApplicationStatusCommandInput, options?: __HttpHandlerOptions): Promise<DescribeApplicationStatusCommandOutput>;
    describeApplicationStatus(args: DescribeApplicationStatusCommandInput, cb: (err: any, data?: DescribeApplicationStatusCommandOutput) => void): void;
    describeApplicationStatus(args: DescribeApplicationStatusCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeApplicationStatusCommandOutput) => void): void;
    /**
    ...
    describeApplicationStatusCheckAssociations(args: DescribeApplicationStatusCheckAssociationsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeApplicationStatusCheckAssociationsCommandOutput>;
    describeApplicationStatusCheckAssociations(args: DescribeApplicationStatusCheckAssociationsCommandInput, cb: (err: any, data?: DescribeApplicationStatusCheckAssociationsCommandOutput) => void): void;
    describeApplicationStatusCheckAssociations(args: DescribeApplicationStatusCheckAssociationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeApplicationStatusCheckAssociationsCommandOutput) => void): void;
    /**
    ...
    describeApplicationStatusChecks(args: DescribeApplicationStatusChecksCommandInput, options?: __HttpHandlerOptions): Promise<DescribeApplicationStatusChecksCommandOutput>;
    describeApplicationStatusChecks(args: DescribeApplicationStatusChecksCommandInput, cb: (err: any, data?: DescribeApplicationStatusChecksCommandOutput) => void): void;
    describeApplicationStatusChecks(args: DescribeApplicationStatusChecksCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeApplicationStatusChecksCommandOutput) => void): void;
    /**
    ...
    describeCapacityBlockExtensionHistory(args: DescribeCapacityBlockExtensionHistoryCommandInput, options?: __HttpHandlerOptions): Promise<DescribeCapacityBlockExtensionHistoryCommandOutput>;
    describeCapacityBlockExtensionHistory(args: DescribeCapacityBlockExtensionHistoryCommandInput, cb: (err: any, data?: DescribeCapacityBlockExtensionHistoryCommandOutput) => void): void;
    describeCapacityBlockExtensionHistory(args: DescribeCapacityBlockExtensionHistoryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeCapacityBlockExtensionHistoryCommandOutput) => void): void;
    /**
     * @see {@link DescribeCapacityBlockExtensionOfferingsCommand}
     */
    describeCapacityBlockExtensionOfferings(args: DescribeCapacityBlockExtensionOfferingsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeCapacityBlockExtensionOfferingsCommandOutput>;
    describeCapacityBlockExtensionOfferings(args: DescribeCapacityBlockExtensionOfferingsCommandInput, cb: (err: any, data?: DescribeCapacityBlockExtensionOfferingsCommandOutput) => void): void;
    describeCapacityBlockExtensionOfferings(args: DescribeCapacityBlockExtensionOfferingsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeCapacityBlockExtensionOfferingsCommandOutput) => void): void;
    /**
    ...
    describeCapacityBlocks(args: DescribeCapacityBlocksCommandInput, options?: __HttpHandlerOptions): Promise<DescribeCapacityBlocksCommandOutput>;
    describeCapacityBlocks(args: DescribeCapacityBlocksCommandInput, cb: (err: any, data?: DescribeCapacityBlocksCommandOutput) => void): void;
    describeCapacityBlocks(args: DescribeCapacityBlocksCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeCapacityBlocksCommandOutput) => void): void;
    /**
     * @see {@link DescribeCapacityBlockStatusCommand}
     */
    describeCapacityBlockStatus(): Promise<DescribeCapacityBlockStatusCommandOutput>;
    describeCapacityBlockStatus(args: DescribeCapacityBlockStatusCommandInput, options?: __HttpHandlerOptions): Promise<DescribeCapacityBlockStatusCommandOutput>;
    describeCapacityBlockStatus(args: DescribeCapacityBlockStatusCommandInput, cb: (err: any, data?: DescribeCapacityBlockStatusCommandOutput) => void): void;
    describeCapacityBlockStatus(args: DescribeCapacityBlockStatusCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeCapacityBlockStatusCommandOutput) => void): void;
    /**
    ...
    describeCapacityManagerDataExports(args: DescribeCapacityManagerDataExportsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeCapacityManagerDataExportsCommandOutput>;
    describeCapacityManagerDataExports(args: DescribeCapacityManagerDataExportsCommandInput, cb: (err: any, data?: DescribeCapacityManagerDataExportsCommandOutput) => void): void;
    describeCapacityManagerDataExports(args: DescribeCapacityManagerDataExportsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeCapacityManagerDataExportsCommandOutput) => void): void;
    /**
     ...
     */
    describeImageReferences(args: DescribeImageReferencesCommandInput, options?: __HttpHandlerOptions): Promise<DescribeImageReferencesCommandOutput>;
    describeImageReferences(args: DescribeImageReferencesCommandInput, cb: (err: any, data?: DescribeImageReferencesCommandOutput) => void): void;
    describeImageReferences(args: DescribeImageReferencesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeImageReferencesCommandOutput) => void): void;
    /**
    ...
    describeImageUsageReportEntries(args: DescribeImageUsageReportEntriesCommandInput, options?: __HttpHandlerOptions): Promise<DescribeImageUsageReportEntriesCommandOutput>;
    describeImageUsageReportEntries(args: DescribeImageUsageReportEntriesCommandInput, cb: (err: any, data?: DescribeImageUsageReportEntriesCommandOutput) => void): void;
    describeImageUsageReportEntries(args: DescribeImageUsageReportEntriesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeImageUsageReportEntriesCommandOutput) => void): void;
    /**
     * @see {@link DescribeImageUsageReportsCommand}
     */
    describeImageUsageReports(): Promise<DescribeImageUsageReportsCommandOutput>;
    describeImageUsageReports(args: DescribeImageUsageReportsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeImageUsageReportsCommandOutput>;
    describeImageUsageReports(args: DescribeImageUsageReportsCommandInput, cb: (err: any, data?: DescribeImageUsageReportsCommandOutput) => void): void;
    describeImageUsageReports(args: DescribeImageUsageReportsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeImageUsageReportsCommandOutput) => void): void;
    /**
    ...
    describeInstanceImageMetadata(args: DescribeInstanceImageMetadataCommandInput, options?: __HttpHandlerOptions): Promise<DescribeInstanceImageMetadataCommandOutput>;
    describeInstanceImageMetadata(args: DescribeInstanceImageMetadataCommandInput, cb: (err: any, data?: DescribeInstanceImageMetadataCommandOutput) => void): void;
    describeInstanceImageMetadata(args: DescribeInstanceImageMetadataCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeInstanceImageMetadataCommandOutput) => void): void;
    /**
    ...
    describeInstanceSqlHaHistoryStates(args: DescribeInstanceSqlHaHistoryStatesCommandInput, options?: __HttpHandlerOptions): Promise<DescribeInstanceSqlHaHistoryStatesCommandOutput>;
    describeInstanceSqlHaHistoryStates(args: DescribeInstanceSqlHaHistoryStatesCommandInput, cb: (err: any, data?: DescribeInstanceSqlHaHistoryStatesCommandOutput) => void): void;
    describeInstanceSqlHaHistoryStates(args: DescribeInstanceSqlHaHistoryStatesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeInstanceSqlHaHistoryStatesCommandOutput) => void): void;
    /**
     * @see {@link DescribeInstanceSqlHaStatesCommand}
     */
    describeInstanceSqlHaStates(): Promise<DescribeInstanceSqlHaStatesCommandOutput>;
    describeInstanceSqlHaStates(args: DescribeInstanceSqlHaStatesCommandInput, options?: __HttpHandlerOptions): Promise<DescribeInstanceSqlHaStatesCommandOutput>;
    describeInstanceSqlHaStates(args: DescribeInstanceSqlHaStatesCommandInput, cb: (err: any, data?: DescribeInstanceSqlHaStatesCommandOutput) => void): void;
    describeInstanceSqlHaStates(args: DescribeInstanceSqlHaStatesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeInstanceSqlHaStatesCommandOutput) => void): void;
    /**
    ...
    describeIpamPrefixListResolvers(args: DescribeIpamPrefixListResolversCommandInput, options?: __HttpHandlerOptions): Promise<DescribeIpamPrefixListResolversCommandOutput>;
    describeIpamPrefixListResolvers(args: DescribeIpamPrefixListResolversCommandInput, cb: (err: any, data?: DescribeIpamPrefixListResolversCommandOutput) => void): void;
    describeIpamPrefixListResolvers(args: DescribeIpamPrefixListResolversCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeIpamPrefixListResolversCommandOutput) => void): void;
    /**
    ...
    describeIpamPrefixListResolverTargets(args: DescribeIpamPrefixListResolverTargetsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeIpamPrefixListResolverTargetsCommandOutput>;
    describeIpamPrefixListResolverTargets(args: DescribeIpamPrefixListResolverTargetsCommandInput, cb: (err: any, data?: DescribeIpamPrefixListResolverTargetsCommandOutput) => void): void;
    describeIpamPrefixListResolverTargets(args: DescribeIpamPrefixListResolverTargetsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeIpamPrefixListResolverTargetsCommandOutput) => void): void;
    /**
    ...
    describeMacModificationTasks(args: DescribeMacModificationTasksCommandInput, options?: __HttpHandlerOptions): Promise<DescribeMacModificationTasksCommandOutput>;
    describeMacModificationTasks(args: DescribeMacModificationTasksCommandInput, cb: (err: any, data?: DescribeMacModificationTasksCommandOutput) => void): void;
    describeMacModificationTasks(args: DescribeMacModificationTasksCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeMacModificationTasksCommandOutput) => void): void;
    /**
    ...
    describeOutpostLags(args: DescribeOutpostLagsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeOutpostLagsCommandOutput>;
    describeOutpostLags(args: DescribeOutpostLagsCommandInput, cb: (err: any, data?: DescribeOutpostLagsCommandOutput) => void): void;
    describeOutpostLags(args: DescribeOutpostLagsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeOutpostLagsCommandOutput) => void): void;
    /**
    ...
    describeRouteServerEndpoints(args: DescribeRouteServerEndpointsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRouteServerEndpointsCommandOutput>;
    describeRouteServerEndpoints(args: DescribeRouteServerEndpointsCommandInput, cb: (err: any, data?: DescribeRouteServerEndpointsCommandOutput) => void): void;
    describeRouteServerEndpoints(args: DescribeRouteServerEndpointsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRouteServerEndpointsCommandOutput) => void): void;
    /**
     * @see {@link DescribeRouteServerPeersCommand}
     */
    describeRouteServerPeers(): Promise<DescribeRouteServerPeersCommandOutput>;
    describeRouteServerPeers(args: DescribeRouteServerPeersCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRouteServerPeersCommandOutput>;
    describeRouteServerPeers(args: DescribeRouteServerPeersCommandInput, cb: (err: any, data?: DescribeRouteServerPeersCommandOutput) => void): void;
    describeRouteServerPeers(args: DescribeRouteServerPeersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRouteServerPeersCommandOutput) => void): void;
    /**
     * @see {@link DescribeRouteServersCommand}
     */
    describeRouteServers(): Promise<DescribeRouteServersCommandOutput>;
    describeRouteServers(args: DescribeRouteServersCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRouteServersCommandOutput>;
    describeRouteServers(args: DescribeRouteServersCommandInput, cb: (err: any, data?: DescribeRouteServersCommandOutput) => void): void;
    describeRouteServers(args: DescribeRouteServersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRouteServersCommandOutput) => void): void;
    /**
    ...
    describeServiceLinkVirtualInterfaces(args: DescribeServiceLinkVirtualInterfacesCommandInput, options?: __HttpHandlerOptions): Promise<DescribeServiceLinkVirtualInterfacesCommandOutput>;
    describeServiceLinkVirtualInterfaces(args: DescribeServiceLinkVirtualInterfacesCommandInput, cb: (err: any, data?: DescribeServiceLinkVirtualInterfacesCommandOutput) => void): void;
    describeServiceLinkVirtualInterfaces(args: DescribeServiceLinkVirtualInterfacesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeServiceLinkVirtualInterfacesCommandOutput) => void): void;
    /**
    ...
    describeVpcBlockPublicAccessExclusions(args: DescribeVpcBlockPublicAccessExclusionsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeVpcBlockPublicAccessExclusionsCommandOutput>;
    describeVpcBlockPublicAccessExclusions(args: DescribeVpcBlockPublicAccessExclusionsCommandInput, cb: (err: any, data?: DescribeVpcBlockPublicAccessExclusionsCommandOutput) => void): void;
    describeVpcBlockPublicAccessExclusions(args: DescribeVpcBlockPublicAccessExclusionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeVpcBlockPublicAccessExclusionsCommandOutput) => void): void;
    /**
    ...
    describeVpcBlockPublicAccessOptions(args: DescribeVpcBlockPublicAccessOptionsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeVpcBlockPublicAccessOptionsCommandOutput>;
    describeVpcBlockPublicAccessOptions(args: DescribeVpcBlockPublicAccessOptionsCommandInput, cb: (err: any, data?: DescribeVpcBlockPublicAccessOptionsCommandOutput) => void): void;
    describeVpcBlockPublicAccessOptions(args: DescribeVpcBlockPublicAccessOptionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeVpcBlockPublicAccessOptionsCommandOutput) => void): void;
    /**
    ...
    describeVpnConcentrators(args: DescribeVpnConcentratorsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeVpnConcentratorsCommandOutput>;
    describeVpnConcentrators(args: DescribeVpnConcentratorsCommandInput, cb: (err: any, data?: DescribeVpnConcentratorsCommandOutput) => void): void;
    describeVpnConcentrators(args: DescribeVpnConcentratorsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeVpnConcentratorsCommandOutput) => void): void;
    /**
    ...
    disableApplicationStatusCheckSuppression(args: DisableApplicationStatusCheckSuppressionCommandInput, options?: __HttpHandlerOptions): Promise<DisableApplicationStatusCheckSuppressionCommandOutput>;
    disableApplicationStatusCheckSuppression(args: DisableApplicationStatusCheckSuppressionCommandInput, cb: (err: any, data?: DisableApplicationStatusCheckSuppressionCommandOutput) => void): void;
    disableApplicationStatusCheckSuppression(args: DisableApplicationStatusCheckSuppressionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisableApplicationStatusCheckSuppressionCommandOutput) => void): void;
    /**
    ...
    disableCapacityManager(args: DisableCapacityManagerCommandInput, options?: __HttpHandlerOptions): Promise<DisableCapacityManagerCommandOutput>;
    disableCapacityManager(args: DisableCapacityManagerCommandInput, cb: (err: any, data?: DisableCapacityManagerCommandOutput) => void): void;
    disableCapacityManager(args: DisableCapacityManagerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisableCapacityManagerCommandOutput) => void): void;
    /**
     ...
     */
    disableImageDeregistrationProtection(args: DisableImageDeregistrationProtectionCommandInput, options?: __HttpHandlerOptions): Promise<DisableImageDeregistrationProtectionCommandOutput>;
    disableImageDeregistrationProtection(args: DisableImageDeregistrationProtectionCommandInput, cb: (err: any, data?: DisableImageDeregistrationProtectionCommandOutput) => void): void;
    disableImageDeregistrationProtection(args: DisableImageDeregistrationProtectionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisableImageDeregistrationProtectionCommandOutput) => void): void;
    /**
     * @see {@link DisableInstanceSqlHaStandbyDetectionsCommand}
     */
    disableInstanceSqlHaStandbyDetections(args: DisableInstanceSqlHaStandbyDetectionsCommandInput, options?: __HttpHandlerOptions): Promise<DisableInstanceSqlHaStandbyDetectionsCommandOutput>;
    disableInstanceSqlHaStandbyDetections(args: DisableInstanceSqlHaStandbyDetectionsCommandInput, cb: (err: any, data?: DisableInstanceSqlHaStandbyDetectionsCommandOutput) => void): void;
    disableInstanceSqlHaStandbyDetections(args: DisableInstanceSqlHaStandbyDetectionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisableInstanceSqlHaStandbyDetectionsCommandOutput) => void): void;
    /**
     ...
     */
    disableIpamPolicy(args: DisableIpamPolicyCommandInput, options?: __HttpHandlerOptions): Promise<DisableIpamPolicyCommandOutput>;
    disableIpamPolicy(args: DisableIpamPolicyCommandInput, cb: (err: any, data?: DisableIpamPolicyCommandOutput) => void): void;
    disableIpamPolicy(args: DisableIpamPolicyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisableIpamPolicyCommandOutput) => void): void;
    /**
     * @see {@link DisableRouteServerPropagationCommand}
     */
    disableRouteServerPropagation(args: DisableRouteServerPropagationCommandInput, options?: __HttpHandlerOptions): Promise<DisableRouteServerPropagationCommandOutput>;
    disableRouteServerPropagation(args: DisableRouteServerPropagationCommandInput, cb: (err: any, data?: DisableRouteServerPropagationCommandOutput) => void): void;
    disableRouteServerPropagation(args: DisableRouteServerPropagationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisableRouteServerPropagationCommandOutput) => void): void;
    /**
     ...
     */
    disassociateApplicationStatusCheck(args: DisassociateApplicationStatusCheckCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateApplicationStatusCheckCommandOutput>;
    disassociateApplicationStatusCheck(args: DisassociateApplicationStatusCheckCommandInput, cb: (err: any, data?: DisassociateApplicationStatusCheckCommandOutput) => void): void;
    disassociateApplicationStatusCheck(args: DisassociateApplicationStatusCheckCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateApplicationStatusCheckCommandOutput) => void): void;
    /**
     * @see {@link DisassociateCapacityReservationBillingOwnerCommand}
     */
    disassociateCapacityReservationBillingOwner(args: DisassociateCapacityReservationBillingOwnerCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateCapacityReservationBillingOwnerCommandOutput>;
    disassociateCapacityReservationBillingOwner(args: DisassociateCapacityReservationBillingOwnerCommandInput, cb: (err: any, data?: DisassociateCapacityReservationBillingOwnerCommandOutput) => void): void;
    disassociateCapacityReservationBillingOwner(args: DisassociateCapacityReservationBillingOwnerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateCapacityReservationBillingOwnerCommandOutput) => void): void;
    /**
     ...
     */
    disassociateIpamByoasn(args: DisassociateIpamByoasnCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateIpamByoasnCommandOutput>;
    disassociateIpamByoasn(args: DisassociateIpamByoasnCommandInput, cb: (err: any, data?: DisassociateIpamByoasnCommandOutput) => void): void;
    disassociateIpamByoasn(args: DisassociateIpamByoasnCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateIpamByoasnCommandOutput) => void): void;
    /**
     ...
     */
    disassociateRouteServer(args: DisassociateRouteServerCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateRouteServerCommandOutput>;
    disassociateRouteServer(args: DisassociateRouteServerCommandInput, cb: (err: any, data?: DisassociateRouteServerCommandOutput) => void): void;
    disassociateRouteServer(args: DisassociateRouteServerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateRouteServerCommandOutput) => void): void;
    /**
    ...
    enableApplicationStatusCheckSuppression(args: EnableApplicationStatusCheckSuppressionCommandInput, options?: __HttpHandlerOptions): Promise<EnableApplicationStatusCheckSuppressionCommandOutput>;
    enableApplicationStatusCheckSuppression(args: EnableApplicationStatusCheckSuppressionCommandInput, cb: (err: any, data?: EnableApplicationStatusCheckSuppressionCommandOutput) => void): void;
    enableApplicationStatusCheckSuppression(args: EnableApplicationStatusCheckSuppressionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: EnableApplicationStatusCheckSuppressionCommandOutput) => void): void;
    /**
    ...
    enableCapacityManager(args: EnableCapacityManagerCommandInput, options?: __HttpHandlerOptions): Promise<EnableCapacityManagerCommandOutput>;
    enableCapacityManager(args: EnableCapacityManagerCommandInput, cb: (err: any, data?: EnableCapacityManagerCommandOutput) => void): void;
    enableCapacityManager(args: EnableCapacityManagerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: EnableCapacityManagerCommandOutput) => void): void;
    /**
     ...
     */
    enableImageDeregistrationProtection(args: EnableImageDeregistrationProtectionCommandInput, options?: __HttpHandlerOptions): Promise<EnableImageDeregistrationProtectionCommandOutput>;
    enableImageDeregistrationProtection(args: EnableImageDeregistrationProtectionCommandInput, cb: (err: any, data?: EnableImageDeregistrationProtectionCommandOutput) => void): void;
    enableImageDeregistrationProtection(args: EnableImageDeregistrationProtectionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: EnableImageDeregistrationProtectionCommandOutput) => void): void;
    /**
     ...
     */
    enableIpamPolicy(args: EnableIpamPolicyCommandInput, options?: __HttpHandlerOptions): Promise<EnableIpamPolicyCommandOutput>;
    enableIpamPolicy(args: EnableIpamPolicyCommandInput, cb: (err: any, data?: EnableIpamPolicyCommandOutput) => void): void;
    enableIpamPolicy(args: EnableIpamPolicyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: EnableIpamPolicyCommandOutput) => void): void;
    /**
     ...
     */
    enableRouteServerPropagation(args: EnableRouteServerPropagationCommandInput, options?: __HttpHandlerOptions): Promise<EnableRouteServerPropagationCommandOutput>;
    enableRouteServerPropagation(args: EnableRouteServerPropagationCommandInput, cb: (err: any, data?: EnableRouteServerPropagationCommandOutput) => void): void;
    enableRouteServerPropagation(args: EnableRouteServerPropagationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: EnableRouteServerPropagationCommandOutput) => void): void;
    /**
    ...
    getCapacityManagerAttributes(args: GetCapacityManagerAttributesCommandInput, options?: __HttpHandlerOptions): Promise<GetCapacityManagerAttributesCommandOutput>;
    getCapacityManagerAttributes(args: GetCapacityManagerAttributesCommandInput, cb: (err: any, data?: GetCapacityManagerAttributesCommandOutput) => void): void;
    getCapacityManagerAttributes(args: GetCapacityManagerAttributesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetCapacityManagerAttributesCommandOutput) => void): void;
    /**
     * @see {@link GetCapacityManagerMetricDataCommand}
     */
    getCapacityManagerMetricData(args: GetCapacityManagerMetricDataCommandInput, options?: __HttpHandlerOptions): Promise<GetCapacityManagerMetricDataCommandOutput>;
    getCapacityManagerMetricData(args: GetCapacityManagerMetricDataCommandInput, cb: (err: any, data?: GetCapacityManagerMetricDataCommandOutput) => void): void;
    getCapacityManagerMetricData(args: GetCapacityManagerMetricDataCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetCapacityManagerMetricDataCommandOutput) => void): void;
    /**
    ...
    getEnabledIpamPolicy(args: GetEnabledIpamPolicyCommandInput, options?: __HttpHandlerOptions): Promise<GetEnabledIpamPolicyCommandOutput>;
    getEnabledIpamPolicy(args: GetEnabledIpamPolicyCommandInput, cb: (err: any, data?: GetEnabledIpamPolicyCommandOutput) => void): void;
    getEnabledIpamPolicy(args: GetEnabledIpamPolicyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetEnabledIpamPolicyCommandOutput) => void): void;
    /**
     ...
     */
    getImageAncestry(args: GetImageAncestryCommandInput, options?: __HttpHandlerOptions): Promise<GetImageAncestryCommandOutput>;
    getImageAncestry(args: GetImageAncestryCommandInput, cb: (err: any, data?: GetImageAncestryCommandOutput) => void): void;
    getImageAncestry(args: GetImageAncestryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetImageAncestryCommandOutput) => void): void;
    /**
     ...
     */
    getIpamDiscoveredPublicAddresses(args: GetIpamDiscoveredPublicAddressesCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamDiscoveredPublicAddressesCommandOutput>;
    getIpamDiscoveredPublicAddresses(args: GetIpamDiscoveredPublicAddressesCommandInput, cb: (err: any, data?: GetIpamDiscoveredPublicAddressesCommandOutput) => void): void;
    getIpamDiscoveredPublicAddresses(args: GetIpamDiscoveredPublicAddressesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamDiscoveredPublicAddressesCommandOutput) => void): void;
    /**
     ...
     */
    getIpamPolicyAllocationRules(args: GetIpamPolicyAllocationRulesCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamPolicyAllocationRulesCommandOutput>;
    getIpamPolicyAllocationRules(args: GetIpamPolicyAllocationRulesCommandInput, cb: (err: any, data?: GetIpamPolicyAllocationRulesCommandOutput) => void): void;
    getIpamPolicyAllocationRules(args: GetIpamPolicyAllocationRulesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamPolicyAllocationRulesCommandOutput) => void): void;
    /**
     * @see {@link GetIpamPolicyOrganizationTargetsCommand}
     */
    getIpamPolicyOrganizationTargets(args: GetIpamPolicyOrganizationTargetsCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamPolicyOrganizationTargetsCommandOutput>;
    getIpamPolicyOrganizationTargets(args: GetIpamPolicyOrganizationTargetsCommandInput, cb: (err: any, data?: GetIpamPolicyOrganizationTargetsCommandOutput) => void): void;
    getIpamPolicyOrganizationTargets(args: GetIpamPolicyOrganizationTargetsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamPolicyOrganizationTargetsCommandOutput) => void): void;
    /**
     ...
     */
    getIpamPrefixListResolverRules(args: GetIpamPrefixListResolverRulesCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamPrefixListResolverRulesCommandOutput>;
    getIpamPrefixListResolverRules(args: GetIpamPrefixListResolverRulesCommandInput, cb: (err: any, data?: GetIpamPrefixListResolverRulesCommandOutput) => void): void;
    getIpamPrefixListResolverRules(args: GetIpamPrefixListResolverRulesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamPrefixListResolverRulesCommandOutput) => void): void;
    /**
     * @see {@link GetIpamPrefixListResolverVersionEntriesCommand}
     */
    getIpamPrefixListResolverVersionEntries(args: GetIpamPrefixListResolverVersionEntriesCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamPrefixListResolverVersionEntriesCommandOutput>;
    getIpamPrefixListResolverVersionEntries(args: GetIpamPrefixListResolverVersionEntriesCommandInput, cb: (err: any, data?: GetIpamPrefixListResolverVersionEntriesCommandOutput) => void): void;
    getIpamPrefixListResolverVersionEntries(args: GetIpamPrefixListResolverVersionEntriesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamPrefixListResolverVersionEntriesCommandOutput) => void): void;
    /**
     * @see {@link GetIpamPrefixListResolverVersionsCommand}
     */
    getIpamPrefixListResolverVersions(args: GetIpamPrefixListResolverVersionsCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamPrefixListResolverVersionsCommandOutput>;
    getIpamPrefixListResolverVersions(args: GetIpamPrefixListResolverVersionsCommandInput, cb: (err: any, data?: GetIpamPrefixListResolverVersionsCommandOutput) => void): void;
    getIpamPrefixListResolverVersions(args: GetIpamPrefixListResolverVersionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamPrefixListResolverVersionsCommandOutput) => void): void;
    /**
     ...
     */
    getRouteServerAssociations(args: GetRouteServerAssociationsCommandInput, options?: __HttpHandlerOptions): Promise<GetRouteServerAssociationsCommandOutput>;
    getRouteServerAssociations(args: GetRouteServerAssociationsCommandInput, cb: (err: any, data?: GetRouteServerAssociationsCommandOutput) => void): void;
    getRouteServerAssociations(args: GetRouteServerAssociationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetRouteServerAssociationsCommandOutput) => void): void;
    /**
     * @see {@link GetRouteServerPropagationsCommand}
     */
    getRouteServerPropagations(args: GetRouteServerPropagationsCommandInput, options?: __HttpHandlerOptions): Promise<GetRouteServerPropagationsCommandOutput>;
    getRouteServerPropagations(args: GetRouteServerPropagationsCommandInput, cb: (err: any, data?: GetRouteServerPropagationsCommandOutput) => void): void;
    getRouteServerPropagations(args: GetRouteServerPropagationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetRouteServerPropagationsCommandOutput) => void): void;
    /**
     * @see {@link GetRouteServerRoutingDatabaseCommand}
     */
    getRouteServerRoutingDatabase(args: GetRouteServerRoutingDatabaseCommandInput, options?: __HttpHandlerOptions): Promise<GetRouteServerRoutingDatabaseCommandOutput>;
    getRouteServerRoutingDatabase(args: GetRouteServerRoutingDatabaseCommandInput, cb: (err: any, data?: GetRouteServerRoutingDatabaseCommandOutput) => void): void;
    getRouteServerRoutingDatabase(args: GetRouteServerRoutingDatabaseCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetRouteServerRoutingDatabaseCommandOutput) => void): void;
    /**
     * @see {@link GetSecurityGroupsForVpcCommand}
     */
    getSecurityGroupsForVpc(args: GetSecurityGroupsForVpcCommandInput, options?: __HttpHandlerOptions): Promise<GetSecurityGroupsForVpcCommandOutput>;
    getSecurityGroupsForVpc(args: GetSecurityGroupsForVpcCommandInput, cb: (err: any, data?: GetSecurityGroupsForVpcCommandOutput) => void): void;
    getSecurityGroupsForVpc(args: GetSecurityGroupsForVpcCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetSecurityGroupsForVpcCommandOutput) => void): void;
    /**
    ...
    modifyAccountVpcEncryptionControl(args: ModifyAccountVpcEncryptionControlCommandInput, options?: __HttpHandlerOptions): Promise<ModifyAccountVpcEncryptionControlCommandOutput>;
    modifyAccountVpcEncryptionControl(args: ModifyAccountVpcEncryptionControlCommandInput, cb: (err: any, data?: ModifyAccountVpcEncryptionControlCommandOutput) => void): void;
    modifyAccountVpcEncryptionControl(args: ModifyAccountVpcEncryptionControlCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyAccountVpcEncryptionControlCommandOutput) => void): void;
    /**
     ...
     */
    modifyApplicationStatusCheck(args: ModifyApplicationStatusCheckCommandInput, options?: __HttpHandlerOptions): Promise<ModifyApplicationStatusCheckCommandOutput>;
    modifyApplicationStatusCheck(args: ModifyApplicationStatusCheckCommandInput, cb: (err: any, data?: ModifyApplicationStatusCheckCommandOutput) => void): void;
    modifyApplicationStatusCheck(args: ModifyApplicationStatusCheckCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyApplicationStatusCheckCommandOutput) => void): void;
    /**
     ...
     */
    modifyInstanceConnectEndpoint(args: ModifyInstanceConnectEndpointCommandInput, options?: __HttpHandlerOptions): Promise<ModifyInstanceConnectEndpointCommandOutput>;
    modifyInstanceConnectEndpoint(args: ModifyInstanceConnectEndpointCommandInput, cb: (err: any, data?: ModifyInstanceConnectEndpointCommandOutput) => void): void;
    modifyInstanceConnectEndpoint(args: ModifyInstanceConnectEndpointCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyInstanceConnectEndpointCommandOutput) => void): void;
    /**
    ...
    modifyInstanceMetadataDefaults(args: ModifyInstanceMetadataDefaultsCommandInput, options?: __HttpHandlerOptions): Promise<ModifyInstanceMetadataDefaultsCommandOutput>;
    modifyInstanceMetadataDefaults(args: ModifyInstanceMetadataDefaultsCommandInput, cb: (err: any, data?: ModifyInstanceMetadataDefaultsCommandOutput) => void): void;
    modifyInstanceMetadataDefaults(args: ModifyInstanceMetadataDefaultsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyInstanceMetadataDefaultsCommandOutput) => void): void;
    /**
     ...
     */
    modifyIpamPolicyAllocationRules(args: ModifyIpamPolicyAllocationRulesCommandInput, options?: __HttpHandlerOptions): Promise<ModifyIpamPolicyAllocationRulesCommandOutput>;
    modifyIpamPolicyAllocationRules(args: ModifyIpamPolicyAllocationRulesCommandInput, cb: (err: any, data?: ModifyIpamPolicyAllocationRulesCommandOutput) => void): void;
    modifyIpamPolicyAllocationRules(args: ModifyIpamPolicyAllocationRulesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyIpamPolicyAllocationRulesCommandOutput) => void): void;
    /**
     ...
     */
    modifyIpamPrefixListResolver(args: ModifyIpamPrefixListResolverCommandInput, options?: __HttpHandlerOptions): Promise<ModifyIpamPrefixListResolverCommandOutput>;
    modifyIpamPrefixListResolver(args: ModifyIpamPrefixListResolverCommandInput, cb: (err: any, data?: ModifyIpamPrefixListResolverCommandOutput) => void): void;
    modifyIpamPrefixListResolver(args: ModifyIpamPrefixListResolverCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyIpamPrefixListResolverCommandOutput) => void): void;
    /**
     * @see {@link ModifyIpamPrefixListResolverTargetCommand}
     */
    modifyIpamPrefixListResolverTarget(args: ModifyIpamPrefixListResolverTargetCommandInput, options?: __HttpHandlerOptions): Promise<ModifyIpamPrefixListResolverTargetCommandOutput>;
    modifyIpamPrefixListResolverTarget(args: ModifyIpamPrefixListResolverTargetCommandInput, cb: (err: any, data?: ModifyIpamPrefixListResolverTargetCommandOutput) => void): void;
    modifyIpamPrefixListResolverTarget(args: ModifyIpamPrefixListResolverTargetCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyIpamPrefixListResolverTargetCommandOutput) => void): void;
    /**
     ...
     */
    modifyRouteServer(args: ModifyRouteServerCommandInput, options?: __HttpHandlerOptions): Promise<ModifyRouteServerCommandOutput>;
    modifyRouteServer(args: ModifyRouteServerCommandInput, cb: (err: any, data?: ModifyRouteServerCommandOutput) => void): void;
    modifyRouteServer(args: ModifyRouteServerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyRouteServerCommandOutput) => void): void;
    /**
     ...
     */
    modifyTransitGatewayPolicyTableEntry(args: ModifyTransitGatewayPolicyTableEntryCommandInput, options?: __HttpHandlerOptions): Promise<ModifyTransitGatewayPolicyTableEntryCommandOutput>;
    modifyTransitGatewayPolicyTableEntry(args: ModifyTransitGatewayPolicyTableEntryCommandInput, cb: (err: any, data?: ModifyTransitGatewayPolicyTableEntryCommandOutput) => void): void;
    modifyTransitGatewayPolicyTableEntry(args: ModifyTransitGatewayPolicyTableEntryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyTransitGatewayPolicyTableEntryCommandOutput) => void): void;
    /**
     ...
     */
    modifyVpcBlockPublicAccessExclusion(args: ModifyVpcBlockPublicAccessExclusionCommandInput, options?: __HttpHandlerOptions): Promise<ModifyVpcBlockPublicAccessExclusionCommandOutput>;
    modifyVpcBlockPublicAccessExclusion(args: ModifyVpcBlockPublicAccessExclusionCommandInput, cb: (err: any, data?: ModifyVpcBlockPublicAccessExclusionCommandOutput) => void): void;
    modifyVpcBlockPublicAccessExclusion(args: ModifyVpcBlockPublicAccessExclusionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyVpcBlockPublicAccessExclusionCommandOutput) => void): void;
    /**
     ...
     */
    provisionIpamByoasn(args: ProvisionIpamByoasnCommandInput, options?: __HttpHandlerOptions): Promise<ProvisionIpamByoasnCommandOutput>;
    provisionIpamByoasn(args: ProvisionIpamByoasnCommandInput, cb: (err: any, data?: ProvisionIpamByoasnCommandOutput) => void): void;
    provisionIpamByoasn(args: ProvisionIpamByoasnCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ProvisionIpamByoasnCommandOutput) => void): void;
    /**
     ...
     */
    purchaseCapacityBlockExtension(args: PurchaseCapacityBlockExtensionCommandInput, options?: __HttpHandlerOptions): Promise<PurchaseCapacityBlockExtensionCommandOutput>;
    purchaseCapacityBlockExtension(args: PurchaseCapacityBlockExtensionCommandInput, cb: (err: any, data?: PurchaseCapacityBlockExtensionCommandOutput) => void): void;
    purchaseCapacityBlockExtension(args: PurchaseCapacityBlockExtensionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PurchaseCapacityBlockExtensionCommandOutput) => void): void;
    /**
     ...
     */
    paginateGetTransitGatewayPolicyTableEntries(args: GetTransitGatewayPolicyTableEntriesCommandInput, paginationConfig?: Omit<PaginationConfiguration, "client">): Paginator<GetTransitGatewayPolicyTableEntriesCommandOutput>;
    /**
     * @see {@link GetTransitGatewayPrefixListReferencesCommand}
     * @param args - command input.
     * @param paginationConfig - optional pagination config.
