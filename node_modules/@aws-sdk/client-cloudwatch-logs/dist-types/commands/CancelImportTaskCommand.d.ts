...
declare const CancelImportTaskCommand_base: {
    new (input: CancelImportTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelImportTaskCommandInput, CancelImportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelImportTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelImportTaskCommandInput, CancelImportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
