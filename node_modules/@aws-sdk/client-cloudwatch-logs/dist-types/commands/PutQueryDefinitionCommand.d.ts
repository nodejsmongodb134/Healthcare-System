...
declare const PutQueryDefinitionCommand_base: {
    new (input: PutQueryDefinitionCommandInput): import("@smithy/core/client").CommandImpl<PutQueryDefinitionCommandInput, PutQueryDefinitionCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutQueryDefinitionCommandInput): import("@smithy/core/client").CommandImpl<PutQueryDefinitionCommandInput, PutQueryDefinitionCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutQueryDefinitionCommand extends PutQueryDefinitionCommand_base {
