...
declare const GetIntegrationCommand_base: {
    new (input: GetIntegrationCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIntegrationCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
