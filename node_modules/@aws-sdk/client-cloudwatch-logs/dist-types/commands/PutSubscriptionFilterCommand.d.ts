...
import type { PutSubscriptionFilterRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const PutSubscriptionFilterCommand_base: {
    new (input: PutSubscriptionFilterCommandInput): import("@smithy/core/client").CommandImpl<PutSubscriptionFilterCommandInput, PutSubscriptionFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutSubscriptionFilterCommandInput): import("@smithy/core/client").CommandImpl<PutSubscriptionFilterCommandInput, PutSubscriptionFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutSubscriptionFilterCommand extends PutSubscriptionFilterCommand_base {
