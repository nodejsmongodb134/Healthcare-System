...
declare const CreateLogGroupCommand_base: {
    new (input: CreateLogGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateLogGroupCommandInput, CreateLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLogGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateLogGroupCommandInput, CreateLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLogGroupCommand extends CreateLogGroupCommand_base {
