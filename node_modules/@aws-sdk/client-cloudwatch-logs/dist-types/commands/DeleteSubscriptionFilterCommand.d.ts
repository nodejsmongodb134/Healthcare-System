...
import type { DeleteSubscriptionFilterRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteSubscriptionFilterCommand_base: {
    new (input: DeleteSubscriptionFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubscriptionFilterCommandInput, DeleteSubscriptionFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSubscriptionFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubscriptionFilterCommandInput, DeleteSubscriptionFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteSubscriptionFilterCommand extends DeleteSubscriptionFilterCommand_base {
