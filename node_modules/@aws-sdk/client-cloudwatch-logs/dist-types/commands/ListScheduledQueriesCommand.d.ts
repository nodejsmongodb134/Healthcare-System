...
declare const ListScheduledQueriesCommand_base: {
    new (input: ListScheduledQueriesCommandInput): import("@smithy/core/client").CommandImpl<ListScheduledQueriesCommandInput, ListScheduledQueriesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListScheduledQueriesCommandInput]): import("@smithy/core/client").CommandImpl<ListScheduledQueriesCommandInput, ListScheduledQueriesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
