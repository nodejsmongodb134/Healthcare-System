...
declare const TagLogGroupCommand_base: {
    new (input: TagLogGroupCommandInput): import("@smithy/core/client").CommandImpl<TagLogGroupCommandInput, TagLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagLogGroupCommandInput): import("@smithy/core/client").CommandImpl<TagLogGroupCommandInput, TagLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TagLogGroupCommand extends TagLogGroupCommand_base {
