...
declare const GetScheduledQueryHistoryCommand_base: {
    new (input: GetScheduledQueryHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetScheduledQueryHistoryCommandInput, GetScheduledQueryHistoryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetScheduledQueryHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetScheduledQueryHistoryCommandInput, GetScheduledQueryHistoryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
