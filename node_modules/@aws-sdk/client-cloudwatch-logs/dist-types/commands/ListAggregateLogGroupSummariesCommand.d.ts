...
declare const ListAggregateLogGroupSummariesCommand_base: {
    new (input: ListAggregateLogGroupSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListAggregateLogGroupSummariesCommandInput, ListAggregateLogGroupSummariesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAggregateLogGroupSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListAggregateLogGroupSummariesCommandInput, ListAggregateLogGroupSummariesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
