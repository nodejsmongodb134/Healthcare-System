...
declare const DeleteDeliverySourceCommand_base: {
    new (input: DeleteDeliverySourceCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliverySourceCommandInput, DeleteDeliverySourceCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDeliverySourceCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliverySourceCommandInput, DeleteDeliverySourceCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteDeliverySourceCommand extends DeleteDeliverySourceCommand_base {
