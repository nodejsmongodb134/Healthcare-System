...
declare const DeleteSyslogConfigurationCommand_base: {
    new (input: DeleteSyslogConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSyslogConfigurationCommandInput, DeleteSyslogConfigurationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSyslogConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSyslogConfigurationCommandInput, DeleteSyslogConfigurationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
