...
import type { DescribeDeliveryDestinationsRequest, DescribeDeliveryDestinationsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeDeliveryDestinationsCommand_base: {
    new (input: DescribeDeliveryDestinationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeliveryDestinationsCommandInput, DescribeDeliveryDestinationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDeliveryDestinationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDeliveryDestinationsCommandInput, DescribeDeliveryDestinationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeDeliveryDestinationsCommand extends DescribeDeliveryDestinationsCommand_base {
