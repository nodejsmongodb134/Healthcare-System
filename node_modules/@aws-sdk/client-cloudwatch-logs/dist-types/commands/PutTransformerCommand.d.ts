...
declare const PutTransformerCommand_base: {
    new (input: PutTransformerCommandInput): import("@smithy/core/client").CommandImpl<PutTransformerCommandInput, PutTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutTransformerCommandInput): import("@smithy/core/client").CommandImpl<PutTransformerCommandInput, PutTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
