...
declare const DeleteIndexPolicyCommand_base: {
    new (input: DeleteIndexPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteIndexPolicyCommandInput, DeleteIndexPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIndexPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteIndexPolicyCommandInput, DeleteIndexPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
