...
declare const DescribeIndexPoliciesCommand_base: {
    new (input: DescribeIndexPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIndexPoliciesCommandInput, DescribeIndexPoliciesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeIndexPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIndexPoliciesCommandInput, DescribeIndexPoliciesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
