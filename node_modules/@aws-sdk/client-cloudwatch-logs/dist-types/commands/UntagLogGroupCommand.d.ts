...
declare const UntagLogGroupCommand_base: {
    new (input: UntagLogGroupCommandInput): import("@smithy/core/client").CommandImpl<UntagLogGroupCommandInput, UntagLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagLogGroupCommandInput): import("@smithy/core/client").CommandImpl<UntagLogGroupCommandInput, UntagLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
