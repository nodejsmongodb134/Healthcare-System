...
declare const DescribeResourcePoliciesCommand_base: {
    new (input: DescribeResourcePoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeResourcePoliciesCommandInput, DescribeResourcePoliciesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeResourcePoliciesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeResourcePoliciesCommandInput, DescribeResourcePoliciesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeResourcePoliciesCommand extends DescribeResourcePoliciesCommand_base {
