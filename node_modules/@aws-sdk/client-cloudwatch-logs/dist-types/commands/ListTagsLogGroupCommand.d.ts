...
declare const ListTagsLogGroupCommand_base: {
    new (input: ListTagsLogGroupCommandInput): import("@smithy/core/client").CommandImpl<ListTagsLogGroupCommandInput, ListTagsLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTagsLogGroupCommandInput): import("@smithy/core/client").CommandImpl<ListTagsLogGroupCommandInput, ListTagsLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListTagsLogGroupCommand extends ListTagsLogGroupCommand_base {
