...
declare const StartQueryCommand_base: {
    new (input: StartQueryCommandInput): import("@smithy/core/client").CommandImpl<StartQueryCommandInput, StartQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartQueryCommandInput): import("@smithy/core/client").CommandImpl<StartQueryCommandInput, StartQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
