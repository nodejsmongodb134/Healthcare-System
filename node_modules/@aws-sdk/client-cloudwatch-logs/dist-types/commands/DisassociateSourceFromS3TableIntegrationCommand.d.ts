...
import type { DisassociateSourceFromS3TableIntegrationRequest, DisassociateSourceFromS3TableIntegrationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DisassociateSourceFromS3TableIntegrationCommand_base: {
    new (input: DisassociateSourceFromS3TableIntegrationCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSourceFromS3TableIntegrationCommandInput, DisassociateSourceFromS3TableIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateSourceFromS3TableIntegrationCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSourceFromS3TableIntegrationCommandInput, DisassociateSourceFromS3TableIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
