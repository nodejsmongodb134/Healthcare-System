...
declare const ListLogGroupsCommand_base: {
    new (input: ListLogGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListLogGroupsCommandInput, ListLogGroupsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLogGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListLogGroupsCommandInput, ListLogGroupsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
