...
declare const DescribeConfigurationTemplatesCommand_base: {
    new (input: DescribeConfigurationTemplatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeConfigurationTemplatesCommandInput, DescribeConfigurationTemplatesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeConfigurationTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeConfigurationTemplatesCommandInput, DescribeConfigurationTemplatesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
