...
import type { CreateDeliveryRequest, CreateDeliveryResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateDeliveryCommand_base: {
    new (input: CreateDeliveryCommandInput): import("@smithy/core/client").CommandImpl<CreateDeliveryCommandInput, CreateDeliveryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDeliveryCommandInput): import("@smithy/core/client").CommandImpl<CreateDeliveryCommandInput, CreateDeliveryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateDeliveryCommand extends CreateDeliveryCommand_base {
