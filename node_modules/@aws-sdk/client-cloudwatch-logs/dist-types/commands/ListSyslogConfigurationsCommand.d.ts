...
declare const ListSyslogConfigurationsCommand_base: {
    new (input: ListSyslogConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<ListSyslogConfigurationsCommandInput, ListSyslogConfigurationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSyslogConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<ListSyslogConfigurationsCommandInput, ListSyslogConfigurationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
