...
declare const UpdateAnomalyCommand_base: {
    new (input: UpdateAnomalyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAnomalyCommandInput, UpdateAnomalyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAnomalyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAnomalyCommandInput, UpdateAnomalyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateAnomalyCommand extends UpdateAnomalyCommand_base {
