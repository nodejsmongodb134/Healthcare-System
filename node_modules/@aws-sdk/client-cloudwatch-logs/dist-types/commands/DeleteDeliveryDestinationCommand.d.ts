...
import type { DeleteDeliveryDestinationRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteDeliveryDestinationCommand_base: {
    new (input: DeleteDeliveryDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliveryDestinationCommandInput, DeleteDeliveryDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDeliveryDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliveryDestinationCommandInput, DeleteDeliveryDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteDeliveryDestinationCommand extends DeleteDeliveryDestinationCommand_base {
