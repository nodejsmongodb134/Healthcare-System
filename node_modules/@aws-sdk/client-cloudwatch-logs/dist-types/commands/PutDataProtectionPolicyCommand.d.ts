...
declare const PutDataProtectionPolicyCommand_base: {
    new (input: PutDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutDataProtectionPolicyCommandInput, PutDataProtectionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutDataProtectionPolicyCommandInput, PutDataProtectionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
