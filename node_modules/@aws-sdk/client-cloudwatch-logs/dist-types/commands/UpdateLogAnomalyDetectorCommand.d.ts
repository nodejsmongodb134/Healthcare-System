...
declare const UpdateLogAnomalyDetectorCommand_base: {
    new (input: UpdateLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<UpdateLogAnomalyDetectorCommandInput, UpdateLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<UpdateLogAnomalyDetectorCommandInput, UpdateLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateLogAnomalyDetectorCommand extends UpdateLogAnomalyDetectorCommand_base {
