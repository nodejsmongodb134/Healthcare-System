...
declare const DeleteDeliveryCommand_base: {
    new (input: DeleteDeliveryCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliveryCommandInput, DeleteDeliveryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDeliveryCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliveryCommandInput, DeleteDeliveryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteDeliveryCommand extends DeleteDeliveryCommand_base {
