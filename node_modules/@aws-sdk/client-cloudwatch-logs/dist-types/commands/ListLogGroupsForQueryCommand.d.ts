...
import type { ListLogGroupsForQueryRequest, ListLogGroupsForQueryResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListLogGroupsForQueryCommand_base: {
    new (input: ListLogGroupsForQueryCommandInput): import("@smithy/core/client").CommandImpl<ListLogGroupsForQueryCommandInput, ListLogGroupsForQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListLogGroupsForQueryCommandInput): import("@smithy/core/client").CommandImpl<ListLogGroupsForQueryCommandInput, ListLogGroupsForQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
