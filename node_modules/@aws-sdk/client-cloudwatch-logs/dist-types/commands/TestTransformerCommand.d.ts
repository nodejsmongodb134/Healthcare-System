...
declare const TestTransformerCommand_base: {
    new (input: TestTransformerCommandInput): import("@smithy/core/client").CommandImpl<TestTransformerCommandInput, TestTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TestTransformerCommandInput): import("@smithy/core/client").CommandImpl<TestTransformerCommandInput, TestTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
