...
declare const DeleteLogGroupCommand_base: {
    new (input: DeleteLogGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteLogGroupCommandInput, DeleteLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLogGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteLogGroupCommandInput, DeleteLogGroupCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
