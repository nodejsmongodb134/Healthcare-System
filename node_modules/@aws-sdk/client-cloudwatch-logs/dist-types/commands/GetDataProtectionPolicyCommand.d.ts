...
import type { GetDataProtectionPolicyRequest, GetDataProtectionPolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDataProtectionPolicyCommand_base: {
    new (input: GetDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetDataProtectionPolicyCommandInput, GetDataProtectionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetDataProtectionPolicyCommandInput, GetDataProtectionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
