...
import type { DeleteDestinationRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteDestinationCommand_base: {
    new (input: DeleteDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteDestinationCommandInput, DeleteDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteDestinationCommandInput, DeleteDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
