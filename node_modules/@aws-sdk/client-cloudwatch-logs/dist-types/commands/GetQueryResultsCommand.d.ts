...
declare const GetQueryResultsCommand_base: {
    new (input: GetQueryResultsCommandInput): import("@smithy/core/client").CommandImpl<GetQueryResultsCommandInput, GetQueryResultsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetQueryResultsCommandInput): import("@smithy/core/client").CommandImpl<GetQueryResultsCommandInput, GetQueryResultsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
