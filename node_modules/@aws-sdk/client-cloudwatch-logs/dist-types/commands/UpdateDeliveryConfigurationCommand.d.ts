...
declare const UpdateDeliveryConfigurationCommand_base: {
    new (input: UpdateDeliveryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeliveryConfigurationCommandInput, UpdateDeliveryConfigurationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDeliveryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeliveryConfigurationCommandInput, UpdateDeliveryConfigurationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
