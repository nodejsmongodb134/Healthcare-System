...
declare const GetDeliveryDestinationPolicyCommand_base: {
    new (input: GetDeliveryDestinationPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetDeliveryDestinationPolicyCommandInput, GetDeliveryDestinationPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeliveryDestinationPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetDeliveryDestinationPolicyCommandInput, GetDeliveryDestinationPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDeliveryDestinationPolicyCommand extends GetDeliveryDestinationPolicyCommand_base {
