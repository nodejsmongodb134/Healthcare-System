...
declare const DisassociateKmsKeyCommand_base: {
    new (input: DisassociateKmsKeyCommandInput): import("@smithy/core/client").CommandImpl<DisassociateKmsKeyCommandInput, DisassociateKmsKeyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisassociateKmsKeyCommandInput]): import("@smithy/core/client").CommandImpl<DisassociateKmsKeyCommandInput, DisassociateKmsKeyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateKmsKeyCommand extends DisassociateKmsKeyCommand_base {
