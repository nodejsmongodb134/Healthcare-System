...
declare const DescribeDeliveriesCommand_base: {
    new (input: DescribeDeliveriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeliveriesCommandInput, DescribeDeliveriesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDeliveriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDeliveriesCommandInput, DescribeDeliveriesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeDeliveriesCommand extends DescribeDeliveriesCommand_base {
