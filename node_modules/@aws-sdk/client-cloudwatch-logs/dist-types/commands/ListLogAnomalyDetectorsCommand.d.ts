...
import type { ListLogAnomalyDetectorsRequest, ListLogAnomalyDetectorsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListLogAnomalyDetectorsCommand_base: {
    new (input: ListLogAnomalyDetectorsCommandInput): import("@smithy/core/client").CommandImpl<ListLogAnomalyDetectorsCommandInput, ListLogAnomalyDetectorsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLogAnomalyDetectorsCommandInput]): import("@smithy/core/client").CommandImpl<ListLogAnomalyDetectorsCommandInput, ListLogAnomalyDetectorsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListLogAnomalyDetectorsCommand extends ListLogAnomalyDetectorsCommand_base {
