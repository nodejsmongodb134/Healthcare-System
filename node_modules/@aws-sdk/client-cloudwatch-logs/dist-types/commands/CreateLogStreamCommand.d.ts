...
import type { CreateLogStreamRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateLogStreamCommand_base: {
    new (input: CreateLogStreamCommandInput): import("@smithy/core/client").CommandImpl<CreateLogStreamCommandInput, CreateLogStreamCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLogStreamCommandInput): import("@smithy/core/client").CommandImpl<CreateLogStreamCommandInput, CreateLogStreamCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLogStreamCommand extends CreateLogStreamCommand_base {
