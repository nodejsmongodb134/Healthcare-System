...
declare const StopQueryCommand_base: {
    new (input: StopQueryCommandInput): import("@smithy/core/client").CommandImpl<StopQueryCommandInput, StopQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopQueryCommandInput): import("@smithy/core/client").CommandImpl<StopQueryCommandInput, StopQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
