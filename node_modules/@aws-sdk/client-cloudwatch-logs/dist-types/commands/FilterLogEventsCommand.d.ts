...
import type { FilterLogEventsRequest, FilterLogEventsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const FilterLogEventsCommand_base: {
    new (input: FilterLogEventsCommandInput): import("@smithy/core/client").CommandImpl<FilterLogEventsCommandInput, FilterLogEventsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [FilterLogEventsCommandInput]): import("@smithy/core/client").CommandImpl<FilterLogEventsCommandInput, FilterLogEventsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class FilterLogEventsCommand extends FilterLogEventsCommand_base {
