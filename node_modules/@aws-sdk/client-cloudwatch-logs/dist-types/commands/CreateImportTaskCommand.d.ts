...
declare const CreateImportTaskCommand_base: {
    new (input: CreateImportTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateImportTaskCommandInput, CreateImportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateImportTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateImportTaskCommandInput, CreateImportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
