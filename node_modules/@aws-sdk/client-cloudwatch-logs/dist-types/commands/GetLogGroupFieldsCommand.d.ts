...
declare const GetLogGroupFieldsCommand_base: {
    new (input: GetLogGroupFieldsCommandInput): import("@smithy/core/client").CommandImpl<GetLogGroupFieldsCommandInput, GetLogGroupFieldsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetLogGroupFieldsCommandInput]): import("@smithy/core/client").CommandImpl<GetLogGroupFieldsCommandInput, GetLogGroupFieldsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLogGroupFieldsCommand extends GetLogGroupFieldsCommand_base {
