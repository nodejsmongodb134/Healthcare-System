...
declare const CreateLogAnomalyDetectorCommand_base: {
    new (input: CreateLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<CreateLogAnomalyDetectorCommandInput, CreateLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<CreateLogAnomalyDetectorCommandInput, CreateLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLogAnomalyDetectorCommand extends CreateLogAnomalyDetectorCommand_base {
