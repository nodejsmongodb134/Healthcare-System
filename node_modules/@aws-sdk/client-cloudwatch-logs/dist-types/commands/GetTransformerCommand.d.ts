...
declare const GetTransformerCommand_base: {
    new (input: GetTransformerCommandInput): import("@smithy/core/client").CommandImpl<GetTransformerCommandInput, GetTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTransformerCommandInput): import("@smithy/core/client").CommandImpl<GetTransformerCommandInput, GetTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
