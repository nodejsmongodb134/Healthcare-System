...
declare const CreateScheduledQueryCommand_base: {
    new (input: CreateScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<CreateScheduledQueryCommandInput, CreateScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<CreateScheduledQueryCommandInput, CreateScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
