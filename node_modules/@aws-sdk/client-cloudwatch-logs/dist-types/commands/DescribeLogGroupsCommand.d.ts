...
declare const DescribeLogGroupsCommand_base: {
    new (input: DescribeLogGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLogGroupsCommandInput, DescribeLogGroupsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLogGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLogGroupsCommandInput, DescribeLogGroupsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
