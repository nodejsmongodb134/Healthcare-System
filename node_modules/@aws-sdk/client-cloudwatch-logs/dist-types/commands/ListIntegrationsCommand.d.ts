...
declare const ListIntegrationsCommand_base: {
    new (input: ListIntegrationsCommandInput): import("@smithy/core/client").CommandImpl<ListIntegrationsCommandInput, ListIntegrationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListIntegrationsCommandInput]): import("@smithy/core/client").CommandImpl<ListIntegrationsCommandInput, ListIntegrationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
