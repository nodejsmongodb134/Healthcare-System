...
declare const DescribeImportTaskBatchesCommand_base: {
    new (input: DescribeImportTaskBatchesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImportTaskBatchesCommandInput, DescribeImportTaskBatchesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImportTaskBatchesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImportTaskBatchesCommandInput, DescribeImportTaskBatchesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
