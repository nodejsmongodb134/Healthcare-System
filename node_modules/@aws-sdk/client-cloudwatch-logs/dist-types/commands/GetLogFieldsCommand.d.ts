...
declare const GetLogFieldsCommand_base: {
    new (input: GetLogFieldsCommandInput): import("@smithy/core/client").CommandImpl<GetLogFieldsCommandInput, GetLogFieldsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLogFieldsCommandInput): import("@smithy/core/client").CommandImpl<GetLogFieldsCommandInput, GetLogFieldsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
