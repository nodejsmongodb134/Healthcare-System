...
declare const PutIndexPolicyCommand_base: {
    new (input: PutIndexPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutIndexPolicyCommandInput, PutIndexPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutIndexPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutIndexPolicyCommandInput, PutIndexPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
