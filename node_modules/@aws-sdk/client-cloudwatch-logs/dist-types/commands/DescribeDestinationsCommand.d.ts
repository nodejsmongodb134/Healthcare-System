...
declare const DescribeDestinationsCommand_base: {
    new (input: DescribeDestinationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDestinationsCommandInput, DescribeDestinationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDestinationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDestinationsCommandInput, DescribeDestinationsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
