...
import type { GetDeliveryDestinationRequest, GetDeliveryDestinationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDeliveryDestinationCommand_base: {
    new (input: GetDeliveryDestinationCommandInput): import("@smithy/core/client").CommandImpl<GetDeliveryDestinationCommandInput, GetDeliveryDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeliveryDestinationCommandInput): import("@smithy/core/client").CommandImpl<GetDeliveryDestinationCommandInput, GetDeliveryDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDeliveryDestinationCommand extends GetDeliveryDestinationCommand_base {
