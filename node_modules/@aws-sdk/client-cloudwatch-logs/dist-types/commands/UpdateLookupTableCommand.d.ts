...
declare const UpdateLookupTableCommand_base: {
    new (input: UpdateLookupTableCommandInput): import("@smithy/core/client").CommandImpl<UpdateLookupTableCommandInput, UpdateLookupTableCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateLookupTableCommandInput): import("@smithy/core/client").CommandImpl<UpdateLookupTableCommandInput, UpdateLookupTableCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
