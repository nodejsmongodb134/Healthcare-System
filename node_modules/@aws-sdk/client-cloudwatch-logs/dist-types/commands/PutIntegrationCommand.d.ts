...
declare const PutIntegrationCommand_base: {
    new (input: PutIntegrationCommandInput): import("@smithy/core/client").CommandImpl<PutIntegrationCommandInput, PutIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutIntegrationCommandInput): import("@smithy/core/client").CommandImpl<PutIntegrationCommandInput, PutIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
