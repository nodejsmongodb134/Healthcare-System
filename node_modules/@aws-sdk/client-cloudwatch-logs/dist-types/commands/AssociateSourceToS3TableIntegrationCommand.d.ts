...
import type { AssociateSourceToS3TableIntegrationRequest, AssociateSourceToS3TableIntegrationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateSourceToS3TableIntegrationCommand_base: {
    new (input: AssociateSourceToS3TableIntegrationCommandInput): import("@smithy/core/client").CommandImpl<AssociateSourceToS3TableIntegrationCommandInput, AssociateSourceToS3TableIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateSourceToS3TableIntegrationCommandInput): import("@smithy/core/client").CommandImpl<AssociateSourceToS3TableIntegrationCommandInput, AssociateSourceToS3TableIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
