...
declare const GetLogEventsCommand_base: {
    new (input: GetLogEventsCommandInput): import("@smithy/core/client").CommandImpl<GetLogEventsCommandInput, GetLogEventsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLogEventsCommandInput): import("@smithy/core/client").CommandImpl<GetLogEventsCommandInput, GetLogEventsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLogEventsCommand extends GetLogEventsCommand_base {
