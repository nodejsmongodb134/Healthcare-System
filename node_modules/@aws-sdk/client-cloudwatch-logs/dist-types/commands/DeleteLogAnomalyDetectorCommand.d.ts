...
declare const DeleteLogAnomalyDetectorCommand_base: {
    new (input: DeleteLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<DeleteLogAnomalyDetectorCommandInput, DeleteLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<DeleteLogAnomalyDetectorCommandInput, DeleteLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteLogAnomalyDetectorCommand extends DeleteLogAnomalyDetectorCommand_base {
