...
declare const GetLookupTableCommand_base: {
    new (input: GetLookupTableCommandInput): import("@smithy/core/client").CommandImpl<GetLookupTableCommandInput, GetLookupTableCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLookupTableCommandInput): import("@smithy/core/client").CommandImpl<GetLookupTableCommandInput, GetLookupTableCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
