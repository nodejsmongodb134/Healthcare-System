...
declare const DescribeSubscriptionFiltersCommand_base: {
    new (input: DescribeSubscriptionFiltersCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubscriptionFiltersCommandInput, DescribeSubscriptionFiltersCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSubscriptionFiltersCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubscriptionFiltersCommandInput, DescribeSubscriptionFiltersCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
