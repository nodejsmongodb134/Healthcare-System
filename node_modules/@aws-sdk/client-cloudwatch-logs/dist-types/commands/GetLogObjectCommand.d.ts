...
declare const GetLogObjectCommand_base: {
    new (input: GetLogObjectCommandInput): import("@smithy/core/client").CommandImpl<GetLogObjectCommandInput, GetLogObjectCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLogObjectCommandInput): import("@smithy/core/client").CommandImpl<GetLogObjectCommandInput, GetLogObjectCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
