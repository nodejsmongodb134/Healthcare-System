...
declare const DescribeLookupTablesCommand_base: {
    new (input: DescribeLookupTablesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLookupTablesCommandInput, DescribeLookupTablesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLookupTablesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLookupTablesCommandInput, DescribeLookupTablesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
