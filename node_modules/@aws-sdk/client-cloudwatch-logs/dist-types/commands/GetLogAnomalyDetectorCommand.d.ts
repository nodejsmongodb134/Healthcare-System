...
declare const GetLogAnomalyDetectorCommand_base: {
    new (input: GetLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<GetLogAnomalyDetectorCommandInput, GetLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLogAnomalyDetectorCommandInput): import("@smithy/core/client").CommandImpl<GetLogAnomalyDetectorCommandInput, GetLogAnomalyDetectorCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLogAnomalyDetectorCommand extends GetLogAnomalyDetectorCommand_base {
