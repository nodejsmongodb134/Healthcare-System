...
declare const PutRetentionPolicyCommand_base: {
    new (input: PutRetentionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRetentionPolicyCommandInput, PutRetentionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRetentionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRetentionPolicyCommandInput, PutRetentionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
