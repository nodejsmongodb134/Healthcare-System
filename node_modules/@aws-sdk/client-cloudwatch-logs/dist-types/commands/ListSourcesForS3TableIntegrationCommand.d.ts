...
import type { ListSourcesForS3TableIntegrationRequest, ListSourcesForS3TableIntegrationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListSourcesForS3TableIntegrationCommand_base: {
    new (input: ListSourcesForS3TableIntegrationCommandInput): import("@smithy/core/client").CommandImpl<ListSourcesForS3TableIntegrationCommandInput, ListSourcesForS3TableIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSourcesForS3TableIntegrationCommandInput): import("@smithy/core/client").CommandImpl<ListSourcesForS3TableIntegrationCommandInput, ListSourcesForS3TableIntegrationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
