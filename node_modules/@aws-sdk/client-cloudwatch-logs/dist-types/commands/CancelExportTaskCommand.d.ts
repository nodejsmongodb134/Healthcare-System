...
import type { CancelExportTaskRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const CancelExportTaskCommand_base: {
    new (input: CancelExportTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelExportTaskCommandInput, CancelExportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelExportTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelExportTaskCommandInput, CancelExportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
