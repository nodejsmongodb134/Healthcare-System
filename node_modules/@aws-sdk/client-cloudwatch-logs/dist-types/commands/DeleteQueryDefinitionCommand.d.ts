...
import type { DeleteQueryDefinitionRequest, DeleteQueryDefinitionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteQueryDefinitionCommand_base: {
    new (input: DeleteQueryDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeleteQueryDefinitionCommandInput, DeleteQueryDefinitionCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteQueryDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeleteQueryDefinitionCommandInput, DeleteQueryDefinitionCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteQueryDefinitionCommand extends DeleteQueryDefinitionCommand_base {
