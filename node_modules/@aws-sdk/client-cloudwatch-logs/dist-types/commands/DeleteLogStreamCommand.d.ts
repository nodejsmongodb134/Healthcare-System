...
declare const DeleteLogStreamCommand_base: {
    new (input: DeleteLogStreamCommandInput): import("@smithy/core/client").CommandImpl<DeleteLogStreamCommandInput, DeleteLogStreamCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLogStreamCommandInput): import("@smithy/core/client").CommandImpl<DeleteLogStreamCommandInput, DeleteLogStreamCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteLogStreamCommand extends DeleteLogStreamCommand_base {
