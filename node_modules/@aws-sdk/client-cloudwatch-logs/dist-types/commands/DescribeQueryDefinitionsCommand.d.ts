...
import type { DescribeQueryDefinitionsRequest, DescribeQueryDefinitionsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeQueryDefinitionsCommand_base: {
    new (input: DescribeQueryDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeQueryDefinitionsCommandInput, DescribeQueryDefinitionsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeQueryDefinitionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeQueryDefinitionsCommandInput, DescribeQueryDefinitionsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeQueryDefinitionsCommand extends DescribeQueryDefinitionsCommand_base {
