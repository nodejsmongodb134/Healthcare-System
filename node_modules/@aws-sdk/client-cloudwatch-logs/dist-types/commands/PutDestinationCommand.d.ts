...
declare const PutDestinationCommand_base: {
    new (input: PutDestinationCommandInput): import("@smithy/core/client").CommandImpl<PutDestinationCommandInput, PutDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDestinationCommandInput): import("@smithy/core/client").CommandImpl<PutDestinationCommandInput, PutDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutDestinationCommand extends PutDestinationCommand_base {
