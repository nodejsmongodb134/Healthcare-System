...
import type { ListAnomaliesRequest, ListAnomaliesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAnomaliesCommand_base: {
    new (input: ListAnomaliesCommandInput): import("@smithy/core/client").CommandImpl<ListAnomaliesCommandInput, ListAnomaliesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAnomaliesCommandInput]): import("@smithy/core/client").CommandImpl<ListAnomaliesCommandInput, ListAnomaliesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAnomaliesCommand extends ListAnomaliesCommand_base {
