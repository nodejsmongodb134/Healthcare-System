...
declare const CreateExportTaskCommand_base: {
    new (input: CreateExportTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateExportTaskCommandInput, CreateExportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateExportTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateExportTaskCommandInput, CreateExportTaskCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateExportTaskCommand extends CreateExportTaskCommand_base {
