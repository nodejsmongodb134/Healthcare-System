...
declare const GetScheduledQueryCommand_base: {
    new (input: GetScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<GetScheduledQueryCommandInput, GetScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<GetScheduledQueryCommandInput, GetScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
