...
declare const PutBearerTokenAuthenticationCommand_base: {
    new (input: PutBearerTokenAuthenticationCommandInput): import("@smithy/core/client").CommandImpl<PutBearerTokenAuthenticationCommandInput, PutBearerTokenAuthenticationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBearerTokenAuthenticationCommandInput): import("@smithy/core/client").CommandImpl<PutBearerTokenAuthenticationCommandInput, PutBearerTokenAuthenticationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
