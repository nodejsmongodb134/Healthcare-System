...
declare const GetDeliveryCommand_base: {
    new (input: GetDeliveryCommandInput): import("@smithy/core/client").CommandImpl<GetDeliveryCommandInput, GetDeliveryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeliveryCommandInput): import("@smithy/core/client").CommandImpl<GetDeliveryCommandInput, GetDeliveryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDeliveryCommand extends GetDeliveryCommand_base {
