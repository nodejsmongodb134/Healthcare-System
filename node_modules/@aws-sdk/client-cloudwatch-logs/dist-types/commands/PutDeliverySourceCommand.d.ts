...
declare const PutDeliverySourceCommand_base: {
    new (input: PutDeliverySourceCommandInput): import("@smithy/core/client").CommandImpl<PutDeliverySourceCommandInput, PutDeliverySourceCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDeliverySourceCommandInput): import("@smithy/core/client").CommandImpl<PutDeliverySourceCommandInput, PutDeliverySourceCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutDeliverySourceCommand extends PutDeliverySourceCommand_base {
