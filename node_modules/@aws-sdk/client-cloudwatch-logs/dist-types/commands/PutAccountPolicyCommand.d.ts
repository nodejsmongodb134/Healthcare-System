...
declare const PutAccountPolicyCommand_base: {
    new (input: PutAccountPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutAccountPolicyCommandInput, PutAccountPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAccountPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutAccountPolicyCommandInput, PutAccountPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutAccountPolicyCommand extends PutAccountPolicyCommand_base {
