...
declare const DeleteScheduledQueryCommand_base: {
    new (input: DeleteScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<DeleteScheduledQueryCommandInput, DeleteScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<DeleteScheduledQueryCommandInput, DeleteScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
