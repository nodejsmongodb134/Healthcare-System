...
declare const PutLogGroupDeletionProtectionCommand_base: {
    new (input: PutLogGroupDeletionProtectionCommandInput): import("@smithy/core/client").CommandImpl<PutLogGroupDeletionProtectionCommandInput, PutLogGroupDeletionProtectionCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutLogGroupDeletionProtectionCommandInput): import("@smithy/core/client").CommandImpl<PutLogGroupDeletionProtectionCommandInput, PutLogGroupDeletionProtectionCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
