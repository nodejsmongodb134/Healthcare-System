...
import type { DeleteDataProtectionPolicyRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteDataProtectionPolicyCommand_base: {
    new (input: DeleteDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteDataProtectionPolicyCommandInput, DeleteDataProtectionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteDataProtectionPolicyCommandInput, DeleteDataProtectionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteDataProtectionPolicyCommand extends DeleteDataProtectionPolicyCommand_base {
