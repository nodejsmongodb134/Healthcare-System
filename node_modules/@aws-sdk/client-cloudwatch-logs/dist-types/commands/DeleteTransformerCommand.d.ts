...
declare const DeleteTransformerCommand_base: {
    new (input: DeleteTransformerCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransformerCommandInput, DeleteTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTransformerCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransformerCommandInput, DeleteTransformerCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
