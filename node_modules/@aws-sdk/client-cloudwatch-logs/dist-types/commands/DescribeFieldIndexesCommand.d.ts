...
import type { DescribeFieldIndexesRequest, DescribeFieldIndexesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeFieldIndexesCommand_base: {
    new (input: DescribeFieldIndexesCommandInput): import("@smithy/core/client").CommandImpl<DescribeFieldIndexesCommandInput, DescribeFieldIndexesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFieldIndexesCommandInput): import("@smithy/core/client").CommandImpl<DescribeFieldIndexesCommandInput, DescribeFieldIndexesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
