...
declare const AssociateKmsKeyCommand_base: {
    new (input: AssociateKmsKeyCommandInput): import("@smithy/core/client").CommandImpl<AssociateKmsKeyCommandInput, AssociateKmsKeyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateKmsKeyCommandInput): import("@smithy/core/client").CommandImpl<AssociateKmsKeyCommandInput, AssociateKmsKeyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
