...
declare const DescribeAccountPoliciesCommand_base: {
    new (input: DescribeAccountPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAccountPoliciesCommandInput, DescribeAccountPoliciesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAccountPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAccountPoliciesCommandInput, DescribeAccountPoliciesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeAccountPoliciesCommand extends DescribeAccountPoliciesCommand_base {
