...
declare const UpdateScheduledQueryCommand_base: {
    new (input: UpdateScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<UpdateScheduledQueryCommandInput, UpdateScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<UpdateScheduledQueryCommandInput, UpdateScheduledQueryCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
