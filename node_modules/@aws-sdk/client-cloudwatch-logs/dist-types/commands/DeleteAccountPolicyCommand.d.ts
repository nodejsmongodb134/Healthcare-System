...
declare const DeleteAccountPolicyCommand_base: {
    new (input: DeleteAccountPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccountPolicyCommandInput, DeleteAccountPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAccountPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccountPolicyCommandInput, DeleteAccountPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAccountPolicyCommand extends DeleteAccountPolicyCommand_base {
