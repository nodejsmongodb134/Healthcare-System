...
declare const DescribeLogStreamsCommand_base: {
    new (input: DescribeLogStreamsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLogStreamsCommandInput, DescribeLogStreamsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLogStreamsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLogStreamsCommandInput, DescribeLogStreamsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeLogStreamsCommand extends DescribeLogStreamsCommand_base {
