...
declare const GetLogRecordCommand_base: {
    new (input: GetLogRecordCommandInput): import("@smithy/core/client").CommandImpl<GetLogRecordCommandInput, GetLogRecordCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLogRecordCommandInput): import("@smithy/core/client").CommandImpl<GetLogRecordCommandInput, GetLogRecordCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
