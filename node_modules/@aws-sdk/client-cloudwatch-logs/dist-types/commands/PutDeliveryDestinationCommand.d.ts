...
declare const PutDeliveryDestinationCommand_base: {
    new (input: PutDeliveryDestinationCommandInput): import("@smithy/core/client").CommandImpl<PutDeliveryDestinationCommandInput, PutDeliveryDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDeliveryDestinationCommandInput): import("@smithy/core/client").CommandImpl<PutDeliveryDestinationCommandInput, PutDeliveryDestinationCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutDeliveryDestinationCommand extends PutDeliveryDestinationCommand_base {
