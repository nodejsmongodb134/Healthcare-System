...
declare const PutDestinationPolicyCommand_base: {
    new (input: PutDestinationPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutDestinationPolicyCommandInput, PutDestinationPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDestinationPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutDestinationPolicyCommandInput, PutDestinationPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
