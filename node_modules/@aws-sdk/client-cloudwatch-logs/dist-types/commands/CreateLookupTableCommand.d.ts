...
declare const CreateLookupTableCommand_base: {
    new (input: CreateLookupTableCommandInput): import("@smithy/core/client").CommandImpl<CreateLookupTableCommandInput, CreateLookupTableCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLookupTableCommandInput): import("@smithy/core/client").CommandImpl<CreateLookupTableCommandInput, CreateLookupTableCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
