...
declare const DescribeQueriesCommand_base: {
    new (input: DescribeQueriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeQueriesCommandInput, DescribeQueriesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeQueriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeQueriesCommandInput, DescribeQueriesCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeQueriesCommand extends DescribeQueriesCommand_base {
