...
declare const DescribeMetricFiltersCommand_base: {
    new (input: DescribeMetricFiltersCommandInput): import("@smithy/core/client").CommandImpl<DescribeMetricFiltersCommandInput, DescribeMetricFiltersCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeMetricFiltersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeMetricFiltersCommandInput, DescribeMetricFiltersCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeMetricFiltersCommand extends DescribeMetricFiltersCommand_base {
