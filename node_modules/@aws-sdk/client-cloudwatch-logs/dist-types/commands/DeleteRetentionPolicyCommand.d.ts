...
declare const DeleteRetentionPolicyCommand_base: {
    new (input: DeleteRetentionPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRetentionPolicyCommandInput, DeleteRetentionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRetentionPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRetentionPolicyCommandInput, DeleteRetentionPolicyCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
