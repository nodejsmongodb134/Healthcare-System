...
declare const StartLiveTailCommand_base: {
    new (input: StartLiveTailCommandInput): import("@smithy/core/client").CommandImpl<StartLiveTailCommandInput, StartLiveTailCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartLiveTailCommandInput): import("@smithy/core/client").CommandImpl<StartLiveTailCommandInput, StartLiveTailCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartLiveTailCommand extends StartLiveTailCommand_base {
