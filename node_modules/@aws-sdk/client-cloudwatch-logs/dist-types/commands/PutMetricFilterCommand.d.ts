...
import type { PutMetricFilterRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const PutMetricFilterCommand_base: {
    new (input: PutMetricFilterCommandInput): import("@smithy/core/client").CommandImpl<PutMetricFilterCommandInput, PutMetricFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutMetricFilterCommandInput): import("@smithy/core/client").CommandImpl<PutMetricFilterCommandInput, PutMetricFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutMetricFilterCommand extends PutMetricFilterCommand_base {
