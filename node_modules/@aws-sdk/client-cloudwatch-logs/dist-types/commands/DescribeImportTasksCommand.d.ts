...
declare const DescribeImportTasksCommand_base: {
    new (input: DescribeImportTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeImportTasksCommandInput, DescribeImportTasksCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeImportTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeImportTasksCommandInput, DescribeImportTasksCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
