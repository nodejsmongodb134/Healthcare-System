...
declare const PutLogEventsCommand_base: {
    new (input: PutLogEventsCommandInput): import("@smithy/core/client").CommandImpl<PutLogEventsCommandInput, PutLogEventsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutLogEventsCommandInput): import("@smithy/core/client").CommandImpl<PutLogEventsCommandInput, PutLogEventsCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutLogEventsCommand extends PutLogEventsCommand_base {
