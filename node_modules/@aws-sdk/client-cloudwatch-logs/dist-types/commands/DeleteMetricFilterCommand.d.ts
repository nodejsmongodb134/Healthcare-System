...
declare const DeleteMetricFilterCommand_base: {
    new (input: DeleteMetricFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteMetricFilterCommandInput, DeleteMetricFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMetricFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteMetricFilterCommandInput, DeleteMetricFilterCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteMetricFilterCommand extends DeleteMetricFilterCommand_base {
