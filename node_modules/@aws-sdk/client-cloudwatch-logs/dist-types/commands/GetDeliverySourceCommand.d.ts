...
import type { GetDeliverySourceRequest, GetDeliverySourceResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDeliverySourceCommand_base: {
    new (input: GetDeliverySourceCommandInput): import("@smithy/core/client").CommandImpl<GetDeliverySourceCommandInput, GetDeliverySourceCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeliverySourceCommandInput): import("@smithy/core/client").CommandImpl<GetDeliverySourceCommandInput, GetDeliverySourceCommandOutput, import("..").CloudWatchLogsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDeliverySourceCommand extends GetDeliverySourceCommand_base {
