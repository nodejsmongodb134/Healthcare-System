...
declare const StartChangeRequestExecutionCommand_base: {
    new (input: StartChangeRequestExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartChangeRequestExecutionCommandInput, StartChangeRequestExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartChangeRequestExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartChangeRequestExecutionCommandInput, StartChangeRequestExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
