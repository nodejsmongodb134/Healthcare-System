...
declare const StartAutomationExecutionCommand_base: {
    new (input: StartAutomationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartAutomationExecutionCommandInput, StartAutomationExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartAutomationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartAutomationExecutionCommandInput, StartAutomationExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
