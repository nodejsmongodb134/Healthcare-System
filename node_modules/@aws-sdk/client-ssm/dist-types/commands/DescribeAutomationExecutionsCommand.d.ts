...
import type { DescribeAutomationExecutionsRequest, DescribeAutomationExecutionsResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAutomationExecutionsCommand_base: {
    new (input: DescribeAutomationExecutionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutomationExecutionsCommandInput, DescribeAutomationExecutionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAutomationExecutionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAutomationExecutionsCommandInput, DescribeAutomationExecutionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
