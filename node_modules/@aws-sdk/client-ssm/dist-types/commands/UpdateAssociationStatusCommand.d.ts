...
import type { UpdateAssociationStatusRequest, UpdateAssociationStatusResult } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateAssociationStatusCommand_base: {
    new (input: UpdateAssociationStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateAssociationStatusCommandInput, UpdateAssociationStatusCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAssociationStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateAssociationStatusCommandInput, UpdateAssociationStatusCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
