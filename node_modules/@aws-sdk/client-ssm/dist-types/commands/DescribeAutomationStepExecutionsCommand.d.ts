...
import type { DescribeAutomationStepExecutionsRequest, DescribeAutomationStepExecutionsResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAutomationStepExecutionsCommand_base: {
    new (input: DescribeAutomationStepExecutionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutomationStepExecutionsCommandInput, DescribeAutomationStepExecutionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAutomationStepExecutionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutomationStepExecutionsCommandInput, DescribeAutomationStepExecutionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
