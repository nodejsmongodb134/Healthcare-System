...
import type { DescribeAssociationRequest, DescribeAssociationResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAssociationCommand_base: {
    new (input: DescribeAssociationCommandInput): import("@smithy/core/client").CommandImpl<DescribeAssociationCommandInput, DescribeAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAssociationCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAssociationCommandInput, DescribeAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
