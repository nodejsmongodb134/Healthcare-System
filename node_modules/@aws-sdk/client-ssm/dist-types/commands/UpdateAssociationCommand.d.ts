...
import type { UpdateAssociationRequest, UpdateAssociationResult } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateAssociationCommand_base: {
    new (input: UpdateAssociationCommandInput): import("@smithy/core/client").CommandImpl<UpdateAssociationCommandInput, UpdateAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAssociationCommandInput): import("@smithy/core/client").CommandImpl<UpdateAssociationCommandInput, UpdateAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
