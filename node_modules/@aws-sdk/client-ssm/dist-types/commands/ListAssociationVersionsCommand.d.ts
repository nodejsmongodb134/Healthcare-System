...
import type { ListAssociationVersionsRequest, ListAssociationVersionsResult } from "../models/models_1";
/**
 * @public
 */
...
declare const ListAssociationVersionsCommand_base: {
    new (input: ListAssociationVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListAssociationVersionsCommandInput, ListAssociationVersionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAssociationVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListAssociationVersionsCommandInput, ListAssociationVersionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
