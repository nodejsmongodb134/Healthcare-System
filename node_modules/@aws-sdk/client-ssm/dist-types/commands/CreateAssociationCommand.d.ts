...
declare const CreateAssociationCommand_base: {
    new (input: CreateAssociationCommandInput): import("@smithy/core/client").CommandImpl<CreateAssociationCommandInput, CreateAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAssociationCommandInput): import("@smithy/core/client").CommandImpl<CreateAssociationCommandInput, CreateAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
