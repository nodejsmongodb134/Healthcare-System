...
declare const StartExecutionPreviewCommand_base: {
    new (input: StartExecutionPreviewCommandInput): import("@smithy/core/client").CommandImpl<StartExecutionPreviewCommandInput, StartExecutionPreviewCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartExecutionPreviewCommandInput): import("@smithy/core/client").CommandImpl<StartExecutionPreviewCommandInput, StartExecutionPreviewCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
