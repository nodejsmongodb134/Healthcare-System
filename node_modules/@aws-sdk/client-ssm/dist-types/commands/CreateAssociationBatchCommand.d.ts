...
declare const CreateAssociationBatchCommand_base: {
    new (input: CreateAssociationBatchCommandInput): import("@smithy/core/client").CommandImpl<CreateAssociationBatchCommandInput, CreateAssociationBatchCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAssociationBatchCommandInput): import("@smithy/core/client").CommandImpl<CreateAssociationBatchCommandInput, CreateAssociationBatchCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
